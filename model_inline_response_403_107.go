...
// InlineResponse403107 struct for InlineResponse403107
type InlineResponse403107 struct {
...
func (o InlineResponse403107) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse403107 struct {
	value *InlineResponse403107
	isSet bool
}

func (v NullableInlineResponse403107) Get() *InlineResponse403107 {
	return v.value
}

func (v *NullableInlineResponse403107) Set(val *InlineResponse403107) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse403107) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse403107) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse403107(val *InlineResponse403107) *NullableInlineResponse403107 {
	return &NullableInlineResponse403107{value: val, isSet: true}
}

func (v NullableInlineResponse403107) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse403107) UnmarshalJSON(src []byte) error {
	v.isSet = true
