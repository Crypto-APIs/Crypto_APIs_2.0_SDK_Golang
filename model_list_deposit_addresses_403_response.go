...
type ListDepositAddresses403Response struct {
	...
	Error ListDepositAddressesE403 `json:"error"`
}
...
func NewListDepositAddresses403Response(apiVersion string, requestId string, error_ ListDepositAddressesE403) *ListDepositAddresses403Response {
	this := ListDepositAddresses403Response{}
...
func (o *ListDepositAddresses403Response) GetError() ListDepositAddressesE403 {
	if o == nil {
		var ret ListDepositAddressesE403
		return ret
	}
...
func (o ListDepositAddresses403Response) MarshalJSON() ([]byte, error) {
...
type NullableListDepositAddresses403Response struct {
	value *ListDepositAddresses403Response
	isSet bool
}

func (v NullableListDepositAddresses403Response) Get() *ListDepositAddresses403Response {
	return v.value
}

func (v *NullableListDepositAddresses403Response) Set(val *ListDepositAddresses403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDepositAddresses403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDepositAddresses403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDepositAddresses403Response(val *ListDepositAddresses403Response) *NullableListDepositAddresses403Response {
	return &NullableListDepositAddresses403Response{value: val, isSet: true}
}

func (v NullableListDepositAddresses403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDepositAddresses403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
