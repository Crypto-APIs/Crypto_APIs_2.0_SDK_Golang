...
type GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic struct {
...
func NewGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic(difficulty string, nonce string, size int32, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, sha3Uncles string, totalDifficulty string) *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic {
	this := GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic{}
...
func (o GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic struct {
	value *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) Get() *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) Set(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic {
	return &NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic) UnmarshalJSON(src []byte) error {
	v.isSet = true
