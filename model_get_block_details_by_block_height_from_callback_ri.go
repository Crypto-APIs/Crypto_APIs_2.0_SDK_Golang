...
type GetBlockDetailsByBlockHeightFromCallbackRI struct {
	...
	BlockchainSpecific GetBlockDetailsByBlockHeightFromCallbackRIBS `json:"blockchainSpecific"`
}
...
func NewGetBlockDetailsByBlockHeightFromCallbackRI(hash string, height int32, previousBlockHash string, timestamp int32, transactionsCount int32, blockchainSpecific GetBlockDetailsByBlockHeightFromCallbackRIBS) *GetBlockDetailsByBlockHeightFromCallbackRI {
	this := GetBlockDetailsByBlockHeightFromCallbackRI{}
	this.Hash = hash
	this.Height = height
...
func (o *GetBlockDetailsByBlockHeightFromCallbackRI) GetBlockchainSpecific() GetBlockDetailsByBlockHeightFromCallbackRIBS {
	if o == nil {
		var ret GetBlockDetailsByBlockHeightFromCallbackRIBS
		return ret
	}
...
func (o GetBlockDetailsByBlockHeightFromCallbackRI) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightFromCallbackRI struct {
	value *GetBlockDetailsByBlockHeightFromCallbackRI
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRI) Get() *GetBlockDetailsByBlockHeightFromCallbackRI {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRI) Set(val *GetBlockDetailsByBlockHeightFromCallbackRI) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRI) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightFromCallbackRI(val *GetBlockDetailsByBlockHeightFromCallbackRI) *NullableGetBlockDetailsByBlockHeightFromCallbackRI {
	return &NullableGetBlockDetailsByBlockHeightFromCallbackRI{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRI) UnmarshalJSON(src []byte) error {
	v.isSet = true
