...
// InlineResponse4032 struct for InlineResponse4032
...
func (o InlineResponse4032) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse4032 struct {
	value *InlineResponse4032
	isSet bool
}

func (v NullableInlineResponse4032) Get() *InlineResponse4032 {
	return v.value
}

func (v *NullableInlineResponse4032) Set(val *InlineResponse4032) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse4032) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse4032) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse4032(val *InlineResponse4032) *NullableInlineResponse4032 {
	return &NullableInlineResponse4032{value: val, isSet: true}
}

func (v NullableInlineResponse4032) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse4032) UnmarshalJSON(src []byte) error {
	v.isSet = true
