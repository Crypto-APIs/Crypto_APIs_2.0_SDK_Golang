...
type ListHDWalletXPubYPubZPubUTXOs400Response struct {
	...
	Error ListHDWalletXPubYPubZPubUTXOsE400 `json:"error"`
}
...
func (o *ListHDWalletXPubYPubZPubUTXOs400Response) GetError() ListHDWalletXPubYPubZPubUTXOsE400 {
	if o == nil {
		var ret ListHDWalletXPubYPubZPubUTXOsE400
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubUTXOs400Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubUTXOs400Response struct {
	value *ListHDWalletXPubYPubZPubUTXOs400Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubUTXOs400Response) Get() *ListHDWalletXPubYPubZPubUTXOs400Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs400Response) Set(val *ListHDWalletXPubYPubZPubUTXOs400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubUTXOs400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubUTXOs400Response(val *ListHDWalletXPubYPubZPubUTXOs400Response) *NullableListHDWalletXPubYPubZPubUTXOs400Response {
	return &NullableListHDWalletXPubYPubZPubUTXOs400Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubUTXOs400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
