...
type AddTokensToExistingFromAddress400Response struct {
	...
	Error AddTokensToExistingFromAddressE400 `json:"error"`
}
...
func (o *AddTokensToExistingFromAddress400Response) GetError() AddTokensToExistingFromAddressE400 {
	if o == nil {
		var ret AddTokensToExistingFromAddressE400
		return ret
	}
...
func (o AddTokensToExistingFromAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableAddTokensToExistingFromAddress400Response struct {
	value *AddTokensToExistingFromAddress400Response
	isSet bool
}

func (v NullableAddTokensToExistingFromAddress400Response) Get() *AddTokensToExistingFromAddress400Response {
	return v.value
}

func (v *NullableAddTokensToExistingFromAddress400Response) Set(val *AddTokensToExistingFromAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddTokensToExistingFromAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddTokensToExistingFromAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddTokensToExistingFromAddress400Response(val *AddTokensToExistingFromAddress400Response) *NullableAddTokensToExistingFromAddress400Response {
	return &NullableAddTokensToExistingFromAddress400Response{value: val, isSet: true}
}

func (v NullableAddTokensToExistingFromAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddTokensToExistingFromAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
