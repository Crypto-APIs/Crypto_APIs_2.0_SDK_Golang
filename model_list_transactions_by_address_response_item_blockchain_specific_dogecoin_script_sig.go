...
type ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig struct {
...
func NewListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig(asm string, hex string, type_ string) *ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig {
	this := ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig struct {
	value *ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig
	isSet bool
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) Get() *ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig {
	return v.value
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) Set(val *ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig(val *ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) *NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig {
	return &NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
