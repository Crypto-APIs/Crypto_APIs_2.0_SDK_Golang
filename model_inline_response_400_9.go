...
// InlineResponse4009 struct for InlineResponse4009
...
func (o InlineResponse4009) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse4009 struct {
	value *InlineResponse4009
	isSet bool
}

func (v NullableInlineResponse4009) Get() *InlineResponse4009 {
	return v.value
}

func (v *NullableInlineResponse4009) Set(val *InlineResponse4009) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse4009) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse4009) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse4009(val *InlineResponse4009) *NullableInlineResponse4009 {
	return &NullableInlineResponse4009{value: val, isSet: true}
}

func (v NullableInlineResponse4009) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse4009) UnmarshalJSON(src []byte) error {
	v.isSet = true
