...
// ListOmniTokensByAddress401Response struct for ListOmniTokensByAddress401Response
type ListOmniTokensByAddress401Response struct {
...
func NewListOmniTokensByAddress401Response(apiVersion string, requestId string, error_ ListOmniTokensByAddressE401) *ListOmniTokensByAddress401Response {
	this := ListOmniTokensByAddress401Response{}
...
func (o ListOmniTokensByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTokensByAddress401Response struct {
	value *ListOmniTokensByAddress401Response
	isSet bool
}

func (v NullableListOmniTokensByAddress401Response) Get() *ListOmniTokensByAddress401Response {
	return v.value
}

func (v *NullableListOmniTokensByAddress401Response) Set(val *ListOmniTokensByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTokensByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTokensByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTokensByAddress401Response(val *ListOmniTokensByAddress401Response) *NullableListOmniTokensByAddress401Response {
	return &NullableListOmniTokensByAddress401Response{value: val, isSet: true}
}

func (v NullableListOmniTokensByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTokensByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
