...
type ListUnconfirmedTransactionsByAddress403Response struct {
	...
	Error ListUnconfirmedTransactionsByAddressE403 `json:"error"`
}
...
func (o *ListUnconfirmedTransactionsByAddress403Response) GetError() ListUnconfirmedTransactionsByAddressE403 {
	if o == nil {
		var ret ListUnconfirmedTransactionsByAddressE403
		return ret
	}
...
func (o ListUnconfirmedTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddress403Response struct {
	value *ListUnconfirmedTransactionsByAddress403Response
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddress403Response) Get() *ListUnconfirmedTransactionsByAddress403Response {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddress403Response) Set(val *ListUnconfirmedTransactionsByAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddress403Response(val *ListUnconfirmedTransactionsByAddress403Response) *NullableListUnconfirmedTransactionsByAddress403Response {
	return &NullableListUnconfirmedTransactionsByAddress403Response{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
