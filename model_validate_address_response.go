...
// ValidateAddressResponse struct for ValidateAddressResponse
type ValidateAddressResponse struct {
	...
	Data ValidateAddressResponseData `json:"data"`
}
...
func (o *ValidateAddressResponse) GetData() ValidateAddressResponseData {
	if o == nil {
		var ret ValidateAddressResponseData
		return ret
	}
...
type NullableValidateAddressResponse struct {
	value *ValidateAddressResponse
	isSet bool
}

func (v NullableValidateAddressResponse) Get() *ValidateAddressResponse {
	return v.value
}

func (v *NullableValidateAddressResponse) Set(val *ValidateAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateAddressResponse(val *ValidateAddressResponse) *NullableValidateAddressResponse {
	return &NullableValidateAddressResponse{value: val, isSet: true}
}

func (v NullableValidateAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
