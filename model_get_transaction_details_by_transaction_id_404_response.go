...
type GetTransactionDetailsByTransactionID404Response struct {
	...
	Error BlockchainDataTransactionNotFound `json:"error"`
}
...
func NewGetTransactionDetailsByTransactionID404Response(apiVersion string, requestId string, error_ BlockchainDataTransactionNotFound) *GetTransactionDetailsByTransactionID404Response {
	this := GetTransactionDetailsByTransactionID404Response{}
...
func (o *GetTransactionDetailsByTransactionID404Response) GetError() BlockchainDataTransactionNotFound {
	if o == nil {
		var ret BlockchainDataTransactionNotFound
		return ret
	}
...
func (o GetTransactionDetailsByTransactionID404Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionID404Response struct {
	value *GetTransactionDetailsByTransactionID404Response
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionID404Response) Get() *GetTransactionDetailsByTransactionID404Response {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionID404Response) Set(val *GetTransactionDetailsByTransactionID404Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionID404Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionID404Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionID404Response(val *GetTransactionDetailsByTransactionID404Response) *NullableGetTransactionDetailsByTransactionID404Response {
	return &NullableGetTransactionDetailsByTransactionID404Response{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionID404Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionID404Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
