...
type GetHDWalletXPubYPubZPubDetails401Response struct {
...
func NewGetHDWalletXPubYPubZPubDetails401Response(apiVersion string, requestId string, error_ GetHDWalletXPubYPubZPubDetailsE401) *GetHDWalletXPubYPubZPubDetails401Response {
	this := GetHDWalletXPubYPubZPubDetails401Response{}
...
func (o GetHDWalletXPubYPubZPubDetails401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetHDWalletXPubYPubZPubDetails401Response struct {
	value *GetHDWalletXPubYPubZPubDetails401Response
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubDetails401Response) Get() *GetHDWalletXPubYPubZPubDetails401Response {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubDetails401Response) Set(val *GetHDWalletXPubYPubZPubDetails401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubDetails401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubDetails401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubDetails401Response(val *GetHDWalletXPubYPubZPubDetails401Response) *NullableGetHDWalletXPubYPubZPubDetails401Response {
	return &NullableGetHDWalletXPubYPubZPubDetails401Response{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubDetails401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubDetails401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
