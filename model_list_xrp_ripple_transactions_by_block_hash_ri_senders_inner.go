...
type ListXRPRippleTransactionsByBlockHashRISendersInner struct {
...
func NewListXRPRippleTransactionsByBlockHashRISendersInner(address string, amount string) *ListXRPRippleTransactionsByBlockHashRISendersInner {
	this := ListXRPRippleTransactionsByBlockHashRISendersInner{}
...
func (o ListXRPRippleTransactionsByBlockHashRISendersInner) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHashRISendersInner struct {
	value *ListXRPRippleTransactionsByBlockHashRISendersInner
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHashRISendersInner) Get() *ListXRPRippleTransactionsByBlockHashRISendersInner {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHashRISendersInner) Set(val *ListXRPRippleTransactionsByBlockHashRISendersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHashRISendersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHashRISendersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHashRISendersInner(val *ListXRPRippleTransactionsByBlockHashRISendersInner) *NullableListXRPRippleTransactionsByBlockHashRISendersInner {
	return &NullableListXRPRippleTransactionsByBlockHashRISendersInner{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHashRISendersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHashRISendersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
