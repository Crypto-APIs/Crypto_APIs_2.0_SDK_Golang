...
func (a *AssetsApiService) GetAssetDetailsByAssetIDExecute(r ApiGetAssetDetailsByAssetIDRequest) (*GetAssetDetailsByAssetIDR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v GetAssetDetailsByAssetID400Response
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v GetAssetDetailsByAssetID401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v GetAssetDetailsByAssetID403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *AssetsApiService) GetAssetDetailsByAssetSymbolExecute(r ApiGetAssetDetailsByAssetSymbolRequest) (*GetAssetDetailsByAssetSymbolR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v GetAssetDetailsByAssetSymbol400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v GetAssetDetailsByAssetSymbol401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v GetAssetDetailsByAssetSymbol403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *AssetsApiService) ListAssetsDetailsExecute(r ApiListAssetsDetailsRequest) (*ListAssetsDetailsR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ListAssetsDetails400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v ListAssetsDetails401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v ListAssetsDetails403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
