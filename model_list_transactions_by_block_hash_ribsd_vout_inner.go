...
type ListTransactionsByBlockHashRIBSDVoutInner struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByBlockHashRIBSDVoutInner(isSpent bool, scriptPubKey ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey, value string) *ListTransactionsByBlockHashRIBSDVoutInner {
	this := ListTransactionsByBlockHashRIBSDVoutInner{}
...
func (o *ListTransactionsByBlockHashRIBSDVoutInner) GetScriptPubKey() ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey {
	if o == nil {
		var ret ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey
		return ret
	}
...
func (o ListTransactionsByBlockHashRIBSDVoutInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSDVoutInner struct {
	value *ListTransactionsByBlockHashRIBSDVoutInner
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSDVoutInner) Get() *ListTransactionsByBlockHashRIBSDVoutInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSDVoutInner) Set(val *ListTransactionsByBlockHashRIBSDVoutInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSDVoutInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSDVoutInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSDVoutInner(val *ListTransactionsByBlockHashRIBSDVoutInner) *NullableListTransactionsByBlockHashRIBSDVoutInner {
	return &NullableListTransactionsByBlockHashRIBSDVoutInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSDVoutInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSDVoutInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
