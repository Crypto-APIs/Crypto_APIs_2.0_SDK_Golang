...
type GetWalletTransactionDetailsByTransactionIDRIBSBSC struct {
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSBSC(contract string, gasLimit string, gasPrice GetTransactionDetailsByTransactionIDRIBSBSCGasPrice, gasUsed string, inputData string, nonce int32) *GetWalletTransactionDetailsByTransactionIDRIBSBSC {
	this := GetWalletTransactionDetailsByTransactionIDRIBSBSC{}
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSBSC) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSBSC
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC) Get() *GetWalletTransactionDetailsByTransactionIDRIBSBSC {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSBSC) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSBSC(val *GetWalletTransactionDetailsByTransactionIDRIBSBSC) *NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBSC) UnmarshalJSON(src []byte) error {
	v.isSet = true
