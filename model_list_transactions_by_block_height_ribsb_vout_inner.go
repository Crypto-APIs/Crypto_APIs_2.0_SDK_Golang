...
type ListTransactionsByBlockHeightRIBSBVoutInner struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByBlockHeightRIBSBVoutInner(isSpent bool, scriptPubKey ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey, value string) *ListTransactionsByBlockHeightRIBSBVoutInner {
	this := ListTransactionsByBlockHeightRIBSBVoutInner{}
...
func (o *ListTransactionsByBlockHeightRIBSBVoutInner) GetScriptPubKey() ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey {
	if o == nil {
		var ret ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey
		return ret
	}
...
func (o ListTransactionsByBlockHeightRIBSBVoutInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSBVoutInner struct {
	value *ListTransactionsByBlockHeightRIBSBVoutInner
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSBVoutInner) Get() *ListTransactionsByBlockHeightRIBSBVoutInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSBVoutInner) Set(val *ListTransactionsByBlockHeightRIBSBVoutInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSBVoutInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSBVoutInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSBVoutInner(val *ListTransactionsByBlockHeightRIBSBVoutInner) *NullableListTransactionsByBlockHeightRIBSBVoutInner {
	return &NullableListTransactionsByBlockHeightRIBSBVoutInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSBVoutInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSBVoutInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
