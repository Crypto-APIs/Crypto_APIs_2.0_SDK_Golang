...
type GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey struct {
...
func NewGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey {
	this := GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey{}
...
func (o GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey struct {
	value *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) Get() *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) Set(val *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey(val *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey {
	return &NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
