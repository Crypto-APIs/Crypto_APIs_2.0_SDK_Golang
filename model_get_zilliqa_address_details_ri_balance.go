...
type GetZilliqaAddressDetailsRIBalance struct {
...
func NewGetZilliqaAddressDetailsRIBalance(amount string, unit string) *GetZilliqaAddressDetailsRIBalance {
	this := GetZilliqaAddressDetailsRIBalance{}
	this.Amount = amount
	this.Unit = unit
	return &this
}
...
func (o GetZilliqaAddressDetailsRIBalance) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaAddressDetailsRIBalance struct {
	value *GetZilliqaAddressDetailsRIBalance
	isSet bool
}

func (v NullableGetZilliqaAddressDetailsRIBalance) Get() *GetZilliqaAddressDetailsRIBalance {
	return v.value
}

func (v *NullableGetZilliqaAddressDetailsRIBalance) Set(val *GetZilliqaAddressDetailsRIBalance) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaAddressDetailsRIBalance) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaAddressDetailsRIBalance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaAddressDetailsRIBalance(val *GetZilliqaAddressDetailsRIBalance) *NullableGetZilliqaAddressDetailsRIBalance {
	return &NullableGetZilliqaAddressDetailsRIBalance{value: val, isSet: true}
}

func (v NullableGetZilliqaAddressDetailsRIBalance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaAddressDetailsRIBalance) UnmarshalJSON(src []byte) error {
	v.isSet = true
