...
type ListHDWalletXPubYPubZPubTransactionsE401 struct {
...
func (dst *ListHDWalletXPubYPubZPubTransactionsE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListHDWalletXPubYPubZPubTransactionsE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListHDWalletXPubYPubZPubTransactionsE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListHDWalletXPubYPubZPubTransactionsE401) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactionsE401 struct {
	value *ListHDWalletXPubYPubZPubTransactionsE401
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactionsE401) Get() *ListHDWalletXPubYPubZPubTransactionsE401 {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsE401) Set(val *ListHDWalletXPubYPubZPubTransactionsE401) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactionsE401) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactionsE401(val *ListHDWalletXPubYPubZPubTransactionsE401) *NullableListHDWalletXPubYPubZPubTransactionsE401 {
	return &NullableListHDWalletXPubYPubZPubTransactionsE401{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactionsE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
