...
type ListTransactionsByBlockHashRData struct {
	...
	Items []ListTransactionsByBlockHashRI `json:"items"`
}
...
func NewListTransactionsByBlockHashRData(offset int32, limit int32, total int32, items []ListTransactionsByBlockHashRI) *ListTransactionsByBlockHashRData {
	this := ListTransactionsByBlockHashRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListTransactionsByBlockHashRData) GetItems() []ListTransactionsByBlockHashRI {
	if o == nil {
		var ret []ListTransactionsByBlockHashRI
		return ret
	}
...
func (o ListTransactionsByBlockHashRData) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRData struct {
	value *ListTransactionsByBlockHashRData
	isSet bool
}

func (v NullableListTransactionsByBlockHashRData) Get() *ListTransactionsByBlockHashRData {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRData) Set(val *ListTransactionsByBlockHashRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRData(val *ListTransactionsByBlockHashRData) *NullableListTransactionsByBlockHashRData {
	return &NullableListTransactionsByBlockHashRData{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
