...
type CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner struct {
...
func NewCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner(address string, amount string) *CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner {
	this := CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner{}
...
func (o CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) MarshalJSON() ([]byte, error) {
...
type NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner struct {
	value *CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner
	isSet bool
}

func (v NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) Get() *CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner {
	return v.value
}

func (v *NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) Set(val *CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner(val *CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) *NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner {
	return &NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner{value: val, isSet: true}
}

func (v NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
