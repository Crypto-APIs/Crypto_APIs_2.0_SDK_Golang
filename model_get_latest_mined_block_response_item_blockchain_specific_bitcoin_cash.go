...
type GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash struct {
...
func NewGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, version int32, versionHex string) *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash {
	this := GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash{}
...
func (o GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash struct {
	value *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) Get() *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) Set(val *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash(val *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) *NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash {
	return &NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) UnmarshalJSON(src []byte) error {
	v.isSet = true
