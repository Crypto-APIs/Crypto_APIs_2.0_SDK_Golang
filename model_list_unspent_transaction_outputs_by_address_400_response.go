...
type ListUnspentTransactionOutputsByAddress400Response struct {
	...
	Error ListUnspentTransactionOutputsByAddressE400 `json:"error"`
}
...
func (o *ListUnspentTransactionOutputsByAddress400Response) GetError() ListUnspentTransactionOutputsByAddressE400 {
	if o == nil {
		var ret ListUnspentTransactionOutputsByAddressE400
		return ret
	}
...
func (o ListUnspentTransactionOutputsByAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableListUnspentTransactionOutputsByAddress400Response struct {
	value *ListUnspentTransactionOutputsByAddress400Response
	isSet bool
}

func (v NullableListUnspentTransactionOutputsByAddress400Response) Get() *ListUnspentTransactionOutputsByAddress400Response {
	return v.value
}

func (v *NullableListUnspentTransactionOutputsByAddress400Response) Set(val *ListUnspentTransactionOutputsByAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnspentTransactionOutputsByAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnspentTransactionOutputsByAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnspentTransactionOutputsByAddress400Response(val *ListUnspentTransactionOutputsByAddress400Response) *NullableListUnspentTransactionOutputsByAddress400Response {
	return &NullableListUnspentTransactionOutputsByAddress400Response{value: val, isSet: true}
}

func (v NullableListUnspentTransactionOutputsByAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnspentTransactionOutputsByAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
