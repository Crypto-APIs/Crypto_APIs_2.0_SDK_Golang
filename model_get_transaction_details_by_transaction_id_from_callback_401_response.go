...
type GetTransactionDetailsByTransactionIDFromCallback401Response struct {
	...
	Error GetTransactionDetailsByTransactionIDFromCallbackE401 `json:"error"`
}
...
func (o *GetTransactionDetailsByTransactionIDFromCallback401Response) GetError() GetTransactionDetailsByTransactionIDFromCallbackE401 {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDFromCallbackE401
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDFromCallback401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallback401Response struct {
	value *GetTransactionDetailsByTransactionIDFromCallback401Response
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallback401Response) Get() *GetTransactionDetailsByTransactionIDFromCallback401Response {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallback401Response) Set(val *GetTransactionDetailsByTransactionIDFromCallback401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallback401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallback401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallback401Response(val *GetTransactionDetailsByTransactionIDFromCallback401Response) *NullableGetTransactionDetailsByTransactionIDFromCallback401Response {
	return &NullableGetTransactionDetailsByTransactionIDFromCallback401Response{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallback401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallback401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
