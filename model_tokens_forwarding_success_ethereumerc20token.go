...
type TokensForwardingSuccessEthereumerc20token struct {
...
func NewTokensForwardingSuccessEthereumerc20token(name string, symbol string, amount string, contractAddress string) *TokensForwardingSuccessEthereumerc20token {
	this := TokensForwardingSuccessEthereumerc20token{}
	this.Name = name
	this.Symbol = symbol
	this.Amount = amount
...
func (o TokensForwardingSuccessEthereumerc20token) MarshalJSON() ([]byte, error) {
...
type NullableTokensForwardingSuccessEthereumerc20token struct {
	value *TokensForwardingSuccessEthereumerc20token
	isSet bool
}

func (v NullableTokensForwardingSuccessEthereumerc20token) Get() *TokensForwardingSuccessEthereumerc20token {
	return v.value
}

func (v *NullableTokensForwardingSuccessEthereumerc20token) Set(val *TokensForwardingSuccessEthereumerc20token) {
	v.value = val
	v.isSet = true
}

func (v NullableTokensForwardingSuccessEthereumerc20token) IsSet() bool {
	return v.isSet
}

func (v *NullableTokensForwardingSuccessEthereumerc20token) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokensForwardingSuccessEthereumerc20token(val *TokensForwardingSuccessEthereumerc20token) *NullableTokensForwardingSuccessEthereumerc20token {
	return &NullableTokensForwardingSuccessEthereumerc20token{value: val, isSet: true}
}

func (v NullableTokensForwardingSuccessEthereumerc20token) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokensForwardingSuccessEthereumerc20token) UnmarshalJSON(src []byte) error {
	v.isSet = true
