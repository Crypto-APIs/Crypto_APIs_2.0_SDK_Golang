...
type NewBlock400Response struct {
...
func (o NewBlock400Response) MarshalJSON() ([]byte, error) {
...
type NullableNewBlock400Response struct {
	value *NewBlock400Response
	isSet bool
}

func (v NullableNewBlock400Response) Get() *NewBlock400Response {
	return v.value
}

func (v *NullableNewBlock400Response) Set(val *NewBlock400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewBlock400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewBlock400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewBlock400Response(val *NewBlock400Response) *NullableNewBlock400Response {
	return &NullableNewBlock400Response{value: val, isSet: true}
}

func (v NullableNewBlock400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewBlock400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
