...
// ListAssetsDetails401Response struct for ListAssetsDetails401Response
type ListAssetsDetails401Response struct {
...
func NewListAssetsDetails401Response(apiVersion string, requestId string, error_ ListAssetsDetailsE401) *ListAssetsDetails401Response {
	this := ListAssetsDetails401Response{}
...
func (o ListAssetsDetails401Response) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetails401Response struct {
	value *ListAssetsDetails401Response
	isSet bool
}

func (v NullableListAssetsDetails401Response) Get() *ListAssetsDetails401Response {
	return v.value
}

func (v *NullableListAssetsDetails401Response) Set(val *ListAssetsDetails401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetails401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetails401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetails401Response(val *ListAssetsDetails401Response) *NullableListAssetsDetails401Response {
	return &NullableListAssetsDetails401Response{value: val, isSet: true}
}

func (v NullableListAssetsDetails401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetails401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
