...
// ListAssetsDetailsR struct for ListAssetsDetailsR
type ListAssetsDetailsR struct {
	...
	Data ListAssetsDetailsRData `json:"data"`
}
...
func (o *ListAssetsDetailsR) GetData() ListAssetsDetailsRData {
	if o == nil {
		var ret ListAssetsDetailsRData
		return ret
	}
...
func (o ListAssetsDetailsR) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetailsR struct {
	value *ListAssetsDetailsR
	isSet bool
}

func (v NullableListAssetsDetailsR) Get() *ListAssetsDetailsR {
	return v.value
}

func (v *NullableListAssetsDetailsR) Set(val *ListAssetsDetailsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetailsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetailsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetailsR(val *ListAssetsDetailsR) *NullableListAssetsDetailsR {
	return &NullableListAssetsDetailsR{value: val, isSet: true}
}

func (v NullableListAssetsDetailsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetailsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
