...
type GetZilliqaTransactionDetailsByTransactionIDE403 struct {
...
func (dst *GetZilliqaTransactionDetailsByTransactionIDE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetZilliqaTransactionDetailsByTransactionIDE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetZilliqaTransactionDetailsByTransactionIDE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetZilliqaTransactionDetailsByTransactionIDE403) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaTransactionDetailsByTransactionIDE403 struct {
	value *GetZilliqaTransactionDetailsByTransactionIDE403
	isSet bool
}

func (v NullableGetZilliqaTransactionDetailsByTransactionIDE403) Get() *GetZilliqaTransactionDetailsByTransactionIDE403 {
	return v.value
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionIDE403) Set(val *GetZilliqaTransactionDetailsByTransactionIDE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaTransactionDetailsByTransactionIDE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionIDE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaTransactionDetailsByTransactionIDE403(val *GetZilliqaTransactionDetailsByTransactionIDE403) *NullableGetZilliqaTransactionDetailsByTransactionIDE403 {
	return &NullableGetZilliqaTransactionDetailsByTransactionIDE403{value: val, isSet: true}
}

func (v NullableGetZilliqaTransactionDetailsByTransactionIDE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionIDE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
