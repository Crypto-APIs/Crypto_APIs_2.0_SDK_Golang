...
type AddressTokensTransactionUnconfirmedErc20 struct {
...
func NewAddressTokensTransactionUnconfirmedErc20(name string, symbol string, amount string, contractAddress string) *AddressTokensTransactionUnconfirmedErc20 {
	this := AddressTokensTransactionUnconfirmedErc20{}
	this.Name = name
	this.Symbol = symbol
	this.Amount = amount
...
func (o AddressTokensTransactionUnconfirmedErc20) MarshalJSON() ([]byte, error) {
...
type NullableAddressTokensTransactionUnconfirmedErc20 struct {
	value *AddressTokensTransactionUnconfirmedErc20
	isSet bool
}

func (v NullableAddressTokensTransactionUnconfirmedErc20) Get() *AddressTokensTransactionUnconfirmedErc20 {
	return v.value
}

func (v *NullableAddressTokensTransactionUnconfirmedErc20) Set(val *AddressTokensTransactionUnconfirmedErc20) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressTokensTransactionUnconfirmedErc20) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressTokensTransactionUnconfirmedErc20) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressTokensTransactionUnconfirmedErc20(val *AddressTokensTransactionUnconfirmedErc20) *NullableAddressTokensTransactionUnconfirmedErc20 {
	return &NullableAddressTokensTransactionUnconfirmedErc20{value: val, isSet: true}
}

func (v NullableAddressTokensTransactionUnconfirmedErc20) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressTokensTransactionUnconfirmedErc20) UnmarshalJSON(src []byte) error {
	v.isSet = true
