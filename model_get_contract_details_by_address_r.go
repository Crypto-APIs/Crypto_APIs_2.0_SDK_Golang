...
// GetContractDetailsByAddressR struct for GetContractDetailsByAddressR
type GetContractDetailsByAddressR struct {
	...
	Data GetContractDetailsByAddressRData `json:"data"`
}
...
func NewGetContractDetailsByAddressR(apiVersion string, requestId string, data GetContractDetailsByAddressRData) *GetContractDetailsByAddressR {
	this := GetContractDetailsByAddressR{}
...
func (o *GetContractDetailsByAddressR) GetData() GetContractDetailsByAddressRData {
	if o == nil {
		var ret GetContractDetailsByAddressRData
		return ret
	}
...
func (o GetContractDetailsByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableGetContractDetailsByAddressR struct {
	value *GetContractDetailsByAddressR
	isSet bool
}

func (v NullableGetContractDetailsByAddressR) Get() *GetContractDetailsByAddressR {
	return v.value
}

func (v *NullableGetContractDetailsByAddressR) Set(val *GetContractDetailsByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContractDetailsByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContractDetailsByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContractDetailsByAddressR(val *GetContractDetailsByAddressR) *NullableGetContractDetailsByAddressR {
	return &NullableGetContractDetailsByAddressR{value: val, isSet: true}
}

func (v NullableGetContractDetailsByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContractDetailsByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
