...
type GetLatestMinedBlockRIBSE struct {
...
func (o GetLatestMinedBlockRIBSE) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockRIBSE struct {
	value *GetLatestMinedBlockRIBSE
	isSet bool
}

func (v NullableGetLatestMinedBlockRIBSE) Get() *GetLatestMinedBlockRIBSE {
	return v.value
}

func (v *NullableGetLatestMinedBlockRIBSE) Set(val *GetLatestMinedBlockRIBSE) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockRIBSE) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockRIBSE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockRIBSE(val *GetLatestMinedBlockRIBSE) *NullableGetLatestMinedBlockRIBSE {
	return &NullableGetLatestMinedBlockRIBSE{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockRIBSE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockRIBSE) UnmarshalJSON(src []byte) error {
	v.isSet = true
