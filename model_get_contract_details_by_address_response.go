...
// GetContractDetailsByAddressResponse struct for GetContractDetailsByAddressResponse
type GetContractDetailsByAddressResponse struct {
	...
	Data GetContractDetailsByAddressResponseData `json:"data"`
}
...
func NewGetContractDetailsByAddressResponse(apiVersion string, requestId string, data GetContractDetailsByAddressResponseData) *GetContractDetailsByAddressResponse {
	this := GetContractDetailsByAddressResponse{}
...
func (o *GetContractDetailsByAddressResponse) GetData() GetContractDetailsByAddressResponseData {
	if o == nil {
		var ret GetContractDetailsByAddressResponseData
		return ret
	}
...
func (o GetContractDetailsByAddressResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetContractDetailsByAddressResponse struct {
	value *GetContractDetailsByAddressResponse
	isSet bool
}

func (v NullableGetContractDetailsByAddressResponse) Get() *GetContractDetailsByAddressResponse {
	return v.value
}

func (v *NullableGetContractDetailsByAddressResponse) Set(val *GetContractDetailsByAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContractDetailsByAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContractDetailsByAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContractDetailsByAddressResponse(val *GetContractDetailsByAddressResponse) *NullableGetContractDetailsByAddressResponse {
	return &NullableGetContractDetailsByAddressResponse{value: val, isSet: true}
}

func (v NullableGetContractDetailsByAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContractDetailsByAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
