...
// GetUnconfirmedOmniTransactionByTransactionIDTxidE400 - struct for GetUnconfirmedOmniTransactionByTransactionIDTxidE400
type GetUnconfirmedOmniTransactionByTransactionIDTxidE400 struct {
...
func (dst *GetUnconfirmedOmniTransactionByTransactionIDTxidE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetUnconfirmedOmniTransactionByTransactionIDTxidE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetUnconfirmedOmniTransactionByTransactionIDTxidE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetUnconfirmedOmniTransactionByTransactionIDTxidE400) MarshalJSON() ([]byte, error) {
...
type NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400 struct {
	value *GetUnconfirmedOmniTransactionByTransactionIDTxidE400
	isSet bool
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400) Get() *GetUnconfirmedOmniTransactionByTransactionIDTxidE400 {
	return v.value
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400) Set(val *GetUnconfirmedOmniTransactionByTransactionIDTxidE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400(val *GetUnconfirmedOmniTransactionByTransactionIDTxidE400) *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400 {
	return &NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400{value: val, isSet: true}
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
