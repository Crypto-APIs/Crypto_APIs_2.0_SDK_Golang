...
type GetWalletTransactionDetailsByTransactionIDRIBSP struct {
	// Represents the specific transaction contract
	Contract string `json:"contract"`
	// Represents the amount of gas used by this specific transaction alone.
	GasLimit string `json:"gasLimit"`
	GasPrice GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice `json:"gasPrice"`
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSP(contract string, gasLimit string, gasPrice GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice, gasUsed string, inputData string, nonce int32) *GetWalletTransactionDetailsByTransactionIDRIBSP {
	this := GetWalletTransactionDetailsByTransactionIDRIBSP{}
...
func (o *GetWalletTransactionDetailsByTransactionIDRIBSP) GetGasPrice() GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice {
	if o == nil {
		var ret GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice
		return ret
	}
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSP) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSP struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSP
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSP) Get() *GetWalletTransactionDetailsByTransactionIDRIBSP {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSP) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSP) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSP) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSP) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSP(val *GetWalletTransactionDetailsByTransactionIDRIBSP) *NullableGetWalletTransactionDetailsByTransactionIDRIBSP {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSP{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSP) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSP) UnmarshalJSON(src []byte) error {
	v.isSet = true
