...
type ListWalletTransactionsE403 struct {
...
func BannedIpAddressAsListWalletTransactionsE403(v *BannedIpAddress) ListWalletTransactionsE403 {
	return ListWalletTransactionsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListWalletTransactionsE403(v *EndpointNotAllowedForApiKey) ListWalletTransactionsE403 {
	return ListWalletTransactionsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListWalletTransactionsE403(v *EndpointNotAllowedForPlan) ListWalletTransactionsE403 {
	return ListWalletTransactionsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListWalletTransactionsE403(v *FeatureMainnetsNotAllowedForPlan) ListWalletTransactionsE403 {
	return ListWalletTransactionsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListWalletTransactionsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListWalletTransactionsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListWalletTransactionsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListWalletTransactionsE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListWalletTransactionsE403) GetActualInstance() (interface{}) {
...
type NullableListWalletTransactionsE403 struct {
	value *ListWalletTransactionsE403
	isSet bool
}

func (v NullableListWalletTransactionsE403) Get() *ListWalletTransactionsE403 {
	return v.value
}

func (v *NullableListWalletTransactionsE403) Set(val *ListWalletTransactionsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListWalletTransactionsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListWalletTransactionsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWalletTransactionsE403(val *ListWalletTransactionsE403) *NullableListWalletTransactionsE403 {
	return &NullableListWalletTransactionsE403{value: val, isSet: true}
}

func (v NullableListWalletTransactionsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWalletTransactionsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
