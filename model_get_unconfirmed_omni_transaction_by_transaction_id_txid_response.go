...
// GetUnconfirmedOmniTransactionByTransactionIDTxidResponse struct for GetUnconfirmedOmniTransactionByTransactionIDTxidResponse
type GetUnconfirmedOmniTransactionByTransactionIDTxidResponse struct {
	...
	Data GetUnconfirmedOmniTransactionByTransactionIDTxidResponseData `json:"data"`
}
...
func NewGetUnconfirmedOmniTransactionByTransactionIDTxidResponse(apiVersion string, requestId string, data GetUnconfirmedOmniTransactionByTransactionIDTxidResponseData) *GetUnconfirmedOmniTransactionByTransactionIDTxidResponse {
	this := GetUnconfirmedOmniTransactionByTransactionIDTxidResponse{}
...
func (o *GetUnconfirmedOmniTransactionByTransactionIDTxidResponse) GetData() GetUnconfirmedOmniTransactionByTransactionIDTxidResponseData {
	if o == nil {
		var ret GetUnconfirmedOmniTransactionByTransactionIDTxidResponseData
		return ret
	}
...
func (o GetUnconfirmedOmniTransactionByTransactionIDTxidResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse struct {
	value *GetUnconfirmedOmniTransactionByTransactionIDTxidResponse
	isSet bool
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse) Get() *GetUnconfirmedOmniTransactionByTransactionIDTxidResponse {
	return v.value
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse) Set(val *GetUnconfirmedOmniTransactionByTransactionIDTxidResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse(val *GetUnconfirmedOmniTransactionByTransactionIDTxidResponse) *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse {
	return &NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse{value: val, isSet: true}
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
