...
type GetFeeAddressDetailsE403 struct {
...
func BannedIpAddressAsGetFeeAddressDetailsE403(v *BannedIpAddress) GetFeeAddressDetailsE403 {
	return GetFeeAddressDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetFeeAddressDetailsE403(v *EndpointNotAllowedForApiKey) GetFeeAddressDetailsE403 {
	return GetFeeAddressDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetFeeAddressDetailsE403(v *EndpointNotAllowedForPlan) GetFeeAddressDetailsE403 {
	return GetFeeAddressDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetFeeAddressDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetFeeAddressDetailsE403 {
	return GetFeeAddressDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetFeeAddressDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetFeeAddressDetailsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetFeeAddressDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetFeeAddressDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetFeeAddressDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetFeeAddressDetailsE403 struct {
	value *GetFeeAddressDetailsE403
	isSet bool
}

func (v NullableGetFeeAddressDetailsE403) Get() *GetFeeAddressDetailsE403 {
	return v.value
}

func (v *NullableGetFeeAddressDetailsE403) Set(val *GetFeeAddressDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeAddressDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeAddressDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeAddressDetailsE403(val *GetFeeAddressDetailsE403) *NullableGetFeeAddressDetailsE403 {
	return &NullableGetFeeAddressDetailsE403{value: val, isSet: true}
}

func (v NullableGetFeeAddressDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeAddressDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
