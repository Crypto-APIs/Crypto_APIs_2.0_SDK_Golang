...
type GetBlockDetailsByBlockHeightFromCallbackRIBSD2 struct {
...
func NewGetBlockDetailsByBlockHeightFromCallbackRIBSD2(bits string, chainwork string, difficulty string, merkleRoot string, nonce int64, size int32, strippedSize int32, version int32, weight int32) *GetBlockDetailsByBlockHeightFromCallbackRIBSD2 {
	this := GetBlockDetailsByBlockHeightFromCallbackRIBSD2{}
	this.Bits = bits
...
func (o GetBlockDetailsByBlockHeightFromCallbackRIBSD2) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2 struct {
	value *GetBlockDetailsByBlockHeightFromCallbackRIBSD2
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2) Get() *GetBlockDetailsByBlockHeightFromCallbackRIBSD2 {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2) Set(val *GetBlockDetailsByBlockHeightFromCallbackRIBSD2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2(val *GetBlockDetailsByBlockHeightFromCallbackRIBSD2) *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2 {
	return &NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD2) UnmarshalJSON(src []byte) error {
	v.isSet = true
