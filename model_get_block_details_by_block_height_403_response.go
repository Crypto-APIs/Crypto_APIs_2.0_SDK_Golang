...
type GetBlockDetailsByBlockHeight403Response struct {
...
func NewGetBlockDetailsByBlockHeight403Response(apiVersion string, requestId string, error_ GetBlockDetailsByBlockHeightE403) *GetBlockDetailsByBlockHeight403Response {
	this := GetBlockDetailsByBlockHeight403Response{}
...
func (o GetBlockDetailsByBlockHeight403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeight403Response struct {
	value *GetBlockDetailsByBlockHeight403Response
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeight403Response) Get() *GetBlockDetailsByBlockHeight403Response {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeight403Response) Set(val *GetBlockDetailsByBlockHeight403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeight403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeight403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeight403Response(val *GetBlockDetailsByBlockHeight403Response) *NullableGetBlockDetailsByBlockHeight403Response {
	return &NullableGetBlockDetailsByBlockHeight403Response{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeight403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeight403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
