...
type ConvertBitcoinCashAddress500Response struct {
	...
	Error UnexpectedServerError `json:"error"`
}
...
func NewConvertBitcoinCashAddress500Response(apiVersion string, requestId string, error_ UnexpectedServerError) *ConvertBitcoinCashAddress500Response {
	this := ConvertBitcoinCashAddress500Response{}
...
func (o ConvertBitcoinCashAddress500Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress500Response struct {
	value *ConvertBitcoinCashAddress500Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress500Response) Get() *ConvertBitcoinCashAddress500Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress500Response) Set(val *ConvertBitcoinCashAddress500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress500Response(val *ConvertBitcoinCashAddress500Response) *NullableConvertBitcoinCashAddress500Response {
	return &NullableConvertBitcoinCashAddress500Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
