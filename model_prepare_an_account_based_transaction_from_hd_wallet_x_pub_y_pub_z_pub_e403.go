...
type PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 struct {
...
func BannedIpAddressAsPrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(v *BannedIpAddress) PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 {
...
func EndpointNotAllowedForApiKeyAsPrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(v *EndpointNotAllowedForApiKey) PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 {
	return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403{
...
func EndpointNotAllowedForPlanAsPrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(v *EndpointNotAllowedForPlan) PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 {
	return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403{
...
func FeatureMainnetsNotAllowedForPlanAsPrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(v *FeatureMainnetsNotAllowedForPlan) PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 {
	return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403{
...
func (dst *PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) MarshalJSON() ([]byte, error) {
...
func (obj *PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 struct {
	value *PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403
	isSet bool
}

func (v NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) Get() *PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 {
	return v.value
}

func (v *NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) Set(val *PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) {
	v.value = val
	v.isSet = true
}

func (v NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) IsSet() bool {
	return v.isSet
}

func (v *NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(val *PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) *NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 {
	return &NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403{value: val, isSet: true}
}

func (v NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
