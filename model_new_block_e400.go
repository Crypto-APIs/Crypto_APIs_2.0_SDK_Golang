...
func InvalidPaginationAsNewBlockE400(v *InvalidPagination) NewBlockE400 {
	return NewBlockE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsNewBlockE400(v *LimitGreaterThanAllowed) NewBlockE400 {
	return NewBlockE400{ LimitGreaterThanAllowed: v}
}

// UriNotFoundAsNewBlockE400 is a convenience function that returns UriNotFound wrapped in NewBlockE400
func UriNotFoundAsNewBlockE400(v *UriNotFound) NewBlockE400 {
	return NewBlockE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *NewBlockE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewBlockE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewBlockE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewBlockE400) MarshalJSON() ([]byte, error) {
...
func (obj *NewBlockE400) GetActualInstance() (interface{}) {
...
type NullableNewBlockE400 struct {
	value *NewBlockE400
	isSet bool
}

func (v NullableNewBlockE400) Get() *NewBlockE400 {
	return v.value
}

func (v *NullableNewBlockE400) Set(val *NewBlockE400) {
	v.value = val
	v.isSet = true
}

func (v NullableNewBlockE400) IsSet() bool {
	return v.isSet
}

func (v *NullableNewBlockE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewBlockE400(val *NewBlockE400) *NullableNewBlockE400 {
	return &NullableNewBlockE400{value: val, isSet: true}
}

func (v NullableNewBlockE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewBlockE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
