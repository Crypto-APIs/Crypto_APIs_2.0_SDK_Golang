...
type ListTransactionsByBlockHashRIBSD2ScriptPubKey struct {
...
func NewListTransactionsByBlockHashRIBSD2ScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHashRIBSD2ScriptPubKey {
	this := ListTransactionsByBlockHashRIBSD2ScriptPubKey{}
...
func (o ListTransactionsByBlockHashRIBSD2ScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSD2ScriptPubKey struct {
	value *ListTransactionsByBlockHashRIBSD2ScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSD2ScriptPubKey) Get() *ListTransactionsByBlockHashRIBSD2ScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSD2ScriptPubKey) Set(val *ListTransactionsByBlockHashRIBSD2ScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSD2ScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSD2ScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSD2ScriptPubKey(val *ListTransactionsByBlockHashRIBSD2ScriptPubKey) *NullableListTransactionsByBlockHashRIBSD2ScriptPubKey {
	return &NullableListTransactionsByBlockHashRIBSD2ScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSD2ScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSD2ScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
