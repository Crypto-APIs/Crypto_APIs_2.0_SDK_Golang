...
// ListTokensTransfersByAddressResponseItem struct for ListTokensTransfersByAddressResponseItem
type ListTokensTransfersByAddressResponseItem struct {
...
func NewListTokensTransfersByAddressResponseItem(contractAddress string, minedInBlockHeight int32, recipientAddress string, senderAddress string, tokenDecimals int32, tokenName string, tokenSymbol string, tokenType string, tokensAmount string, transactionHash string, transactionTimestamp int32) *ListTokensTransfersByAddressResponseItem {
	this := ListTokensTransfersByAddressResponseItem{}
...
func (o ListTokensTransfersByAddressResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByAddressResponseItem struct {
	value *ListTokensTransfersByAddressResponseItem
	isSet bool
}

func (v NullableListTokensTransfersByAddressResponseItem) Get() *ListTokensTransfersByAddressResponseItem {
	return v.value
}

func (v *NullableListTokensTransfersByAddressResponseItem) Set(val *ListTokensTransfersByAddressResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByAddressResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByAddressResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByAddressResponseItem(val *ListTokensTransfersByAddressResponseItem) *NullableListTokensTransfersByAddressResponseItem {
	return &NullableListTokensTransfersByAddressResponseItem{value: val, isSet: true}
}

func (v NullableListTokensTransfersByAddressResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByAddressResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
