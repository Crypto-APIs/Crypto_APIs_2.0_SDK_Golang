...
type ListWalletTransactions400Response struct {
	...
	Error ListWalletTransactionsE400 `json:"error"`
}
...
func NewListWalletTransactions400Response(apiVersion string, requestId string, error_ ListWalletTransactionsE400) *ListWalletTransactions400Response {
	this := ListWalletTransactions400Response{}
...
func (o *ListWalletTransactions400Response) GetError() ListWalletTransactionsE400 {
	if o == nil {
		var ret ListWalletTransactionsE400
		return ret
	}
...
func (o ListWalletTransactions400Response) MarshalJSON() ([]byte, error) {
...
type NullableListWalletTransactions400Response struct {
	value *ListWalletTransactions400Response
	isSet bool
}

func (v NullableListWalletTransactions400Response) Get() *ListWalletTransactions400Response {
	return v.value
}

func (v *NullableListWalletTransactions400Response) Set(val *ListWalletTransactions400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListWalletTransactions400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListWalletTransactions400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWalletTransactions400Response(val *ListWalletTransactions400Response) *NullableListWalletTransactions400Response {
	return &NullableListWalletTransactions400Response{value: val, isSet: true}
}

func (v NullableListWalletTransactions400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWalletTransactions400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
