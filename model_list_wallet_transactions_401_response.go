...
type ListWalletTransactions401Response struct {
	...
	Error ListWalletTransactionsE401 `json:"error"`
}
...
func (o *ListWalletTransactions401Response) GetError() ListWalletTransactionsE401 {
	if o == nil {
		var ret ListWalletTransactionsE401
		return ret
	}
...
func (o ListWalletTransactions401Response) MarshalJSON() ([]byte, error) {
...
type NullableListWalletTransactions401Response struct {
	value *ListWalletTransactions401Response
	isSet bool
}

func (v NullableListWalletTransactions401Response) Get() *ListWalletTransactions401Response {
	return v.value
}

func (v *NullableListWalletTransactions401Response) Set(val *ListWalletTransactions401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListWalletTransactions401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListWalletTransactions401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWalletTransactions401Response(val *ListWalletTransactions401Response) *NullableListWalletTransactions401Response {
	return &NullableListWalletTransactions401Response{value: val, isSet: true}
}

func (v NullableListWalletTransactions401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWalletTransactions401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
