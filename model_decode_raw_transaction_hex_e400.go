...
func InvalidBlockchainAsDecodeRawTransactionHexE400(v *InvalidBlockchain) DecodeRawTransactionHexE400 {
...
func InvalidNetworkAsDecodeRawTransactionHexE400(v *InvalidNetwork) DecodeRawTransactionHexE400 {
	return DecodeRawTransactionHexE400{
		InvalidNetwork: v,
	}
}
...
func InvalidPaginationAsDecodeRawTransactionHexE400(v *InvalidPagination) DecodeRawTransactionHexE400 {
	return DecodeRawTransactionHexE400{
		InvalidPagination: v,
	}
}
...
func InvalidTransactionHexAsDecodeRawTransactionHexE400(v *InvalidTransactionHex) DecodeRawTransactionHexE400 {
	return DecodeRawTransactionHexE400{
		InvalidTransactionHex: v,
	}
}
...
func LimitGreaterThanAllowedAsDecodeRawTransactionHexE400(v *LimitGreaterThanAllowed) DecodeRawTransactionHexE400 {
	return DecodeRawTransactionHexE400{
...
func UriNotFoundAsDecodeRawTransactionHexE400(v *UriNotFound) DecodeRawTransactionHexE400 {
	return DecodeRawTransactionHexE400{
		UriNotFound: v,
	}
}
...
func (dst *DecodeRawTransactionHexE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	// try to unmarshal data into InvalidTransactionHex
	err = newStrictDecoder(data).Decode(&dst.InvalidTransactionHex)
	if err == nil {
		jsonInvalidTransactionHex, _ := json.Marshal(dst.InvalidTransactionHex)
		if string(jsonInvalidTransactionHex) == "{}" { // empty struct
			dst.InvalidTransactionHex = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DecodeRawTransactionHexE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DecodeRawTransactionHexE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DecodeRawTransactionHexE400) MarshalJSON() ([]byte, error) {
	...
	if src.InvalidTransactionHex != nil {
		return json.Marshal(&src.InvalidTransactionHex)
	}
...
func (obj *DecodeRawTransactionHexE400) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	...
	if obj.InvalidTransactionHex != nil {
		return obj.InvalidTransactionHex
	}
...
type NullableDecodeRawTransactionHexE400 struct {
	value *DecodeRawTransactionHexE400
	isSet bool
}

func (v NullableDecodeRawTransactionHexE400) Get() *DecodeRawTransactionHexE400 {
	return v.value
}

func (v *NullableDecodeRawTransactionHexE400) Set(val *DecodeRawTransactionHexE400) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexE400) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexE400(val *DecodeRawTransactionHexE400) *NullableDecodeRawTransactionHexE400 {
	return &NullableDecodeRawTransactionHexE400{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
