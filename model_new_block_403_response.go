...
type NewBlock403Response struct {
...
func (o NewBlock403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewBlock403Response struct {
	value *NewBlock403Response
	isSet bool
}

func (v NullableNewBlock403Response) Get() *NewBlock403Response {
	return v.value
}

func (v *NullableNewBlock403Response) Set(val *NewBlock403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewBlock403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewBlock403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewBlock403Response(val *NewBlock403Response) *NullableNewBlock403Response {
	return &NullableNewBlock403Response{value: val, isSet: true}
}

func (v NullableNewBlock403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewBlock403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
