...
type ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey struct {
...
func NewListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey(addresses []string, asm string, hex string, type_ string) *ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey {
	this := ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey{}
...
func (o ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey struct {
	value *ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) Get() *ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) Set(val *ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey(val *ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) *NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey {
	return &NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
