...
type DecodeXAddressE403 struct {
...
func BannedIpAddressAsDecodeXAddressE403(v *BannedIpAddress) DecodeXAddressE403 {
...
func EndpointNotAllowedForApiKeyAsDecodeXAddressE403(v *EndpointNotAllowedForApiKey) DecodeXAddressE403 {
	return DecodeXAddressE403{
...
func EndpointNotAllowedForPlanAsDecodeXAddressE403(v *EndpointNotAllowedForPlan) DecodeXAddressE403 {
	return DecodeXAddressE403{
...
func FeatureMainnetsNotAllowedForPlanAsDecodeXAddressE403(v *FeatureMainnetsNotAllowedForPlan) DecodeXAddressE403 {
	return DecodeXAddressE403{
...
func (dst *DecodeXAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DecodeXAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DecodeXAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DecodeXAddressE403) MarshalJSON() ([]byte, error) {
...
func (obj *DecodeXAddressE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableDecodeXAddressE403 struct {
	value *DecodeXAddressE403
	isSet bool
}

func (v NullableDecodeXAddressE403) Get() *DecodeXAddressE403 {
	return v.value
}

func (v *NullableDecodeXAddressE403) Set(val *DecodeXAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeXAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeXAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeXAddressE403(val *DecodeXAddressE403) *NullableDecodeXAddressE403 {
	return &NullableDecodeXAddressE403{value: val, isSet: true}
}

func (v NullableDecodeXAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeXAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
