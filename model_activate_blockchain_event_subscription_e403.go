...
type ActivateBlockchainEventSubscriptionE403 struct {
...
func BannedIpAddressAsActivateBlockchainEventSubscriptionE403(v *BannedIpAddress) ActivateBlockchainEventSubscriptionE403 {
	return ActivateBlockchainEventSubscriptionE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsActivateBlockchainEventSubscriptionE403(v *EndpointNotAllowedForApiKey) ActivateBlockchainEventSubscriptionE403 {
	return ActivateBlockchainEventSubscriptionE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsActivateBlockchainEventSubscriptionE403(v *EndpointNotAllowedForPlan) ActivateBlockchainEventSubscriptionE403 {
	return ActivateBlockchainEventSubscriptionE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsActivateBlockchainEventSubscriptionE403(v *FeatureMainnetsNotAllowedForPlan) ActivateBlockchainEventSubscriptionE403 {
	return ActivateBlockchainEventSubscriptionE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ActivateBlockchainEventSubscriptionE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ActivateBlockchainEventSubscriptionE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ActivateBlockchainEventSubscriptionE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ActivateBlockchainEventSubscriptionE403) MarshalJSON() ([]byte, error) {
...
func (obj *ActivateBlockchainEventSubscriptionE403) GetActualInstance() (interface{}) {
...
type NullableActivateBlockchainEventSubscriptionE403 struct {
	value *ActivateBlockchainEventSubscriptionE403
	isSet bool
}

func (v NullableActivateBlockchainEventSubscriptionE403) Get() *ActivateBlockchainEventSubscriptionE403 {
	return v.value
}

func (v *NullableActivateBlockchainEventSubscriptionE403) Set(val *ActivateBlockchainEventSubscriptionE403) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateBlockchainEventSubscriptionE403) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateBlockchainEventSubscriptionE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateBlockchainEventSubscriptionE403(val *ActivateBlockchainEventSubscriptionE403) *NullableActivateBlockchainEventSubscriptionE403 {
	return &NullableActivateBlockchainEventSubscriptionE403{value: val, isSet: true}
}

func (v NullableActivateBlockchainEventSubscriptionE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateBlockchainEventSubscriptionE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
