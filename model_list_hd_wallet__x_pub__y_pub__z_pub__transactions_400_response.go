...
type ListHDWalletXPubYPubZPubTransactions400Response struct {
	...
	Error ListHDWalletXPubYPubZPubTransactionsE400 `json:"error"`
}
...
func (o *ListHDWalletXPubYPubZPubTransactions400Response) GetError() ListHDWalletXPubYPubZPubTransactionsE400 {
	if o == nil {
		var ret ListHDWalletXPubYPubZPubTransactionsE400
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubTransactions400Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactions400Response struct {
	value *ListHDWalletXPubYPubZPubTransactions400Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactions400Response) Get() *ListHDWalletXPubYPubZPubTransactions400Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactions400Response) Set(val *ListHDWalletXPubYPubZPubTransactions400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactions400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactions400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactions400Response(val *ListHDWalletXPubYPubZPubTransactions400Response) *NullableListHDWalletXPubYPubZPubTransactions400Response {
	return &NullableListHDWalletXPubYPubZPubTransactions400Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactions400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactions400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
