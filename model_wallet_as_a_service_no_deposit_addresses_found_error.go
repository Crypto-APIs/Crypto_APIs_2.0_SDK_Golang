...
// WalletAsAServiceNoDepositAddressesFoundError struct for WalletAsAServiceNoDepositAddressesFoundError
type WalletAsAServiceNoDepositAddressesFoundError struct {
...
func NewWalletAsAServiceNoDepositAddressesFoundError(code string, message string) *WalletAsAServiceNoDepositAddressesFoundError {
	this := WalletAsAServiceNoDepositAddressesFoundError{}
	this.Code = code
...
func (o WalletAsAServiceNoDepositAddressesFoundError) MarshalJSON() ([]byte, error) {
...
type NullableWalletAsAServiceNoDepositAddressesFoundError struct {
	value *WalletAsAServiceNoDepositAddressesFoundError
	isSet bool
}

func (v NullableWalletAsAServiceNoDepositAddressesFoundError) Get() *WalletAsAServiceNoDepositAddressesFoundError {
	return v.value
}

func (v *NullableWalletAsAServiceNoDepositAddressesFoundError) Set(val *WalletAsAServiceNoDepositAddressesFoundError) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletAsAServiceNoDepositAddressesFoundError) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletAsAServiceNoDepositAddressesFoundError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletAsAServiceNoDepositAddressesFoundError(val *WalletAsAServiceNoDepositAddressesFoundError) *NullableWalletAsAServiceNoDepositAddressesFoundError {
	return &NullableWalletAsAServiceNoDepositAddressesFoundError{value: val, isSet: true}
}

func (v NullableWalletAsAServiceNoDepositAddressesFoundError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletAsAServiceNoDepositAddressesFoundError) UnmarshalJSON(src []byte) error {
	v.isSet = true
