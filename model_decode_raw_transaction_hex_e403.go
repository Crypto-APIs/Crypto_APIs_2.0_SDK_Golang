...
type DecodeRawTransactionHexE403 struct {
...
func BannedIpAddressAsDecodeRawTransactionHexE403(v *BannedIpAddress) DecodeRawTransactionHexE403 {
...
func EndpointNotAllowedForApiKeyAsDecodeRawTransactionHexE403(v *EndpointNotAllowedForApiKey) DecodeRawTransactionHexE403 {
	return DecodeRawTransactionHexE403{
...
func EndpointNotAllowedForPlanAsDecodeRawTransactionHexE403(v *EndpointNotAllowedForPlan) DecodeRawTransactionHexE403 {
	return DecodeRawTransactionHexE403{
...
func FeatureMainnetsNotAllowedForPlanAsDecodeRawTransactionHexE403(v *FeatureMainnetsNotAllowedForPlan) DecodeRawTransactionHexE403 {
	return DecodeRawTransactionHexE403{
...
func (dst *DecodeRawTransactionHexE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DecodeRawTransactionHexE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DecodeRawTransactionHexE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DecodeRawTransactionHexE403) MarshalJSON() ([]byte, error) {
...
func (obj *DecodeRawTransactionHexE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableDecodeRawTransactionHexE403 struct {
	value *DecodeRawTransactionHexE403
	isSet bool
}

func (v NullableDecodeRawTransactionHexE403) Get() *DecodeRawTransactionHexE403 {
	return v.value
}

func (v *NullableDecodeRawTransactionHexE403) Set(val *DecodeRawTransactionHexE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexE403(val *DecodeRawTransactionHexE403) *NullableDecodeRawTransactionHexE403 {
	return &NullableDecodeRawTransactionHexE403{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
