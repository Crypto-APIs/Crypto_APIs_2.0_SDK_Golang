...
type GetWalletTransactionDetailsByTransactionIDRIBSBVinInner struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig `json:"scriptSig"`
...
func (o *GetWalletTransactionDetailsByTransactionIDRIBSBVinInner) GetScriptSig() GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig {
	if o == nil {
		var ret GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig
		return ret
	}
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSBVinInner) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSBVinInner
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner) Get() *GetWalletTransactionDetailsByTransactionIDRIBSBVinInner {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSBVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner(val *GetWalletTransactionDetailsByTransactionIDRIBSBVinInner) *NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
