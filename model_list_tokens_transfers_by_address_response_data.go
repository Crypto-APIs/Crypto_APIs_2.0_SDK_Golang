...
// ListTokensTransfersByAddressResponseData struct for ListTokensTransfersByAddressResponseData
type ListTokensTransfersByAddressResponseData struct {
	...
	Items []ListTokensTransfersByAddressResponseItem `json:"items"`
}
...
func NewListTokensTransfersByAddressResponseData(offset int32, limit int32, total int32, items []ListTokensTransfersByAddressResponseItem) *ListTokensTransfersByAddressResponseData {
	this := ListTokensTransfersByAddressResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListTokensTransfersByAddressResponseData) GetItems() []ListTokensTransfersByAddressResponseItem {
	if o == nil {
		var ret []ListTokensTransfersByAddressResponseItem
		return ret
	}
...
func (o ListTokensTransfersByAddressResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByAddressResponseData struct {
	value *ListTokensTransfersByAddressResponseData
	isSet bool
}

func (v NullableListTokensTransfersByAddressResponseData) Get() *ListTokensTransfersByAddressResponseData {
	return v.value
}

func (v *NullableListTokensTransfersByAddressResponseData) Set(val *ListTokensTransfersByAddressResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByAddressResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByAddressResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByAddressResponseData(val *ListTokensTransfersByAddressResponseData) *NullableListTokensTransfersByAddressResponseData {
	return &NullableListTokensTransfersByAddressResponseData{value: val, isSet: true}
}

func (v NullableListTokensTransfersByAddressResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByAddressResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
