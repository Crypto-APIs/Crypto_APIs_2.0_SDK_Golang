...
type ValidateAddressE403 struct {
...
func (dst *ValidateAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ValidateAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ValidateAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ValidateAddressE403) MarshalJSON() ([]byte, error) {
...
type NullableValidateAddressE403 struct {
	value *ValidateAddressE403
	isSet bool
}

func (v NullableValidateAddressE403) Get() *ValidateAddressE403 {
	return v.value
}

func (v *NullableValidateAddressE403) Set(val *ValidateAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateAddressE403(val *ValidateAddressE403) *NullableValidateAddressE403 {
	return &NullableValidateAddressE403{value: val, isSet: true}
}

func (v NullableValidateAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
