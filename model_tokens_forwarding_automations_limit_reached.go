...
// TokensForwardingAutomationsLimitReached struct for TokensForwardingAutomationsLimitReached
type TokensForwardingAutomationsLimitReached struct {
	...
	Error TokensForwardingAutomationsLimitReachedError `json:"error"`
}
...
func NewTokensForwardingAutomationsLimitReached(apiVersion string, requestId string, error_ TokensForwardingAutomationsLimitReachedError) *TokensForwardingAutomationsLimitReached {
	this := TokensForwardingAutomationsLimitReached{}
...
func (o *TokensForwardingAutomationsLimitReached) GetError() TokensForwardingAutomationsLimitReachedError {
	if o == nil {
		var ret TokensForwardingAutomationsLimitReachedError
		return ret
	}
...
func (o TokensForwardingAutomationsLimitReached) MarshalJSON() ([]byte, error) {
...
type NullableTokensForwardingAutomationsLimitReached struct {
	value *TokensForwardingAutomationsLimitReached
	isSet bool
}

func (v NullableTokensForwardingAutomationsLimitReached) Get() *TokensForwardingAutomationsLimitReached {
	return v.value
}

func (v *NullableTokensForwardingAutomationsLimitReached) Set(val *TokensForwardingAutomationsLimitReached) {
	v.value = val
	v.isSet = true
}

func (v NullableTokensForwardingAutomationsLimitReached) IsSet() bool {
	return v.isSet
}

func (v *NullableTokensForwardingAutomationsLimitReached) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokensForwardingAutomationsLimitReached(val *TokensForwardingAutomationsLimitReached) *NullableTokensForwardingAutomationsLimitReached {
	return &NullableTokensForwardingAutomationsLimitReached{value: val, isSet: true}
}

func (v NullableTokensForwardingAutomationsLimitReached) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokensForwardingAutomationsLimitReached) UnmarshalJSON(src []byte) error {
	v.isSet = true
