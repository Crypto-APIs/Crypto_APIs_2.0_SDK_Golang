...
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin struct {
	...
	Vin []ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin `json:"vin"`
	// Represents the transaction outputs.
	Vout []ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinVout `json:"vout"`
}
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin(locktime int32, size int32, vSize int32, version int32, vin []ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin, vout []ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinVout) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin{}
...
func (o *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) GetVin() []ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin {
	if o == nil {
		var ret []ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin
		return ret
	}
...
func (o *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) GetVout() []ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinVout {
	if o == nil {
		var ret []ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinVout
		return ret
	}
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
