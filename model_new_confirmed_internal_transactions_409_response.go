...
type NewConfirmedInternalTransactions409Response struct {
	...
	Error NewConfirmedInternalTransactionsE409 `json:"error"`
}
...
func (o *NewConfirmedInternalTransactions409Response) GetError() NewConfirmedInternalTransactionsE409 {
	if o == nil {
		var ret NewConfirmedInternalTransactionsE409
		return ret
	}
...
func (o NewConfirmedInternalTransactions409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactions409Response struct {
	value *NewConfirmedInternalTransactions409Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactions409Response) Get() *NewConfirmedInternalTransactions409Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactions409Response) Set(val *NewConfirmedInternalTransactions409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactions409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactions409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactions409Response(val *NewConfirmedInternalTransactions409Response) *NullableNewConfirmedInternalTransactions409Response {
	return &NullableNewConfirmedInternalTransactions409Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactions409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactions409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
