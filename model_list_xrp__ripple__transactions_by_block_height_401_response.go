...
type ListXRPRippleTransactionsByBlockHeight401Response struct {
...
func NewListXRPRippleTransactionsByBlockHeight401Response(apiVersion string, requestId string, error_ ListXRPRippleTransactionsByBlockHeightE401) *ListXRPRippleTransactionsByBlockHeight401Response {
	this := ListXRPRippleTransactionsByBlockHeight401Response{}
...
func (o ListXRPRippleTransactionsByBlockHeight401Response) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHeight401Response struct {
	value *ListXRPRippleTransactionsByBlockHeight401Response
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHeight401Response) Get() *ListXRPRippleTransactionsByBlockHeight401Response {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHeight401Response) Set(val *ListXRPRippleTransactionsByBlockHeight401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHeight401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHeight401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHeight401Response(val *ListXRPRippleTransactionsByBlockHeight401Response) *NullableListXRPRippleTransactionsByBlockHeight401Response {
	return &NullableListXRPRippleTransactionsByBlockHeight401Response{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHeight401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHeight401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
