...
type GetAssetDetailsByAssetID401Response struct {
	...
	Error GetAssetDetailsByAssetIDE401 `json:"error"`
}
...
func NewGetAssetDetailsByAssetID401Response(apiVersion string, requestId string, error_ GetAssetDetailsByAssetIDE401) *GetAssetDetailsByAssetID401Response {
	this := GetAssetDetailsByAssetID401Response{}
...
func (o *GetAssetDetailsByAssetID401Response) GetError() GetAssetDetailsByAssetIDE401 {
	if o == nil {
		var ret GetAssetDetailsByAssetIDE401
		return ret
	}
...
func (o GetAssetDetailsByAssetID401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAssetDetailsByAssetID401Response struct {
	value *GetAssetDetailsByAssetID401Response
	isSet bool
}

func (v NullableGetAssetDetailsByAssetID401Response) Get() *GetAssetDetailsByAssetID401Response {
	return v.value
}

func (v *NullableGetAssetDetailsByAssetID401Response) Set(val *GetAssetDetailsByAssetID401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetDetailsByAssetID401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetDetailsByAssetID401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetDetailsByAssetID401Response(val *GetAssetDetailsByAssetID401Response) *NullableGetAssetDetailsByAssetID401Response {
	return &NullableGetAssetDetailsByAssetID401Response{value: val, isSet: true}
}

func (v NullableGetAssetDetailsByAssetID401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetDetailsByAssetID401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
