...
type DeriveAndSyncNewChangeAddresses400Response struct {
	...
	Error DeriveAndSyncNewChangeAddressesE400 `json:"error"`
}
...
func NewDeriveAndSyncNewChangeAddresses400Response(apiVersion string, requestId string, error_ DeriveAndSyncNewChangeAddressesE400) *DeriveAndSyncNewChangeAddresses400Response {
	this := DeriveAndSyncNewChangeAddresses400Response{}
...
func (o *DeriveAndSyncNewChangeAddresses400Response) GetError() DeriveAndSyncNewChangeAddressesE400 {
	if o == nil {
		var ret DeriveAndSyncNewChangeAddressesE400
		return ret
	}
...
func (o DeriveAndSyncNewChangeAddresses400Response) MarshalJSON() ([]byte, error) {
...
type NullableDeriveAndSyncNewChangeAddresses400Response struct {
	value *DeriveAndSyncNewChangeAddresses400Response
	isSet bool
}

func (v NullableDeriveAndSyncNewChangeAddresses400Response) Get() *DeriveAndSyncNewChangeAddresses400Response {
	return v.value
}

func (v *NullableDeriveAndSyncNewChangeAddresses400Response) Set(val *DeriveAndSyncNewChangeAddresses400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewChangeAddresses400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewChangeAddresses400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewChangeAddresses400Response(val *DeriveAndSyncNewChangeAddresses400Response) *NullableDeriveAndSyncNewChangeAddresses400Response {
	return &NullableDeriveAndSyncNewChangeAddresses400Response{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewChangeAddresses400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewChangeAddresses400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
