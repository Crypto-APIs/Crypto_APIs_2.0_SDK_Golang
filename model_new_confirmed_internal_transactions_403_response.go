...
type NewConfirmedInternalTransactions403Response struct {
	...
	Error NewConfirmedInternalTransactionsE403 `json:"error"`
}
...
func NewNewConfirmedInternalTransactions403Response(apiVersion string, requestId string, error_ NewConfirmedInternalTransactionsE403) *NewConfirmedInternalTransactions403Response {
	this := NewConfirmedInternalTransactions403Response{}
...
func (o *NewConfirmedInternalTransactions403Response) GetError() NewConfirmedInternalTransactionsE403 {
	if o == nil {
		var ret NewConfirmedInternalTransactionsE403
		return ret
	}
...
func (o NewConfirmedInternalTransactions403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactions403Response struct {
	value *NewConfirmedInternalTransactions403Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactions403Response) Get() *NewConfirmedInternalTransactions403Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactions403Response) Set(val *NewConfirmedInternalTransactions403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactions403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactions403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactions403Response(val *NewConfirmedInternalTransactions403Response) *NullableNewConfirmedInternalTransactions403Response {
	return &NullableNewConfirmedInternalTransactions403Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactions403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactions403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
