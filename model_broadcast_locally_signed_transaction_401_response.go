...
type BroadcastLocallySignedTransaction401Response struct {
	...
	Error BroadcastLocallySignedTransactionE401 `json:"error"`
}
...
func NewBroadcastLocallySignedTransaction401Response(apiVersion string, requestId string, error_ BroadcastLocallySignedTransactionE401) *BroadcastLocallySignedTransaction401Response {
	this := BroadcastLocallySignedTransaction401Response{}
...
func (o *BroadcastLocallySignedTransaction401Response) GetError() BroadcastLocallySignedTransactionE401 {
	if o == nil {
		var ret BroadcastLocallySignedTransactionE401
		return ret
	}
...
func (o BroadcastLocallySignedTransaction401Response) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastLocallySignedTransaction401Response struct {
	value *BroadcastLocallySignedTransaction401Response
	isSet bool
}

func (v NullableBroadcastLocallySignedTransaction401Response) Get() *BroadcastLocallySignedTransaction401Response {
	return v.value
}

func (v *NullableBroadcastLocallySignedTransaction401Response) Set(val *BroadcastLocallySignedTransaction401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastLocallySignedTransaction401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastLocallySignedTransaction401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastLocallySignedTransaction401Response(val *BroadcastLocallySignedTransaction401Response) *NullableBroadcastLocallySignedTransaction401Response {
	return &NullableBroadcastLocallySignedTransaction401Response{value: val, isSet: true}
}

func (v NullableBroadcastLocallySignedTransaction401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastLocallySignedTransaction401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
