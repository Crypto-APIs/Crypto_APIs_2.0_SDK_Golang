...
type GetNextAvailableNonceE403 struct {
...
func BannedIpAddressAsGetNextAvailableNonceE403(v *BannedIpAddress) GetNextAvailableNonceE403 {
...
func EndpointNotAllowedForApiKeyAsGetNextAvailableNonceE403(v *EndpointNotAllowedForApiKey) GetNextAvailableNonceE403 {
	return GetNextAvailableNonceE403{
...
func EndpointNotAllowedForPlanAsGetNextAvailableNonceE403(v *EndpointNotAllowedForPlan) GetNextAvailableNonceE403 {
	return GetNextAvailableNonceE403{
...
func FeatureMainnetsNotAllowedForPlanAsGetNextAvailableNonceE403(v *FeatureMainnetsNotAllowedForPlan) GetNextAvailableNonceE403 {
	return GetNextAvailableNonceE403{
...
func (dst *GetNextAvailableNonceE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetNextAvailableNonceE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetNextAvailableNonceE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetNextAvailableNonceE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetNextAvailableNonceE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableGetNextAvailableNonceE403 struct {
	value *GetNextAvailableNonceE403
	isSet bool
}

func (v NullableGetNextAvailableNonceE403) Get() *GetNextAvailableNonceE403 {
	return v.value
}

func (v *NullableGetNextAvailableNonceE403) Set(val *GetNextAvailableNonceE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNextAvailableNonceE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNextAvailableNonceE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNextAvailableNonceE403(val *GetNextAvailableNonceE403) *NullableGetNextAvailableNonceE403 {
	return &NullableGetNextAvailableNonceE403{value: val, isSet: true}
}

func (v NullableGetNextAvailableNonceE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNextAvailableNonceE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
