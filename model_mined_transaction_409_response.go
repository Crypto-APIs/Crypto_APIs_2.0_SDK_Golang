...
type MinedTransaction409Response struct {
	...
	Error MinedTransactionE409 `json:"error"`
}
...
func NewMinedTransaction409Response(apiVersion string, requestId string, error_ MinedTransactionE409) *MinedTransaction409Response {
	this := MinedTransaction409Response{}
...
func (o MinedTransaction409Response) MarshalJSON() ([]byte, error) {
...
type NullableMinedTransaction409Response struct {
	value *MinedTransaction409Response
	isSet bool
}

func (v NullableMinedTransaction409Response) Get() *MinedTransaction409Response {
	return v.value
}

func (v *NullableMinedTransaction409Response) Set(val *MinedTransaction409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMinedTransaction409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMinedTransaction409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinedTransaction409Response(val *MinedTransaction409Response) *NullableMinedTransaction409Response {
	return &NullableMinedTransaction409Response{value: val, isSet: true}
}

func (v NullableMinedTransaction409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinedTransaction409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
