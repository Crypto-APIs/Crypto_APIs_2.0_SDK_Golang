...
func (r ApiListAllAssetsFromAllWalletsRequest) Limit(limit int64) ApiListAllAssetsFromAllWalletsRequest {
	r.limit = &limit
	return r
}

// The starting index of the response items, i.e. where the response should start listing the returned items.
func (r ApiListAllAssetsFromAllWalletsRequest) Offset(offset int64) ApiListAllAssetsFromAllWalletsRequest {
	r.offset = &offset
	return r
}
...
// Defines how many items should be returned in the response per page basis.
func (r ApiListSupportedTokensRequest) Limit(limit int64) ApiListSupportedTokensRequest {
	r.limit = &limit
	return r
}

// The starting index of the response items, i.e. where the response should start listing the returned items.
func (r ApiListSupportedTokensRequest) Offset(offset int64) ApiListSupportedTokensRequest {
	r.offset = &offset
	return r
}
