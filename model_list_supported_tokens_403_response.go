...
type ListSupportedTokens403Response struct {
	...
	Error ListSupportedTokensE403 `json:"error"`
}
...
func NewListSupportedTokens403Response(apiVersion string, requestId string, error_ ListSupportedTokensE403) *ListSupportedTokens403Response {
	this := ListSupportedTokens403Response{}
...
func (o *ListSupportedTokens403Response) GetError() ListSupportedTokensE403 {
	if o == nil {
		var ret ListSupportedTokensE403
		return ret
	}
...
func (o ListSupportedTokens403Response) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedTokens403Response struct {
	value *ListSupportedTokens403Response
	isSet bool
}

func (v NullableListSupportedTokens403Response) Get() *ListSupportedTokens403Response {
	return v.value
}

func (v *NullableListSupportedTokens403Response) Set(val *ListSupportedTokens403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedTokens403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedTokens403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedTokens403Response(val *ListSupportedTokens403Response) *NullableListSupportedTokens403Response {
	return &NullableListSupportedTokens403Response{value: val, isSet: true}
}

func (v NullableListSupportedTokens403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedTokens403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
