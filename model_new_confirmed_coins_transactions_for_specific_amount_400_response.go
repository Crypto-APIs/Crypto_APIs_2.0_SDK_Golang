...
type NewConfirmedCoinsTransactionsForSpecificAmount400Response struct {
	...
	Error NewConfirmedCoinsTransactionsForSpecificAmountE400 `json:"error"`
}
...
func NewNewConfirmedCoinsTransactionsForSpecificAmount400Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsForSpecificAmountE400) *NewConfirmedCoinsTransactionsForSpecificAmount400Response {
	this := NewConfirmedCoinsTransactionsForSpecificAmount400Response{}
...
func (o *NewConfirmedCoinsTransactionsForSpecificAmount400Response) GetError() NewConfirmedCoinsTransactionsForSpecificAmountE400 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsForSpecificAmountE400
		return ret
	}
...
func (o NewConfirmedCoinsTransactionsForSpecificAmount400Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response struct {
	value *NewConfirmedCoinsTransactionsForSpecificAmount400Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response) Get() *NewConfirmedCoinsTransactionsForSpecificAmount400Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response) Set(val *NewConfirmedCoinsTransactionsForSpecificAmount400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsForSpecificAmount400Response(val *NewConfirmedCoinsTransactionsForSpecificAmount400Response) *NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response {
	return &NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmount400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
