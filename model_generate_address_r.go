...
// GenerateAddressR struct for GenerateAddressR
type GenerateAddressR struct {
	...
	Data GenerateAddressRData `json:"data"`
}
...
func (o GenerateAddressR) MarshalJSON() ([]byte, error) {
...
type NullableGenerateAddressR struct {
	value *GenerateAddressR
	isSet bool
}

func (v NullableGenerateAddressR) Get() *GenerateAddressR {
	return v.value
}

func (v *NullableGenerateAddressR) Set(val *GenerateAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateAddressR(val *GenerateAddressR) *NullableGenerateAddressR {
	return &NullableGenerateAddressR{value: val, isSet: true}
}

func (v NullableGenerateAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
