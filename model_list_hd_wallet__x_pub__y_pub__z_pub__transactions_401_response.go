...
type ListHDWalletXPubYPubZPubTransactions401Response struct {
...
func NewListHDWalletXPubYPubZPubTransactions401Response(apiVersion string, requestId string, error_ ListHDWalletXPubYPubZPubTransactionsE401) *ListHDWalletXPubYPubZPubTransactions401Response {
	this := ListHDWalletXPubYPubZPubTransactions401Response{}
...
func (o ListHDWalletXPubYPubZPubTransactions401Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactions401Response struct {
	value *ListHDWalletXPubYPubZPubTransactions401Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactions401Response) Get() *ListHDWalletXPubYPubZPubTransactions401Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactions401Response) Set(val *ListHDWalletXPubYPubZPubTransactions401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactions401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactions401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactions401Response(val *ListHDWalletXPubYPubZPubTransactions401Response) *NullableListHDWalletXPubYPubZPubTransactions401Response {
	return &NullableListHDWalletXPubYPubZPubTransactions401Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactions401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactions401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
