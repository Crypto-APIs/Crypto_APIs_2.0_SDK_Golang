...
type ListTransactionsByBlockHeightRIBSLScriptPubKey struct {
...
func NewListTransactionsByBlockHeightRIBSLScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHeightRIBSLScriptPubKey {
	this := ListTransactionsByBlockHeightRIBSLScriptPubKey{}
...
func (o ListTransactionsByBlockHeightRIBSLScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSLScriptPubKey struct {
	value *ListTransactionsByBlockHeightRIBSLScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSLScriptPubKey) Get() *ListTransactionsByBlockHeightRIBSLScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSLScriptPubKey) Set(val *ListTransactionsByBlockHeightRIBSLScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSLScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSLScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSLScriptPubKey(val *ListTransactionsByBlockHeightRIBSLScriptPubKey) *NullableListTransactionsByBlockHeightRIBSLScriptPubKey {
	return &NullableListTransactionsByBlockHeightRIBSLScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSLScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSLScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
