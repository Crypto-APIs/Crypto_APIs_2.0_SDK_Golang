...
type ListTransactionsByBlockHashRIBSLVinInner struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig ListTransactionsByBlockHashRIBSLVinInnerScriptSig `json:"scriptSig"`
...
func NewListTransactionsByBlockHashRIBSLVinInner(addresses []string, scriptSig ListTransactionsByBlockHashRIBSLVinInnerScriptSig, sequence string, txid string, txinwitness []string, value string, vout int32) *ListTransactionsByBlockHashRIBSLVinInner {
	this := ListTransactionsByBlockHashRIBSLVinInner{}
...
func (o *ListTransactionsByBlockHashRIBSLVinInner) GetScriptSig() ListTransactionsByBlockHashRIBSLVinInnerScriptSig {
	if o == nil {
		var ret ListTransactionsByBlockHashRIBSLVinInnerScriptSig
		return ret
	}
...
func (o ListTransactionsByBlockHashRIBSLVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSLVinInner struct {
	value *ListTransactionsByBlockHashRIBSLVinInner
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSLVinInner) Get() *ListTransactionsByBlockHashRIBSLVinInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSLVinInner) Set(val *ListTransactionsByBlockHashRIBSLVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSLVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSLVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSLVinInner(val *ListTransactionsByBlockHashRIBSLVinInner) *NullableListTransactionsByBlockHashRIBSLVinInner {
	return &NullableListTransactionsByBlockHashRIBSLVinInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSLVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSLVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
