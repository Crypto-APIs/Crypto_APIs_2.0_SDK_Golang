...
type ListUnconfirmedTransactionsByAddressRIBSBC struct {
	...
	Vin []ListUnconfirmedTransactionsByAddressRIBSBCVinInner `json:"vin"`
	// Represents the transaction outputs.
	Vout []ListUnconfirmedTransactionsByAddressRIBSBCVoutInner `json:"vout"`
}
...
func NewListUnconfirmedTransactionsByAddressRIBSBC(locktime int64, size int32, version int32, vin []ListUnconfirmedTransactionsByAddressRIBSBCVinInner, vout []ListUnconfirmedTransactionsByAddressRIBSBCVoutInner) *ListUnconfirmedTransactionsByAddressRIBSBC {
	this := ListUnconfirmedTransactionsByAddressRIBSBC{}
...
func (o *ListUnconfirmedTransactionsByAddressRIBSBC) GetVin() []ListUnconfirmedTransactionsByAddressRIBSBCVinInner {
	if o == nil {
		var ret []ListUnconfirmedTransactionsByAddressRIBSBCVinInner
		return ret
	}
...
func (o *ListUnconfirmedTransactionsByAddressRIBSBC) GetVout() []ListUnconfirmedTransactionsByAddressRIBSBCVoutInner {
	if o == nil {
		var ret []ListUnconfirmedTransactionsByAddressRIBSBCVoutInner
		return ret
	}
...
func (o ListUnconfirmedTransactionsByAddressRIBSBC) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSBC struct {
	value *ListUnconfirmedTransactionsByAddressRIBSBC
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBC) Get() *ListUnconfirmedTransactionsByAddressRIBSBC {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBC) Set(val *ListUnconfirmedTransactionsByAddressRIBSBC) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBC) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSBC(val *ListUnconfirmedTransactionsByAddressRIBSBC) *NullableListUnconfirmedTransactionsByAddressRIBSBC {
	return &NullableListUnconfirmedTransactionsByAddressRIBSBC{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBC) UnmarshalJSON(src []byte) error {
	v.isSet = true
