...
type ListSyncedAddresses400Response struct {
	...
	Error ListSyncedAddressesE400 `json:"error"`
}
...
func NewListSyncedAddresses400Response(apiVersion string, requestId string, error_ ListSyncedAddressesE400) *ListSyncedAddresses400Response {
	this := ListSyncedAddresses400Response{}
...
func (o *ListSyncedAddresses400Response) GetError() ListSyncedAddressesE400 {
	if o == nil {
		var ret ListSyncedAddressesE400
		return ret
	}
...
func (o ListSyncedAddresses400Response) MarshalJSON() ([]byte, error) {
...
type NullableListSyncedAddresses400Response struct {
	value *ListSyncedAddresses400Response
	isSet bool
}

func (v NullableListSyncedAddresses400Response) Get() *ListSyncedAddresses400Response {
	return v.value
}

func (v *NullableListSyncedAddresses400Response) Set(val *ListSyncedAddresses400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSyncedAddresses400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSyncedAddresses400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSyncedAddresses400Response(val *ListSyncedAddresses400Response) *NullableListSyncedAddresses400Response {
	return &NullableListSyncedAddresses400Response{value: val, isSet: true}
}

func (v NullableListSyncedAddresses400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSyncedAddresses400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
