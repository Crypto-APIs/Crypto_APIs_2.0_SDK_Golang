...
type ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey struct {
...
func NewListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey {
	this := ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey{}
...
func (o ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey struct {
	value *ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) Get() *ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) Set(val *ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey(val *ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) *NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey {
	return &NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
