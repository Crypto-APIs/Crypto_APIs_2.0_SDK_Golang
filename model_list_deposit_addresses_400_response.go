...
type ListDepositAddresses400Response struct {
	...
	Error ListDepositAddressesE400 `json:"error"`
}
...
func NewListDepositAddresses400Response(apiVersion string, requestId string, error_ ListDepositAddressesE400) *ListDepositAddresses400Response {
	this := ListDepositAddresses400Response{}
...
func (o *ListDepositAddresses400Response) GetError() ListDepositAddressesE400 {
	if o == nil {
		var ret ListDepositAddressesE400
		return ret
	}
...
func (o ListDepositAddresses400Response) MarshalJSON() ([]byte, error) {
...
type NullableListDepositAddresses400Response struct {
	value *ListDepositAddresses400Response
	isSet bool
}

func (v NullableListDepositAddresses400Response) Get() *ListDepositAddresses400Response {
	return v.value
}

func (v *NullableListDepositAddresses400Response) Set(val *ListDepositAddresses400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDepositAddresses400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDepositAddresses400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDepositAddresses400Response(val *ListDepositAddresses400Response) *NullableListDepositAddresses400Response {
	return &NullableListDepositAddresses400Response{value: val, isSet: true}
}

func (v NullableListDepositAddresses400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDepositAddresses400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
