...
type GetTransactionDetailsByTransactionIDE403 struct {
...
func BannedIpAddressAsGetTransactionDetailsByTransactionIDE403(v *BannedIpAddress) GetTransactionDetailsByTransactionIDE403 {
	return GetTransactionDetailsByTransactionIDE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetTransactionDetailsByTransactionIDE403(v *EndpointNotAllowedForApiKey) GetTransactionDetailsByTransactionIDE403 {
	return GetTransactionDetailsByTransactionIDE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetTransactionDetailsByTransactionIDE403(v *EndpointNotAllowedForPlan) GetTransactionDetailsByTransactionIDE403 {
	return GetTransactionDetailsByTransactionIDE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetTransactionDetailsByTransactionIDE403(v *FeatureMainnetsNotAllowedForPlan) GetTransactionDetailsByTransactionIDE403 {
	return GetTransactionDetailsByTransactionIDE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetTransactionDetailsByTransactionIDE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetTransactionDetailsByTransactionIDE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetTransactionDetailsByTransactionIDE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetTransactionDetailsByTransactionIDE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetTransactionDetailsByTransactionIDE403) GetActualInstance() (interface{}) {
...
type NullableGetTransactionDetailsByTransactionIDE403 struct {
	value *GetTransactionDetailsByTransactionIDE403
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDE403) Get() *GetTransactionDetailsByTransactionIDE403 {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDE403) Set(val *GetTransactionDetailsByTransactionIDE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDE403(val *GetTransactionDetailsByTransactionIDE403) *NullableGetTransactionDetailsByTransactionIDE403 {
	return &NullableGetTransactionDetailsByTransactionIDE403{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
