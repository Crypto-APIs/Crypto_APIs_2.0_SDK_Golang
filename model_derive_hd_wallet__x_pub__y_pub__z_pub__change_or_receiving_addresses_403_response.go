...
type DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response struct {
	...
	Error DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 `json:"error"`
}
...
func NewDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response(apiVersion string, requestId string, error_ DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response {
	this := DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response{}
...
func (o *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) GetError() DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
	if o == nil {
		var ret DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403
		return ret
	}
...
func (o DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) MarshalJSON() ([]byte, error) {
...
type NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response struct {
	value *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response
	isSet bool
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) Get() *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response {
	return v.value
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) Set(val *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response(val *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response {
	return &NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response{value: val, isSet: true}
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
