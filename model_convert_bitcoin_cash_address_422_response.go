...
type ConvertBitcoinCashAddress422Response struct {
...
func NewConvertBitcoinCashAddress422Response(apiVersion string, requestId string, error_ InvalidRequestBodyStructure) *ConvertBitcoinCashAddress422Response {
	this := ConvertBitcoinCashAddress422Response{}
...
func (o ConvertBitcoinCashAddress422Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress422Response struct {
	value *ConvertBitcoinCashAddress422Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress422Response) Get() *ConvertBitcoinCashAddress422Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress422Response) Set(val *ConvertBitcoinCashAddress422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress422Response(val *ConvertBitcoinCashAddress422Response) *NullableConvertBitcoinCashAddress422Response {
	return &NullableConvertBitcoinCashAddress422Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
