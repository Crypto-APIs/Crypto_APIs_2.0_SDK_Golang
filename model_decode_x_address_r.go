...
type DecodeXAddressR struct {
	...
	Data DecodeXAddressRData `json:"data"`
}
...
func (o DecodeXAddressR) MarshalJSON() ([]byte, error) {
...
type NullableDecodeXAddressR struct {
	value *DecodeXAddressR
	isSet bool
}

func (v NullableDecodeXAddressR) Get() *DecodeXAddressR {
	return v.value
}

func (v *NullableDecodeXAddressR) Set(val *DecodeXAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeXAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeXAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeXAddressR(val *DecodeXAddressR) *NullableDecodeXAddressR {
	return &NullableDecodeXAddressR{value: val, isSet: true}
}

func (v NullableDecodeXAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeXAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
