...
type SyncHDWalletXPubYPubZPubR struct {
	...
	Data SyncHDWalletXPubYPubZPubRData `json:"data"`
}
...
func NewSyncHDWalletXPubYPubZPubR(apiVersion string, requestId string, data SyncHDWalletXPubYPubZPubRData) *SyncHDWalletXPubYPubZPubR {
	this := SyncHDWalletXPubYPubZPubR{}
...
func (o *SyncHDWalletXPubYPubZPubR) GetData() SyncHDWalletXPubYPubZPubRData {
	if o == nil {
		var ret SyncHDWalletXPubYPubZPubRData
		return ret
	}
...
func (o SyncHDWalletXPubYPubZPubR) MarshalJSON() ([]byte, error) {
...
type NullableSyncHDWalletXPubYPubZPubR struct {
	value *SyncHDWalletXPubYPubZPubR
	isSet bool
}

func (v NullableSyncHDWalletXPubYPubZPubR) Get() *SyncHDWalletXPubYPubZPubR {
	return v.value
}

func (v *NullableSyncHDWalletXPubYPubZPubR) Set(val *SyncHDWalletXPubYPubZPubR) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncHDWalletXPubYPubZPubR) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncHDWalletXPubYPubZPubR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncHDWalletXPubYPubZPubR(val *SyncHDWalletXPubYPubZPubR) *NullableSyncHDWalletXPubYPubZPubR {
	return &NullableSyncHDWalletXPubYPubZPubR{value: val, isSet: true}
}

func (v NullableSyncHDWalletXPubYPubZPubR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncHDWalletXPubYPubZPubR) UnmarshalJSON(src []byte) error {
	v.isSet = true
