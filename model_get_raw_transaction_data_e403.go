...
type GetRawTransactionDataE403 struct {
...
func BannedIpAddressAsGetRawTransactionDataE403(v *BannedIpAddress) GetRawTransactionDataE403 {
...
func EndpointNotAllowedForApiKeyAsGetRawTransactionDataE403(v *EndpointNotAllowedForApiKey) GetRawTransactionDataE403 {
	return GetRawTransactionDataE403{
...
func EndpointNotAllowedForPlanAsGetRawTransactionDataE403(v *EndpointNotAllowedForPlan) GetRawTransactionDataE403 {
	return GetRawTransactionDataE403{
...
func FeatureMainnetsNotAllowedForPlanAsGetRawTransactionDataE403(v *FeatureMainnetsNotAllowedForPlan) GetRawTransactionDataE403 {
	return GetRawTransactionDataE403{
...
func (dst *GetRawTransactionDataE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetRawTransactionDataE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetRawTransactionDataE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetRawTransactionDataE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetRawTransactionDataE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableGetRawTransactionDataE403 struct {
	value *GetRawTransactionDataE403
	isSet bool
}

func (v NullableGetRawTransactionDataE403) Get() *GetRawTransactionDataE403 {
	return v.value
}

func (v *NullableGetRawTransactionDataE403) Set(val *GetRawTransactionDataE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRawTransactionDataE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRawTransactionDataE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRawTransactionDataE403(val *GetRawTransactionDataE403) *NullableGetRawTransactionDataE403 {
	return &NullableGetRawTransactionDataE403{value: val, isSet: true}
}

func (v NullableGetRawTransactionDataE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRawTransactionDataE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
