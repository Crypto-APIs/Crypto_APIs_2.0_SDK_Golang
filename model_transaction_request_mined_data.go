...
type TransactionRequestMinedData struct {
...
func NewTransactionRequestMinedData(product string, event string, item TransactionRequestBroadcastedDataItem) *TransactionRequestMinedData {
	this := TransactionRequestMinedData{}
...
func (o TransactionRequestMinedData) MarshalJSON() ([]byte, error) {
...
type NullableTransactionRequestMinedData struct {
	value *TransactionRequestMinedData
	isSet bool
}

func (v NullableTransactionRequestMinedData) Get() *TransactionRequestMinedData {
	return v.value
}

func (v *NullableTransactionRequestMinedData) Set(val *TransactionRequestMinedData) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRequestMinedData) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRequestMinedData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRequestMinedData(val *TransactionRequestMinedData) *NullableTransactionRequestMinedData {
	return &NullableTransactionRequestMinedData{value: val, isSet: true}
}

func (v NullableTransactionRequestMinedData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRequestMinedData) UnmarshalJSON(src []byte) error {
	v.isSet = true
