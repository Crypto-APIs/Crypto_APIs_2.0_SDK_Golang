...
type ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
