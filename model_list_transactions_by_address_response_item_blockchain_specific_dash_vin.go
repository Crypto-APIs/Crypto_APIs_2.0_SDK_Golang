...
// ListTransactionsByAddressResponseItemBlockchainSpecificDashVin struct for ListTransactionsByAddressResponseItemBlockchainSpecificDashVin
type ListTransactionsByAddressResponseItemBlockchainSpecificDashVin struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig `json:"scriptSig"`
...
func NewListTransactionsByAddressResponseItemBlockchainSpecificDashVin(addresses []string, scriptSig ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig, sequence string, txinwitness []string, vout int32) *ListTransactionsByAddressResponseItemBlockchainSpecificDashVin {
	this := ListTransactionsByAddressResponseItemBlockchainSpecificDashVin{}
...
func (o *ListTransactionsByAddressResponseItemBlockchainSpecificDashVin) GetScriptSig() ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig {
	if o == nil {
		var ret ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig
		return ret
	}
...
func (o ListTransactionsByAddressResponseItemBlockchainSpecificDashVin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin struct {
	value *ListTransactionsByAddressResponseItemBlockchainSpecificDashVin
	isSet bool
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin) Get() *ListTransactionsByAddressResponseItemBlockchainSpecificDashVin {
	return v.value
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin) Set(val *ListTransactionsByAddressResponseItemBlockchainSpecificDashVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin(val *ListTransactionsByAddressResponseItemBlockchainSpecificDashVin) *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin {
	return &NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
