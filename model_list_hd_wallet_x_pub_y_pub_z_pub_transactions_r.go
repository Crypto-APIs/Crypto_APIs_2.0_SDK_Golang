...
type ListHDWalletXPubYPubZPubTransactionsR struct {
	...
	Data ListHDWalletXPubYPubZPubTransactionsRData `json:"data"`
}
...
func NewListHDWalletXPubYPubZPubTransactionsR(apiVersion string, requestId string, data ListHDWalletXPubYPubZPubTransactionsRData) *ListHDWalletXPubYPubZPubTransactionsR {
	this := ListHDWalletXPubYPubZPubTransactionsR{}
...
func (o *ListHDWalletXPubYPubZPubTransactionsR) GetData() ListHDWalletXPubYPubZPubTransactionsRData {
	if o == nil {
		var ret ListHDWalletXPubYPubZPubTransactionsRData
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubTransactionsR) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactionsR struct {
	value *ListHDWalletXPubYPubZPubTransactionsR
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactionsR) Get() *ListHDWalletXPubYPubZPubTransactionsR {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsR) Set(val *ListHDWalletXPubYPubZPubTransactionsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactionsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactionsR(val *ListHDWalletXPubYPubZPubTransactionsR) *NullableListHDWalletXPubYPubZPubTransactionsR {
	return &NullableListHDWalletXPubYPubZPubTransactionsR{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactionsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
