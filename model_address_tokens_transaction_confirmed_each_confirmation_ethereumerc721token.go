...
type AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token struct {
...
func NewAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token(name string, symbol string, tokenId string, contractAddress string) *AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token {
	this := AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token{}
	this.Name = name
	this.Symbol = symbol
...
func (o AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) MarshalJSON() ([]byte, error) {
...
type NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token struct {
	value *AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token
	isSet bool
}

func (v NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) Get() *AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token {
	return v.value
}

func (v *NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) Set(val *AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token(val *AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) *NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token {
	return &NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token{value: val, isSet: true}
}

func (v NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressTokensTransactionConfirmedEachConfirmationEthereumerc721token) UnmarshalJSON(src []byte) error {
	v.isSet = true
