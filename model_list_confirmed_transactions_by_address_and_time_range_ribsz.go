...
type ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ struct {
...
func NewListConfirmedTransactionsByAddressAndTimeRangeRIBSZ(bindingSig string, expiryHeight int32, joinSplitPubKey string, joinSplitSig string, locktime int64, overwintered bool, size int32, vJoinSplit []ListConfirmedTransactionsByAddressRIBSZVJoinSplit, vShieldedOutput []GetTransactionDetailsByTransactionIDRIBSZVShieldedOutput, vShieldedSpend []GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend, valueBalance string, version int32, versionGroupId string, vin []ListConfirmedTransactionsByAddressRIBSZVin, vout []GetTransactionDetailsByTransactionIDRIBSZVout) *ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ {
	this := ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ{}
...
func (o ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ struct {
	value *ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) Get() *ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) Set(val *ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ(val *ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) *NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ {
	return &NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeRIBSZ) UnmarshalJSON(src []byte) error {
	v.isSet = true
