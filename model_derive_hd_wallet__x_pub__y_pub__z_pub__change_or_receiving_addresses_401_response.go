...
type DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response struct {
	...
	Error DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 `json:"error"`
}
...
func (o *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) GetError() DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 {
	if o == nil {
		var ret DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401
		return ret
	}
...
func (o DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) MarshalJSON() ([]byte, error) {
...
type NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response struct {
	value *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response
	isSet bool
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) Get() *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response {
	return v.value
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) Set(val *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response(val *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response {
	return &NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response{value: val, isSet: true}
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
