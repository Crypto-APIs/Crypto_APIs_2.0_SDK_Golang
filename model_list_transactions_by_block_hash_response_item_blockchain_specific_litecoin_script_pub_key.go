...
type ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
