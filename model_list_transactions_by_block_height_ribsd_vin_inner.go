...
type ListTransactionsByBlockHeightRIBSDVinInner struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase string `json:"coinbase"`
	ScriptSig ListTransactionsByBlockHeightRIBSDVinInnerScriptSig `json:"scriptSig"`
...
func NewListTransactionsByBlockHeightRIBSDVinInner(addresses []string, coinbase string, scriptSig ListTransactionsByBlockHeightRIBSDVinInnerScriptSig, sequence string, txinwitness []string, vout int32) *ListTransactionsByBlockHeightRIBSDVinInner {
	this := ListTransactionsByBlockHeightRIBSDVinInner{}
...
func (o *ListTransactionsByBlockHeightRIBSDVinInner) GetScriptSig() ListTransactionsByBlockHeightRIBSDVinInnerScriptSig {
	if o == nil {
		var ret ListTransactionsByBlockHeightRIBSDVinInnerScriptSig
		return ret
	}
...
func (o ListTransactionsByBlockHeightRIBSDVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSDVinInner struct {
	value *ListTransactionsByBlockHeightRIBSDVinInner
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSDVinInner) Get() *ListTransactionsByBlockHeightRIBSDVinInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSDVinInner) Set(val *ListTransactionsByBlockHeightRIBSDVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSDVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSDVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSDVinInner(val *ListTransactionsByBlockHeightRIBSDVinInner) *NullableListTransactionsByBlockHeightRIBSDVinInner {
	return &NullableListTransactionsByBlockHeightRIBSDVinInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSDVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSDVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
