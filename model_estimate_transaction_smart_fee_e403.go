...
type EstimateTransactionSmartFeeE403 struct {
...
func BannedIpAddressAsEstimateTransactionSmartFeeE403(v *BannedIpAddress) EstimateTransactionSmartFeeE403 {
...
func EndpointNotAllowedForApiKeyAsEstimateTransactionSmartFeeE403(v *EndpointNotAllowedForApiKey) EstimateTransactionSmartFeeE403 {
	return EstimateTransactionSmartFeeE403{
...
func EndpointNotAllowedForPlanAsEstimateTransactionSmartFeeE403(v *EndpointNotAllowedForPlan) EstimateTransactionSmartFeeE403 {
	return EstimateTransactionSmartFeeE403{
...
func FeatureMainnetsNotAllowedForPlanAsEstimateTransactionSmartFeeE403(v *FeatureMainnetsNotAllowedForPlan) EstimateTransactionSmartFeeE403 {
	return EstimateTransactionSmartFeeE403{
...
func (dst *EstimateTransactionSmartFeeE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(EstimateTransactionSmartFeeE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(EstimateTransactionSmartFeeE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src EstimateTransactionSmartFeeE403) MarshalJSON() ([]byte, error) {
...
func (obj *EstimateTransactionSmartFeeE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableEstimateTransactionSmartFeeE403 struct {
	value *EstimateTransactionSmartFeeE403
	isSet bool
}

func (v NullableEstimateTransactionSmartFeeE403) Get() *EstimateTransactionSmartFeeE403 {
	return v.value
}

func (v *NullableEstimateTransactionSmartFeeE403) Set(val *EstimateTransactionSmartFeeE403) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTransactionSmartFeeE403) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTransactionSmartFeeE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTransactionSmartFeeE403(val *EstimateTransactionSmartFeeE403) *NullableEstimateTransactionSmartFeeE403 {
	return &NullableEstimateTransactionSmartFeeE403{value: val, isSet: true}
}

func (v NullableEstimateTransactionSmartFeeE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTransactionSmartFeeE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
