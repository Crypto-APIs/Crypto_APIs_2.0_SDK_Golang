...
type NewConfirmedInternalTransactionsForSpecificAmount400Response struct {
	...
	Error NewConfirmedInternalTransactionsForSpecificAmountE400 `json:"error"`
}
...
func (o *NewConfirmedInternalTransactionsForSpecificAmount400Response) GetError() NewConfirmedInternalTransactionsForSpecificAmountE400 {
	if o == nil {
		var ret NewConfirmedInternalTransactionsForSpecificAmountE400
		return ret
	}
...
func (o NewConfirmedInternalTransactionsForSpecificAmount400Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsForSpecificAmount400Response struct {
	value *NewConfirmedInternalTransactionsForSpecificAmount400Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmount400Response) Get() *NewConfirmedInternalTransactionsForSpecificAmount400Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmount400Response) Set(val *NewConfirmedInternalTransactionsForSpecificAmount400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmount400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmount400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsForSpecificAmount400Response(val *NewConfirmedInternalTransactionsForSpecificAmount400Response) *NullableNewConfirmedInternalTransactionsForSpecificAmount400Response {
	return &NullableNewConfirmedInternalTransactionsForSpecificAmount400Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmount400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmount400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
