...
type ListHDWalletXPubYPubZPubUTXOs403Response struct {
...
func NewListHDWalletXPubYPubZPubUTXOs403Response(apiVersion string, requestId string, error_ ListHDWalletXPubYPubZPubUTXOsE403) *ListHDWalletXPubYPubZPubUTXOs403Response {
	this := ListHDWalletXPubYPubZPubUTXOs403Response{}
...
func (o ListHDWalletXPubYPubZPubUTXOs403Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubUTXOs403Response struct {
	value *ListHDWalletXPubYPubZPubUTXOs403Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubUTXOs403Response) Get() *ListHDWalletXPubYPubZPubUTXOs403Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs403Response) Set(val *ListHDWalletXPubYPubZPubUTXOs403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubUTXOs403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubUTXOs403Response(val *ListHDWalletXPubYPubZPubUTXOs403Response) *NullableListHDWalletXPubYPubZPubUTXOs403Response {
	return &NullableListHDWalletXPubYPubZPubUTXOs403Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubUTXOs403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
