...
type ConvertBitcoinCashAddressRB struct {
	// In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
	Context *string `json:"context,omitempty"`
	Data ConvertBitcoinCashAddressRBData `json:"data"`
}
...
func NewConvertBitcoinCashAddressRB(data ConvertBitcoinCashAddressRBData) *ConvertBitcoinCashAddressRB {
	this := ConvertBitcoinCashAddressRB{}
	this.Data = data
	return &this
}
...
func (o *ConvertBitcoinCashAddressRB) GetData() ConvertBitcoinCashAddressRBData {
	if o == nil {
		var ret ConvertBitcoinCashAddressRBData
		return ret
	}
...
func (o ConvertBitcoinCashAddressRB) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddressRB struct {
	value *ConvertBitcoinCashAddressRB
	isSet bool
}

func (v NullableConvertBitcoinCashAddressRB) Get() *ConvertBitcoinCashAddressRB {
	return v.value
}

func (v *NullableConvertBitcoinCashAddressRB) Set(val *ConvertBitcoinCashAddressRB) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddressRB) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddressRB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddressRB(val *ConvertBitcoinCashAddressRB) *NullableConvertBitcoinCashAddressRB {
	return &NullableConvertBitcoinCashAddressRB{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddressRB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddressRB) UnmarshalJSON(src []byte) error {
	v.isSet = true
