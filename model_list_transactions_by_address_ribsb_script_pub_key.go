...
type ListTransactionsByAddressRIBSBScriptPubKey struct {
...
func NewListTransactionsByAddressRIBSBScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByAddressRIBSBScriptPubKey {
	this := ListTransactionsByAddressRIBSBScriptPubKey{}
...
func (o ListTransactionsByAddressRIBSBScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSBScriptPubKey struct {
	value *ListTransactionsByAddressRIBSBScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSBScriptPubKey) Get() *ListTransactionsByAddressRIBSBScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSBScriptPubKey) Set(val *ListTransactionsByAddressRIBSBScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSBScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSBScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSBScriptPubKey(val *ListTransactionsByAddressRIBSBScriptPubKey) *NullableListTransactionsByAddressRIBSBScriptPubKey {
	return &NullableListTransactionsByAddressRIBSBScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSBScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSBScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
