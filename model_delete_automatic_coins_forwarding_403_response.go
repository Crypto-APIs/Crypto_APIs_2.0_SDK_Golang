...
type DeleteAutomaticCoinsForwarding403Response struct {
...
func NewDeleteAutomaticCoinsForwarding403Response(apiVersion string, requestId string, error_ DeleteAutomaticCoinsForwardingE403) *DeleteAutomaticCoinsForwarding403Response {
	this := DeleteAutomaticCoinsForwarding403Response{}
...
func (o DeleteAutomaticCoinsForwarding403Response) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticCoinsForwarding403Response struct {
	value *DeleteAutomaticCoinsForwarding403Response
	isSet bool
}

func (v NullableDeleteAutomaticCoinsForwarding403Response) Get() *DeleteAutomaticCoinsForwarding403Response {
	return v.value
}

func (v *NullableDeleteAutomaticCoinsForwarding403Response) Set(val *DeleteAutomaticCoinsForwarding403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticCoinsForwarding403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticCoinsForwarding403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticCoinsForwarding403Response(val *DeleteAutomaticCoinsForwarding403Response) *NullableDeleteAutomaticCoinsForwarding403Response {
	return &NullableDeleteAutomaticCoinsForwarding403Response{value: val, isSet: true}
}

func (v NullableDeleteAutomaticCoinsForwarding403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticCoinsForwarding403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
