...
// ListCoinsForwardingAutomationsResponseItem struct for ListCoinsForwardingAutomationsResponseItem
type ListCoinsForwardingAutomationsResponseItem struct {
...
func NewListCoinsForwardingAutomationsResponseItem(callbackUrl string, confirmationsCountTrigger int32, createdTimestamp int32, feePriority string, fromAddress string, minimumTransferAmount string, referenceId string, toAddress string) *ListCoinsForwardingAutomationsResponseItem {
	this := ListCoinsForwardingAutomationsResponseItem{}
...
func (o ListCoinsForwardingAutomationsResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableListCoinsForwardingAutomationsResponseItem struct {
	value *ListCoinsForwardingAutomationsResponseItem
	isSet bool
}

func (v NullableListCoinsForwardingAutomationsResponseItem) Get() *ListCoinsForwardingAutomationsResponseItem {
	return v.value
}

func (v *NullableListCoinsForwardingAutomationsResponseItem) Set(val *ListCoinsForwardingAutomationsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoinsForwardingAutomationsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoinsForwardingAutomationsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoinsForwardingAutomationsResponseItem(val *ListCoinsForwardingAutomationsResponseItem) *NullableListCoinsForwardingAutomationsResponseItem {
	return &NullableListCoinsForwardingAutomationsResponseItem{value: val, isSet: true}
}

func (v NullableListCoinsForwardingAutomationsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoinsForwardingAutomationsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
