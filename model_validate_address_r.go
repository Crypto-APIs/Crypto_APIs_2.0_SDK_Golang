...
type ValidateAddressR struct {
	...
	Data ValidateAddressRData `json:"data"`
}
...
func (o ValidateAddressR) MarshalJSON() ([]byte, error) {
...
type NullableValidateAddressR struct {
	value *ValidateAddressR
	isSet bool
}

func (v NullableValidateAddressR) Get() *ValidateAddressR {
	return v.value
}

func (v *NullableValidateAddressR) Set(val *ValidateAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateAddressR(val *ValidateAddressR) *NullableValidateAddressR {
	return &NullableValidateAddressR{value: val, isSet: true}
}

func (v NullableValidateAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
