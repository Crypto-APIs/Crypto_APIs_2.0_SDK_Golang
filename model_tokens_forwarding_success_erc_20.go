...
type TokensForwardingSuccessErc20 struct {
...
func NewTokensForwardingSuccessErc20(name string, symbol string, amount string, contractAddress string) *TokensForwardingSuccessErc20 {
	this := TokensForwardingSuccessErc20{}
	this.Name = name
	this.Symbol = symbol
	this.Amount = amount
...
func (o TokensForwardingSuccessErc20) MarshalJSON() ([]byte, error) {
...
type NullableTokensForwardingSuccessErc20 struct {
	value *TokensForwardingSuccessErc20
	isSet bool
}

func (v NullableTokensForwardingSuccessErc20) Get() *TokensForwardingSuccessErc20 {
	return v.value
}

func (v *NullableTokensForwardingSuccessErc20) Set(val *TokensForwardingSuccessErc20) {
	v.value = val
	v.isSet = true
}

func (v NullableTokensForwardingSuccessErc20) IsSet() bool {
	return v.isSet
}

func (v *NullableTokensForwardingSuccessErc20) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokensForwardingSuccessErc20(val *TokensForwardingSuccessErc20) *NullableTokensForwardingSuccessErc20 {
	return &NullableTokensForwardingSuccessErc20{value: val, isSet: true}
}

func (v NullableTokensForwardingSuccessErc20) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokensForwardingSuccessErc20) UnmarshalJSON(src []byte) error {
	v.isSet = true
