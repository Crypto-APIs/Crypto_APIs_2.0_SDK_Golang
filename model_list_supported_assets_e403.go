...
type ListSupportedAssetsE403 struct {
...
func BannedIpAddressAsListSupportedAssetsE403(v *BannedIpAddress) ListSupportedAssetsE403 {
	return ListSupportedAssetsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListSupportedAssetsE403(v *EndpointNotAllowedForApiKey) ListSupportedAssetsE403 {
	return ListSupportedAssetsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListSupportedAssetsE403(v *EndpointNotAllowedForPlan) ListSupportedAssetsE403 {
	return ListSupportedAssetsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListSupportedAssetsE403(v *FeatureMainnetsNotAllowedForPlan) ListSupportedAssetsE403 {
	return ListSupportedAssetsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListSupportedAssetsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListSupportedAssetsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListSupportedAssetsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListSupportedAssetsE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListSupportedAssetsE403) GetActualInstance() (interface{}) {
...
type NullableListSupportedAssetsE403 struct {
	value *ListSupportedAssetsE403
	isSet bool
}

func (v NullableListSupportedAssetsE403) Get() *ListSupportedAssetsE403 {
	return v.value
}

func (v *NullableListSupportedAssetsE403) Set(val *ListSupportedAssetsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedAssetsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedAssetsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedAssetsE403(val *ListSupportedAssetsE403) *NullableListSupportedAssetsE403 {
	return &NullableListSupportedAssetsE403{value: val, isSet: true}
}

func (v NullableListSupportedAssetsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedAssetsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
