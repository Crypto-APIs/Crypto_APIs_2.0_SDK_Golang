...
type GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic struct {
...
func NewGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic(difficulty string, nonce string, size int32, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, sha3Uncles string, totalDifficulty string) *GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic {
	this := GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic{}
...
func (o GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic struct {
	value *GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) Get() *GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) Set(val *GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic(val *GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic {
	return &NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic) UnmarshalJSON(src []byte) error {
	v.isSet = true
