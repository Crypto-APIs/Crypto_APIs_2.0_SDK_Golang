...
type CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response struct {
	...
	Error CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 `json:"error"`
}
...
func NewCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response(apiVersion string, requestId string, error_ CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409) *CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response {
	this := CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response{}
...
func (o *CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) GetError() CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 {
	if o == nil {
		var ret CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409
		return ret
	}
...
func (o CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response struct {
	value *CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response
	isSet bool
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) Get() *CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response {
	return v.value
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) Set(val *CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response(val *CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response {
	return &NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response{value: val, isSet: true}
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
