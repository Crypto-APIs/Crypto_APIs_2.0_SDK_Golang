...
type GetBlockDetailsByBlockHash401Response struct {
	...
	Error GetBlockDetailsByBlockHashE401 `json:"error"`
}
...
func NewGetBlockDetailsByBlockHash401Response(apiVersion string, requestId string, error_ GetBlockDetailsByBlockHashE401) *GetBlockDetailsByBlockHash401Response {
	this := GetBlockDetailsByBlockHash401Response{}
...
func (o *GetBlockDetailsByBlockHash401Response) GetError() GetBlockDetailsByBlockHashE401 {
	if o == nil {
		var ret GetBlockDetailsByBlockHashE401
		return ret
	}
...
func (o GetBlockDetailsByBlockHash401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHash401Response struct {
	value *GetBlockDetailsByBlockHash401Response
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHash401Response) Get() *GetBlockDetailsByBlockHash401Response {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHash401Response) Set(val *GetBlockDetailsByBlockHash401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHash401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHash401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHash401Response(val *GetBlockDetailsByBlockHash401Response) *NullableGetBlockDetailsByBlockHash401Response {
	return &NullableGetBlockDetailsByBlockHash401Response{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHash401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHash401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
