...
// ListTokensTransfersByTransactionHashResponseData struct for ListTokensTransfersByTransactionHashResponseData
type ListTokensTransfersByTransactionHashResponseData struct {
	...
	Items []ListTokensTransfersByTransactionHashResponseItem `json:"items"`
}
...
func NewListTokensTransfersByTransactionHashResponseData(offset int32, limit int32, total int32, items []ListTokensTransfersByTransactionHashResponseItem) *ListTokensTransfersByTransactionHashResponseData {
	this := ListTokensTransfersByTransactionHashResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListTokensTransfersByTransactionHashResponseData) GetItems() []ListTokensTransfersByTransactionHashResponseItem {
	if o == nil {
		var ret []ListTokensTransfersByTransactionHashResponseItem
		return ret
	}
...
func (o ListTokensTransfersByTransactionHashResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByTransactionHashResponseData struct {
	value *ListTokensTransfersByTransactionHashResponseData
	isSet bool
}

func (v NullableListTokensTransfersByTransactionHashResponseData) Get() *ListTokensTransfersByTransactionHashResponseData {
	return v.value
}

func (v *NullableListTokensTransfersByTransactionHashResponseData) Set(val *ListTokensTransfersByTransactionHashResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByTransactionHashResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByTransactionHashResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByTransactionHashResponseData(val *ListTokensTransfersByTransactionHashResponseData) *NullableListTokensTransfersByTransactionHashResponseData {
	return &NullableListTokensTransfersByTransactionHashResponseData{value: val, isSet: true}
}

func (v NullableListTokensTransfersByTransactionHashResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByTransactionHashResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
