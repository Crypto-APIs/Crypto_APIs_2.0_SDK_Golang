...
// GetOmniTransactionDetailsByTransactionIDTxidResponse struct for GetOmniTransactionDetailsByTransactionIDTxidResponse
type GetOmniTransactionDetailsByTransactionIDTxidResponse struct {
	...
	Data GetOmniTransactionDetailsByTransactionIDTxidResponseData `json:"data"`
}
...
func NewGetOmniTransactionDetailsByTransactionIDTxidResponse(apiVersion string, requestId string, data GetOmniTransactionDetailsByTransactionIDTxidResponseData) *GetOmniTransactionDetailsByTransactionIDTxidResponse {
	this := GetOmniTransactionDetailsByTransactionIDTxidResponse{}
...
func (o *GetOmniTransactionDetailsByTransactionIDTxidResponse) GetData() GetOmniTransactionDetailsByTransactionIDTxidResponseData {
	if o == nil {
		var ret GetOmniTransactionDetailsByTransactionIDTxidResponseData
		return ret
	}
...
func (o GetOmniTransactionDetailsByTransactionIDTxidResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetOmniTransactionDetailsByTransactionIDTxidResponse struct {
	value *GetOmniTransactionDetailsByTransactionIDTxidResponse
	isSet bool
}

func (v NullableGetOmniTransactionDetailsByTransactionIDTxidResponse) Get() *GetOmniTransactionDetailsByTransactionIDTxidResponse {
	return v.value
}

func (v *NullableGetOmniTransactionDetailsByTransactionIDTxidResponse) Set(val *GetOmniTransactionDetailsByTransactionIDTxidResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOmniTransactionDetailsByTransactionIDTxidResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOmniTransactionDetailsByTransactionIDTxidResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOmniTransactionDetailsByTransactionIDTxidResponse(val *GetOmniTransactionDetailsByTransactionIDTxidResponse) *NullableGetOmniTransactionDetailsByTransactionIDTxidResponse {
	return &NullableGetOmniTransactionDetailsByTransactionIDTxidResponse{value: val, isSet: true}
}

func (v NullableGetOmniTransactionDetailsByTransactionIDTxidResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOmniTransactionDetailsByTransactionIDTxidResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
