...
type GetLastMinedBlock401Response struct {
	...
	Error GetLastMinedBlockE401 `json:"error"`
}
...
func NewGetLastMinedBlock401Response(apiVersion string, requestId string, error_ GetLastMinedBlockE401) *GetLastMinedBlock401Response {
	this := GetLastMinedBlock401Response{}
...
func (o GetLastMinedBlock401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetLastMinedBlock401Response struct {
	value *GetLastMinedBlock401Response
	isSet bool
}

func (v NullableGetLastMinedBlock401Response) Get() *GetLastMinedBlock401Response {
	return v.value
}

func (v *NullableGetLastMinedBlock401Response) Set(val *GetLastMinedBlock401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastMinedBlock401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastMinedBlock401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastMinedBlock401Response(val *GetLastMinedBlock401Response) *NullableGetLastMinedBlock401Response {
	return &NullableGetLastMinedBlock401Response{value: val, isSet: true}
}

func (v NullableGetLastMinedBlock401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastMinedBlock401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
