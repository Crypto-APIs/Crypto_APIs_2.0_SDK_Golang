...
type DeleteBlockchainEventSubscriptionE403 struct {
...
func BannedIpAddressAsDeleteBlockchainEventSubscriptionE403(v *BannedIpAddress) DeleteBlockchainEventSubscriptionE403 {
	return DeleteBlockchainEventSubscriptionE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsDeleteBlockchainEventSubscriptionE403(v *EndpointNotAllowedForApiKey) DeleteBlockchainEventSubscriptionE403 {
	return DeleteBlockchainEventSubscriptionE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsDeleteBlockchainEventSubscriptionE403(v *EndpointNotAllowedForPlan) DeleteBlockchainEventSubscriptionE403 {
	return DeleteBlockchainEventSubscriptionE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsDeleteBlockchainEventSubscriptionE403(v *FeatureMainnetsNotAllowedForPlan) DeleteBlockchainEventSubscriptionE403 {
	return DeleteBlockchainEventSubscriptionE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *DeleteBlockchainEventSubscriptionE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DeleteBlockchainEventSubscriptionE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DeleteBlockchainEventSubscriptionE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DeleteBlockchainEventSubscriptionE403) MarshalJSON() ([]byte, error) {
...
func (obj *DeleteBlockchainEventSubscriptionE403) GetActualInstance() (interface{}) {
...
type NullableDeleteBlockchainEventSubscriptionE403 struct {
	value *DeleteBlockchainEventSubscriptionE403
	isSet bool
}

func (v NullableDeleteBlockchainEventSubscriptionE403) Get() *DeleteBlockchainEventSubscriptionE403 {
	return v.value
}

func (v *NullableDeleteBlockchainEventSubscriptionE403) Set(val *DeleteBlockchainEventSubscriptionE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBlockchainEventSubscriptionE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBlockchainEventSubscriptionE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBlockchainEventSubscriptionE403(val *DeleteBlockchainEventSubscriptionE403) *NullableDeleteBlockchainEventSubscriptionE403 {
	return &NullableDeleteBlockchainEventSubscriptionE403{value: val, isSet: true}
}

func (v NullableDeleteBlockchainEventSubscriptionE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBlockchainEventSubscriptionE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
