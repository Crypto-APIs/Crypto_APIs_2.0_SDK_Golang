...
type GetInternalTransactionByTransactionHashAndOperationId404Response struct {
...
func NewGetInternalTransactionByTransactionHashAndOperationId404Response(apiVersion string, requestId string, error_ BlockchainDataInternalTransactionNotFound) *GetInternalTransactionByTransactionHashAndOperationId404Response {
	this := GetInternalTransactionByTransactionHashAndOperationId404Response{}
...
func (o GetInternalTransactionByTransactionHashAndOperationId404Response) MarshalJSON() ([]byte, error) {
...
type NullableGetInternalTransactionByTransactionHashAndOperationId404Response struct {
	value *GetInternalTransactionByTransactionHashAndOperationId404Response
	isSet bool
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationId404Response) Get() *GetInternalTransactionByTransactionHashAndOperationId404Response {
	return v.value
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationId404Response) Set(val *GetInternalTransactionByTransactionHashAndOperationId404Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationId404Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationId404Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInternalTransactionByTransactionHashAndOperationId404Response(val *GetInternalTransactionByTransactionHashAndOperationId404Response) *NullableGetInternalTransactionByTransactionHashAndOperationId404Response {
	return &NullableGetInternalTransactionByTransactionHashAndOperationId404Response{value: val, isSet: true}
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationId404Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationId404Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
