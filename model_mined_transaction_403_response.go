...
type MinedTransaction403Response struct {
	...
	Error MinedTransactionE403 `json:"error"`
}
...
func NewMinedTransaction403Response(apiVersion string, requestId string, error_ MinedTransactionE403) *MinedTransaction403Response {
	this := MinedTransaction403Response{}
...
func (o MinedTransaction403Response) MarshalJSON() ([]byte, error) {
...
type NullableMinedTransaction403Response struct {
	value *MinedTransaction403Response
	isSet bool
}

func (v NullableMinedTransaction403Response) Get() *MinedTransaction403Response {
	return v.value
}

func (v *NullableMinedTransaction403Response) Set(val *MinedTransaction403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMinedTransaction403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMinedTransaction403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinedTransaction403Response(val *MinedTransaction403Response) *NullableMinedTransaction403Response {
	return &NullableMinedTransaction403Response{value: val, isSet: true}
}

func (v NullableMinedTransaction403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinedTransaction403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
