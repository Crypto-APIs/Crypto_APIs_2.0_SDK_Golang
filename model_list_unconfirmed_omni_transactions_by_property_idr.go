...
// ListUnconfirmedOmniTransactionsByPropertyIDR struct for ListUnconfirmedOmniTransactionsByPropertyIDR
type ListUnconfirmedOmniTransactionsByPropertyIDR struct {
	...
	Data ListUnconfirmedOmniTransactionsByPropertyIDRData `json:"data"`
}
...
func NewListUnconfirmedOmniTransactionsByPropertyIDR(apiVersion string, requestId string, data ListUnconfirmedOmniTransactionsByPropertyIDRData) *ListUnconfirmedOmniTransactionsByPropertyIDR {
	this := ListUnconfirmedOmniTransactionsByPropertyIDR{}
...
func (o *ListUnconfirmedOmniTransactionsByPropertyIDR) GetData() ListUnconfirmedOmniTransactionsByPropertyIDRData {
	if o == nil {
		var ret ListUnconfirmedOmniTransactionsByPropertyIDRData
		return ret
	}
...
func (o ListUnconfirmedOmniTransactionsByPropertyIDR) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedOmniTransactionsByPropertyIDR struct {
	value *ListUnconfirmedOmniTransactionsByPropertyIDR
	isSet bool
}

func (v NullableListUnconfirmedOmniTransactionsByPropertyIDR) Get() *ListUnconfirmedOmniTransactionsByPropertyIDR {
	return v.value
}

func (v *NullableListUnconfirmedOmniTransactionsByPropertyIDR) Set(val *ListUnconfirmedOmniTransactionsByPropertyIDR) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedOmniTransactionsByPropertyIDR) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedOmniTransactionsByPropertyIDR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedOmniTransactionsByPropertyIDR(val *ListUnconfirmedOmniTransactionsByPropertyIDR) *NullableListUnconfirmedOmniTransactionsByPropertyIDR {
	return &NullableListUnconfirmedOmniTransactionsByPropertyIDR{value: val, isSet: true}
}

func (v NullableListUnconfirmedOmniTransactionsByPropertyIDR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedOmniTransactionsByPropertyIDR) UnmarshalJSON(src []byte) error {
	v.isSet = true
