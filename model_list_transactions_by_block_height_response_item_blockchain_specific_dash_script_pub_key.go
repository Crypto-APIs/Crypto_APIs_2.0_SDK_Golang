...
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey struct {
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey{}
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
