...
type NewConfirmedInternalTransactionsRB struct {
	// In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
	Context *string `json:"context,omitempty"`
	Data NewConfirmedInternalTransactionsRBData `json:"data"`
}
...
func NewNewConfirmedInternalTransactionsRB(data NewConfirmedInternalTransactionsRBData) *NewConfirmedInternalTransactionsRB {
	this := NewConfirmedInternalTransactionsRB{}
	this.Data = data
	return &this
}
...
func (o *NewConfirmedInternalTransactionsRB) GetData() NewConfirmedInternalTransactionsRBData {
	if o == nil {
		var ret NewConfirmedInternalTransactionsRBData
		return ret
	}
...
func (o NewConfirmedInternalTransactionsRB) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsRB struct {
	value *NewConfirmedInternalTransactionsRB
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsRB) Get() *NewConfirmedInternalTransactionsRB {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsRB) Set(val *NewConfirmedInternalTransactionsRB) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsRB) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsRB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsRB(val *NewConfirmedInternalTransactionsRB) *NullableNewConfirmedInternalTransactionsRB {
	return &NullableNewConfirmedInternalTransactionsRB{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsRB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsRB) UnmarshalJSON(src []byte) error {
	v.isSet = true
