...
type ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey struct {
...
func NewListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey {
	this := ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey{}
...
func (o ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey struct {
	value *ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) Get() *ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) Set(val *ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey(val *ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey {
	return &NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
