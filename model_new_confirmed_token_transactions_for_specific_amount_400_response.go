...
type NewConfirmedTokenTransactionsForSpecificAmount400Response struct {
	...
	Error NewConfirmedTokenTransactionsForSpecificAmountE400 `json:"error"`
}
...
func NewNewConfirmedTokenTransactionsForSpecificAmount400Response(apiVersion string, requestId string, error_ NewConfirmedTokenTransactionsForSpecificAmountE400) *NewConfirmedTokenTransactionsForSpecificAmount400Response {
	this := NewConfirmedTokenTransactionsForSpecificAmount400Response{}
...
func (o *NewConfirmedTokenTransactionsForSpecificAmount400Response) GetError() NewConfirmedTokenTransactionsForSpecificAmountE400 {
	if o == nil {
		var ret NewConfirmedTokenTransactionsForSpecificAmountE400
		return ret
	}
...
func (o NewConfirmedTokenTransactionsForSpecificAmount400Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokenTransactionsForSpecificAmount400Response struct {
	value *NewConfirmedTokenTransactionsForSpecificAmount400Response
	isSet bool
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount400Response) Get() *NewConfirmedTokenTransactionsForSpecificAmount400Response {
	return v.value
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount400Response) Set(val *NewConfirmedTokenTransactionsForSpecificAmount400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokenTransactionsForSpecificAmount400Response(val *NewConfirmedTokenTransactionsForSpecificAmount400Response) *NullableNewConfirmedTokenTransactionsForSpecificAmount400Response {
	return &NullableNewConfirmedTokenTransactionsForSpecificAmount400Response{value: val, isSet: true}
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
