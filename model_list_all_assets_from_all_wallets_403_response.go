...
type ListAllAssetsFromAllWallets403Response struct {
	...
	Error ListAllAssetsFromAllWalletsE403 `json:"error"`
}
...
func NewListAllAssetsFromAllWallets403Response(apiVersion string, requestId string, error_ ListAllAssetsFromAllWalletsE403) *ListAllAssetsFromAllWallets403Response {
	this := ListAllAssetsFromAllWallets403Response{}
...
func (o *ListAllAssetsFromAllWallets403Response) GetError() ListAllAssetsFromAllWalletsE403 {
	if o == nil {
		var ret ListAllAssetsFromAllWalletsE403
		return ret
	}
...
func (o ListAllAssetsFromAllWallets403Response) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsFromAllWallets403Response struct {
	value *ListAllAssetsFromAllWallets403Response
	isSet bool
}

func (v NullableListAllAssetsFromAllWallets403Response) Get() *ListAllAssetsFromAllWallets403Response {
	return v.value
}

func (v *NullableListAllAssetsFromAllWallets403Response) Set(val *ListAllAssetsFromAllWallets403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsFromAllWallets403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsFromAllWallets403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsFromAllWallets403Response(val *ListAllAssetsFromAllWallets403Response) *NullableListAllAssetsFromAllWallets403Response {
	return &NullableListAllAssetsFromAllWallets403Response{value: val, isSet: true}
}

func (v NullableListAllAssetsFromAllWallets403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsFromAllWallets403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
