...
// ListTransactionsByBlockHeightRIBSBVout struct for ListTransactionsByBlockHeightRIBSBVout
type ListTransactionsByBlockHeightRIBSBVout struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByBlockHeightRIBSBScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByBlockHeightRIBSBVout(isSpent bool, scriptPubKey ListTransactionsByBlockHeightRIBSBScriptPubKey, value string) *ListTransactionsByBlockHeightRIBSBVout {
	this := ListTransactionsByBlockHeightRIBSBVout{}
...
func (o *ListTransactionsByBlockHeightRIBSBVout) GetScriptPubKey() ListTransactionsByBlockHeightRIBSBScriptPubKey {
	if o == nil {
		var ret ListTransactionsByBlockHeightRIBSBScriptPubKey
		return ret
	}
...
func (o ListTransactionsByBlockHeightRIBSBVout) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSBVout struct {
	value *ListTransactionsByBlockHeightRIBSBVout
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSBVout) Get() *ListTransactionsByBlockHeightRIBSBVout {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSBVout) Set(val *ListTransactionsByBlockHeightRIBSBVout) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSBVout) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSBVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSBVout(val *ListTransactionsByBlockHeightRIBSBVout) *NullableListTransactionsByBlockHeightRIBSBVout {
	return &NullableListTransactionsByBlockHeightRIBSBVout{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSBVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSBVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
