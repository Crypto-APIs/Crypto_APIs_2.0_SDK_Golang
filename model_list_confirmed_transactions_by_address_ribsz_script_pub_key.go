...
type ListConfirmedTransactionsByAddressRIBSZScriptPubKey struct {
...
func NewListConfirmedTransactionsByAddressRIBSZScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListConfirmedTransactionsByAddressRIBSZScriptPubKey {
	this := ListConfirmedTransactionsByAddressRIBSZScriptPubKey{}
...
func (o ListConfirmedTransactionsByAddressRIBSZScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey struct {
	value *ListConfirmedTransactionsByAddressRIBSZScriptPubKey
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey) Get() *ListConfirmedTransactionsByAddressRIBSZScriptPubKey {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey) Set(val *ListConfirmedTransactionsByAddressRIBSZScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRIBSZScriptPubKey(val *ListConfirmedTransactionsByAddressRIBSZScriptPubKey) *NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey {
	return &NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRIBSZScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
