...
// ListAllUnconfirmedTransactionsRIBSBVinInner struct for ListAllUnconfirmedTransactionsRIBSBVinInner
type ListAllUnconfirmedTransactionsRIBSBVinInner struct {
	Addresses []string `json:"addresses"`
	ScriptSig ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig `json:"scriptSig"`
...
func NewListAllUnconfirmedTransactionsRIBSBVinInner(addresses []string, scriptSig ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig, sequence string, vout int32) *ListAllUnconfirmedTransactionsRIBSBVinInner {
	this := ListAllUnconfirmedTransactionsRIBSBVinInner{}
...
func (o *ListAllUnconfirmedTransactionsRIBSBVinInner) GetScriptSig() ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig {
	if o == nil {
		var ret ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig
		return ret
	}
...
func (o ListAllUnconfirmedTransactionsRIBSBVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListAllUnconfirmedTransactionsRIBSBVinInner struct {
	value *ListAllUnconfirmedTransactionsRIBSBVinInner
	isSet bool
}

func (v NullableListAllUnconfirmedTransactionsRIBSBVinInner) Get() *ListAllUnconfirmedTransactionsRIBSBVinInner {
	return v.value
}

func (v *NullableListAllUnconfirmedTransactionsRIBSBVinInner) Set(val *ListAllUnconfirmedTransactionsRIBSBVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllUnconfirmedTransactionsRIBSBVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllUnconfirmedTransactionsRIBSBVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllUnconfirmedTransactionsRIBSBVinInner(val *ListAllUnconfirmedTransactionsRIBSBVinInner) *NullableListAllUnconfirmedTransactionsRIBSBVinInner {
	return &NullableListAllUnconfirmedTransactionsRIBSBVinInner{value: val, isSet: true}
}

func (v NullableListAllUnconfirmedTransactionsRIBSBVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllUnconfirmedTransactionsRIBSBVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
