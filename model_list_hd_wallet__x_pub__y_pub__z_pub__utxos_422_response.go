...
type ListHDWalletXPubYPubZPubUTXOs422Response struct {
	...
	Error ListHDWalletXPubYPubZPubUTXOsE422 `json:"error"`
}
...
func NewListHDWalletXPubYPubZPubUTXOs422Response(apiVersion string, requestId string, error_ ListHDWalletXPubYPubZPubUTXOsE422) *ListHDWalletXPubYPubZPubUTXOs422Response {
	this := ListHDWalletXPubYPubZPubUTXOs422Response{}
...
func (o *ListHDWalletXPubYPubZPubUTXOs422Response) GetError() ListHDWalletXPubYPubZPubUTXOsE422 {
	if o == nil {
		var ret ListHDWalletXPubYPubZPubUTXOsE422
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubUTXOs422Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubUTXOs422Response struct {
	value *ListHDWalletXPubYPubZPubUTXOs422Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubUTXOs422Response) Get() *ListHDWalletXPubYPubZPubUTXOs422Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs422Response) Set(val *ListHDWalletXPubYPubZPubUTXOs422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubUTXOs422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubUTXOs422Response(val *ListHDWalletXPubYPubZPubUTXOs422Response) *NullableListHDWalletXPubYPubZPubUTXOs422Response {
	return &NullableListHDWalletXPubYPubZPubUTXOs422Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubUTXOs422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubUTXOs422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
