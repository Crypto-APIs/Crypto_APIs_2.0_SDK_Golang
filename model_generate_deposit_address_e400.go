...
type GenerateDepositAddressE400 struct {
...
func InvalidPaginationAsGenerateDepositAddressE400(v *InvalidPagination) GenerateDepositAddressE400 {
	return GenerateDepositAddressE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsGenerateDepositAddressE400(v *LimitGreaterThanAllowed) GenerateDepositAddressE400 {
	return GenerateDepositAddressE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsGenerateDepositAddressE400(v *UriNotFound) GenerateDepositAddressE400 {
	return GenerateDepositAddressE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GenerateDepositAddressE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GenerateDepositAddressE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GenerateDepositAddressE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GenerateDepositAddressE400) MarshalJSON() ([]byte, error) {
...
func (obj *GenerateDepositAddressE400) GetActualInstance() (interface{}) {
...
type NullableGenerateDepositAddressE400 struct {
	value *GenerateDepositAddressE400
	isSet bool
}

func (v NullableGenerateDepositAddressE400) Get() *GenerateDepositAddressE400 {
	return v.value
}

func (v *NullableGenerateDepositAddressE400) Set(val *GenerateDepositAddressE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateDepositAddressE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateDepositAddressE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateDepositAddressE400(val *GenerateDepositAddressE400) *NullableGenerateDepositAddressE400 {
	return &NullableGenerateDepositAddressE400{value: val, isSet: true}
}

func (v NullableGenerateDepositAddressE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateDepositAddressE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
