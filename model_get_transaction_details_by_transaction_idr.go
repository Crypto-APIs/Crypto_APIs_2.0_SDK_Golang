...
type GetTransactionDetailsByTransactionIDR struct {
	...
	Data GetTransactionDetailsByTransactionIDRData `json:"data"`
}
...
func NewGetTransactionDetailsByTransactionIDR(apiVersion string, requestId string, data GetTransactionDetailsByTransactionIDRData) *GetTransactionDetailsByTransactionIDR {
	this := GetTransactionDetailsByTransactionIDR{}
...
func (o *GetTransactionDetailsByTransactionIDR) GetData() GetTransactionDetailsByTransactionIDRData {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDRData
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDR) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDR struct {
	value *GetTransactionDetailsByTransactionIDR
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDR) Get() *GetTransactionDetailsByTransactionIDR {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDR) Set(val *GetTransactionDetailsByTransactionIDR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDR(val *GetTransactionDetailsByTransactionIDR) *NullableGetTransactionDetailsByTransactionIDR {
	return &NullableGetTransactionDetailsByTransactionIDR{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDR) UnmarshalJSON(src []byte) error {
	v.isSet = true
