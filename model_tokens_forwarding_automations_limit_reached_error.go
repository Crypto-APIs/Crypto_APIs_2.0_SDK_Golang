...
// TokensForwardingAutomationsLimitReachedError struct for TokensForwardingAutomationsLimitReachedError
type TokensForwardingAutomationsLimitReachedError struct {
...
func NewTokensForwardingAutomationsLimitReachedError(code string, message string) *TokensForwardingAutomationsLimitReachedError {
	this := TokensForwardingAutomationsLimitReachedError{}
	this.Code = code
...
func (o TokensForwardingAutomationsLimitReachedError) MarshalJSON() ([]byte, error) {
...
type NullableTokensForwardingAutomationsLimitReachedError struct {
	value *TokensForwardingAutomationsLimitReachedError
	isSet bool
}

func (v NullableTokensForwardingAutomationsLimitReachedError) Get() *TokensForwardingAutomationsLimitReachedError {
	return v.value
}

func (v *NullableTokensForwardingAutomationsLimitReachedError) Set(val *TokensForwardingAutomationsLimitReachedError) {
	v.value = val
	v.isSet = true
}

func (v NullableTokensForwardingAutomationsLimitReachedError) IsSet() bool {
	return v.isSet
}

func (v *NullableTokensForwardingAutomationsLimitReachedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokensForwardingAutomationsLimitReachedError(val *TokensForwardingAutomationsLimitReachedError) *NullableTokensForwardingAutomationsLimitReachedError {
	return &NullableTokensForwardingAutomationsLimitReachedError{value: val, isSet: true}
}

func (v NullableTokensForwardingAutomationsLimitReachedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokensForwardingAutomationsLimitReachedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
