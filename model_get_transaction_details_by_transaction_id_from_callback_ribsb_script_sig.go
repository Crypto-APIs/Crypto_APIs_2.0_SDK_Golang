...
type GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig struct {
...
func NewGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig(asm string, hex string, type_ string) *GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig {
	this := GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) Get() *GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) Set(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
