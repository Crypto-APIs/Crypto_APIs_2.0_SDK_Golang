...
type NewUnconfirmedTokensTransactions409Response struct {
	...
	Error NewUnconfirmedTokensTransactionsE409 `json:"error"`
}
...
func NewNewUnconfirmedTokensTransactions409Response(apiVersion string, requestId string, error_ NewUnconfirmedTokensTransactionsE409) *NewUnconfirmedTokensTransactions409Response {
	this := NewUnconfirmedTokensTransactions409Response{}
...
func (o *NewUnconfirmedTokensTransactions409Response) GetError() NewUnconfirmedTokensTransactionsE409 {
	if o == nil {
		var ret NewUnconfirmedTokensTransactionsE409
		return ret
	}
...
func (o NewUnconfirmedTokensTransactions409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewUnconfirmedTokensTransactions409Response struct {
	value *NewUnconfirmedTokensTransactions409Response
	isSet bool
}

func (v NullableNewUnconfirmedTokensTransactions409Response) Get() *NewUnconfirmedTokensTransactions409Response {
	return v.value
}

func (v *NullableNewUnconfirmedTokensTransactions409Response) Set(val *NewUnconfirmedTokensTransactions409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUnconfirmedTokensTransactions409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUnconfirmedTokensTransactions409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUnconfirmedTokensTransactions409Response(val *NewUnconfirmedTokensTransactions409Response) *NullableNewUnconfirmedTokensTransactions409Response {
	return &NullableNewUnconfirmedTokensTransactions409Response{value: val, isSet: true}
}

func (v NullableNewUnconfirmedTokensTransactions409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUnconfirmedTokensTransactions409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
