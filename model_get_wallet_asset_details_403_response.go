...
type GetWalletAssetDetails403Response struct {
	...
	Error GetWalletAssetDetailsE403 `json:"error"`
}
...
func NewGetWalletAssetDetails403Response(apiVersion string, requestId string, error_ GetWalletAssetDetailsE403) *GetWalletAssetDetails403Response {
	this := GetWalletAssetDetails403Response{}
...
func (o *GetWalletAssetDetails403Response) GetError() GetWalletAssetDetailsE403 {
	if o == nil {
		var ret GetWalletAssetDetailsE403
		return ret
	}
...
func (o GetWalletAssetDetails403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletAssetDetails403Response struct {
	value *GetWalletAssetDetails403Response
	isSet bool
}

func (v NullableGetWalletAssetDetails403Response) Get() *GetWalletAssetDetails403Response {
	return v.value
}

func (v *NullableGetWalletAssetDetails403Response) Set(val *GetWalletAssetDetails403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletAssetDetails403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletAssetDetails403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletAssetDetails403Response(val *GetWalletAssetDetails403Response) *NullableGetWalletAssetDetails403Response {
	return &NullableGetWalletAssetDetails403Response{value: val, isSet: true}
}

func (v NullableGetWalletAssetDetails403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletAssetDetails403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
