...
type GetBlockDetailsByBlockHashRIBSEC struct {
...
func NewGetBlockDetailsByBlockHashRIBSEC(difficulty string, nonce int32, size int32, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, sha3Uncles string, totalDifficulty string, uncles []string) *GetBlockDetailsByBlockHashRIBSEC {
	this := GetBlockDetailsByBlockHashRIBSEC{}
...
func (o GetBlockDetailsByBlockHashRIBSEC) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashRIBSEC struct {
	value *GetBlockDetailsByBlockHashRIBSEC
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashRIBSEC) Get() *GetBlockDetailsByBlockHashRIBSEC {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashRIBSEC) Set(val *GetBlockDetailsByBlockHashRIBSEC) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashRIBSEC) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashRIBSEC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashRIBSEC(val *GetBlockDetailsByBlockHashRIBSEC) *NullableGetBlockDetailsByBlockHashRIBSEC {
	return &NullableGetBlockDetailsByBlockHashRIBSEC{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashRIBSEC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashRIBSEC) UnmarshalJSON(src []byte) error {
	v.isSet = true
