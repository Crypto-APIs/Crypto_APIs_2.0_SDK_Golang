...
type EncodeXAddress403Response struct {
	...
	Error EncodeXAddressE403 `json:"error"`
}
...
func NewEncodeXAddress403Response(apiVersion string, requestId string, error_ EncodeXAddressE403) *EncodeXAddress403Response {
	this := EncodeXAddress403Response{}
...
func (o EncodeXAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableEncodeXAddress403Response struct {
	value *EncodeXAddress403Response
	isSet bool
}

func (v NullableEncodeXAddress403Response) Get() *EncodeXAddress403Response {
	return v.value
}

func (v *NullableEncodeXAddress403Response) Set(val *EncodeXAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeXAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeXAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeXAddress403Response(val *EncodeXAddress403Response) *NullableEncodeXAddress403Response {
	return &NullableEncodeXAddress403Response{value: val, isSet: true}
}

func (v NullableEncodeXAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeXAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
