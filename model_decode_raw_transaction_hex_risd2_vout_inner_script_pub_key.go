...
type DecodeRawTransactionHexRISD2VoutInnerScriptPubKey struct {
...
func (o DecodeRawTransactionHexRISD2VoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey struct {
	value *DecodeRawTransactionHexRISD2VoutInnerScriptPubKey
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey) Get() *DecodeRawTransactionHexRISD2VoutInnerScriptPubKey {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey) Set(val *DecodeRawTransactionHexRISD2VoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey(val *DecodeRawTransactionHexRISD2VoutInnerScriptPubKey) *NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey {
	return &NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISD2VoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
