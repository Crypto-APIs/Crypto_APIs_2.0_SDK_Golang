...
type ListSupportedTokensRData struct {
	...
	Items []ListSupportedTokensRI `json:"items"`
}
...
func (o ListSupportedTokensRData) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedTokensRData struct {
	value *ListSupportedTokensRData
	isSet bool
}

func (v NullableListSupportedTokensRData) Get() *ListSupportedTokensRData {
	return v.value
}

func (v *NullableListSupportedTokensRData) Set(val *ListSupportedTokensRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedTokensRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedTokensRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedTokensRData(val *ListSupportedTokensRData) *NullableListSupportedTokensRData {
	return &NullableListSupportedTokensRData{value: val, isSet: true}
}

func (v NullableListSupportedTokensRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedTokensRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
