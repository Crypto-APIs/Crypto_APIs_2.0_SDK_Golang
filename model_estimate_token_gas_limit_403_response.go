...
type EstimateTokenGasLimit403Response struct {
	...
	Error EstimateTokenGasLimitE403 `json:"error"`
}
...
func NewEstimateTokenGasLimit403Response(apiVersion string, requestId string, error_ EstimateTokenGasLimitE403) *EstimateTokenGasLimit403Response {
	this := EstimateTokenGasLimit403Response{}
...
func (o *EstimateTokenGasLimit403Response) GetError() EstimateTokenGasLimitE403 {
	if o == nil {
		var ret EstimateTokenGasLimitE403
		return ret
	}
...
func (o EstimateTokenGasLimit403Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateTokenGasLimit403Response struct {
	value *EstimateTokenGasLimit403Response
	isSet bool
}

func (v NullableEstimateTokenGasLimit403Response) Get() *EstimateTokenGasLimit403Response {
	return v.value
}

func (v *NullableEstimateTokenGasLimit403Response) Set(val *EstimateTokenGasLimit403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTokenGasLimit403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTokenGasLimit403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTokenGasLimit403Response(val *EstimateTokenGasLimit403Response) *NullableEstimateTokenGasLimit403Response {
	return &NullableEstimateTokenGasLimit403Response{value: val, isSet: true}
}

func (v NullableEstimateTokenGasLimit403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTokenGasLimit403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
