...
type NewConfirmedInternalTransactionsForSpecificAmount409Response struct {
	...
	Error NewConfirmedInternalTransactionsForSpecificAmountE409 `json:"error"`
}
...
func NewNewConfirmedInternalTransactionsForSpecificAmount409Response(apiVersion string, requestId string, error_ NewConfirmedInternalTransactionsForSpecificAmountE409) *NewConfirmedInternalTransactionsForSpecificAmount409Response {
	this := NewConfirmedInternalTransactionsForSpecificAmount409Response{}
...
func (o *NewConfirmedInternalTransactionsForSpecificAmount409Response) GetError() NewConfirmedInternalTransactionsForSpecificAmountE409 {
	if o == nil {
		var ret NewConfirmedInternalTransactionsForSpecificAmountE409
		return ret
	}
...
func (o NewConfirmedInternalTransactionsForSpecificAmount409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsForSpecificAmount409Response struct {
	value *NewConfirmedInternalTransactionsForSpecificAmount409Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmount409Response) Get() *NewConfirmedInternalTransactionsForSpecificAmount409Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmount409Response) Set(val *NewConfirmedInternalTransactionsForSpecificAmount409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmount409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmount409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsForSpecificAmount409Response(val *NewConfirmedInternalTransactionsForSpecificAmount409Response) *NullableNewConfirmedInternalTransactionsForSpecificAmount409Response {
	return &NullableNewConfirmedInternalTransactionsForSpecificAmount409Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmount409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmount409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
