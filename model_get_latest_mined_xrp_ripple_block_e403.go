...
type GetLatestMinedXRPRippleBlockE403 struct {
...
func BannedIpAddressAsGetLatestMinedXRPRippleBlockE403(v *BannedIpAddress) GetLatestMinedXRPRippleBlockE403 {
	return GetLatestMinedXRPRippleBlockE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetLatestMinedXRPRippleBlockE403(v *EndpointNotAllowedForApiKey) GetLatestMinedXRPRippleBlockE403 {
	return GetLatestMinedXRPRippleBlockE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetLatestMinedXRPRippleBlockE403(v *EndpointNotAllowedForPlan) GetLatestMinedXRPRippleBlockE403 {
	return GetLatestMinedXRPRippleBlockE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetLatestMinedXRPRippleBlockE403(v *FeatureMainnetsNotAllowedForPlan) GetLatestMinedXRPRippleBlockE403 {
	return GetLatestMinedXRPRippleBlockE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetLatestMinedXRPRippleBlockE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetLatestMinedXRPRippleBlockE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetLatestMinedXRPRippleBlockE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetLatestMinedXRPRippleBlockE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetLatestMinedXRPRippleBlockE403) GetActualInstance() (interface{}) {
...
type NullableGetLatestMinedXRPRippleBlockE403 struct {
	value *GetLatestMinedXRPRippleBlockE403
	isSet bool
}

func (v NullableGetLatestMinedXRPRippleBlockE403) Get() *GetLatestMinedXRPRippleBlockE403 {
	return v.value
}

func (v *NullableGetLatestMinedXRPRippleBlockE403) Set(val *GetLatestMinedXRPRippleBlockE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedXRPRippleBlockE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedXRPRippleBlockE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedXRPRippleBlockE403(val *GetLatestMinedXRPRippleBlockE403) *NullableGetLatestMinedXRPRippleBlockE403 {
	return &NullableGetLatestMinedXRPRippleBlockE403{value: val, isSet: true}
}

func (v NullableGetLatestMinedXRPRippleBlockE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedXRPRippleBlockE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
