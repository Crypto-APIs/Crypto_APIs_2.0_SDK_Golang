...
type ListLatestMinedBlocks400Response struct {
	...
	Error ListLatestMinedBlocksE400 `json:"error"`
}
...
func NewListLatestMinedBlocks400Response(apiVersion string, requestId string, error_ ListLatestMinedBlocksE400) *ListLatestMinedBlocks400Response {
	this := ListLatestMinedBlocks400Response{}
...
func (o *ListLatestMinedBlocks400Response) GetError() ListLatestMinedBlocksE400 {
	if o == nil {
		var ret ListLatestMinedBlocksE400
		return ret
	}
...
func (o ListLatestMinedBlocks400Response) MarshalJSON() ([]byte, error) {
...
type NullableListLatestMinedBlocks400Response struct {
	value *ListLatestMinedBlocks400Response
	isSet bool
}

func (v NullableListLatestMinedBlocks400Response) Get() *ListLatestMinedBlocks400Response {
	return v.value
}

func (v *NullableListLatestMinedBlocks400Response) Set(val *ListLatestMinedBlocks400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListLatestMinedBlocks400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListLatestMinedBlocks400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLatestMinedBlocks400Response(val *ListLatestMinedBlocks400Response) *NullableListLatestMinedBlocks400Response {
	return &NullableListLatestMinedBlocks400Response{value: val, isSet: true}
}

func (v NullableListLatestMinedBlocks400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLatestMinedBlocks400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
