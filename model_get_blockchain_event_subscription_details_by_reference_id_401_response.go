...
type GetBlockchainEventSubscriptionDetailsByReferenceID401Response struct {
	...
	Error GetBlockchainEventSubscriptionDetailsByReferenceIDE401 `json:"error"`
}
...
func (o *GetBlockchainEventSubscriptionDetailsByReferenceID401Response) GetError() GetBlockchainEventSubscriptionDetailsByReferenceIDE401 {
	if o == nil {
		var ret GetBlockchainEventSubscriptionDetailsByReferenceIDE401
		return ret
	}
...
func (o GetBlockchainEventSubscriptionDetailsByReferenceID401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response struct {
	value *GetBlockchainEventSubscriptionDetailsByReferenceID401Response
	isSet bool
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response) Get() *GetBlockchainEventSubscriptionDetailsByReferenceID401Response {
	return v.value
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response) Set(val *GetBlockchainEventSubscriptionDetailsByReferenceID401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response(val *GetBlockchainEventSubscriptionDetailsByReferenceID401Response) *NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response {
	return &NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response{value: val, isSet: true}
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
