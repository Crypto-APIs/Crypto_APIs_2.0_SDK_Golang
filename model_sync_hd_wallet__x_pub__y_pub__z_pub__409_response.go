...
type SyncHDWalletXPubYPubZPub409Response struct {
	...
	Error SyncHDWalletXPubYPubZPubE409 `json:"error"`
}
...
func (o *SyncHDWalletXPubYPubZPub409Response) GetError() SyncHDWalletXPubYPubZPubE409 {
	if o == nil {
		var ret SyncHDWalletXPubYPubZPubE409
		return ret
	}
...
func (o SyncHDWalletXPubYPubZPub409Response) MarshalJSON() ([]byte, error) {
...
type NullableSyncHDWalletXPubYPubZPub409Response struct {
	value *SyncHDWalletXPubYPubZPub409Response
	isSet bool
}

func (v NullableSyncHDWalletXPubYPubZPub409Response) Get() *SyncHDWalletXPubYPubZPub409Response {
	return v.value
}

func (v *NullableSyncHDWalletXPubYPubZPub409Response) Set(val *SyncHDWalletXPubYPubZPub409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncHDWalletXPubYPubZPub409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncHDWalletXPubYPubZPub409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncHDWalletXPubYPubZPub409Response(val *SyncHDWalletXPubYPubZPub409Response) *NullableSyncHDWalletXPubYPubZPub409Response {
	return &NullableSyncHDWalletXPubYPubZPub409Response{value: val, isSet: true}
}

func (v NullableSyncHDWalletXPubYPubZPub409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncHDWalletXPubYPubZPub409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
