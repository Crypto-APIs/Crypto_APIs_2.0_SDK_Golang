...
type DeriveAndSyncNewReceivingAddressesRBDataItem struct {
...
func NewDeriveAndSyncNewReceivingAddressesRBDataItem(extendedPublicKey string) *DeriveAndSyncNewReceivingAddressesRBDataItem {
	this := DeriveAndSyncNewReceivingAddressesRBDataItem{}
...
func (o DeriveAndSyncNewReceivingAddressesRBDataItem) MarshalJSON() ([]byte, error) {
...
type NullableDeriveAndSyncNewReceivingAddressesRBDataItem struct {
	value *DeriveAndSyncNewReceivingAddressesRBDataItem
	isSet bool
}

func (v NullableDeriveAndSyncNewReceivingAddressesRBDataItem) Get() *DeriveAndSyncNewReceivingAddressesRBDataItem {
	return v.value
}

func (v *NullableDeriveAndSyncNewReceivingAddressesRBDataItem) Set(val *DeriveAndSyncNewReceivingAddressesRBDataItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewReceivingAddressesRBDataItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewReceivingAddressesRBDataItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewReceivingAddressesRBDataItem(val *DeriveAndSyncNewReceivingAddressesRBDataItem) *NullableDeriveAndSyncNewReceivingAddressesRBDataItem {
	return &NullableDeriveAndSyncNewReceivingAddressesRBDataItem{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewReceivingAddressesRBDataItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewReceivingAddressesRBDataItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
