...
type ListHDWalletXPubYPubZPubTransactions403Response struct {
...
func NewListHDWalletXPubYPubZPubTransactions403Response(apiVersion string, requestId string, error_ ListHDWalletXPubYPubZPubTransactionsE403) *ListHDWalletXPubYPubZPubTransactions403Response {
	this := ListHDWalletXPubYPubZPubTransactions403Response{}
...
func (o ListHDWalletXPubYPubZPubTransactions403Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactions403Response struct {
	value *ListHDWalletXPubYPubZPubTransactions403Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactions403Response) Get() *ListHDWalletXPubYPubZPubTransactions403Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactions403Response) Set(val *ListHDWalletXPubYPubZPubTransactions403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactions403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactions403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactions403Response(val *ListHDWalletXPubYPubZPubTransactions403Response) *NullableListHDWalletXPubYPubZPubTransactions403Response {
	return &NullableListHDWalletXPubYPubZPubTransactions403Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactions403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactions403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
