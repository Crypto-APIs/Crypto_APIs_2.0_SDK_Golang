...
type GetHDWalletXPubYPubZPubAssetsE403 struct {
...
func BannedIpAddressAsGetHDWalletXPubYPubZPubAssetsE403(v *BannedIpAddress) GetHDWalletXPubYPubZPubAssetsE403 {
...
func EndpointNotAllowedForApiKeyAsGetHDWalletXPubYPubZPubAssetsE403(v *EndpointNotAllowedForApiKey) GetHDWalletXPubYPubZPubAssetsE403 {
	return GetHDWalletXPubYPubZPubAssetsE403{
...
func EndpointNotAllowedForPlanAsGetHDWalletXPubYPubZPubAssetsE403(v *EndpointNotAllowedForPlan) GetHDWalletXPubYPubZPubAssetsE403 {
	return GetHDWalletXPubYPubZPubAssetsE403{
...
func FeatureMainnetsNotAllowedForPlanAsGetHDWalletXPubYPubZPubAssetsE403(v *FeatureMainnetsNotAllowedForPlan) GetHDWalletXPubYPubZPubAssetsE403 {
	return GetHDWalletXPubYPubZPubAssetsE403{
...
func (dst *GetHDWalletXPubYPubZPubAssetsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetHDWalletXPubYPubZPubAssetsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetHDWalletXPubYPubZPubAssetsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetHDWalletXPubYPubZPubAssetsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetHDWalletXPubYPubZPubAssetsE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableGetHDWalletXPubYPubZPubAssetsE403 struct {
	value *GetHDWalletXPubYPubZPubAssetsE403
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubAssetsE403) Get() *GetHDWalletXPubYPubZPubAssetsE403 {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubAssetsE403) Set(val *GetHDWalletXPubYPubZPubAssetsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubAssetsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubAssetsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubAssetsE403(val *GetHDWalletXPubYPubZPubAssetsE403) *NullableGetHDWalletXPubYPubZPubAssetsE403 {
	return &NullableGetHDWalletXPubYPubZPubAssetsE403{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubAssetsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubAssetsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
