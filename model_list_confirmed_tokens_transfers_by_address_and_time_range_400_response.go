...
type ListConfirmedTokensTransfersByAddressAndTimeRange400Response struct {
	...
	Error ListConfirmedTokensTransfersByAddressAndTimeRangeE400 `json:"error"`
}
...
func NewListConfirmedTokensTransfersByAddressAndTimeRange400Response(apiVersion string, requestId string, error_ ListConfirmedTokensTransfersByAddressAndTimeRangeE400) *ListConfirmedTokensTransfersByAddressAndTimeRange400Response {
	this := ListConfirmedTokensTransfersByAddressAndTimeRange400Response{}
...
func (o ListConfirmedTokensTransfersByAddressAndTimeRange400Response) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response struct {
	value *ListConfirmedTokensTransfersByAddressAndTimeRange400Response
	isSet bool
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response) Get() *ListConfirmedTokensTransfersByAddressAndTimeRange400Response {
	return v.value
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response) Set(val *ListConfirmedTokensTransfersByAddressAndTimeRange400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTokensTransfersByAddressAndTimeRange400Response(val *ListConfirmedTokensTransfersByAddressAndTimeRange400Response) *NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response {
	return &NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response{value: val, isSet: true}
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRange400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
