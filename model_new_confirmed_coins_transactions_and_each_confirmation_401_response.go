...
type NewConfirmedCoinsTransactionsAndEachConfirmation401Response struct {
	...
	Error NewConfirmedCoinsTransactionsAndEachConfirmationE401 `json:"error"`
}
...
func (o *NewConfirmedCoinsTransactionsAndEachConfirmation401Response) GetError() NewConfirmedCoinsTransactionsAndEachConfirmationE401 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsAndEachConfirmationE401
		return ret
	}
...
func (o NewConfirmedCoinsTransactionsAndEachConfirmation401Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response struct {
	value *NewConfirmedCoinsTransactionsAndEachConfirmation401Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response) Get() *NewConfirmedCoinsTransactionsAndEachConfirmation401Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response) Set(val *NewConfirmedCoinsTransactionsAndEachConfirmation401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response(val *NewConfirmedCoinsTransactionsAndEachConfirmation401Response) *NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response {
	return &NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
