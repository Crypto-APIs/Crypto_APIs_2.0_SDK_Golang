...
type ListTransactionsByAddressRIBSEC struct {
	// Represents the specific transaction contract.
	Contract string `json:"contract"`
	// Represents the amount of gas used by this specific transaction alone.
	GasLimit string `json:"gasLimit"`
	GasPrice ListTransactionsByAddressRIBSECGasPrice `json:"gasPrice"`
...
func NewListTransactionsByAddressRIBSEC(contract string, gasLimit string, gasPrice ListTransactionsByAddressRIBSECGasPrice, gasUsed string, inputData string, nonce int32, transactionStatus string) *ListTransactionsByAddressRIBSEC {
	this := ListTransactionsByAddressRIBSEC{}
...
func (o *ListTransactionsByAddressRIBSEC) GetGasPrice() ListTransactionsByAddressRIBSECGasPrice {
	if o == nil {
		var ret ListTransactionsByAddressRIBSECGasPrice
		return ret
	}
...
func (o ListTransactionsByAddressRIBSEC) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSEC struct {
	value *ListTransactionsByAddressRIBSEC
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSEC) Get() *ListTransactionsByAddressRIBSEC {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSEC) Set(val *ListTransactionsByAddressRIBSEC) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSEC) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSEC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSEC(val *ListTransactionsByAddressRIBSEC) *NullableListTransactionsByAddressRIBSEC {
	return &NullableListTransactionsByAddressRIBSEC{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSEC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSEC) UnmarshalJSON(src []byte) error {
	v.isSet = true
