...
type ListConfirmedTransactionsByAddressAndTimeRange400Response struct {
	...
	Error ListConfirmedTransactionsByAddressAndTimeRangeE400 `json:"error"`
}
...
func (o *ListConfirmedTransactionsByAddressAndTimeRange400Response) GetError() ListConfirmedTransactionsByAddressAndTimeRangeE400 {
	if o == nil {
		var ret ListConfirmedTransactionsByAddressAndTimeRangeE400
		return ret
	}
...
func (o ListConfirmedTransactionsByAddressAndTimeRange400Response) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressAndTimeRange400Response struct {
	value *ListConfirmedTransactionsByAddressAndTimeRange400Response
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange400Response) Get() *ListConfirmedTransactionsByAddressAndTimeRange400Response {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange400Response) Set(val *ListConfirmedTransactionsByAddressAndTimeRange400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressAndTimeRange400Response(val *ListConfirmedTransactionsByAddressAndTimeRange400Response) *NullableListConfirmedTransactionsByAddressAndTimeRange400Response {
	return &NullableListConfirmedTransactionsByAddressAndTimeRange400Response{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
