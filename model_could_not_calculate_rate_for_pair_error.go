...
// CouldNotCalculateRateForPairError struct for CouldNotCalculateRateForPairError
type CouldNotCalculateRateForPairError struct {
...
func NewCouldNotCalculateRateForPairError(code string, message string) *CouldNotCalculateRateForPairError {
	this := CouldNotCalculateRateForPairError{}
	this.Code = code
...
func (o CouldNotCalculateRateForPairError) MarshalJSON() ([]byte, error) {
...
type NullableCouldNotCalculateRateForPairError struct {
	value *CouldNotCalculateRateForPairError
	isSet bool
}

func (v NullableCouldNotCalculateRateForPairError) Get() *CouldNotCalculateRateForPairError {
	return v.value
}

func (v *NullableCouldNotCalculateRateForPairError) Set(val *CouldNotCalculateRateForPairError) {
	v.value = val
	v.isSet = true
}

func (v NullableCouldNotCalculateRateForPairError) IsSet() bool {
	return v.isSet
}

func (v *NullableCouldNotCalculateRateForPairError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCouldNotCalculateRateForPairError(val *CouldNotCalculateRateForPairError) *NullableCouldNotCalculateRateForPairError {
	return &NullableCouldNotCalculateRateForPairError{value: val, isSet: true}
}

func (v NullableCouldNotCalculateRateForPairError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCouldNotCalculateRateForPairError) UnmarshalJSON(src []byte) error {
	v.isSet = true
