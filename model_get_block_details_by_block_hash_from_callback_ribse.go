...
type GetBlockDetailsByBlockHashFromCallbackRIBSE struct {
...
func NewGetBlockDetailsByBlockHashFromCallbackRIBSE(difficulty string, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, nonce string, sha3Uncles string, size int32, totalDifficulty string) *GetBlockDetailsByBlockHashFromCallbackRIBSE {
	this := GetBlockDetailsByBlockHashFromCallbackRIBSE{}
...
func (o GetBlockDetailsByBlockHashFromCallbackRIBSE) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashFromCallbackRIBSE struct {
	value *GetBlockDetailsByBlockHashFromCallbackRIBSE
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackRIBSE) Get() *GetBlockDetailsByBlockHashFromCallbackRIBSE {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackRIBSE) Set(val *GetBlockDetailsByBlockHashFromCallbackRIBSE) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackRIBSE) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackRIBSE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashFromCallbackRIBSE(val *GetBlockDetailsByBlockHashFromCallbackRIBSE) *NullableGetBlockDetailsByBlockHashFromCallbackRIBSE {
	return &NullableGetBlockDetailsByBlockHashFromCallbackRIBSE{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackRIBSE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackRIBSE) UnmarshalJSON(src []byte) error {
	v.isSet = true
