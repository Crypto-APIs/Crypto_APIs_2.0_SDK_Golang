...
type GetHDWalletXPubYPubZPubDetailsE403 struct {
...
func BannedIpAddressAsGetHDWalletXPubYPubZPubDetailsE403(v *BannedIpAddress) GetHDWalletXPubYPubZPubDetailsE403 {
	return GetHDWalletXPubYPubZPubDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetHDWalletXPubYPubZPubDetailsE403(v *EndpointNotAllowedForApiKey) GetHDWalletXPubYPubZPubDetailsE403 {
	return GetHDWalletXPubYPubZPubDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetHDWalletXPubYPubZPubDetailsE403(v *EndpointNotAllowedForPlan) GetHDWalletXPubYPubZPubDetailsE403 {
	return GetHDWalletXPubYPubZPubDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetHDWalletXPubYPubZPubDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetHDWalletXPubYPubZPubDetailsE403 {
	return GetHDWalletXPubYPubZPubDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetHDWalletXPubYPubZPubDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetHDWalletXPubYPubZPubDetailsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetHDWalletXPubYPubZPubDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetHDWalletXPubYPubZPubDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetHDWalletXPubYPubZPubDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetHDWalletXPubYPubZPubDetailsE403 struct {
	value *GetHDWalletXPubYPubZPubDetailsE403
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubDetailsE403) Get() *GetHDWalletXPubYPubZPubDetailsE403 {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubDetailsE403) Set(val *GetHDWalletXPubYPubZPubDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubDetailsE403(val *GetHDWalletXPubYPubZPubDetailsE403) *NullableGetHDWalletXPubYPubZPubDetailsE403 {
	return &NullableGetHDWalletXPubYPubZPubDetailsE403{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
