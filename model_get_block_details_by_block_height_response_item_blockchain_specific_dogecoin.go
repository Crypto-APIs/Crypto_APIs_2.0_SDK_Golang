...
type GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin struct {
...
func NewGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, weight int32) *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin {
	this := GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin{}
...
func (o GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin struct {
	value *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) Get() *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) Set(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin {
	return &NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
