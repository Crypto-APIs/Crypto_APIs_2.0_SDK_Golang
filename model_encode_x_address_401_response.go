...
type EncodeXAddress401Response struct {
	...
	Error EncodeXAddressE401 `json:"error"`
}
...
func NewEncodeXAddress401Response(apiVersion string, requestId string, error_ EncodeXAddressE401) *EncodeXAddress401Response {
	this := EncodeXAddress401Response{}
...
func (o EncodeXAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableEncodeXAddress401Response struct {
	value *EncodeXAddress401Response
	isSet bool
}

func (v NullableEncodeXAddress401Response) Get() *EncodeXAddress401Response {
	return v.value
}

func (v *NullableEncodeXAddress401Response) Set(val *EncodeXAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeXAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeXAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeXAddress401Response(val *EncodeXAddress401Response) *NullableEncodeXAddress401Response {
	return &NullableEncodeXAddress401Response{value: val, isSet: true}
}

func (v NullableEncodeXAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeXAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
