...
type ListXRPRippleTransactionsByBlockHeightE403 struct {
...
func BannedIpAddressAsListXRPRippleTransactionsByBlockHeightE403(v *BannedIpAddress) ListXRPRippleTransactionsByBlockHeightE403 {
	return ListXRPRippleTransactionsByBlockHeightE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListXRPRippleTransactionsByBlockHeightE403(v *EndpointNotAllowedForApiKey) ListXRPRippleTransactionsByBlockHeightE403 {
	return ListXRPRippleTransactionsByBlockHeightE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListXRPRippleTransactionsByBlockHeightE403(v *EndpointNotAllowedForPlan) ListXRPRippleTransactionsByBlockHeightE403 {
	return ListXRPRippleTransactionsByBlockHeightE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListXRPRippleTransactionsByBlockHeightE403(v *FeatureMainnetsNotAllowedForPlan) ListXRPRippleTransactionsByBlockHeightE403 {
	return ListXRPRippleTransactionsByBlockHeightE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListXRPRippleTransactionsByBlockHeightE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListXRPRippleTransactionsByBlockHeightE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListXRPRippleTransactionsByBlockHeightE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListXRPRippleTransactionsByBlockHeightE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListXRPRippleTransactionsByBlockHeightE403) GetActualInstance() (interface{}) {
...
type NullableListXRPRippleTransactionsByBlockHeightE403 struct {
	value *ListXRPRippleTransactionsByBlockHeightE403
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHeightE403) Get() *ListXRPRippleTransactionsByBlockHeightE403 {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHeightE403) Set(val *ListXRPRippleTransactionsByBlockHeightE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHeightE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHeightE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHeightE403(val *ListXRPRippleTransactionsByBlockHeightE403) *NullableListXRPRippleTransactionsByBlockHeightE403 {
	return &NullableListXRPRippleTransactionsByBlockHeightE403{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHeightE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHeightE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
