...
type GetHDWalletXPubYPubZPubDetails403Response struct {
	...
	Error GetHDWalletXPubYPubZPubDetailsE403 `json:"error"`
}
...
func NewGetHDWalletXPubYPubZPubDetails403Response(apiVersion string, requestId string, error_ GetHDWalletXPubYPubZPubDetailsE403) *GetHDWalletXPubYPubZPubDetails403Response {
	this := GetHDWalletXPubYPubZPubDetails403Response{}
...
func (o *GetHDWalletXPubYPubZPubDetails403Response) GetError() GetHDWalletXPubYPubZPubDetailsE403 {
	if o == nil {
		var ret GetHDWalletXPubYPubZPubDetailsE403
		return ret
	}
...
func (o GetHDWalletXPubYPubZPubDetails403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetHDWalletXPubYPubZPubDetails403Response struct {
	value *GetHDWalletXPubYPubZPubDetails403Response
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubDetails403Response) Get() *GetHDWalletXPubYPubZPubDetails403Response {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubDetails403Response) Set(val *GetHDWalletXPubYPubZPubDetails403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubDetails403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubDetails403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubDetails403Response(val *GetHDWalletXPubYPubZPubDetails403Response) *NullableGetHDWalletXPubYPubZPubDetails403Response {
	return &NullableGetHDWalletXPubYPubZPubDetails403Response{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubDetails403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubDetails403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
