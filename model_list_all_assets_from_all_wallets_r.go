...
type ListAllAssetsFromAllWalletsR struct {
	...
	Data ListAllAssetsFromAllWalletsRData `json:"data"`
}
...
func NewListAllAssetsFromAllWalletsR(apiVersion string, requestId string, data ListAllAssetsFromAllWalletsRData) *ListAllAssetsFromAllWalletsR {
	this := ListAllAssetsFromAllWalletsR{}
...
func (o *ListAllAssetsFromAllWalletsR) GetData() ListAllAssetsFromAllWalletsRData {
	if o == nil {
		var ret ListAllAssetsFromAllWalletsRData
		return ret
	}
...
func (o ListAllAssetsFromAllWalletsR) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsFromAllWalletsR struct {
	value *ListAllAssetsFromAllWalletsR
	isSet bool
}

func (v NullableListAllAssetsFromAllWalletsR) Get() *ListAllAssetsFromAllWalletsR {
	return v.value
}

func (v *NullableListAllAssetsFromAllWalletsR) Set(val *ListAllAssetsFromAllWalletsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsFromAllWalletsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsFromAllWalletsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsFromAllWalletsR(val *ListAllAssetsFromAllWalletsR) *NullableListAllAssetsFromAllWalletsR {
	return &NullableListAllAssetsFromAllWalletsR{value: val, isSet: true}
}

func (v NullableListAllAssetsFromAllWalletsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsFromAllWalletsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
