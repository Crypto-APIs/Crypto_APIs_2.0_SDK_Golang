...
type ListAllAssetsFromAllWallets400Response struct {
	...
	Error ListAllAssetsFromAllWalletsE400 `json:"error"`
}
...
func NewListAllAssetsFromAllWallets400Response(apiVersion string, requestId string, error_ ListAllAssetsFromAllWalletsE400) *ListAllAssetsFromAllWallets400Response {
	this := ListAllAssetsFromAllWallets400Response{}
...
func (o *ListAllAssetsFromAllWallets400Response) GetError() ListAllAssetsFromAllWalletsE400 {
	if o == nil {
		var ret ListAllAssetsFromAllWalletsE400
		return ret
	}
...
func (o ListAllAssetsFromAllWallets400Response) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsFromAllWallets400Response struct {
	value *ListAllAssetsFromAllWallets400Response
	isSet bool
}

func (v NullableListAllAssetsFromAllWallets400Response) Get() *ListAllAssetsFromAllWallets400Response {
	return v.value
}

func (v *NullableListAllAssetsFromAllWallets400Response) Set(val *ListAllAssetsFromAllWallets400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsFromAllWallets400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsFromAllWallets400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsFromAllWallets400Response(val *ListAllAssetsFromAllWallets400Response) *NullableListAllAssetsFromAllWallets400Response {
	return &NullableListAllAssetsFromAllWallets400Response{value: val, isSet: true}
}

func (v NullableListAllAssetsFromAllWallets400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsFromAllWallets400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
