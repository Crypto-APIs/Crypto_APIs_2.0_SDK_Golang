...
type ListXRPRippleTransactionsByAddressRIReceive struct {
...
func NewListXRPRippleTransactionsByAddressRIReceive(amount string, unit string) *ListXRPRippleTransactionsByAddressRIReceive {
	this := ListXRPRippleTransactionsByAddressRIReceive{}
	this.Amount = amount
	this.Unit = unit
	return &this
}
...
func (o ListXRPRippleTransactionsByAddressRIReceive) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByAddressRIReceive struct {
	value *ListXRPRippleTransactionsByAddressRIReceive
	isSet bool
}

func (v NullableListXRPRippleTransactionsByAddressRIReceive) Get() *ListXRPRippleTransactionsByAddressRIReceive {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByAddressRIReceive) Set(val *ListXRPRippleTransactionsByAddressRIReceive) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByAddressRIReceive) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByAddressRIReceive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByAddressRIReceive(val *ListXRPRippleTransactionsByAddressRIReceive) *NullableListXRPRippleTransactionsByAddressRIReceive {
	return &NullableListXRPRippleTransactionsByAddressRIReceive{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByAddressRIReceive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByAddressRIReceive) UnmarshalJSON(src []byte) error {
	v.isSet = true
