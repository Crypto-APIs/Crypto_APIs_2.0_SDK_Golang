...
func (o NewBlockR) MarshalJSON() ([]byte, error) {
...
type NullableNewBlockR struct {
	value *NewBlockR
	isSet bool
}

func (v NullableNewBlockR) Get() *NewBlockR {
	return v.value
}

func (v *NullableNewBlockR) Set(val *NewBlockR) {
	v.value = val
	v.isSet = true
}

func (v NullableNewBlockR) IsSet() bool {
	return v.isSet
}

func (v *NullableNewBlockR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewBlockR(val *NewBlockR) *NullableNewBlockR {
	return &NullableNewBlockR{value: val, isSet: true}
}

func (v NullableNewBlockR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewBlockR) UnmarshalJSON(src []byte) error {
	v.isSet = true
