...
// GetUnconfirmedOmniTransactionByTransactionIDTxidR struct for GetUnconfirmedOmniTransactionByTransactionIDTxidR
type GetUnconfirmedOmniTransactionByTransactionIDTxidR struct {
	...
	Data GetUnconfirmedOmniTransactionByTransactionIDTxidRData `json:"data"`
}
...
func NewGetUnconfirmedOmniTransactionByTransactionIDTxidR(apiVersion string, requestId string, data GetUnconfirmedOmniTransactionByTransactionIDTxidRData) *GetUnconfirmedOmniTransactionByTransactionIDTxidR {
	this := GetUnconfirmedOmniTransactionByTransactionIDTxidR{}
...
func (o *GetUnconfirmedOmniTransactionByTransactionIDTxidR) GetData() GetUnconfirmedOmniTransactionByTransactionIDTxidRData {
	if o == nil {
		var ret GetUnconfirmedOmniTransactionByTransactionIDTxidRData
		return ret
	}
...
func (o GetUnconfirmedOmniTransactionByTransactionIDTxidR) MarshalJSON() ([]byte, error) {
...
type NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR struct {
	value *GetUnconfirmedOmniTransactionByTransactionIDTxidR
	isSet bool
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR) Get() *GetUnconfirmedOmniTransactionByTransactionIDTxidR {
	return v.value
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR) Set(val *GetUnconfirmedOmniTransactionByTransactionIDTxidR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUnconfirmedOmniTransactionByTransactionIDTxidR(val *GetUnconfirmedOmniTransactionByTransactionIDTxidR) *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR {
	return &NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR{value: val, isSet: true}
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidR) UnmarshalJSON(src []byte) error {
	v.isSet = true
