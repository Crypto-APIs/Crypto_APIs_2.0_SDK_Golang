...
type NullableListTokensByAddressRData struct {
	value *ListTokensByAddressRData
	isSet bool
}

func (v NullableListTokensByAddressRData) Get() *ListTokensByAddressRData {
	return v.value
}

func (v *NullableListTokensByAddressRData) Set(val *ListTokensByAddressRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensByAddressRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensByAddressRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensByAddressRData(val *ListTokensByAddressRData) *NullableListTokensByAddressRData {
	return &NullableListTokensByAddressRData{value: val, isSet: true}
}

func (v NullableListTokensByAddressRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensByAddressRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
