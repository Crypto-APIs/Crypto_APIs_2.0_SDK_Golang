...
// ListUnconfirmedOmniTransactionsByAddressResponse struct for ListUnconfirmedOmniTransactionsByAddressResponse
type ListUnconfirmedOmniTransactionsByAddressResponse struct {
	...
	Data ListUnconfirmedOmniTransactionsByAddressResponseData `json:"data"`
}
...
func NewListUnconfirmedOmniTransactionsByAddressResponse(apiVersion string, requestId string, data ListUnconfirmedOmniTransactionsByAddressResponseData) *ListUnconfirmedOmniTransactionsByAddressResponse {
	this := ListUnconfirmedOmniTransactionsByAddressResponse{}
...
func (o *ListUnconfirmedOmniTransactionsByAddressResponse) GetData() ListUnconfirmedOmniTransactionsByAddressResponseData {
	if o == nil {
		var ret ListUnconfirmedOmniTransactionsByAddressResponseData
		return ret
	}
...
func (o ListUnconfirmedOmniTransactionsByAddressResponse) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedOmniTransactionsByAddressResponse struct {
	value *ListUnconfirmedOmniTransactionsByAddressResponse
	isSet bool
}

func (v NullableListUnconfirmedOmniTransactionsByAddressResponse) Get() *ListUnconfirmedOmniTransactionsByAddressResponse {
	return v.value
}

func (v *NullableListUnconfirmedOmniTransactionsByAddressResponse) Set(val *ListUnconfirmedOmniTransactionsByAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedOmniTransactionsByAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedOmniTransactionsByAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedOmniTransactionsByAddressResponse(val *ListUnconfirmedOmniTransactionsByAddressResponse) *NullableListUnconfirmedOmniTransactionsByAddressResponse {
	return &NullableListUnconfirmedOmniTransactionsByAddressResponse{value: val, isSet: true}
}

func (v NullableListUnconfirmedOmniTransactionsByAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedOmniTransactionsByAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
