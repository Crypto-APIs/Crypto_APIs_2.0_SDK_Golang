...
type DecodeRawTransactionHexRISD2VinInnerScriptSig struct {
...
func NewDecodeRawTransactionHexRISD2VinInnerScriptSig() *DecodeRawTransactionHexRISD2VinInnerScriptSig {
	this := DecodeRawTransactionHexRISD2VinInnerScriptSig{}
	return &this
}
...
func (o DecodeRawTransactionHexRISD2VinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISD2VinInnerScriptSig struct {
	value *DecodeRawTransactionHexRISD2VinInnerScriptSig
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISD2VinInnerScriptSig) Get() *DecodeRawTransactionHexRISD2VinInnerScriptSig {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISD2VinInnerScriptSig) Set(val *DecodeRawTransactionHexRISD2VinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISD2VinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISD2VinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISD2VinInnerScriptSig(val *DecodeRawTransactionHexRISD2VinInnerScriptSig) *NullableDecodeRawTransactionHexRISD2VinInnerScriptSig {
	return &NullableDecodeRawTransactionHexRISD2VinInnerScriptSig{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISD2VinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISD2VinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
