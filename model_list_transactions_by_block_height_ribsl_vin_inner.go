...
type ListTransactionsByBlockHeightRIBSLVinInner struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig ListTransactionsByBlockHeightRIBSLVinInnerScriptSig `json:"scriptSig"`
...
func NewListTransactionsByBlockHeightRIBSLVinInner(addresses []string, scriptSig ListTransactionsByBlockHeightRIBSLVinInnerScriptSig, sequence string, txid string, txinwitness []string, value string, vout int32) *ListTransactionsByBlockHeightRIBSLVinInner {
	this := ListTransactionsByBlockHeightRIBSLVinInner{}
...
func (o *ListTransactionsByBlockHeightRIBSLVinInner) GetScriptSig() ListTransactionsByBlockHeightRIBSLVinInnerScriptSig {
	if o == nil {
		var ret ListTransactionsByBlockHeightRIBSLVinInnerScriptSig
		return ret
	}
...
func (o ListTransactionsByBlockHeightRIBSLVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSLVinInner struct {
	value *ListTransactionsByBlockHeightRIBSLVinInner
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSLVinInner) Get() *ListTransactionsByBlockHeightRIBSLVinInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSLVinInner) Set(val *ListTransactionsByBlockHeightRIBSLVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSLVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSLVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSLVinInner(val *ListTransactionsByBlockHeightRIBSLVinInner) *NullableListTransactionsByBlockHeightRIBSLVinInner {
	return &NullableListTransactionsByBlockHeightRIBSLVinInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSLVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSLVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
