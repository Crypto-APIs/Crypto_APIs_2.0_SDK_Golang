...
// AddTokensToExistingFromAddressResponseItem struct for AddTokensToExistingFromAddressResponseItem
type AddTokensToExistingFromAddressResponseItem struct {
	...
	TokenData AddTokensToExistingFromAddressResponseItemTokenData `json:"tokenData"`
}
...
func NewAddTokensToExistingFromAddressResponseItem(callbackUrl string, confirmationsCount int32, createdTimestamp int32, feeAddress string, feePriority string, fromAddress string, minimumTransferAmount string, referenceId string, toAddress string, tokenData AddTokensToExistingFromAddressResponseItemTokenData) *AddTokensToExistingFromAddressResponseItem {
	this := AddTokensToExistingFromAddressResponseItem{}
...
func (o *AddTokensToExistingFromAddressResponseItem) GetTokenData() AddTokensToExistingFromAddressResponseItemTokenData {
	if o == nil {
		var ret AddTokensToExistingFromAddressResponseItemTokenData
		return ret
	}
...
func (o AddTokensToExistingFromAddressResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableAddTokensToExistingFromAddressResponseItem struct {
	value *AddTokensToExistingFromAddressResponseItem
	isSet bool
}

func (v NullableAddTokensToExistingFromAddressResponseItem) Get() *AddTokensToExistingFromAddressResponseItem {
	return v.value
}

func (v *NullableAddTokensToExistingFromAddressResponseItem) Set(val *AddTokensToExistingFromAddressResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableAddTokensToExistingFromAddressResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableAddTokensToExistingFromAddressResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddTokensToExistingFromAddressResponseItem(val *AddTokensToExistingFromAddressResponseItem) *NullableAddTokensToExistingFromAddressResponseItem {
	return &NullableAddTokensToExistingFromAddressResponseItem{value: val, isSet: true}
}

func (v NullableAddTokensToExistingFromAddressResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddTokensToExistingFromAddressResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
