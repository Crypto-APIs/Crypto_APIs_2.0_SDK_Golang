...
// ListXRPRippleTransactionsByAddressResponseData struct for ListXRPRippleTransactionsByAddressResponseData
type ListXRPRippleTransactionsByAddressResponseData struct {
	...
	Items []ListXRPRippleTransactionsByAddressResponseItem `json:"items"`
}
...
func NewListXRPRippleTransactionsByAddressResponseData(offset int32, limit int32, total int32, items []ListXRPRippleTransactionsByAddressResponseItem) *ListXRPRippleTransactionsByAddressResponseData {
	this := ListXRPRippleTransactionsByAddressResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListXRPRippleTransactionsByAddressResponseData) GetItems() []ListXRPRippleTransactionsByAddressResponseItem {
	if o == nil {
		var ret []ListXRPRippleTransactionsByAddressResponseItem
		return ret
	}
...
func (o ListXRPRippleTransactionsByAddressResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByAddressResponseData struct {
	value *ListXRPRippleTransactionsByAddressResponseData
	isSet bool
}

func (v NullableListXRPRippleTransactionsByAddressResponseData) Get() *ListXRPRippleTransactionsByAddressResponseData {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByAddressResponseData) Set(val *ListXRPRippleTransactionsByAddressResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByAddressResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByAddressResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByAddressResponseData(val *ListXRPRippleTransactionsByAddressResponseData) *NullableListXRPRippleTransactionsByAddressResponseData {
	return &NullableListXRPRippleTransactionsByAddressResponseData{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByAddressResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByAddressResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
