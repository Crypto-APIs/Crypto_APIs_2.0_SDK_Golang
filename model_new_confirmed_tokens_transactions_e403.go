...
type NewConfirmedTokensTransactionsE403 struct {
...
func BannedIpAddressAsNewConfirmedTokensTransactionsE403(v *BannedIpAddress) NewConfirmedTokensTransactionsE403 {
	return NewConfirmedTokensTransactionsE403{ BannedIpAddress: v}
}
...
func BlockchainEventsCallbacksLimitReachedAsNewConfirmedTokensTransactionsE403(v *BlockchainEventsCallbacksLimitReached) NewConfirmedTokensTransactionsE403 {
	return NewConfirmedTokensTransactionsE403{ BlockchainEventsCallbacksLimitReached: v}
}
...
func EndpointNotAllowedForApiKeyAsNewConfirmedTokensTransactionsE403(v *EndpointNotAllowedForApiKey) NewConfirmedTokensTransactionsE403 {
	return NewConfirmedTokensTransactionsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsNewConfirmedTokensTransactionsE403(v *EndpointNotAllowedForPlan) NewConfirmedTokensTransactionsE403 {
	return NewConfirmedTokensTransactionsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsNewConfirmedTokensTransactionsE403(v *FeatureMainnetsNotAllowedForPlan) NewConfirmedTokensTransactionsE403 {
	return NewConfirmedTokensTransactionsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *NewConfirmedTokensTransactionsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedTokensTransactionsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedTokensTransactionsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedTokensTransactionsE403) MarshalJSON() ([]byte, error) {
...
func (obj *NewConfirmedTokensTransactionsE403) GetActualInstance() (interface{}) {
...
type NullableNewConfirmedTokensTransactionsE403 struct {
	value *NewConfirmedTokensTransactionsE403
	isSet bool
}

func (v NullableNewConfirmedTokensTransactionsE403) Get() *NewConfirmedTokensTransactionsE403 {
	return v.value
}

func (v *NullableNewConfirmedTokensTransactionsE403) Set(val *NewConfirmedTokensTransactionsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokensTransactionsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokensTransactionsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokensTransactionsE403(val *NewConfirmedTokensTransactionsE403) *NullableNewConfirmedTokensTransactionsE403 {
	return &NullableNewConfirmedTokensTransactionsE403{value: val, isSet: true}
}

func (v NullableNewConfirmedTokensTransactionsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokensTransactionsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
