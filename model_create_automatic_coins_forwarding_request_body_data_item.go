...
// CreateAutomaticCoinsForwardingRequestBodyDataItem struct for CreateAutomaticCoinsForwardingRequestBodyDataItem
type CreateAutomaticCoinsForwardingRequestBodyDataItem struct {
...
func NewCreateAutomaticCoinsForwardingRequestBodyDataItem(callbackSecretKey string, callbackUrl string, confirmationsCount int32, feePriority string, minimumTransferAmount string, toAddress string) *CreateAutomaticCoinsForwardingRequestBodyDataItem {
	this := CreateAutomaticCoinsForwardingRequestBodyDataItem{}
...
func (o CreateAutomaticCoinsForwardingRequestBodyDataItem) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticCoinsForwardingRequestBodyDataItem struct {
	value *CreateAutomaticCoinsForwardingRequestBodyDataItem
	isSet bool
}

func (v NullableCreateAutomaticCoinsForwardingRequestBodyDataItem) Get() *CreateAutomaticCoinsForwardingRequestBodyDataItem {
	return v.value
}

func (v *NullableCreateAutomaticCoinsForwardingRequestBodyDataItem) Set(val *CreateAutomaticCoinsForwardingRequestBodyDataItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticCoinsForwardingRequestBodyDataItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticCoinsForwardingRequestBodyDataItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticCoinsForwardingRequestBodyDataItem(val *CreateAutomaticCoinsForwardingRequestBodyDataItem) *NullableCreateAutomaticCoinsForwardingRequestBodyDataItem {
	return &NullableCreateAutomaticCoinsForwardingRequestBodyDataItem{value: val, isSet: true}
}

func (v NullableCreateAutomaticCoinsForwardingRequestBodyDataItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticCoinsForwardingRequestBodyDataItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
