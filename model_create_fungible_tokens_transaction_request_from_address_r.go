...
type CreateFungibleTokensTransactionRequestFromAddressR struct {
	...
	Data CreateFungibleTokensTransactionRequestFromAddressRData `json:"data"`
}
...
func NewCreateFungibleTokensTransactionRequestFromAddressR(apiVersion string, requestId string, data CreateFungibleTokensTransactionRequestFromAddressRData) *CreateFungibleTokensTransactionRequestFromAddressR {
	this := CreateFungibleTokensTransactionRequestFromAddressR{}
...
func (o *CreateFungibleTokensTransactionRequestFromAddressR) GetData() CreateFungibleTokensTransactionRequestFromAddressRData {
	if o == nil {
		var ret CreateFungibleTokensTransactionRequestFromAddressRData
		return ret
	}
...
func (o CreateFungibleTokensTransactionRequestFromAddressR) MarshalJSON() ([]byte, error) {
...
type NullableCreateFungibleTokensTransactionRequestFromAddressR struct {
	value *CreateFungibleTokensTransactionRequestFromAddressR
	isSet bool
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddressR) Get() *CreateFungibleTokensTransactionRequestFromAddressR {
	return v.value
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddressR) Set(val *CreateFungibleTokensTransactionRequestFromAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFungibleTokensTransactionRequestFromAddressR(val *CreateFungibleTokensTransactionRequestFromAddressR) *NullableCreateFungibleTokensTransactionRequestFromAddressR {
	return &NullableCreateFungibleTokensTransactionRequestFromAddressR{value: val, isSet: true}
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
