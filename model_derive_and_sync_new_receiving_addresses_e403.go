...
type DeriveAndSyncNewReceivingAddressesE403 struct {
...
func BannedIpAddressAsDeriveAndSyncNewReceivingAddressesE403(v *BannedIpAddress) DeriveAndSyncNewReceivingAddressesE403 {
...
func EndpointNotAllowedForApiKeyAsDeriveAndSyncNewReceivingAddressesE403(v *EndpointNotAllowedForApiKey) DeriveAndSyncNewReceivingAddressesE403 {
	return DeriveAndSyncNewReceivingAddressesE403{
...
func EndpointNotAllowedForPlanAsDeriveAndSyncNewReceivingAddressesE403(v *EndpointNotAllowedForPlan) DeriveAndSyncNewReceivingAddressesE403 {
	return DeriveAndSyncNewReceivingAddressesE403{
...
func FeatureMainnetsNotAllowedForPlanAsDeriveAndSyncNewReceivingAddressesE403(v *FeatureMainnetsNotAllowedForPlan) DeriveAndSyncNewReceivingAddressesE403 {
	return DeriveAndSyncNewReceivingAddressesE403{
...
func (dst *DeriveAndSyncNewReceivingAddressesE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DeriveAndSyncNewReceivingAddressesE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DeriveAndSyncNewReceivingAddressesE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DeriveAndSyncNewReceivingAddressesE403) MarshalJSON() ([]byte, error) {
...
func (obj *DeriveAndSyncNewReceivingAddressesE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableDeriveAndSyncNewReceivingAddressesE403 struct {
	value *DeriveAndSyncNewReceivingAddressesE403
	isSet bool
}

func (v NullableDeriveAndSyncNewReceivingAddressesE403) Get() *DeriveAndSyncNewReceivingAddressesE403 {
	return v.value
}

func (v *NullableDeriveAndSyncNewReceivingAddressesE403) Set(val *DeriveAndSyncNewReceivingAddressesE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewReceivingAddressesE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewReceivingAddressesE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewReceivingAddressesE403(val *DeriveAndSyncNewReceivingAddressesE403) *NullableDeriveAndSyncNewReceivingAddressesE403 {
	return &NullableDeriveAndSyncNewReceivingAddressesE403{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewReceivingAddressesE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewReceivingAddressesE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
