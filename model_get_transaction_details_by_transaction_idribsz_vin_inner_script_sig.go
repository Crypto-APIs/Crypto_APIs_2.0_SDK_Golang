...
type GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig(asm string, hex string, type_ string) *GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig {
	this := GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig struct {
	value *GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) Get() *GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) Set(val *GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig(val *GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) *NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig {
	return &NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
