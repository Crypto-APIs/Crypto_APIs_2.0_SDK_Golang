...
// ListReceivingAddressesR struct for ListReceivingAddressesR
type ListReceivingAddressesR struct {
	...
	Data ListReceivingAddressesRData `json:"data"`
}
...
func (o *ListReceivingAddressesR) GetData() ListReceivingAddressesRData {
	if o == nil {
		var ret ListReceivingAddressesRData
		return ret
	}
...
func (o ListReceivingAddressesR) MarshalJSON() ([]byte, error) {
...
type NullableListReceivingAddressesR struct {
	value *ListReceivingAddressesR
	isSet bool
}

func (v NullableListReceivingAddressesR) Get() *ListReceivingAddressesR {
	return v.value
}

func (v *NullableListReceivingAddressesR) Set(val *ListReceivingAddressesR) {
	v.value = val
	v.isSet = true
}

func (v NullableListReceivingAddressesR) IsSet() bool {
	return v.isSet
}

func (v *NullableListReceivingAddressesR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListReceivingAddressesR(val *ListReceivingAddressesR) *NullableListReceivingAddressesR {
	return &NullableListReceivingAddressesR{value: val, isSet: true}
}

func (v NullableListReceivingAddressesR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListReceivingAddressesR) UnmarshalJSON(src []byte) error {
	v.isSet = true
