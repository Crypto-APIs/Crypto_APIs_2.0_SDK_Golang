...
type NewConfirmedCoinsTransactionsForSpecificAmountRI struct {
...
func NewNewConfirmedCoinsTransactionsForSpecificAmountRI(amountHigherThan int64, callbackUrl string, createdTimestamp int32, eventType string, isActive bool, referenceId string) *NewConfirmedCoinsTransactionsForSpecificAmountRI {
	this := NewConfirmedCoinsTransactionsForSpecificAmountRI{}
...
func (o NewConfirmedCoinsTransactionsForSpecificAmountRI) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsForSpecificAmountRI struct {
	value *NewConfirmedCoinsTransactionsForSpecificAmountRI
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmountRI) Get() *NewConfirmedCoinsTransactionsForSpecificAmountRI {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmountRI) Set(val *NewConfirmedCoinsTransactionsForSpecificAmountRI) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmountRI) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmountRI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsForSpecificAmountRI(val *NewConfirmedCoinsTransactionsForSpecificAmountRI) *NullableNewConfirmedCoinsTransactionsForSpecificAmountRI {
	return &NullableNewConfirmedCoinsTransactionsForSpecificAmountRI{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmountRI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmountRI) UnmarshalJSON(src []byte) error {
	v.isSet = true
