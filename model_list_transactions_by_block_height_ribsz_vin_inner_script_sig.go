...
type ListTransactionsByBlockHeightRIBSZVinInnerScriptSig struct {
...
func (o ListTransactionsByBlockHeightRIBSZVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig struct {
	value *ListTransactionsByBlockHeightRIBSZVinInnerScriptSig
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig) Get() *ListTransactionsByBlockHeightRIBSZVinInnerScriptSig {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig) Set(val *ListTransactionsByBlockHeightRIBSZVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig(val *ListTransactionsByBlockHeightRIBSZVinInnerScriptSig) *NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig {
	return &NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSZVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
