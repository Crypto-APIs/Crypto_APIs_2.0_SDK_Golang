...
type GetLatestMinedBlockRIBSD2 struct {
...
func NewGetLatestMinedBlockRIBSD2(difficulty string, nonce int32, size int32, bits string, chainwork string, merkleRoot string, version int32, versionHex string) *GetLatestMinedBlockRIBSD2 {
	this := GetLatestMinedBlockRIBSD2{}
...
func (o GetLatestMinedBlockRIBSD2) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockRIBSD2 struct {
	value *GetLatestMinedBlockRIBSD2
	isSet bool
}

func (v NullableGetLatestMinedBlockRIBSD2) Get() *GetLatestMinedBlockRIBSD2 {
	return v.value
}

func (v *NullableGetLatestMinedBlockRIBSD2) Set(val *GetLatestMinedBlockRIBSD2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockRIBSD2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockRIBSD2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockRIBSD2(val *GetLatestMinedBlockRIBSD2) *NullableGetLatestMinedBlockRIBSD2 {
	return &NullableGetLatestMinedBlockRIBSD2{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockRIBSD2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockRIBSD2) UnmarshalJSON(src []byte) error {
	v.isSet = true
