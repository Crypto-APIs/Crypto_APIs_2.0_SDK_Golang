...
type ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin(locktime int32, size int32, vSize int32, version int32, vin []ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin, vout []GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVout) *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
