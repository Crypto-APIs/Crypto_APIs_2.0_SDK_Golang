...
type GetBlockDetailsByBlockHashFromCallbackE403 struct {
...
func BannedIpAddressAsGetBlockDetailsByBlockHashFromCallbackE403(v *BannedIpAddress) GetBlockDetailsByBlockHashFromCallbackE403 {
	return GetBlockDetailsByBlockHashFromCallbackE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetBlockDetailsByBlockHashFromCallbackE403(v *EndpointNotAllowedForApiKey) GetBlockDetailsByBlockHashFromCallbackE403 {
	return GetBlockDetailsByBlockHashFromCallbackE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetBlockDetailsByBlockHashFromCallbackE403(v *EndpointNotAllowedForPlan) GetBlockDetailsByBlockHashFromCallbackE403 {
	return GetBlockDetailsByBlockHashFromCallbackE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetBlockDetailsByBlockHashFromCallbackE403(v *FeatureMainnetsNotAllowedForPlan) GetBlockDetailsByBlockHashFromCallbackE403 {
	return GetBlockDetailsByBlockHashFromCallbackE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetBlockDetailsByBlockHashFromCallbackE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetBlockDetailsByBlockHashFromCallbackE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetBlockDetailsByBlockHashFromCallbackE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetBlockDetailsByBlockHashFromCallbackE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetBlockDetailsByBlockHashFromCallbackE403) GetActualInstance() (interface{}) {
...
type NullableGetBlockDetailsByBlockHashFromCallbackE403 struct {
	value *GetBlockDetailsByBlockHashFromCallbackE403
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackE403) Get() *GetBlockDetailsByBlockHashFromCallbackE403 {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackE403) Set(val *GetBlockDetailsByBlockHashFromCallbackE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashFromCallbackE403(val *GetBlockDetailsByBlockHashFromCallbackE403) *NullableGetBlockDetailsByBlockHashFromCallbackE403 {
	return &NullableGetBlockDetailsByBlockHashFromCallbackE403{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
