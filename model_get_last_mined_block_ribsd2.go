...
type GetLastMinedBlockRIBSD2 struct {
...
func (o GetLastMinedBlockRIBSD2) MarshalJSON() ([]byte, error) {
...
type NullableGetLastMinedBlockRIBSD2 struct {
	value *GetLastMinedBlockRIBSD2
	isSet bool
}

func (v NullableGetLastMinedBlockRIBSD2) Get() *GetLastMinedBlockRIBSD2 {
	return v.value
}

func (v *NullableGetLastMinedBlockRIBSD2) Set(val *GetLastMinedBlockRIBSD2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastMinedBlockRIBSD2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastMinedBlockRIBSD2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastMinedBlockRIBSD2(val *GetLastMinedBlockRIBSD2) *NullableGetLastMinedBlockRIBSD2 {
	return &NullableGetLastMinedBlockRIBSD2{value: val, isSet: true}
}

func (v NullableGetLastMinedBlockRIBSD2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastMinedBlockRIBSD2) UnmarshalJSON(src []byte) error {
	v.isSet = true
