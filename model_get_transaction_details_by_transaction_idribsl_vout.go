...
// GetTransactionDetailsByTransactionIDRIBSLVout struct for GetTransactionDetailsByTransactionIDRIBSLVout
type GetTransactionDetailsByTransactionIDRIBSLVout struct {
...
func (o GetTransactionDetailsByTransactionIDRIBSLVout) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSLVout struct {
	value *GetTransactionDetailsByTransactionIDRIBSLVout
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSLVout) Get() *GetTransactionDetailsByTransactionIDRIBSLVout {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSLVout) Set(val *GetTransactionDetailsByTransactionIDRIBSLVout) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSLVout) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSLVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSLVout(val *GetTransactionDetailsByTransactionIDRIBSLVout) *NullableGetTransactionDetailsByTransactionIDRIBSLVout {
	return &NullableGetTransactionDetailsByTransactionIDRIBSLVout{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSLVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSLVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
