...
type GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig(asm string, hex string, type_ string) *GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig {
	this := GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig struct {
	value *GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) Get() *GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) Set(val *GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig(val *GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) *NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig {
	return &NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
