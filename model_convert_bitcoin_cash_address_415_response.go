...
type ConvertBitcoinCashAddress415Response struct {
...
func NewConvertBitcoinCashAddress415Response(apiVersion string, requestId string, error_ UnsupportedMediaType) *ConvertBitcoinCashAddress415Response {
	this := ConvertBitcoinCashAddress415Response{}
...
func (o ConvertBitcoinCashAddress415Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress415Response struct {
	value *ConvertBitcoinCashAddress415Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress415Response) Get() *ConvertBitcoinCashAddress415Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress415Response) Set(val *ConvertBitcoinCashAddress415Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress415Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress415Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress415Response(val *ConvertBitcoinCashAddress415Response) *NullableConvertBitcoinCashAddress415Response {
	return &NullableConvertBitcoinCashAddress415Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress415Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress415Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
