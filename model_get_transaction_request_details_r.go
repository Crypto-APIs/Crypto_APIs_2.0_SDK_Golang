...
type GetTransactionRequestDetailsR struct {
	...
	Data GetTransactionRequestDetailsRData `json:"data"`
}
...
func NewGetTransactionRequestDetailsR(apiVersion string, requestId string, data GetTransactionRequestDetailsRData) *GetTransactionRequestDetailsR {
	this := GetTransactionRequestDetailsR{}
...
func (o *GetTransactionRequestDetailsR) GetData() GetTransactionRequestDetailsRData {
	if o == nil {
		var ret GetTransactionRequestDetailsRData
		return ret
	}
...
func (o GetTransactionRequestDetailsR) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionRequestDetailsR struct {
	value *GetTransactionRequestDetailsR
	isSet bool
}

func (v NullableGetTransactionRequestDetailsR) Get() *GetTransactionRequestDetailsR {
	return v.value
}

func (v *NullableGetTransactionRequestDetailsR) Set(val *GetTransactionRequestDetailsR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionRequestDetailsR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionRequestDetailsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionRequestDetailsR(val *GetTransactionRequestDetailsR) *NullableGetTransactionRequestDetailsR {
	return &NullableGetTransactionRequestDetailsR{value: val, isSet: true}
}

func (v NullableGetTransactionRequestDetailsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionRequestDetailsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
