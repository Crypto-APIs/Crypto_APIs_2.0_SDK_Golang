...
type CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response struct {
	...
	Error CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 `json:"error"`
}
...
func NewCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response(apiVersion string, requestId string, error_ CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403) *CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response {
	this := CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response{}
...
func (o *CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) GetError() CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403 {
	if o == nil {
		var ret CreateSingleTransactionRequestFromAddressWithoutFeePriorityE403
		return ret
	}
...
func (o CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response struct {
	value *CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response
	isSet bool
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) Get() *CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response {
	return v.value
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) Set(val *CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response(val *CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response {
	return &NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response{value: val, isSet: true}
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
