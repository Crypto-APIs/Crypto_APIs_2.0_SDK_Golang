...
type ListZilliqaTransactionsByBlockHash401Response struct {
	...
	Error ListZilliqaTransactionsByBlockHashE401 `json:"error"`
}
...
func NewListZilliqaTransactionsByBlockHash401Response(apiVersion string, requestId string, error_ ListZilliqaTransactionsByBlockHashE401) *ListZilliqaTransactionsByBlockHash401Response {
	this := ListZilliqaTransactionsByBlockHash401Response{}
...
func (o *ListZilliqaTransactionsByBlockHash401Response) GetError() ListZilliqaTransactionsByBlockHashE401 {
	if o == nil {
		var ret ListZilliqaTransactionsByBlockHashE401
		return ret
	}
...
func (o ListZilliqaTransactionsByBlockHash401Response) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByBlockHash401Response struct {
	value *ListZilliqaTransactionsByBlockHash401Response
	isSet bool
}

func (v NullableListZilliqaTransactionsByBlockHash401Response) Get() *ListZilliqaTransactionsByBlockHash401Response {
	return v.value
}

func (v *NullableListZilliqaTransactionsByBlockHash401Response) Set(val *ListZilliqaTransactionsByBlockHash401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByBlockHash401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByBlockHash401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByBlockHash401Response(val *ListZilliqaTransactionsByBlockHash401Response) *NullableListZilliqaTransactionsByBlockHash401Response {
	return &NullableListZilliqaTransactionsByBlockHash401Response{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByBlockHash401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByBlockHash401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
