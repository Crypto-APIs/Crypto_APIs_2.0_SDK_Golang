...
type ListCoinsForwardingAutomationsE403 struct {
...
func BannedIpAddressAsListCoinsForwardingAutomationsE403(v *BannedIpAddress) ListCoinsForwardingAutomationsE403 {
	return ListCoinsForwardingAutomationsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListCoinsForwardingAutomationsE403(v *EndpointNotAllowedForApiKey) ListCoinsForwardingAutomationsE403 {
	return ListCoinsForwardingAutomationsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListCoinsForwardingAutomationsE403(v *EndpointNotAllowedForPlan) ListCoinsForwardingAutomationsE403 {
	return ListCoinsForwardingAutomationsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListCoinsForwardingAutomationsE403(v *FeatureMainnetsNotAllowedForPlan) ListCoinsForwardingAutomationsE403 {
	return ListCoinsForwardingAutomationsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListCoinsForwardingAutomationsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListCoinsForwardingAutomationsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListCoinsForwardingAutomationsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListCoinsForwardingAutomationsE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListCoinsForwardingAutomationsE403) GetActualInstance() (interface{}) {
...
type NullableListCoinsForwardingAutomationsE403 struct {
	value *ListCoinsForwardingAutomationsE403
	isSet bool
}

func (v NullableListCoinsForwardingAutomationsE403) Get() *ListCoinsForwardingAutomationsE403 {
	return v.value
}

func (v *NullableListCoinsForwardingAutomationsE403) Set(val *ListCoinsForwardingAutomationsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoinsForwardingAutomationsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoinsForwardingAutomationsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoinsForwardingAutomationsE403(val *ListCoinsForwardingAutomationsE403) *NullableListCoinsForwardingAutomationsE403 {
	return &NullableListCoinsForwardingAutomationsE403{value: val, isSet: true}
}

func (v NullableListCoinsForwardingAutomationsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoinsForwardingAutomationsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
