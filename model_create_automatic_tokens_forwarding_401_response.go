...
type CreateAutomaticTokensForwarding401Response struct {
...
func NewCreateAutomaticTokensForwarding401Response(apiVersion string, requestId string, error_ CreateAutomaticTokensForwardingE401) *CreateAutomaticTokensForwarding401Response {
	this := CreateAutomaticTokensForwarding401Response{}
...
func (o CreateAutomaticTokensForwarding401Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticTokensForwarding401Response struct {
	value *CreateAutomaticTokensForwarding401Response
	isSet bool
}

func (v NullableCreateAutomaticTokensForwarding401Response) Get() *CreateAutomaticTokensForwarding401Response {
	return v.value
}

func (v *NullableCreateAutomaticTokensForwarding401Response) Set(val *CreateAutomaticTokensForwarding401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticTokensForwarding401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticTokensForwarding401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticTokensForwarding401Response(val *CreateAutomaticTokensForwarding401Response) *NullableCreateAutomaticTokensForwarding401Response {
	return &NullableCreateAutomaticTokensForwarding401Response{value: val, isSet: true}
}

func (v NullableCreateAutomaticTokensForwarding401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticTokensForwarding401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
