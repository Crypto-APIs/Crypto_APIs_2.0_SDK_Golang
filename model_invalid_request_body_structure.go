...
// InvalidRequestBodyStructure struct for InvalidRequestBodyStructure
type InvalidRequestBodyStructure struct {
	...
	Error InvalidRequestBodyStructureError `json:"error"`
}
...
func (o *InvalidRequestBodyStructure) GetError() InvalidRequestBodyStructureError {
	if o == nil {
		var ret InvalidRequestBodyStructureError
		return ret
	}
