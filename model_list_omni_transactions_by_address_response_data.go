...
// ListOmniTransactionsByAddressResponseData struct for ListOmniTransactionsByAddressResponseData
type ListOmniTransactionsByAddressResponseData struct {
	...
	Items []ListOmniTransactionsByAddressResponseItem `json:"items"`
}
...
func NewListOmniTransactionsByAddressResponseData(offset int32, limit int32, total int32, items []ListOmniTransactionsByAddressResponseItem) *ListOmniTransactionsByAddressResponseData {
	this := ListOmniTransactionsByAddressResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListOmniTransactionsByAddressResponseData) GetItems() []ListOmniTransactionsByAddressResponseItem {
	if o == nil {
		var ret []ListOmniTransactionsByAddressResponseItem
		return ret
	}
...
func (o ListOmniTransactionsByAddressResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByAddressResponseData struct {
	value *ListOmniTransactionsByAddressResponseData
	isSet bool
}

func (v NullableListOmniTransactionsByAddressResponseData) Get() *ListOmniTransactionsByAddressResponseData {
	return v.value
}

func (v *NullableListOmniTransactionsByAddressResponseData) Set(val *ListOmniTransactionsByAddressResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByAddressResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByAddressResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByAddressResponseData(val *ListOmniTransactionsByAddressResponseData) *NullableListOmniTransactionsByAddressResponseData {
	return &NullableListOmniTransactionsByAddressResponseData{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByAddressResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByAddressResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
