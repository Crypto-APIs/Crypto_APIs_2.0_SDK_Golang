...
type ListZilliqaTransactionsByAddressE400 struct {
...
func InvalidPaginationAsListZilliqaTransactionsByAddressE400(v *InvalidPagination) ListZilliqaTransactionsByAddressE400 {
	return ListZilliqaTransactionsByAddressE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsListZilliqaTransactionsByAddressE400(v *LimitGreaterThanAllowed) ListZilliqaTransactionsByAddressE400 {
	return ListZilliqaTransactionsByAddressE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsListZilliqaTransactionsByAddressE400(v *UriNotFound) ListZilliqaTransactionsByAddressE400 {
	return ListZilliqaTransactionsByAddressE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListZilliqaTransactionsByAddressE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListZilliqaTransactionsByAddressE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListZilliqaTransactionsByAddressE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListZilliqaTransactionsByAddressE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListZilliqaTransactionsByAddressE400) GetActualInstance() (interface{}) {
...
type NullableListZilliqaTransactionsByAddressE400 struct {
	value *ListZilliqaTransactionsByAddressE400
	isSet bool
}

func (v NullableListZilliqaTransactionsByAddressE400) Get() *ListZilliqaTransactionsByAddressE400 {
	return v.value
}

func (v *NullableListZilliqaTransactionsByAddressE400) Set(val *ListZilliqaTransactionsByAddressE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByAddressE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByAddressE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByAddressE400(val *ListZilliqaTransactionsByAddressE400) *NullableListZilliqaTransactionsByAddressE400 {
	return &NullableListZilliqaTransactionsByAddressE400{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByAddressE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByAddressE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
