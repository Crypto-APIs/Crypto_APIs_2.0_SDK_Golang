...
type ListTransactionsByBlockHash403Response struct {
...
func NewListTransactionsByBlockHash403Response(apiVersion string, requestId string, error_ ListTransactionsByBlockHashE403) *ListTransactionsByBlockHash403Response {
	this := ListTransactionsByBlockHash403Response{}
...
func (o ListTransactionsByBlockHash403Response) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHash403Response struct {
	value *ListTransactionsByBlockHash403Response
	isSet bool
}

func (v NullableListTransactionsByBlockHash403Response) Get() *ListTransactionsByBlockHash403Response {
	return v.value
}

func (v *NullableListTransactionsByBlockHash403Response) Set(val *ListTransactionsByBlockHash403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHash403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHash403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHash403Response(val *ListTransactionsByBlockHash403Response) *NullableListTransactionsByBlockHash403Response {
	return &NullableListTransactionsByBlockHash403Response{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHash403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHash403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
