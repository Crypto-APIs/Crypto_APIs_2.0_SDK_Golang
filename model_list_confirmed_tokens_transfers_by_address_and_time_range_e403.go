...
type ListConfirmedTokensTransfersByAddressAndTimeRangeE403 struct {
...
func BannedIpAddressAsListConfirmedTokensTransfersByAddressAndTimeRangeE403(v *BannedIpAddress) ListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
...
func EndpointNotAllowedForApiKeyAsListConfirmedTokensTransfersByAddressAndTimeRangeE403(v *EndpointNotAllowedForApiKey) ListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
	return ListConfirmedTokensTransfersByAddressAndTimeRangeE403{
...
func EndpointNotAllowedForPlanAsListConfirmedTokensTransfersByAddressAndTimeRangeE403(v *EndpointNotAllowedForPlan) ListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
	return ListConfirmedTokensTransfersByAddressAndTimeRangeE403{
...
func FeatureMainnetsNotAllowedForPlanAsListConfirmedTokensTransfersByAddressAndTimeRangeE403(v *FeatureMainnetsNotAllowedForPlan) ListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
	return ListConfirmedTokensTransfersByAddressAndTimeRangeE403{
...
func (dst *ListConfirmedTokensTransfersByAddressAndTimeRangeE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListConfirmedTokensTransfersByAddressAndTimeRangeE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListConfirmedTokensTransfersByAddressAndTimeRangeE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListConfirmedTokensTransfersByAddressAndTimeRangeE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListConfirmedTokensTransfersByAddressAndTimeRangeE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403 struct {
	value *ListConfirmedTokensTransfersByAddressAndTimeRangeE403
	isSet bool
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403) Get() *ListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
	return v.value
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403) Set(val *ListConfirmedTokensTransfersByAddressAndTimeRangeE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTokensTransfersByAddressAndTimeRangeE403(val *ListConfirmedTokensTransfersByAddressAndTimeRangeE403) *NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
	return &NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403{value: val, isSet: true}
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRangeE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
