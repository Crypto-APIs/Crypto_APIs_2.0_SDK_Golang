...
type ListAllAssetsFromAllWalletsE400 struct {
...
func InvalidPaginationAsListAllAssetsFromAllWalletsE400(v *InvalidPagination) ListAllAssetsFromAllWalletsE400 {
...
func LimitGreaterThanAllowedAsListAllAssetsFromAllWalletsE400(v *LimitGreaterThanAllowed) ListAllAssetsFromAllWalletsE400 {
	return ListAllAssetsFromAllWalletsE400{
...
func UriNotFoundAsListAllAssetsFromAllWalletsE400(v *UriNotFound) ListAllAssetsFromAllWalletsE400 {
	return ListAllAssetsFromAllWalletsE400{
		UriNotFound: v,
	}
}
...
func (dst *ListAllAssetsFromAllWalletsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListAllAssetsFromAllWalletsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListAllAssetsFromAllWalletsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListAllAssetsFromAllWalletsE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListAllAssetsFromAllWalletsE400) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableListAllAssetsFromAllWalletsE400 struct {
	value *ListAllAssetsFromAllWalletsE400
	isSet bool
}

func (v NullableListAllAssetsFromAllWalletsE400) Get() *ListAllAssetsFromAllWalletsE400 {
	return v.value
}

func (v *NullableListAllAssetsFromAllWalletsE400) Set(val *ListAllAssetsFromAllWalletsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsFromAllWalletsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsFromAllWalletsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsFromAllWalletsE400(val *ListAllAssetsFromAllWalletsE400) *NullableListAllAssetsFromAllWalletsE400 {
	return &NullableListAllAssetsFromAllWalletsE400{value: val, isSet: true}
}

func (v NullableListAllAssetsFromAllWalletsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsFromAllWalletsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
