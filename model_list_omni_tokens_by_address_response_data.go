...
// ListOmniTokensByAddressResponseData struct for ListOmniTokensByAddressResponseData
type ListOmniTokensByAddressResponseData struct {
	...
	Items []ListOmniTokensByAddressResponseItem `json:"items"`
}
...
func NewListOmniTokensByAddressResponseData(offset int32, limit int32, total int32, items []ListOmniTokensByAddressResponseItem) *ListOmniTokensByAddressResponseData {
	this := ListOmniTokensByAddressResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListOmniTokensByAddressResponseData) GetItems() []ListOmniTokensByAddressResponseItem {
	if o == nil {
		var ret []ListOmniTokensByAddressResponseItem
		return ret
	}
...
func (o ListOmniTokensByAddressResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTokensByAddressResponseData struct {
	value *ListOmniTokensByAddressResponseData
	isSet bool
}

func (v NullableListOmniTokensByAddressResponseData) Get() *ListOmniTokensByAddressResponseData {
	return v.value
}

func (v *NullableListOmniTokensByAddressResponseData) Set(val *ListOmniTokensByAddressResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTokensByAddressResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTokensByAddressResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTokensByAddressResponseData(val *ListOmniTokensByAddressResponseData) *NullableListOmniTokensByAddressResponseData {
	return &NullableListOmniTokensByAddressResponseData{value: val, isSet: true}
}

func (v NullableListOmniTokensByAddressResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTokensByAddressResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
