...
type GetNextAvailableNonce403Response struct {
	...
	Error GetNextAvailableNonceE403 `json:"error"`
}
...
func NewGetNextAvailableNonce403Response(apiVersion string, requestId string, error_ GetNextAvailableNonceE403) *GetNextAvailableNonce403Response {
	this := GetNextAvailableNonce403Response{}
...
func (o *GetNextAvailableNonce403Response) GetError() GetNextAvailableNonceE403 {
	if o == nil {
		var ret GetNextAvailableNonceE403
		return ret
	}
...
func (o GetNextAvailableNonce403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetNextAvailableNonce403Response struct {
	value *GetNextAvailableNonce403Response
	isSet bool
}

func (v NullableGetNextAvailableNonce403Response) Get() *GetNextAvailableNonce403Response {
	return v.value
}

func (v *NullableGetNextAvailableNonce403Response) Set(val *GetNextAvailableNonce403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNextAvailableNonce403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNextAvailableNonce403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNextAvailableNonce403Response(val *GetNextAvailableNonce403Response) *NullableGetNextAvailableNonce403Response {
	return &NullableGetNextAvailableNonce403Response{value: val, isSet: true}
}

func (v NullableGetNextAvailableNonce403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNextAvailableNonce403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
