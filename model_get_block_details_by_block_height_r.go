...
type GetBlockDetailsByBlockHeightR struct {
	...
	Data GetBlockDetailsByBlockHeightRData `json:"data"`
}
...
func NewGetBlockDetailsByBlockHeightR(apiVersion string, requestId string, data GetBlockDetailsByBlockHeightRData) *GetBlockDetailsByBlockHeightR {
	this := GetBlockDetailsByBlockHeightR{}
...
func (o *GetBlockDetailsByBlockHeightR) GetData() GetBlockDetailsByBlockHeightRData {
	if o == nil {
		var ret GetBlockDetailsByBlockHeightRData
		return ret
	}
...
func (o GetBlockDetailsByBlockHeightR) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightR struct {
	value *GetBlockDetailsByBlockHeightR
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightR) Get() *GetBlockDetailsByBlockHeightR {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightR) Set(val *GetBlockDetailsByBlockHeightR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightR(val *GetBlockDetailsByBlockHeightR) *NullableGetBlockDetailsByBlockHeightR {
	return &NullableGetBlockDetailsByBlockHeightR{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightR) UnmarshalJSON(src []byte) error {
	v.isSet = true
