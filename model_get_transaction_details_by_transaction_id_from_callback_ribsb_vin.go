...
// GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin struct for GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin
type GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin struct {
...
func (o *GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) GetScriptSig() GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDFromCallbackRIBSBScriptSig
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) Get() *GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) Set(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSBVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
