...
// ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin struct for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin
type ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin(addresses []string, coinbase string, scriptSig GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig, sequence string, txid string, txinwitness []string, value string, vout int32) *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
