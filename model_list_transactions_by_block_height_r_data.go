...
type ListTransactionsByBlockHeightRData struct {
	...
	Items []ListTransactionsByBlockHeightRI `json:"items"`
}
...
func NewListTransactionsByBlockHeightRData(limit int32, offset int32, total int32, items []ListTransactionsByBlockHeightRI) *ListTransactionsByBlockHeightRData {
	this := ListTransactionsByBlockHeightRData{}
	this.Limit = limit
	this.Offset = offset
	this.Total = total
	this.Items = items
...
func (o *ListTransactionsByBlockHeightRData) GetItems() []ListTransactionsByBlockHeightRI {
	if o == nil {
		var ret []ListTransactionsByBlockHeightRI
		return ret
	}
...
func (o ListTransactionsByBlockHeightRData) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRData struct {
	value *ListTransactionsByBlockHeightRData
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRData) Get() *ListTransactionsByBlockHeightRData {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRData) Set(val *ListTransactionsByBlockHeightRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRData(val *ListTransactionsByBlockHeightRData) *NullableListTransactionsByBlockHeightRData {
	return &NullableListTransactionsByBlockHeightRData{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
