...
type GetZilliqaAddressDetails400Response struct {
	...
	Error GetZilliqaAddressDetailsE400 `json:"error"`
}
...
func (o *GetZilliqaAddressDetails400Response) GetError() GetZilliqaAddressDetailsE400 {
	if o == nil {
		var ret GetZilliqaAddressDetailsE400
		return ret
	}
...
func (o GetZilliqaAddressDetails400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaAddressDetails400Response struct {
	value *GetZilliqaAddressDetails400Response
	isSet bool
}

func (v NullableGetZilliqaAddressDetails400Response) Get() *GetZilliqaAddressDetails400Response {
	return v.value
}

func (v *NullableGetZilliqaAddressDetails400Response) Set(val *GetZilliqaAddressDetails400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaAddressDetails400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaAddressDetails400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaAddressDetails400Response(val *GetZilliqaAddressDetails400Response) *NullableGetZilliqaAddressDetails400Response {
	return &NullableGetZilliqaAddressDetails400Response{value: val, isSet: true}
}

func (v NullableGetZilliqaAddressDetails400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaAddressDetails400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
