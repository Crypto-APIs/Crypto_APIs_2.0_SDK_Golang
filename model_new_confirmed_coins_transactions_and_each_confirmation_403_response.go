...
type NewConfirmedCoinsTransactionsAndEachConfirmation403Response struct {
	...
	Error NewConfirmedCoinsTransactionsAndEachConfirmationE403 `json:"error"`
}
...
func NewNewConfirmedCoinsTransactionsAndEachConfirmation403Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsAndEachConfirmationE403) *NewConfirmedCoinsTransactionsAndEachConfirmation403Response {
	this := NewConfirmedCoinsTransactionsAndEachConfirmation403Response{}
...
func (o *NewConfirmedCoinsTransactionsAndEachConfirmation403Response) GetError() NewConfirmedCoinsTransactionsAndEachConfirmationE403 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsAndEachConfirmationE403
		return ret
	}
...
func (o NewConfirmedCoinsTransactionsAndEachConfirmation403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response struct {
	value *NewConfirmedCoinsTransactionsAndEachConfirmation403Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response) Get() *NewConfirmedCoinsTransactionsAndEachConfirmation403Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response) Set(val *NewConfirmedCoinsTransactionsAndEachConfirmation403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response(val *NewConfirmedCoinsTransactionsAndEachConfirmation403Response) *NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response {
	return &NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
