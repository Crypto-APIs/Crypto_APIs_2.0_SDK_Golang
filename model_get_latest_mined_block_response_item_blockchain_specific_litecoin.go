...
type GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin struct {
...
func NewGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, versionHex string, weight int32) *GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin {
	this := GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin{}
...
func (o GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin struct {
	value *GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) Get() *GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) Set(val *GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin(val *GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) *NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin {
	return &NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificLitecoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
