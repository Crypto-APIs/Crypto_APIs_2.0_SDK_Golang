...
type CreateCoinsTransactionRequestFromWalletR struct {
	...
	Data CreateCoinsTransactionRequestFromWalletRData `json:"data"`
}
...
func NewCreateCoinsTransactionRequestFromWalletR(apiVersion string, requestId string, data CreateCoinsTransactionRequestFromWalletRData) *CreateCoinsTransactionRequestFromWalletR {
	this := CreateCoinsTransactionRequestFromWalletR{}
...
func (o *CreateCoinsTransactionRequestFromWalletR) GetData() CreateCoinsTransactionRequestFromWalletRData {
	if o == nil {
		var ret CreateCoinsTransactionRequestFromWalletRData
		return ret
	}
...
func (o CreateCoinsTransactionRequestFromWalletR) MarshalJSON() ([]byte, error) {
...
type NullableCreateCoinsTransactionRequestFromWalletR struct {
	value *CreateCoinsTransactionRequestFromWalletR
	isSet bool
}

func (v NullableCreateCoinsTransactionRequestFromWalletR) Get() *CreateCoinsTransactionRequestFromWalletR {
	return v.value
}

func (v *NullableCreateCoinsTransactionRequestFromWalletR) Set(val *CreateCoinsTransactionRequestFromWalletR) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCoinsTransactionRequestFromWalletR) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCoinsTransactionRequestFromWalletR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCoinsTransactionRequestFromWalletR(val *CreateCoinsTransactionRequestFromWalletR) *NullableCreateCoinsTransactionRequestFromWalletR {
	return &NullableCreateCoinsTransactionRequestFromWalletR{value: val, isSet: true}
}

func (v NullableCreateCoinsTransactionRequestFromWalletR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCoinsTransactionRequestFromWalletR) UnmarshalJSON(src []byte) error {
	v.isSet = true
