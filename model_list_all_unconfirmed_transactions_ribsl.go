...
type ListAllUnconfirmedTransactionsRIBSL struct {
	...
	Vout []ListAllUnconfirmedTransactionsRIBSLVout `json:"vout"`
}
...
func (o *ListAllUnconfirmedTransactionsRIBSL) GetVout() []ListAllUnconfirmedTransactionsRIBSLVout {
	if o == nil {
		var ret []ListAllUnconfirmedTransactionsRIBSLVout
		return ret
	}
...
func (o ListAllUnconfirmedTransactionsRIBSL) MarshalJSON() ([]byte, error) {
...
type NullableListAllUnconfirmedTransactionsRIBSL struct {
	value *ListAllUnconfirmedTransactionsRIBSL
	isSet bool
}

func (v NullableListAllUnconfirmedTransactionsRIBSL) Get() *ListAllUnconfirmedTransactionsRIBSL {
	return v.value
}

func (v *NullableListAllUnconfirmedTransactionsRIBSL) Set(val *ListAllUnconfirmedTransactionsRIBSL) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllUnconfirmedTransactionsRIBSL) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllUnconfirmedTransactionsRIBSL) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllUnconfirmedTransactionsRIBSL(val *ListAllUnconfirmedTransactionsRIBSL) *NullableListAllUnconfirmedTransactionsRIBSL {
	return &NullableListAllUnconfirmedTransactionsRIBSL{value: val, isSet: true}
}

func (v NullableListAllUnconfirmedTransactionsRIBSL) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllUnconfirmedTransactionsRIBSL) UnmarshalJSON(src []byte) error {
	v.isSet = true
