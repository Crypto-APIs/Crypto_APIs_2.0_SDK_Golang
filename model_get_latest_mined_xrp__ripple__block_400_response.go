...
type GetLatestMinedXRPRippleBlock400Response struct {
...
func (o GetLatestMinedXRPRippleBlock400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedXRPRippleBlock400Response struct {
	value *GetLatestMinedXRPRippleBlock400Response
	isSet bool
}

func (v NullableGetLatestMinedXRPRippleBlock400Response) Get() *GetLatestMinedXRPRippleBlock400Response {
	return v.value
}

func (v *NullableGetLatestMinedXRPRippleBlock400Response) Set(val *GetLatestMinedXRPRippleBlock400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedXRPRippleBlock400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedXRPRippleBlock400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedXRPRippleBlock400Response(val *GetLatestMinedXRPRippleBlock400Response) *NullableGetLatestMinedXRPRippleBlock400Response {
	return &NullableGetLatestMinedXRPRippleBlock400Response{value: val, isSet: true}
}

func (v NullableGetLatestMinedXRPRippleBlock400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedXRPRippleBlock400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
