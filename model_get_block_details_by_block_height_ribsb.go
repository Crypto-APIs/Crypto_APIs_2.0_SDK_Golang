...
type GetBlockDetailsByBlockHeightRIBSB struct {
...
func NewGetBlockDetailsByBlockHeightRIBSB(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, versionHex string, weight int32) *GetBlockDetailsByBlockHeightRIBSB {
	this := GetBlockDetailsByBlockHeightRIBSB{}
...
func (o GetBlockDetailsByBlockHeightRIBSB) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightRIBSB struct {
	value *GetBlockDetailsByBlockHeightRIBSB
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightRIBSB) Get() *GetBlockDetailsByBlockHeightRIBSB {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightRIBSB) Set(val *GetBlockDetailsByBlockHeightRIBSB) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightRIBSB) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightRIBSB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightRIBSB(val *GetBlockDetailsByBlockHeightRIBSB) *NullableGetBlockDetailsByBlockHeightRIBSB {
	return &NullableGetBlockDetailsByBlockHeightRIBSB{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightRIBSB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightRIBSB) UnmarshalJSON(src []byte) error {
	v.isSet = true
