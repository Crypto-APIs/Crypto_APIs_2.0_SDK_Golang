...
// InlineResponse40189 struct for InlineResponse40189
type InlineResponse40189 struct {
...
func (o InlineResponse40189) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse40189 struct {
	value *InlineResponse40189
	isSet bool
}

func (v NullableInlineResponse40189) Get() *InlineResponse40189 {
	return v.value
}

func (v *NullableInlineResponse40189) Set(val *InlineResponse40189) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse40189) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse40189) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse40189(val *InlineResponse40189) *NullableInlineResponse40189 {
	return &NullableInlineResponse40189{value: val, isSet: true}
}

func (v NullableInlineResponse40189) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse40189) UnmarshalJSON(src []byte) error {
	v.isSet = true
