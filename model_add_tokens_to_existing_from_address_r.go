...
type AddTokensToExistingFromAddressR struct {
	...
	Data AddTokensToExistingFromAddressRData `json:"data"`
}
...
func NewAddTokensToExistingFromAddressR(apiVersion string, requestId string, data AddTokensToExistingFromAddressRData) *AddTokensToExistingFromAddressR {
	this := AddTokensToExistingFromAddressR{}
...
func (o *AddTokensToExistingFromAddressR) GetData() AddTokensToExistingFromAddressRData {
	if o == nil {
		var ret AddTokensToExistingFromAddressRData
		return ret
	}
...
func (o AddTokensToExistingFromAddressR) MarshalJSON() ([]byte, error) {
...
type NullableAddTokensToExistingFromAddressR struct {
	value *AddTokensToExistingFromAddressR
	isSet bool
}

func (v NullableAddTokensToExistingFromAddressR) Get() *AddTokensToExistingFromAddressR {
	return v.value
}

func (v *NullableAddTokensToExistingFromAddressR) Set(val *AddTokensToExistingFromAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableAddTokensToExistingFromAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableAddTokensToExistingFromAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddTokensToExistingFromAddressR(val *AddTokensToExistingFromAddressR) *NullableAddTokensToExistingFromAddressR {
	return &NullableAddTokensToExistingFromAddressR{value: val, isSet: true}
}

func (v NullableAddTokensToExistingFromAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddTokensToExistingFromAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
