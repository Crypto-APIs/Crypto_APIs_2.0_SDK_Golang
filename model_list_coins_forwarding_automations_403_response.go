...
type ListCoinsForwardingAutomations403Response struct {
...
func NewListCoinsForwardingAutomations403Response(apiVersion string, requestId string, error_ ListCoinsForwardingAutomationsE403) *ListCoinsForwardingAutomations403Response {
	this := ListCoinsForwardingAutomations403Response{}
...
func (o ListCoinsForwardingAutomations403Response) MarshalJSON() ([]byte, error) {
...
type NullableListCoinsForwardingAutomations403Response struct {
	value *ListCoinsForwardingAutomations403Response
	isSet bool
}

func (v NullableListCoinsForwardingAutomations403Response) Get() *ListCoinsForwardingAutomations403Response {
	return v.value
}

func (v *NullableListCoinsForwardingAutomations403Response) Set(val *ListCoinsForwardingAutomations403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoinsForwardingAutomations403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoinsForwardingAutomations403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoinsForwardingAutomations403Response(val *ListCoinsForwardingAutomations403Response) *NullableListCoinsForwardingAutomations403Response {
	return &NullableListCoinsForwardingAutomations403Response{value: val, isSet: true}
}

func (v NullableListCoinsForwardingAutomations403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoinsForwardingAutomations403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
