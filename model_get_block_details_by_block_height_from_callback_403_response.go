...
type GetBlockDetailsByBlockHeightFromCallback403Response struct {
	...
	Error GetBlockDetailsByBlockHeightFromCallbackE403 `json:"error"`
}
...
func (o *GetBlockDetailsByBlockHeightFromCallback403Response) GetError() GetBlockDetailsByBlockHeightFromCallbackE403 {
	if o == nil {
		var ret GetBlockDetailsByBlockHeightFromCallbackE403
		return ret
	}
...
func (o GetBlockDetailsByBlockHeightFromCallback403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightFromCallback403Response struct {
	value *GetBlockDetailsByBlockHeightFromCallback403Response
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightFromCallback403Response) Get() *GetBlockDetailsByBlockHeightFromCallback403Response {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallback403Response) Set(val *GetBlockDetailsByBlockHeightFromCallback403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightFromCallback403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallback403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightFromCallback403Response(val *GetBlockDetailsByBlockHeightFromCallback403Response) *NullableGetBlockDetailsByBlockHeightFromCallback403Response {
	return &NullableGetBlockDetailsByBlockHeightFromCallback403Response{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightFromCallback403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallback403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
