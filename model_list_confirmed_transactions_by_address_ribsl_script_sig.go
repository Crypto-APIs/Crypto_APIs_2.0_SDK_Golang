...
type ListConfirmedTransactionsByAddressRIBSLScriptSig struct {
...
func NewListConfirmedTransactionsByAddressRIBSLScriptSig(asm string, hex string, type_ string) *ListConfirmedTransactionsByAddressRIBSLScriptSig {
	this := ListConfirmedTransactionsByAddressRIBSLScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListConfirmedTransactionsByAddressRIBSLScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRIBSLScriptSig struct {
	value *ListConfirmedTransactionsByAddressRIBSLScriptSig
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRIBSLScriptSig) Get() *ListConfirmedTransactionsByAddressRIBSLScriptSig {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRIBSLScriptSig) Set(val *ListConfirmedTransactionsByAddressRIBSLScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRIBSLScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRIBSLScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRIBSLScriptSig(val *ListConfirmedTransactionsByAddressRIBSLScriptSig) *NullableListConfirmedTransactionsByAddressRIBSLScriptSig {
	return &NullableListConfirmedTransactionsByAddressRIBSLScriptSig{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRIBSLScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRIBSLScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
