...
type GetAddressDetailsE403 struct {
...
func BannedIpAddressAsGetAddressDetailsE403(v *BannedIpAddress) GetAddressDetailsE403 {
	return GetAddressDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetAddressDetailsE403(v *EndpointNotAllowedForApiKey) GetAddressDetailsE403 {
	return GetAddressDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetAddressDetailsE403(v *EndpointNotAllowedForPlan) GetAddressDetailsE403 {
	return GetAddressDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetAddressDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetAddressDetailsE403 {
	return GetAddressDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetAddressDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetAddressDetailsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetAddressDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetAddressDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetAddressDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetAddressDetailsE403 struct {
	value *GetAddressDetailsE403
	isSet bool
}

func (v NullableGetAddressDetailsE403) Get() *GetAddressDetailsE403 {
	return v.value
}

func (v *NullableGetAddressDetailsE403) Set(val *GetAddressDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsE403(val *GetAddressDetailsE403) *NullableGetAddressDetailsE403 {
	return &NullableGetAddressDetailsE403{value: val, isSet: true}
}

func (v NullableGetAddressDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
