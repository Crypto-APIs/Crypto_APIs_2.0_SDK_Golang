...
type GetBlockDetailsByBlockHashFromCallbackRIBSBC struct {
...
func NewGetBlockDetailsByBlockHashFromCallbackRIBSBC(bits string, chainwork string, difficulty string, merkleRoot string, nonce int64, size int32, version int32, versionHex string) *GetBlockDetailsByBlockHashFromCallbackRIBSBC {
	this := GetBlockDetailsByBlockHashFromCallbackRIBSBC{}
	this.Bits = bits
...
func (o GetBlockDetailsByBlockHashFromCallbackRIBSBC) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC struct {
	value *GetBlockDetailsByBlockHashFromCallbackRIBSBC
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC) Get() *GetBlockDetailsByBlockHashFromCallbackRIBSBC {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC) Set(val *GetBlockDetailsByBlockHashFromCallbackRIBSBC) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashFromCallbackRIBSBC(val *GetBlockDetailsByBlockHashFromCallbackRIBSBC) *NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC {
	return &NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashFromCallbackRIBSBC) UnmarshalJSON(src []byte) error {
	v.isSet = true
