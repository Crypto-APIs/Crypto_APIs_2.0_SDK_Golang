...
type GetZilliqaTransactionDetailsByTransactionID401Response struct {
	...
	Error GetZilliqaTransactionDetailsByTransactionIDE401 `json:"error"`
}
...
func (o *GetZilliqaTransactionDetailsByTransactionID401Response) GetError() GetZilliqaTransactionDetailsByTransactionIDE401 {
	if o == nil {
		var ret GetZilliqaTransactionDetailsByTransactionIDE401
		return ret
	}
...
func (o GetZilliqaTransactionDetailsByTransactionID401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaTransactionDetailsByTransactionID401Response struct {
	value *GetZilliqaTransactionDetailsByTransactionID401Response
	isSet bool
}

func (v NullableGetZilliqaTransactionDetailsByTransactionID401Response) Get() *GetZilliqaTransactionDetailsByTransactionID401Response {
	return v.value
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionID401Response) Set(val *GetZilliqaTransactionDetailsByTransactionID401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaTransactionDetailsByTransactionID401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionID401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaTransactionDetailsByTransactionID401Response(val *GetZilliqaTransactionDetailsByTransactionID401Response) *NullableGetZilliqaTransactionDetailsByTransactionID401Response {
	return &NullableGetZilliqaTransactionDetailsByTransactionID401Response{value: val, isSet: true}
}

func (v NullableGetZilliqaTransactionDetailsByTransactionID401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionID401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
