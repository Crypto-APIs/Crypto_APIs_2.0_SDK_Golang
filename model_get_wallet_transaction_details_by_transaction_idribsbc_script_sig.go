...
type GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig struct {
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) Get() *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig(val *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
