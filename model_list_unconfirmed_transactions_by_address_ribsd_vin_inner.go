...
type ListUnconfirmedTransactionsByAddressRIBSDVinInner struct {
...
func NewListUnconfirmedTransactionsByAddressRIBSDVinInner(addresses []string, scriptSig ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig, sequence int64, txinwitness []string, value string) *ListUnconfirmedTransactionsByAddressRIBSDVinInner {
	this := ListUnconfirmedTransactionsByAddressRIBSDVinInner{}
...
func (o ListUnconfirmedTransactionsByAddressRIBSDVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSDVinInner struct {
	value *ListUnconfirmedTransactionsByAddressRIBSDVinInner
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSDVinInner) Get() *ListUnconfirmedTransactionsByAddressRIBSDVinInner {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSDVinInner) Set(val *ListUnconfirmedTransactionsByAddressRIBSDVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSDVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSDVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSDVinInner(val *ListUnconfirmedTransactionsByAddressRIBSDVinInner) *NullableListUnconfirmedTransactionsByAddressRIBSDVinInner {
	return &NullableListUnconfirmedTransactionsByAddressRIBSDVinInner{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSDVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSDVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
