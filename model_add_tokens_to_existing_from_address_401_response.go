...
type AddTokensToExistingFromAddress401Response struct {
...
func (o AddTokensToExistingFromAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableAddTokensToExistingFromAddress401Response struct {
	value *AddTokensToExistingFromAddress401Response
	isSet bool
}

func (v NullableAddTokensToExistingFromAddress401Response) Get() *AddTokensToExistingFromAddress401Response {
	return v.value
}

func (v *NullableAddTokensToExistingFromAddress401Response) Set(val *AddTokensToExistingFromAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddTokensToExistingFromAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddTokensToExistingFromAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddTokensToExistingFromAddress401Response(val *AddTokensToExistingFromAddress401Response) *NullableAddTokensToExistingFromAddress401Response {
	return &NullableAddTokensToExistingFromAddress401Response{value: val, isSet: true}
}

func (v NullableAddTokensToExistingFromAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddTokensToExistingFromAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
