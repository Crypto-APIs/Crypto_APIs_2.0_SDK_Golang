...
type GetExchangeRateByAssetsIDs403Response struct {
...
func (o GetExchangeRateByAssetsIDs403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetExchangeRateByAssetsIDs403Response struct {
	value *GetExchangeRateByAssetsIDs403Response
	isSet bool
}

func (v NullableGetExchangeRateByAssetsIDs403Response) Get() *GetExchangeRateByAssetsIDs403Response {
	return v.value
}

func (v *NullableGetExchangeRateByAssetsIDs403Response) Set(val *GetExchangeRateByAssetsIDs403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExchangeRateByAssetsIDs403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExchangeRateByAssetsIDs403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExchangeRateByAssetsIDs403Response(val *GetExchangeRateByAssetsIDs403Response) *NullableGetExchangeRateByAssetsIDs403Response {
	return &NullableGetExchangeRateByAssetsIDs403Response{value: val, isSet: true}
}

func (v NullableGetExchangeRateByAssetsIDs403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExchangeRateByAssetsIDs403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
