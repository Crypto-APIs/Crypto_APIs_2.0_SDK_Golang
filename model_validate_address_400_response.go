...
type ValidateAddress400Response struct {
	...
	Error ValidateAddressE400 `json:"error"`
}
...
func (o ValidateAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableValidateAddress400Response struct {
	value *ValidateAddress400Response
	isSet bool
}

func (v NullableValidateAddress400Response) Get() *ValidateAddress400Response {
	return v.value
}

func (v *NullableValidateAddress400Response) Set(val *ValidateAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateAddress400Response(val *ValidateAddress400Response) *NullableValidateAddress400Response {
	return &NullableValidateAddress400Response{value: val, isSet: true}
}

func (v NullableValidateAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
