...
type GetXRPRippleBlockDetailsByBlockHeightR struct {
	...
	Data GetXRPRippleBlockDetailsByBlockHeightRData `json:"data"`
}
...
func NewGetXRPRippleBlockDetailsByBlockHeightR(apiVersion string, requestId string, data GetXRPRippleBlockDetailsByBlockHeightRData) *GetXRPRippleBlockDetailsByBlockHeightR {
	this := GetXRPRippleBlockDetailsByBlockHeightR{}
...
func (o *GetXRPRippleBlockDetailsByBlockHeightR) GetData() GetXRPRippleBlockDetailsByBlockHeightRData {
	if o == nil {
		var ret GetXRPRippleBlockDetailsByBlockHeightRData
		return ret
	}
...
func (o GetXRPRippleBlockDetailsByBlockHeightR) MarshalJSON() ([]byte, error) {
...
type NullableGetXRPRippleBlockDetailsByBlockHeightR struct {
	value *GetXRPRippleBlockDetailsByBlockHeightR
	isSet bool
}

func (v NullableGetXRPRippleBlockDetailsByBlockHeightR) Get() *GetXRPRippleBlockDetailsByBlockHeightR {
	return v.value
}

func (v *NullableGetXRPRippleBlockDetailsByBlockHeightR) Set(val *GetXRPRippleBlockDetailsByBlockHeightR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetXRPRippleBlockDetailsByBlockHeightR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetXRPRippleBlockDetailsByBlockHeightR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetXRPRippleBlockDetailsByBlockHeightR(val *GetXRPRippleBlockDetailsByBlockHeightR) *NullableGetXRPRippleBlockDetailsByBlockHeightR {
	return &NullableGetXRPRippleBlockDetailsByBlockHeightR{value: val, isSet: true}
}

func (v NullableGetXRPRippleBlockDetailsByBlockHeightR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetXRPRippleBlockDetailsByBlockHeightR) UnmarshalJSON(src []byte) error {
	v.isSet = true
