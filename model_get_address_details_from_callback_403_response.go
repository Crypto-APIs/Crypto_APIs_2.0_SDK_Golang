...
type GetAddressDetailsFromCallback403Response struct {
	...
	Error GetAddressDetailsFromCallbackE403 `json:"error"`
}
...
func NewGetAddressDetailsFromCallback403Response(apiVersion string, requestId string, error_ GetAddressDetailsFromCallbackE403) *GetAddressDetailsFromCallback403Response {
	this := GetAddressDetailsFromCallback403Response{}
...
func (o *GetAddressDetailsFromCallback403Response) GetError() GetAddressDetailsFromCallbackE403 {
	if o == nil {
		var ret GetAddressDetailsFromCallbackE403
		return ret
	}
...
func (o GetAddressDetailsFromCallback403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetailsFromCallback403Response struct {
	value *GetAddressDetailsFromCallback403Response
	isSet bool
}

func (v NullableGetAddressDetailsFromCallback403Response) Get() *GetAddressDetailsFromCallback403Response {
	return v.value
}

func (v *NullableGetAddressDetailsFromCallback403Response) Set(val *GetAddressDetailsFromCallback403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsFromCallback403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsFromCallback403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsFromCallback403Response(val *GetAddressDetailsFromCallback403Response) *NullableGetAddressDetailsFromCallback403Response {
	return &NullableGetAddressDetailsFromCallback403Response{value: val, isSet: true}
}

func (v NullableGetAddressDetailsFromCallback403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsFromCallback403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
