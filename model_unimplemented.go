...
func (o Unimplemented) MarshalJSON() ([]byte, error) {
...
type NullableUnimplemented struct {
	value *Unimplemented
	isSet bool
}

func (v NullableUnimplemented) Get() *Unimplemented {
	return v.value
}

func (v *NullableUnimplemented) Set(val *Unimplemented) {
	v.value = val
	v.isSet = true
}

func (v NullableUnimplemented) IsSet() bool {
	return v.isSet
}

func (v *NullableUnimplemented) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnimplemented(val *Unimplemented) *NullableUnimplemented {
	return &NullableUnimplemented{value: val, isSet: true}
}

func (v NullableUnimplemented) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnimplemented) UnmarshalJSON(src []byte) error {
	v.isSet = true
