...
type ConvertBitcoinCashAddressR struct {
	...
	Data ConvertBitcoinCashAddressRData `json:"data"`
}
...
func NewConvertBitcoinCashAddressR(apiVersion string, requestId string, data ConvertBitcoinCashAddressRData) *ConvertBitcoinCashAddressR {
	this := ConvertBitcoinCashAddressR{}
...
func (o *ConvertBitcoinCashAddressR) GetData() ConvertBitcoinCashAddressRData {
	if o == nil {
		var ret ConvertBitcoinCashAddressRData
		return ret
	}
...
func (o ConvertBitcoinCashAddressR) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddressR struct {
	value *ConvertBitcoinCashAddressR
	isSet bool
}

func (v NullableConvertBitcoinCashAddressR) Get() *ConvertBitcoinCashAddressR {
	return v.value
}

func (v *NullableConvertBitcoinCashAddressR) Set(val *ConvertBitcoinCashAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddressR(val *ConvertBitcoinCashAddressR) *NullableConvertBitcoinCashAddressR {
	return &NullableConvertBitcoinCashAddressR{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
