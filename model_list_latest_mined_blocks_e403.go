...
type ListLatestMinedBlocksE403 struct {
...
func BannedIpAddressAsListLatestMinedBlocksE403(v *BannedIpAddress) ListLatestMinedBlocksE403 {
	return ListLatestMinedBlocksE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListLatestMinedBlocksE403(v *EndpointNotAllowedForApiKey) ListLatestMinedBlocksE403 {
	return ListLatestMinedBlocksE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListLatestMinedBlocksE403(v *EndpointNotAllowedForPlan) ListLatestMinedBlocksE403 {
	return ListLatestMinedBlocksE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListLatestMinedBlocksE403(v *FeatureMainnetsNotAllowedForPlan) ListLatestMinedBlocksE403 {
	return ListLatestMinedBlocksE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListLatestMinedBlocksE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListLatestMinedBlocksE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListLatestMinedBlocksE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListLatestMinedBlocksE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListLatestMinedBlocksE403) GetActualInstance() (interface{}) {
...
type NullableListLatestMinedBlocksE403 struct {
	value *ListLatestMinedBlocksE403
	isSet bool
}

func (v NullableListLatestMinedBlocksE403) Get() *ListLatestMinedBlocksE403 {
	return v.value
}

func (v *NullableListLatestMinedBlocksE403) Set(val *ListLatestMinedBlocksE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListLatestMinedBlocksE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListLatestMinedBlocksE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLatestMinedBlocksE403(val *ListLatestMinedBlocksE403) *NullableListLatestMinedBlocksE403 {
	return &NullableListLatestMinedBlocksE403{value: val, isSet: true}
}

func (v NullableListLatestMinedBlocksE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLatestMinedBlocksE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
