...
type DeriveAndSyncNewReceivingAddresses400Response struct {
	...
	Error DeriveAndSyncNewReceivingAddressesE400 `json:"error"`
}
...
func NewDeriveAndSyncNewReceivingAddresses400Response(apiVersion string, requestId string, error_ DeriveAndSyncNewReceivingAddressesE400) *DeriveAndSyncNewReceivingAddresses400Response {
	this := DeriveAndSyncNewReceivingAddresses400Response{}
...
func (o *DeriveAndSyncNewReceivingAddresses400Response) GetError() DeriveAndSyncNewReceivingAddressesE400 {
	if o == nil {
		var ret DeriveAndSyncNewReceivingAddressesE400
		return ret
	}
...
func (o DeriveAndSyncNewReceivingAddresses400Response) MarshalJSON() ([]byte, error) {
...
type NullableDeriveAndSyncNewReceivingAddresses400Response struct {
	value *DeriveAndSyncNewReceivingAddresses400Response
	isSet bool
}

func (v NullableDeriveAndSyncNewReceivingAddresses400Response) Get() *DeriveAndSyncNewReceivingAddresses400Response {
	return v.value
}

func (v *NullableDeriveAndSyncNewReceivingAddresses400Response) Set(val *DeriveAndSyncNewReceivingAddresses400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewReceivingAddresses400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewReceivingAddresses400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewReceivingAddresses400Response(val *DeriveAndSyncNewReceivingAddresses400Response) *NullableDeriveAndSyncNewReceivingAddresses400Response {
	return &NullableDeriveAndSyncNewReceivingAddresses400Response{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewReceivingAddresses400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewReceivingAddresses400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
