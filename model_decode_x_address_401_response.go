...
type DecodeXAddress401Response struct {
	...
	Error DecodeXAddressE401 `json:"error"`
}
...
func NewDecodeXAddress401Response(apiVersion string, requestId string, error_ DecodeXAddressE401) *DecodeXAddress401Response {
	this := DecodeXAddress401Response{}
...
func (o DecodeXAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableDecodeXAddress401Response struct {
	value *DecodeXAddress401Response
	isSet bool
}

func (v NullableDecodeXAddress401Response) Get() *DecodeXAddress401Response {
	return v.value
}

func (v *NullableDecodeXAddress401Response) Set(val *DecodeXAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeXAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeXAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeXAddress401Response(val *DecodeXAddress401Response) *NullableDecodeXAddress401Response {
	return &NullableDecodeXAddress401Response{value: val, isSet: true}
}

func (v NullableDecodeXAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeXAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
