...
type DeriveAndSyncNewChangeAddressesRB struct {
	// In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
	Context *string `json:"context,omitempty"`
	Data DeriveAndSyncNewChangeAddressesRBData `json:"data"`
}
...
func NewDeriveAndSyncNewChangeAddressesRB(data DeriveAndSyncNewChangeAddressesRBData) *DeriveAndSyncNewChangeAddressesRB {
	this := DeriveAndSyncNewChangeAddressesRB{}
	this.Data = data
	return &this
}
...
func (o *DeriveAndSyncNewChangeAddressesRB) GetData() DeriveAndSyncNewChangeAddressesRBData {
	if o == nil {
		var ret DeriveAndSyncNewChangeAddressesRBData
		return ret
	}
...
func (o DeriveAndSyncNewChangeAddressesRB) MarshalJSON() ([]byte, error) {
...
type NullableDeriveAndSyncNewChangeAddressesRB struct {
	value *DeriveAndSyncNewChangeAddressesRB
	isSet bool
}

func (v NullableDeriveAndSyncNewChangeAddressesRB) Get() *DeriveAndSyncNewChangeAddressesRB {
	return v.value
}

func (v *NullableDeriveAndSyncNewChangeAddressesRB) Set(val *DeriveAndSyncNewChangeAddressesRB) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewChangeAddressesRB) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewChangeAddressesRB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewChangeAddressesRB(val *DeriveAndSyncNewChangeAddressesRB) *NullableDeriveAndSyncNewChangeAddressesRB {
	return &NullableDeriveAndSyncNewChangeAddressesRB{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewChangeAddressesRB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewChangeAddressesRB) UnmarshalJSON(src []byte) error {
	v.isSet = true
