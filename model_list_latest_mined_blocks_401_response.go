...
type ListLatestMinedBlocks401Response struct {
...
func NewListLatestMinedBlocks401Response(apiVersion string, requestId string, error_ ListLatestMinedBlocksE401) *ListLatestMinedBlocks401Response {
	this := ListLatestMinedBlocks401Response{}
...
func (o ListLatestMinedBlocks401Response) MarshalJSON() ([]byte, error) {
...
type NullableListLatestMinedBlocks401Response struct {
	value *ListLatestMinedBlocks401Response
	isSet bool
}

func (v NullableListLatestMinedBlocks401Response) Get() *ListLatestMinedBlocks401Response {
	return v.value
}

func (v *NullableListLatestMinedBlocks401Response) Set(val *ListLatestMinedBlocks401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListLatestMinedBlocks401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListLatestMinedBlocks401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLatestMinedBlocks401Response(val *ListLatestMinedBlocks401Response) *NullableListLatestMinedBlocks401Response {
	return &NullableListLatestMinedBlocks401Response{value: val, isSet: true}
}

func (v NullableListLatestMinedBlocks401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLatestMinedBlocks401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
