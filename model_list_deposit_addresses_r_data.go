...
type ListDepositAddressesRData struct {
	...
	Items []ListDepositAddressesRI `json:"items"`
}
...
func NewListDepositAddressesRData(limit int32, offset int32, total int32, items []ListDepositAddressesRI) *ListDepositAddressesRData {
	this := ListDepositAddressesRData{}
	this.Limit = limit
	this.Offset = offset
	this.Total = total
	this.Items = items
...
func (o *ListDepositAddressesRData) GetItems() []ListDepositAddressesRI {
	if o == nil {
		var ret []ListDepositAddressesRI
		return ret
	}
...
func (o ListDepositAddressesRData) MarshalJSON() ([]byte, error) {
...
type NullableListDepositAddressesRData struct {
	value *ListDepositAddressesRData
	isSet bool
}

func (v NullableListDepositAddressesRData) Get() *ListDepositAddressesRData {
	return v.value
}

func (v *NullableListDepositAddressesRData) Set(val *ListDepositAddressesRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListDepositAddressesRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListDepositAddressesRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDepositAddressesRData(val *ListDepositAddressesRData) *NullableListDepositAddressesRData {
	return &NullableListDepositAddressesRData{value: val, isSet: true}
}

func (v NullableListDepositAddressesRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDepositAddressesRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
