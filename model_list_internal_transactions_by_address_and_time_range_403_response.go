...
type ListInternalTransactionsByAddressAndTimeRange403Response struct {
	...
	Error ListInternalTransactionsByAddressAndTimeRangeE403 `json:"error"`
}
...
func NewListInternalTransactionsByAddressAndTimeRange403Response(apiVersion string, requestId string, error_ ListInternalTransactionsByAddressAndTimeRangeE403) *ListInternalTransactionsByAddressAndTimeRange403Response {
	this := ListInternalTransactionsByAddressAndTimeRange403Response{}
...
func (o *ListInternalTransactionsByAddressAndTimeRange403Response) GetError() ListInternalTransactionsByAddressAndTimeRangeE403 {
	if o == nil {
		var ret ListInternalTransactionsByAddressAndTimeRangeE403
		return ret
	}
...
func (o ListInternalTransactionsByAddressAndTimeRange403Response) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionsByAddressAndTimeRange403Response struct {
	value *ListInternalTransactionsByAddressAndTimeRange403Response
	isSet bool
}

func (v NullableListInternalTransactionsByAddressAndTimeRange403Response) Get() *ListInternalTransactionsByAddressAndTimeRange403Response {
	return v.value
}

func (v *NullableListInternalTransactionsByAddressAndTimeRange403Response) Set(val *ListInternalTransactionsByAddressAndTimeRange403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddressAndTimeRange403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddressAndTimeRange403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddressAndTimeRange403Response(val *ListInternalTransactionsByAddressAndTimeRange403Response) *NullableListInternalTransactionsByAddressAndTimeRange403Response {
	return &NullableListInternalTransactionsByAddressAndTimeRange403Response{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddressAndTimeRange403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddressAndTimeRange403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
