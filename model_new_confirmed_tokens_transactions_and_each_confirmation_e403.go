...
type NewConfirmedTokensTransactionsAndEachConfirmationE403 struct {
...
func BannedIpAddressAsNewConfirmedTokensTransactionsAndEachConfirmationE403(v *BannedIpAddress) NewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return NewConfirmedTokensTransactionsAndEachConfirmationE403{ BannedIpAddress: v}
}
...
func BlockchainEventsCallbacksLimitReachedAsNewConfirmedTokensTransactionsAndEachConfirmationE403(v *BlockchainEventsCallbacksLimitReached) NewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return NewConfirmedTokensTransactionsAndEachConfirmationE403{ BlockchainEventsCallbacksLimitReached: v}
}
...
func EndpointNotAllowedForApiKeyAsNewConfirmedTokensTransactionsAndEachConfirmationE403(v *EndpointNotAllowedForApiKey) NewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return NewConfirmedTokensTransactionsAndEachConfirmationE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsNewConfirmedTokensTransactionsAndEachConfirmationE403(v *EndpointNotAllowedForPlan) NewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return NewConfirmedTokensTransactionsAndEachConfirmationE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsNewConfirmedTokensTransactionsAndEachConfirmationE403(v *FeatureMainnetsNotAllowedForPlan) NewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return NewConfirmedTokensTransactionsAndEachConfirmationE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *NewConfirmedTokensTransactionsAndEachConfirmationE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedTokensTransactionsAndEachConfirmationE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedTokensTransactionsAndEachConfirmationE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedTokensTransactionsAndEachConfirmationE403) MarshalJSON() ([]byte, error) {
...
func (obj *NewConfirmedTokensTransactionsAndEachConfirmationE403) GetActualInstance() (interface{}) {
...
type NullableNewConfirmedTokensTransactionsAndEachConfirmationE403 struct {
	value *NewConfirmedTokensTransactionsAndEachConfirmationE403
	isSet bool
}

func (v NullableNewConfirmedTokensTransactionsAndEachConfirmationE403) Get() *NewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return v.value
}

func (v *NullableNewConfirmedTokensTransactionsAndEachConfirmationE403) Set(val *NewConfirmedTokensTransactionsAndEachConfirmationE403) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokensTransactionsAndEachConfirmationE403) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokensTransactionsAndEachConfirmationE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokensTransactionsAndEachConfirmationE403(val *NewConfirmedTokensTransactionsAndEachConfirmationE403) *NullableNewConfirmedTokensTransactionsAndEachConfirmationE403 {
	return &NullableNewConfirmedTokensTransactionsAndEachConfirmationE403{value: val, isSet: true}
}

func (v NullableNewConfirmedTokensTransactionsAndEachConfirmationE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokensTransactionsAndEachConfirmationE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
