...
type ListAllAssetsByWalletID403Response struct {
	...
	Error ListAllAssetsByWalletIDE403 `json:"error"`
}
...
func NewListAllAssetsByWalletID403Response(apiVersion string, requestId string, error_ ListAllAssetsByWalletIDE403) *ListAllAssetsByWalletID403Response {
	this := ListAllAssetsByWalletID403Response{}
...
func (o *ListAllAssetsByWalletID403Response) GetError() ListAllAssetsByWalletIDE403 {
	if o == nil {
		var ret ListAllAssetsByWalletIDE403
		return ret
	}
...
func (o ListAllAssetsByWalletID403Response) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsByWalletID403Response struct {
	value *ListAllAssetsByWalletID403Response
	isSet bool
}

func (v NullableListAllAssetsByWalletID403Response) Get() *ListAllAssetsByWalletID403Response {
	return v.value
}

func (v *NullableListAllAssetsByWalletID403Response) Set(val *ListAllAssetsByWalletID403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsByWalletID403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsByWalletID403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsByWalletID403Response(val *ListAllAssetsByWalletID403Response) *NullableListAllAssetsByWalletID403Response {
	return &NullableListAllAssetsByWalletID403Response{value: val, isSet: true}
}

func (v NullableListAllAssetsByWalletID403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsByWalletID403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
