...
// GetHDWalletxPubYPubZPubDetailsResponse struct for GetHDWalletxPubYPubZPubDetailsResponse
type GetHDWalletxPubYPubZPubDetailsResponse struct {
	...
	Data GetHDWalletxPubYPubZPubDetailsResponseData `json:"data"`
}
...
func NewGetHDWalletxPubYPubZPubDetailsResponse(apiVersion string, requestId string, data GetHDWalletxPubYPubZPubDetailsResponseData) *GetHDWalletxPubYPubZPubDetailsResponse {
	this := GetHDWalletxPubYPubZPubDetailsResponse{}
...
func (o *GetHDWalletxPubYPubZPubDetailsResponse) GetData() GetHDWalletxPubYPubZPubDetailsResponseData {
	if o == nil {
		var ret GetHDWalletxPubYPubZPubDetailsResponseData
		return ret
	}
...
func (o GetHDWalletxPubYPubZPubDetailsResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetHDWalletxPubYPubZPubDetailsResponse struct {
	value *GetHDWalletxPubYPubZPubDetailsResponse
	isSet bool
}

func (v NullableGetHDWalletxPubYPubZPubDetailsResponse) Get() *GetHDWalletxPubYPubZPubDetailsResponse {
	return v.value
}

func (v *NullableGetHDWalletxPubYPubZPubDetailsResponse) Set(val *GetHDWalletxPubYPubZPubDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletxPubYPubZPubDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletxPubYPubZPubDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletxPubYPubZPubDetailsResponse(val *GetHDWalletxPubYPubZPubDetailsResponse) *NullableGetHDWalletxPubYPubZPubDetailsResponse {
	return &NullableGetHDWalletxPubYPubZPubDetailsResponse{value: val, isSet: true}
}

func (v NullableGetHDWalletxPubYPubZPubDetailsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletxPubYPubZPubDetailsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
