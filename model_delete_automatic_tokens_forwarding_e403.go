...
type DeleteAutomaticTokensForwardingE403 struct {
...
func BannedIpAddressAsDeleteAutomaticTokensForwardingE403(v *BannedIpAddress) DeleteAutomaticTokensForwardingE403 {
	return DeleteAutomaticTokensForwardingE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsDeleteAutomaticTokensForwardingE403(v *EndpointNotAllowedForApiKey) DeleteAutomaticTokensForwardingE403 {
	return DeleteAutomaticTokensForwardingE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsDeleteAutomaticTokensForwardingE403(v *EndpointNotAllowedForPlan) DeleteAutomaticTokensForwardingE403 {
	return DeleteAutomaticTokensForwardingE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsDeleteAutomaticTokensForwardingE403(v *FeatureMainnetsNotAllowedForPlan) DeleteAutomaticTokensForwardingE403 {
	return DeleteAutomaticTokensForwardingE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *DeleteAutomaticTokensForwardingE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DeleteAutomaticTokensForwardingE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DeleteAutomaticTokensForwardingE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DeleteAutomaticTokensForwardingE403) MarshalJSON() ([]byte, error) {
...
func (obj *DeleteAutomaticTokensForwardingE403) GetActualInstance() (interface{}) {
...
type NullableDeleteAutomaticTokensForwardingE403 struct {
	value *DeleteAutomaticTokensForwardingE403
	isSet bool
}

func (v NullableDeleteAutomaticTokensForwardingE403) Get() *DeleteAutomaticTokensForwardingE403 {
	return v.value
}

func (v *NullableDeleteAutomaticTokensForwardingE403) Set(val *DeleteAutomaticTokensForwardingE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticTokensForwardingE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticTokensForwardingE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticTokensForwardingE403(val *DeleteAutomaticTokensForwardingE403) *NullableDeleteAutomaticTokensForwardingE403 {
	return &NullableDeleteAutomaticTokensForwardingE403{value: val, isSet: true}
}

func (v NullableDeleteAutomaticTokensForwardingE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticTokensForwardingE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
