...
type NewConfirmedCoinsTransactionsForSpecificAmount409Response struct {
	...
	Error NewConfirmedCoinsTransactionsForSpecificAmountE409 `json:"error"`
}
...
func NewNewConfirmedCoinsTransactionsForSpecificAmount409Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsForSpecificAmountE409) *NewConfirmedCoinsTransactionsForSpecificAmount409Response {
	this := NewConfirmedCoinsTransactionsForSpecificAmount409Response{}
...
func (o *NewConfirmedCoinsTransactionsForSpecificAmount409Response) GetError() NewConfirmedCoinsTransactionsForSpecificAmountE409 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsForSpecificAmountE409
		return ret
	}
...
func (o NewConfirmedCoinsTransactionsForSpecificAmount409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response struct {
	value *NewConfirmedCoinsTransactionsForSpecificAmount409Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response) Get() *NewConfirmedCoinsTransactionsForSpecificAmount409Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response) Set(val *NewConfirmedCoinsTransactionsForSpecificAmount409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsForSpecificAmount409Response(val *NewConfirmedCoinsTransactionsForSpecificAmount409Response) *NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response {
	return &NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmount409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
