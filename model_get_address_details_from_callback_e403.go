...
type GetAddressDetailsFromCallbackE403 struct {
...
func BannedIpAddressAsGetAddressDetailsFromCallbackE403(v *BannedIpAddress) GetAddressDetailsFromCallbackE403 {
	return GetAddressDetailsFromCallbackE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetAddressDetailsFromCallbackE403(v *EndpointNotAllowedForApiKey) GetAddressDetailsFromCallbackE403 {
	return GetAddressDetailsFromCallbackE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetAddressDetailsFromCallbackE403(v *EndpointNotAllowedForPlan) GetAddressDetailsFromCallbackE403 {
	return GetAddressDetailsFromCallbackE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetAddressDetailsFromCallbackE403(v *FeatureMainnetsNotAllowedForPlan) GetAddressDetailsFromCallbackE403 {
	return GetAddressDetailsFromCallbackE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetAddressDetailsFromCallbackE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetAddressDetailsFromCallbackE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetAddressDetailsFromCallbackE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetAddressDetailsFromCallbackE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetAddressDetailsFromCallbackE403) GetActualInstance() (interface{}) {
...
type NullableGetAddressDetailsFromCallbackE403 struct {
	value *GetAddressDetailsFromCallbackE403
	isSet bool
}

func (v NullableGetAddressDetailsFromCallbackE403) Get() *GetAddressDetailsFromCallbackE403 {
	return v.value
}

func (v *NullableGetAddressDetailsFromCallbackE403) Set(val *GetAddressDetailsFromCallbackE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsFromCallbackE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsFromCallbackE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsFromCallbackE403(val *GetAddressDetailsFromCallbackE403) *NullableGetAddressDetailsFromCallbackE403 {
	return &NullableGetAddressDetailsFromCallbackE403{value: val, isSet: true}
}

func (v NullableGetAddressDetailsFromCallbackE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsFromCallbackE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
