...
type ListXRPRippleTransactionsByBlockHeightRData struct {
	...
	Items []ListXRPRippleTransactionsByBlockHeightRI `json:"items"`
}
...
func NewListXRPRippleTransactionsByBlockHeightRData(offset int32, limit int32, total int32, items []ListXRPRippleTransactionsByBlockHeightRI) *ListXRPRippleTransactionsByBlockHeightRData {
	this := ListXRPRippleTransactionsByBlockHeightRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListXRPRippleTransactionsByBlockHeightRData) GetItems() []ListXRPRippleTransactionsByBlockHeightRI {
	if o == nil {
		var ret []ListXRPRippleTransactionsByBlockHeightRI
		return ret
	}
...
func (o ListXRPRippleTransactionsByBlockHeightRData) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHeightRData struct {
	value *ListXRPRippleTransactionsByBlockHeightRData
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHeightRData) Get() *ListXRPRippleTransactionsByBlockHeightRData {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHeightRData) Set(val *ListXRPRippleTransactionsByBlockHeightRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHeightRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHeightRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHeightRData(val *ListXRPRippleTransactionsByBlockHeightRData) *NullableListXRPRippleTransactionsByBlockHeightRData {
	return &NullableListXRPRippleTransactionsByBlockHeightRData{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHeightRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHeightRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
