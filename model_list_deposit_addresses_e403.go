...
type ListDepositAddressesE403 struct {
...
func BannedIpAddressAsListDepositAddressesE403(v *BannedIpAddress) ListDepositAddressesE403 {
	return ListDepositAddressesE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListDepositAddressesE403(v *EndpointNotAllowedForApiKey) ListDepositAddressesE403 {
	return ListDepositAddressesE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListDepositAddressesE403(v *EndpointNotAllowedForPlan) ListDepositAddressesE403 {
	return ListDepositAddressesE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListDepositAddressesE403(v *FeatureMainnetsNotAllowedForPlan) ListDepositAddressesE403 {
	return ListDepositAddressesE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListDepositAddressesE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListDepositAddressesE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListDepositAddressesE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListDepositAddressesE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListDepositAddressesE403) GetActualInstance() (interface{}) {
...
type NullableListDepositAddressesE403 struct {
	value *ListDepositAddressesE403
	isSet bool
}

func (v NullableListDepositAddressesE403) Get() *ListDepositAddressesE403 {
	return v.value
}

func (v *NullableListDepositAddressesE403) Set(val *ListDepositAddressesE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListDepositAddressesE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListDepositAddressesE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDepositAddressesE403(val *ListDepositAddressesE403) *NullableListDepositAddressesE403 {
	return &NullableListDepositAddressesE403{value: val, isSet: true}
}

func (v NullableListDepositAddressesE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDepositAddressesE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
