...
type BroadcastLocallySignedTransaction409Response struct {
	...
	Error BroadcastLocallySignedTransactionE409 `json:"error"`
}
...
func NewBroadcastLocallySignedTransaction409Response(apiVersion string, requestId string, error_ BroadcastLocallySignedTransactionE409) *BroadcastLocallySignedTransaction409Response {
	this := BroadcastLocallySignedTransaction409Response{}
...
func (o *BroadcastLocallySignedTransaction409Response) GetError() BroadcastLocallySignedTransactionE409 {
	if o == nil {
		var ret BroadcastLocallySignedTransactionE409
		return ret
	}
...
func (o BroadcastLocallySignedTransaction409Response) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastLocallySignedTransaction409Response struct {
	value *BroadcastLocallySignedTransaction409Response
	isSet bool
}

func (v NullableBroadcastLocallySignedTransaction409Response) Get() *BroadcastLocallySignedTransaction409Response {
	return v.value
}

func (v *NullableBroadcastLocallySignedTransaction409Response) Set(val *BroadcastLocallySignedTransaction409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastLocallySignedTransaction409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastLocallySignedTransaction409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastLocallySignedTransaction409Response(val *BroadcastLocallySignedTransaction409Response) *NullableBroadcastLocallySignedTransaction409Response {
	return &NullableBroadcastLocallySignedTransaction409Response{value: val, isSet: true}
}

func (v NullableBroadcastLocallySignedTransaction409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastLocallySignedTransaction409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
