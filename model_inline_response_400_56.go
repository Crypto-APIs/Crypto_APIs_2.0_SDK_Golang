...
// InlineResponse40056 struct for InlineResponse40056
type InlineResponse40056 struct {
...
func (o InlineResponse40056) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse40056 struct {
	value *InlineResponse40056
	isSet bool
}

func (v NullableInlineResponse40056) Get() *InlineResponse40056 {
	return v.value
}

func (v *NullableInlineResponse40056) Set(val *InlineResponse40056) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse40056) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse40056) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse40056(val *InlineResponse40056) *NullableInlineResponse40056 {
	return &NullableInlineResponse40056{value: val, isSet: true}
}

func (v NullableInlineResponse40056) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse40056) UnmarshalJSON(src []byte) error {
	v.isSet = true
