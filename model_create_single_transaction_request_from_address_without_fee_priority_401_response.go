...
type CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response struct {
	...
	Error CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 `json:"error"`
}
...
func NewCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response(apiVersion string, requestId string, error_ CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401) *CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response {
	this := CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response{}
...
func (o *CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) GetError() CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401 {
	if o == nil {
		var ret CreateSingleTransactionRequestFromAddressWithoutFeePriorityE401
		return ret
	}
...
func (o CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response struct {
	value *CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response
	isSet bool
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) Get() *CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response {
	return v.value
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) Set(val *CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response(val *CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response {
	return &NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response{value: val, isSet: true}
}

func (v NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSingleTransactionRequestFromAddressWithoutFeePriority401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
