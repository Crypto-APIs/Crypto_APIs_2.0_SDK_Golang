...
type ListHDWalletXPubYPubZPubTransactionsRData struct {
	...
	Items []ListHDWalletXPubYPubZPubTransactionsRI `json:"items"`
}
...
func NewListHDWalletXPubYPubZPubTransactionsRData(offset int32, limit int32, total int32, items []ListHDWalletXPubYPubZPubTransactionsRI) *ListHDWalletXPubYPubZPubTransactionsRData {
	this := ListHDWalletXPubYPubZPubTransactionsRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListHDWalletXPubYPubZPubTransactionsRData) GetItems() []ListHDWalletXPubYPubZPubTransactionsRI {
	if o == nil {
		var ret []ListHDWalletXPubYPubZPubTransactionsRI
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubTransactionsRData) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactionsRData struct {
	value *ListHDWalletXPubYPubZPubTransactionsRData
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactionsRData) Get() *ListHDWalletXPubYPubZPubTransactionsRData {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsRData) Set(val *ListHDWalletXPubYPubZPubTransactionsRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactionsRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactionsRData(val *ListHDWalletXPubYPubZPubTransactionsRData) *NullableListHDWalletXPubYPubZPubTransactionsRData {
	return &NullableListHDWalletXPubYPubZPubTransactionsRData{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactionsRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactionsRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
