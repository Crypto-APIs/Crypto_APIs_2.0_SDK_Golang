...
type AddressTokensTransactionUnconfirmedData struct {
	// Represents the Crypto APIs 2.0 product which sends the callback.
	Product string `json:"product"`
	// Defines the specific event, for which a callback subscription is set.
	Event string `json:"event"`
	Item AddressTokensTransactionUnconfirmedDataItem `json:"item"`
}
...
func NewAddressTokensTransactionUnconfirmedData(product string, event string, item AddressTokensTransactionUnconfirmedDataItem) *AddressTokensTransactionUnconfirmedData {
	this := AddressTokensTransactionUnconfirmedData{}
...
func (o *AddressTokensTransactionUnconfirmedData) GetItem() AddressTokensTransactionUnconfirmedDataItem {
	if o == nil {
		var ret AddressTokensTransactionUnconfirmedDataItem
		return ret
	}
...
func (o AddressTokensTransactionUnconfirmedData) MarshalJSON() ([]byte, error) {
...
type NullableAddressTokensTransactionUnconfirmedData struct {
	value *AddressTokensTransactionUnconfirmedData
	isSet bool
}

func (v NullableAddressTokensTransactionUnconfirmedData) Get() *AddressTokensTransactionUnconfirmedData {
	return v.value
}

func (v *NullableAddressTokensTransactionUnconfirmedData) Set(val *AddressTokensTransactionUnconfirmedData) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressTokensTransactionUnconfirmedData) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressTokensTransactionUnconfirmedData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressTokensTransactionUnconfirmedData(val *AddressTokensTransactionUnconfirmedData) *NullableAddressTokensTransactionUnconfirmedData {
	return &NullableAddressTokensTransactionUnconfirmedData{value: val, isSet: true}
}

func (v NullableAddressTokensTransactionUnconfirmedData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressTokensTransactionUnconfirmedData) UnmarshalJSON(src []byte) error {
	v.isSet = true
