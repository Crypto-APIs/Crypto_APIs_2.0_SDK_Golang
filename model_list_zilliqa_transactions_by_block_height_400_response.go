...
type ListZilliqaTransactionsByBlockHeight400Response struct {
...
func NewListZilliqaTransactionsByBlockHeight400Response(apiVersion string, requestId string, error_ ListZilliqaTransactionsByBlockHeightE400) *ListZilliqaTransactionsByBlockHeight400Response {
	this := ListZilliqaTransactionsByBlockHeight400Response{}
...
func (o ListZilliqaTransactionsByBlockHeight400Response) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByBlockHeight400Response struct {
	value *ListZilliqaTransactionsByBlockHeight400Response
	isSet bool
}

func (v NullableListZilliqaTransactionsByBlockHeight400Response) Get() *ListZilliqaTransactionsByBlockHeight400Response {
	return v.value
}

func (v *NullableListZilliqaTransactionsByBlockHeight400Response) Set(val *ListZilliqaTransactionsByBlockHeight400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByBlockHeight400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByBlockHeight400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByBlockHeight400Response(val *ListZilliqaTransactionsByBlockHeight400Response) *NullableListZilliqaTransactionsByBlockHeight400Response {
	return &NullableListZilliqaTransactionsByBlockHeight400Response{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByBlockHeight400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByBlockHeight400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
