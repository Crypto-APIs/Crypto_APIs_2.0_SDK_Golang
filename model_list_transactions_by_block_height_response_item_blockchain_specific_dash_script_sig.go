...
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig struct {
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig(asm string, hex string, type_ string) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
