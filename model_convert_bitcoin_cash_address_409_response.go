...
type ConvertBitcoinCashAddress409Response struct {
...
func NewConvertBitcoinCashAddress409Response(apiVersion string, requestId string, error_ InvalidData) *ConvertBitcoinCashAddress409Response {
	this := ConvertBitcoinCashAddress409Response{}
...
func (o ConvertBitcoinCashAddress409Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress409Response struct {
	value *ConvertBitcoinCashAddress409Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress409Response) Get() *ConvertBitcoinCashAddress409Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress409Response) Set(val *ConvertBitcoinCashAddress409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress409Response(val *ConvertBitcoinCashAddress409Response) *NullableConvertBitcoinCashAddress409Response {
	return &NullableConvertBitcoinCashAddress409Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
