...
type ListTransactionsByBlockHeightE403 struct {
...
func BannedIpAddressAsListTransactionsByBlockHeightE403(v *BannedIpAddress) ListTransactionsByBlockHeightE403 {
	return ListTransactionsByBlockHeightE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListTransactionsByBlockHeightE403(v *EndpointNotAllowedForApiKey) ListTransactionsByBlockHeightE403 {
	return ListTransactionsByBlockHeightE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListTransactionsByBlockHeightE403(v *EndpointNotAllowedForPlan) ListTransactionsByBlockHeightE403 {
	return ListTransactionsByBlockHeightE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListTransactionsByBlockHeightE403(v *FeatureMainnetsNotAllowedForPlan) ListTransactionsByBlockHeightE403 {
	return ListTransactionsByBlockHeightE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListTransactionsByBlockHeightE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListTransactionsByBlockHeightE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListTransactionsByBlockHeightE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListTransactionsByBlockHeightE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListTransactionsByBlockHeightE403) GetActualInstance() (interface{}) {
...
type NullableListTransactionsByBlockHeightE403 struct {
	value *ListTransactionsByBlockHeightE403
	isSet bool
}

func (v NullableListTransactionsByBlockHeightE403) Get() *ListTransactionsByBlockHeightE403 {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightE403) Set(val *ListTransactionsByBlockHeightE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightE403(val *ListTransactionsByBlockHeightE403) *NullableListTransactionsByBlockHeightE403 {
	return &NullableListTransactionsByBlockHeightE403{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
