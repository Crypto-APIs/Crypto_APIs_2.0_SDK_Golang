...
type GetZilliqaAddressDetailsR struct {
	...
	Data GetZilliqaAddressDetailsRData `json:"data"`
}
...
func NewGetZilliqaAddressDetailsR(apiVersion string, requestId string, data GetZilliqaAddressDetailsRData) *GetZilliqaAddressDetailsR {
	this := GetZilliqaAddressDetailsR{}
...
func (o *GetZilliqaAddressDetailsR) GetData() GetZilliqaAddressDetailsRData {
	if o == nil {
		var ret GetZilliqaAddressDetailsRData
		return ret
	}
...
func (o GetZilliqaAddressDetailsR) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaAddressDetailsR struct {
	value *GetZilliqaAddressDetailsR
	isSet bool
}

func (v NullableGetZilliqaAddressDetailsR) Get() *GetZilliqaAddressDetailsR {
	return v.value
}

func (v *NullableGetZilliqaAddressDetailsR) Set(val *GetZilliqaAddressDetailsR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaAddressDetailsR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaAddressDetailsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaAddressDetailsR(val *GetZilliqaAddressDetailsR) *NullableGetZilliqaAddressDetailsR {
	return &NullableGetZilliqaAddressDetailsR{value: val, isSet: true}
}

func (v NullableGetZilliqaAddressDetailsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaAddressDetailsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
