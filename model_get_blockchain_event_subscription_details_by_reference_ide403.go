...
type GetBlockchainEventSubscriptionDetailsByReferenceIDE403 struct {
...
func BannedIpAddressAsGetBlockchainEventSubscriptionDetailsByReferenceIDE403(v *BannedIpAddress) GetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
...
func EndpointNotAllowedForApiKeyAsGetBlockchainEventSubscriptionDetailsByReferenceIDE403(v *EndpointNotAllowedForApiKey) GetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
	return GetBlockchainEventSubscriptionDetailsByReferenceIDE403{
...
func EndpointNotAllowedForPlanAsGetBlockchainEventSubscriptionDetailsByReferenceIDE403(v *EndpointNotAllowedForPlan) GetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
	return GetBlockchainEventSubscriptionDetailsByReferenceIDE403{
...
func FeatureMainnetsNotAllowedForPlanAsGetBlockchainEventSubscriptionDetailsByReferenceIDE403(v *FeatureMainnetsNotAllowedForPlan) GetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
	return GetBlockchainEventSubscriptionDetailsByReferenceIDE403{
...
func (dst *GetBlockchainEventSubscriptionDetailsByReferenceIDE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetBlockchainEventSubscriptionDetailsByReferenceIDE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetBlockchainEventSubscriptionDetailsByReferenceIDE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetBlockchainEventSubscriptionDetailsByReferenceIDE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetBlockchainEventSubscriptionDetailsByReferenceIDE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403 struct {
	value *GetBlockchainEventSubscriptionDetailsByReferenceIDE403
	isSet bool
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403) Get() *GetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
	return v.value
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403) Set(val *GetBlockchainEventSubscriptionDetailsByReferenceIDE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403(val *GetBlockchainEventSubscriptionDetailsByReferenceIDE403) *NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
	return &NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403{value: val, isSet: true}
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceIDE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
