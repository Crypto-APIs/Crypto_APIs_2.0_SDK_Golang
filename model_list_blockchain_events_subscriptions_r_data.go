...
type ListBlockchainEventsSubscriptionsRData struct {
	...
	Items []ListBlockchainEventsSubscriptionsRI `json:"items"`
}
...
func NewListBlockchainEventsSubscriptionsRData(offset int32, limit int32, total int32, items []ListBlockchainEventsSubscriptionsRI) *ListBlockchainEventsSubscriptionsRData {
	this := ListBlockchainEventsSubscriptionsRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListBlockchainEventsSubscriptionsRData) GetItems() []ListBlockchainEventsSubscriptionsRI {
	if o == nil {
		var ret []ListBlockchainEventsSubscriptionsRI
		return ret
	}
...
func (o ListBlockchainEventsSubscriptionsRData) MarshalJSON() ([]byte, error) {
...
type NullableListBlockchainEventsSubscriptionsRData struct {
	value *ListBlockchainEventsSubscriptionsRData
	isSet bool
}

func (v NullableListBlockchainEventsSubscriptionsRData) Get() *ListBlockchainEventsSubscriptionsRData {
	return v.value
}

func (v *NullableListBlockchainEventsSubscriptionsRData) Set(val *ListBlockchainEventsSubscriptionsRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListBlockchainEventsSubscriptionsRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListBlockchainEventsSubscriptionsRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListBlockchainEventsSubscriptionsRData(val *ListBlockchainEventsSubscriptionsRData) *NullableListBlockchainEventsSubscriptionsRData {
	return &NullableListBlockchainEventsSubscriptionsRData{value: val, isSet: true}
}

func (v NullableListBlockchainEventsSubscriptionsRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListBlockchainEventsSubscriptionsRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
