...
type DecodeRawTransactionHex403Response struct {
...
func NewDecodeRawTransactionHex403Response(apiVersion string, requestId string, error_ DecodeRawTransactionHexE403) *DecodeRawTransactionHex403Response {
	this := DecodeRawTransactionHex403Response{}
...
func (o DecodeRawTransactionHex403Response) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHex403Response struct {
	value *DecodeRawTransactionHex403Response
	isSet bool
}

func (v NullableDecodeRawTransactionHex403Response) Get() *DecodeRawTransactionHex403Response {
	return v.value
}

func (v *NullableDecodeRawTransactionHex403Response) Set(val *DecodeRawTransactionHex403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHex403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHex403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHex403Response(val *DecodeRawTransactionHex403Response) *NullableDecodeRawTransactionHex403Response {
	return &NullableDecodeRawTransactionHex403Response{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHex403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHex403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
