...
type EncodeXAddressE401 struct {
...
func InvalidApiKeyAsEncodeXAddressE401(v *InvalidApiKey) EncodeXAddressE401 {
...
func (dst *EncodeXAddressE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(EncodeXAddressE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(EncodeXAddressE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src EncodeXAddressE401) MarshalJSON() ([]byte, error) {
...
func (obj *EncodeXAddressE401) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableEncodeXAddressE401 struct {
	value *EncodeXAddressE401
	isSet bool
}

func (v NullableEncodeXAddressE401) Get() *EncodeXAddressE401 {
	return v.value
}

func (v *NullableEncodeXAddressE401) Set(val *EncodeXAddressE401) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeXAddressE401) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeXAddressE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeXAddressE401(val *EncodeXAddressE401) *NullableEncodeXAddressE401 {
	return &NullableEncodeXAddressE401{value: val, isSet: true}
}

func (v NullableEncodeXAddressE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeXAddressE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
