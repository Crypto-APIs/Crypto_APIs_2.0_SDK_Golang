...
func NewListTransactionsByBlockHashRIFee(amount string, unit string) *ListTransactionsByBlockHashRIFee {
	this := ListTransactionsByBlockHashRIFee{}
	this.Amount = amount
	this.Unit = unit
	return &this
}
...
func (o ListTransactionsByBlockHashRIFee) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIFee struct {
	value *ListTransactionsByBlockHashRIFee
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIFee) Get() *ListTransactionsByBlockHashRIFee {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIFee) Set(val *ListTransactionsByBlockHashRIFee) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIFee) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIFee) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIFee(val *ListTransactionsByBlockHashRIFee) *NullableListTransactionsByBlockHashRIFee {
	return &NullableListTransactionsByBlockHashRIFee{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIFee) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIFee) UnmarshalJSON(src []byte) error {
	v.isSet = true
