...
// WalletAsAServiceWalletBalanceNotEnoughError struct for WalletAsAServiceWalletBalanceNotEnoughError
type WalletAsAServiceWalletBalanceNotEnoughError struct {
...
func NewWalletAsAServiceWalletBalanceNotEnoughError(code string, message string) *WalletAsAServiceWalletBalanceNotEnoughError {
	this := WalletAsAServiceWalletBalanceNotEnoughError{}
	this.Code = code
...
func (o WalletAsAServiceWalletBalanceNotEnoughError) MarshalJSON() ([]byte, error) {
...
type NullableWalletAsAServiceWalletBalanceNotEnoughError struct {
	value *WalletAsAServiceWalletBalanceNotEnoughError
	isSet bool
}

func (v NullableWalletAsAServiceWalletBalanceNotEnoughError) Get() *WalletAsAServiceWalletBalanceNotEnoughError {
	return v.value
}

func (v *NullableWalletAsAServiceWalletBalanceNotEnoughError) Set(val *WalletAsAServiceWalletBalanceNotEnoughError) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletAsAServiceWalletBalanceNotEnoughError) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletAsAServiceWalletBalanceNotEnoughError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletAsAServiceWalletBalanceNotEnoughError(val *WalletAsAServiceWalletBalanceNotEnoughError) *NullableWalletAsAServiceWalletBalanceNotEnoughError {
	return &NullableWalletAsAServiceWalletBalanceNotEnoughError{value: val, isSet: true}
}

func (v NullableWalletAsAServiceWalletBalanceNotEnoughError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletAsAServiceWalletBalanceNotEnoughError) UnmarshalJSON(src []byte) error {
	v.isSet = true
