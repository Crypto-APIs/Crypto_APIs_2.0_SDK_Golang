...
type GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey {
	this := GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey{}
...
func (o GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey struct {
	value *GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) Get() *GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) Set(val *GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey(val *GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) *NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey {
	return &NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
