...
// GetAddressDetails409Response struct for GetAddressDetails409Response
type GetAddressDetails409Response struct {
...
func NewGetAddressDetails409Response(apiVersion string, requestId string, error_ InvalidData) *GetAddressDetails409Response {
	this := GetAddressDetails409Response{}
...
func (o GetAddressDetails409Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetails409Response struct {
	value *GetAddressDetails409Response
	isSet bool
}

func (v NullableGetAddressDetails409Response) Get() *GetAddressDetails409Response {
	return v.value
}

func (v *NullableGetAddressDetails409Response) Set(val *GetAddressDetails409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetails409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetails409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetails409Response(val *GetAddressDetails409Response) *NullableGetAddressDetails409Response {
	return &NullableGetAddressDetails409Response{value: val, isSet: true}
}

func (v NullableGetAddressDetails409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetails409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
