...
type GetFeeAddressDetails401Response struct {
	...
	Error GetFeeAddressDetailsE401 `json:"error"`
}
...
func NewGetFeeAddressDetails401Response(apiVersion string, requestId string, error_ GetFeeAddressDetailsE401) *GetFeeAddressDetails401Response {
	this := GetFeeAddressDetails401Response{}
...
func (o *GetFeeAddressDetails401Response) GetError() GetFeeAddressDetailsE401 {
	if o == nil {
		var ret GetFeeAddressDetailsE401
		return ret
	}
...
func (o GetFeeAddressDetails401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetFeeAddressDetails401Response struct {
	value *GetFeeAddressDetails401Response
	isSet bool
}

func (v NullableGetFeeAddressDetails401Response) Get() *GetFeeAddressDetails401Response {
	return v.value
}

func (v *NullableGetFeeAddressDetails401Response) Set(val *GetFeeAddressDetails401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeAddressDetails401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeAddressDetails401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeAddressDetails401Response(val *GetFeeAddressDetails401Response) *NullableGetFeeAddressDetails401Response {
	return &NullableGetFeeAddressDetails401Response{value: val, isSet: true}
}

func (v NullableGetFeeAddressDetails401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeAddressDetails401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
