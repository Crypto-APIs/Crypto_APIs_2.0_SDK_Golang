...
type SyncHDWalletXPubYPubZPub403Response struct {
	...
	Error SyncHDWalletXPubYPubZPubE403 `json:"error"`
}
...
func NewSyncHDWalletXPubYPubZPub403Response(apiVersion string, requestId string, error_ SyncHDWalletXPubYPubZPubE403) *SyncHDWalletXPubYPubZPub403Response {
	this := SyncHDWalletXPubYPubZPub403Response{}
...
func (o *SyncHDWalletXPubYPubZPub403Response) GetError() SyncHDWalletXPubYPubZPubE403 {
	if o == nil {
		var ret SyncHDWalletXPubYPubZPubE403
		return ret
	}
...
func (o SyncHDWalletXPubYPubZPub403Response) MarshalJSON() ([]byte, error) {
...
type NullableSyncHDWalletXPubYPubZPub403Response struct {
	value *SyncHDWalletXPubYPubZPub403Response
	isSet bool
}

func (v NullableSyncHDWalletXPubYPubZPub403Response) Get() *SyncHDWalletXPubYPubZPub403Response {
	return v.value
}

func (v *NullableSyncHDWalletXPubYPubZPub403Response) Set(val *SyncHDWalletXPubYPubZPub403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncHDWalletXPubYPubZPub403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncHDWalletXPubYPubZPub403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncHDWalletXPubYPubZPub403Response(val *SyncHDWalletXPubYPubZPub403Response) *NullableSyncHDWalletXPubYPubZPub403Response {
	return &NullableSyncHDWalletXPubYPubZPub403Response{value: val, isSet: true}
}

func (v NullableSyncHDWalletXPubYPubZPub403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncHDWalletXPubYPubZPub403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
