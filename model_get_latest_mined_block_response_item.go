...
// GetLatestMinedBlockResponseItem struct for GetLatestMinedBlockResponseItem
type GetLatestMinedBlockResponseItem struct {
	...
	BlockchainSpecific GetLatestMinedBlockResponseItemBlockchainSpecific `json:"blockchainSpecific"`
}
...
func NewGetLatestMinedBlockResponseItem(hash string, height int32, previousBlockHash string, timestamp int32, transactionsCount int32, blockchainSpecific GetLatestMinedBlockResponseItemBlockchainSpecific) *GetLatestMinedBlockResponseItem {
	this := GetLatestMinedBlockResponseItem{}
	this.Hash = hash
	this.Height = height
...
func (o *GetLatestMinedBlockResponseItem) GetBlockchainSpecific() GetLatestMinedBlockResponseItemBlockchainSpecific {
	if o == nil {
		var ret GetLatestMinedBlockResponseItemBlockchainSpecific
		return ret
	}
...
func (o GetLatestMinedBlockResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItem struct {
	value *GetLatestMinedBlockResponseItem
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItem) Get() *GetLatestMinedBlockResponseItem {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItem) Set(val *GetLatestMinedBlockResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItem(val *GetLatestMinedBlockResponseItem) *NullableGetLatestMinedBlockResponseItem {
	return &NullableGetLatestMinedBlockResponseItem{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
