...
// ValidatingApiService ValidatingApi service
type ValidatingApiService service

type ApiValidateAddressRequest struct {
	ctx _context.Context
	ApiService *ValidatingApiService
	blockchain string
	network string
	context *string
 ...
 */
func (a *ValidatingApiService) ValidateAddress(ctx _context.Context, blockchain string, network string) ApiValidateAddressRequest {
	return ApiValidateAddressRequest{
		ApiService: a,
		ctx: ctx,
