...
// NewConfirmedCoinsTransactionsResponseItem struct for NewConfirmedCoinsTransactionsResponseItem
type NewConfirmedCoinsTransactionsResponseItem struct {
...
func NewNewConfirmedCoinsTransactionsResponseItem(address string, callbackSecretKey string, callbackUrl string, confirmationsCount int32, createdTimestamp int32, eventType string, isActive bool, referenceId string, transactionId string) *NewConfirmedCoinsTransactionsResponseItem {
	this := NewConfirmedCoinsTransactionsResponseItem{}
...
func (o NewConfirmedCoinsTransactionsResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsResponseItem struct {
	value *NewConfirmedCoinsTransactionsResponseItem
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsResponseItem) Get() *NewConfirmedCoinsTransactionsResponseItem {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsResponseItem) Set(val *NewConfirmedCoinsTransactionsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsResponseItem(val *NewConfirmedCoinsTransactionsResponseItem) *NullableNewConfirmedCoinsTransactionsResponseItem {
	return &NullableNewConfirmedCoinsTransactionsResponseItem{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
