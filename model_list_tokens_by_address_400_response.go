...
type ListTokensByAddress400Response struct {
	...
	Error ListTokensByAddressE400 `json:"error"`
}
...
func NewListTokensByAddress400Response(apiVersion string, requestId string, error_ ListTokensByAddressE400) *ListTokensByAddress400Response {
	this := ListTokensByAddress400Response{}
...
func (o *ListTokensByAddress400Response) GetError() ListTokensByAddressE400 {
	if o == nil {
		var ret ListTokensByAddressE400
		return ret
	}
...
func (o ListTokensByAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableListTokensByAddress400Response struct {
	value *ListTokensByAddress400Response
	isSet bool
}

func (v NullableListTokensByAddress400Response) Get() *ListTokensByAddress400Response {
	return v.value
}

func (v *NullableListTokensByAddress400Response) Set(val *ListTokensByAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensByAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensByAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensByAddress400Response(val *ListTokensByAddress400Response) *NullableListTokensByAddress400Response {
	return &NullableListTokensByAddress400Response{value: val, isSet: true}
}

func (v NullableListTokensByAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensByAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
