...
// GetAddressDetails429Response struct for GetAddressDetails429Response
type GetAddressDetails429Response struct {
...
func NewGetAddressDetails429Response(apiVersion string, requestId string, error_ RequestLimitReached) *GetAddressDetails429Response {
	this := GetAddressDetails429Response{}
...
func (o GetAddressDetails429Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetails429Response struct {
	value *GetAddressDetails429Response
	isSet bool
}

func (v NullableGetAddressDetails429Response) Get() *GetAddressDetails429Response {
	return v.value
}

func (v *NullableGetAddressDetails429Response) Set(val *GetAddressDetails429Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetails429Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetails429Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetails429Response(val *GetAddressDetails429Response) *NullableGetAddressDetails429Response {
	return &NullableGetAddressDetails429Response{value: val, isSet: true}
}

func (v NullableGetAddressDetails429Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetails429Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
