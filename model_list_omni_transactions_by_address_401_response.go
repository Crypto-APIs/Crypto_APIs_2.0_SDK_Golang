...
// ListOmniTransactionsByAddress401Response struct for ListOmniTransactionsByAddress401Response
type ListOmniTransactionsByAddress401Response struct {
...
func NewListOmniTransactionsByAddress401Response(apiVersion string, requestId string, error_ ListOmniTransactionsByAddressE401) *ListOmniTransactionsByAddress401Response {
	this := ListOmniTransactionsByAddress401Response{}
...
func (o ListOmniTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByAddress401Response struct {
	value *ListOmniTransactionsByAddress401Response
	isSet bool
}

func (v NullableListOmniTransactionsByAddress401Response) Get() *ListOmniTransactionsByAddress401Response {
	return v.value
}

func (v *NullableListOmniTransactionsByAddress401Response) Set(val *ListOmniTransactionsByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByAddress401Response(val *ListOmniTransactionsByAddress401Response) *NullableListOmniTransactionsByAddress401Response {
	return &NullableListOmniTransactionsByAddress401Response{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
