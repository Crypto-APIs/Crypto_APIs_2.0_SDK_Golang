...
type ListXRPRippleTransactionsByAddress400Response struct {
	...
	Error ListXRPRippleTransactionsByAddressE400 `json:"error"`
}
...
func (o *ListXRPRippleTransactionsByAddress400Response) GetError() ListXRPRippleTransactionsByAddressE400 {
	if o == nil {
		var ret ListXRPRippleTransactionsByAddressE400
		return ret
	}
...
func (o ListXRPRippleTransactionsByAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByAddress400Response struct {
	value *ListXRPRippleTransactionsByAddress400Response
	isSet bool
}

func (v NullableListXRPRippleTransactionsByAddress400Response) Get() *ListXRPRippleTransactionsByAddress400Response {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByAddress400Response) Set(val *ListXRPRippleTransactionsByAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByAddress400Response(val *ListXRPRippleTransactionsByAddress400Response) *NullableListXRPRippleTransactionsByAddress400Response {
	return &NullableListXRPRippleTransactionsByAddress400Response{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
