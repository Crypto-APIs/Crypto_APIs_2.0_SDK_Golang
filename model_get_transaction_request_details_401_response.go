...
type GetTransactionRequestDetails401Response struct {
	...
	Error GetTransactionRequestDetailsE401 `json:"error"`
}
...
func NewGetTransactionRequestDetails401Response(apiVersion string, requestId string, error_ GetTransactionRequestDetailsE401) *GetTransactionRequestDetails401Response {
	this := GetTransactionRequestDetails401Response{}
...
func (o *GetTransactionRequestDetails401Response) GetError() GetTransactionRequestDetailsE401 {
	if o == nil {
		var ret GetTransactionRequestDetailsE401
		return ret
	}
...
func (o GetTransactionRequestDetails401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionRequestDetails401Response struct {
	value *GetTransactionRequestDetails401Response
	isSet bool
}

func (v NullableGetTransactionRequestDetails401Response) Get() *GetTransactionRequestDetails401Response {
	return v.value
}

func (v *NullableGetTransactionRequestDetails401Response) Set(val *GetTransactionRequestDetails401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionRequestDetails401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionRequestDetails401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionRequestDetails401Response(val *GetTransactionRequestDetails401Response) *NullableGetTransactionRequestDetails401Response {
	return &NullableGetTransactionRequestDetails401Response{value: val, isSet: true}
}

func (v NullableGetTransactionRequestDetails401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionRequestDetails401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
