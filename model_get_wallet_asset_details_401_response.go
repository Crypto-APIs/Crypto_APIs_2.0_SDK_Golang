...
type GetWalletAssetDetails401Response struct {
	...
	Error GetWalletAssetDetailsE401 `json:"error"`
}
...
func NewGetWalletAssetDetails401Response(apiVersion string, requestId string, error_ GetWalletAssetDetailsE401) *GetWalletAssetDetails401Response {
	this := GetWalletAssetDetails401Response{}
...
func (o *GetWalletAssetDetails401Response) GetError() GetWalletAssetDetailsE401 {
	if o == nil {
		var ret GetWalletAssetDetailsE401
		return ret
	}
...
func (o GetWalletAssetDetails401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletAssetDetails401Response struct {
	value *GetWalletAssetDetails401Response
	isSet bool
}

func (v NullableGetWalletAssetDetails401Response) Get() *GetWalletAssetDetails401Response {
	return v.value
}

func (v *NullableGetWalletAssetDetails401Response) Set(val *GetWalletAssetDetails401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletAssetDetails401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletAssetDetails401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletAssetDetails401Response(val *GetWalletAssetDetails401Response) *NullableGetWalletAssetDetails401Response {
	return &NullableGetWalletAssetDetails401Response{value: val, isSet: true}
}

func (v NullableGetWalletAssetDetails401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletAssetDetails401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
