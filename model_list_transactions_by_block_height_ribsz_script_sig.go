...
type ListTransactionsByBlockHeightRIBSZScriptSig struct {
...
func NewListTransactionsByBlockHeightRIBSZScriptSig(asm string, hex string, type_ string) *ListTransactionsByBlockHeightRIBSZScriptSig {
	this := ListTransactionsByBlockHeightRIBSZScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListTransactionsByBlockHeightRIBSZScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSZScriptSig struct {
	value *ListTransactionsByBlockHeightRIBSZScriptSig
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSZScriptSig) Get() *ListTransactionsByBlockHeightRIBSZScriptSig {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSZScriptSig) Set(val *ListTransactionsByBlockHeightRIBSZScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSZScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSZScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSZScriptSig(val *ListTransactionsByBlockHeightRIBSZScriptSig) *NullableListTransactionsByBlockHeightRIBSZScriptSig {
	return &NullableListTransactionsByBlockHeightRIBSZScriptSig{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSZScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSZScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
