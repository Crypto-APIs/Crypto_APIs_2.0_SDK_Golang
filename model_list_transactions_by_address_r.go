...
// ListTransactionsByAddressR struct for ListTransactionsByAddressR
type ListTransactionsByAddressR struct {
	...
	Data ListTransactionsByAddressRData `json:"data"`
}
...
func NewListTransactionsByAddressR(apiVersion string, requestId string, data ListTransactionsByAddressRData) *ListTransactionsByAddressR {
	this := ListTransactionsByAddressR{}
...
func (o *ListTransactionsByAddressR) GetData() ListTransactionsByAddressRData {
	if o == nil {
		var ret ListTransactionsByAddressRData
		return ret
	}
...
func (o ListTransactionsByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressR struct {
	value *ListTransactionsByAddressR
	isSet bool
}

func (v NullableListTransactionsByAddressR) Get() *ListTransactionsByAddressR {
	return v.value
}

func (v *NullableListTransactionsByAddressR) Set(val *ListTransactionsByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressR(val *ListTransactionsByAddressR) *NullableListTransactionsByAddressR {
	return &NullableListTransactionsByAddressR{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
