...
type GenerateDepositAddress403Response struct {
	...
	Error GenerateDepositAddressE403 `json:"error"`
}
...
func (o *GenerateDepositAddress403Response) GetError() GenerateDepositAddressE403 {
	if o == nil {
		var ret GenerateDepositAddressE403
		return ret
	}
...
func (o GenerateDepositAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableGenerateDepositAddress403Response struct {
	value *GenerateDepositAddress403Response
	isSet bool
}

func (v NullableGenerateDepositAddress403Response) Get() *GenerateDepositAddress403Response {
	return v.value
}

func (v *NullableGenerateDepositAddress403Response) Set(val *GenerateDepositAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateDepositAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateDepositAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateDepositAddress403Response(val *GenerateDepositAddress403Response) *NullableGenerateDepositAddress403Response {
	return &NullableGenerateDepositAddress403Response{value: val, isSet: true}
}

func (v NullableGenerateDepositAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateDepositAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
