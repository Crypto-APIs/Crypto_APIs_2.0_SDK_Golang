...
type ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey struct {
...
func NewListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey {
	this := ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey{}
...
func (o ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey struct {
	value *ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) Get() *ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) Set(val *ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey(val *ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) *NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey {
	return &NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
