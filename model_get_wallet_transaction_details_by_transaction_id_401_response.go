...
type GetWalletTransactionDetailsByTransactionID401Response struct {
	...
	Error GetWalletTransactionDetailsByTransactionIDE401 `json:"error"`
}
...
func NewGetWalletTransactionDetailsByTransactionID401Response(apiVersion string, requestId string, error_ GetWalletTransactionDetailsByTransactionIDE401) *GetWalletTransactionDetailsByTransactionID401Response {
	this := GetWalletTransactionDetailsByTransactionID401Response{}
...
func (o *GetWalletTransactionDetailsByTransactionID401Response) GetError() GetWalletTransactionDetailsByTransactionIDE401 {
	if o == nil {
		var ret GetWalletTransactionDetailsByTransactionIDE401
		return ret
	}
...
func (o GetWalletTransactionDetailsByTransactionID401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionID401Response struct {
	value *GetWalletTransactionDetailsByTransactionID401Response
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionID401Response) Get() *GetWalletTransactionDetailsByTransactionID401Response {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionID401Response) Set(val *GetWalletTransactionDetailsByTransactionID401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionID401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionID401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionID401Response(val *GetWalletTransactionDetailsByTransactionID401Response) *NullableGetWalletTransactionDetailsByTransactionID401Response {
	return &NullableGetWalletTransactionDetailsByTransactionID401Response{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionID401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionID401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
