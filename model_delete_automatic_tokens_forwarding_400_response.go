...
type DeleteAutomaticTokensForwarding400Response struct {
...
func (o DeleteAutomaticTokensForwarding400Response) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticTokensForwarding400Response struct {
	value *DeleteAutomaticTokensForwarding400Response
	isSet bool
}

func (v NullableDeleteAutomaticTokensForwarding400Response) Get() *DeleteAutomaticTokensForwarding400Response {
	return v.value
}

func (v *NullableDeleteAutomaticTokensForwarding400Response) Set(val *DeleteAutomaticTokensForwarding400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticTokensForwarding400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticTokensForwarding400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticTokensForwarding400Response(val *DeleteAutomaticTokensForwarding400Response) *NullableDeleteAutomaticTokensForwarding400Response {
	return &NullableDeleteAutomaticTokensForwarding400Response{value: val, isSet: true}
}

func (v NullableDeleteAutomaticTokensForwarding400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticTokensForwarding400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
