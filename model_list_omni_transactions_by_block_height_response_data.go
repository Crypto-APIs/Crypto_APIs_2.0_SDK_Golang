...
// ListOmniTransactionsByBlockHeightResponseData struct for ListOmniTransactionsByBlockHeightResponseData
type ListOmniTransactionsByBlockHeightResponseData struct {
	...
	Items []ListOmniTransactionsByBlockHeightResponseItem `json:"items"`
}
...
func NewListOmniTransactionsByBlockHeightResponseData(offset int32, limit int32, total int32, items []ListOmniTransactionsByBlockHeightResponseItem) *ListOmniTransactionsByBlockHeightResponseData {
	this := ListOmniTransactionsByBlockHeightResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListOmniTransactionsByBlockHeightResponseData) GetItems() []ListOmniTransactionsByBlockHeightResponseItem {
	if o == nil {
		var ret []ListOmniTransactionsByBlockHeightResponseItem
		return ret
	}
...
func (o ListOmniTransactionsByBlockHeightResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHeightResponseData struct {
	value *ListOmniTransactionsByBlockHeightResponseData
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHeightResponseData) Get() *ListOmniTransactionsByBlockHeightResponseData {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHeightResponseData) Set(val *ListOmniTransactionsByBlockHeightResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHeightResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHeightResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHeightResponseData(val *ListOmniTransactionsByBlockHeightResponseData) *NullableListOmniTransactionsByBlockHeightResponseData {
	return &NullableListOmniTransactionsByBlockHeightResponseData{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHeightResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHeightResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
