...
type ListUnconfirmedTransactionsByAddressRIBSLScriptSig struct {
...
func NewListUnconfirmedTransactionsByAddressRIBSLScriptSig(asm string, hex string, type_ string) *ListUnconfirmedTransactionsByAddressRIBSLScriptSig {
	this := ListUnconfirmedTransactionsByAddressRIBSLScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListUnconfirmedTransactionsByAddressRIBSLScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig struct {
	value *ListUnconfirmedTransactionsByAddressRIBSLScriptSig
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig) Get() *ListUnconfirmedTransactionsByAddressRIBSLScriptSig {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig) Set(val *ListUnconfirmedTransactionsByAddressRIBSLScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSLScriptSig(val *ListUnconfirmedTransactionsByAddressRIBSLScriptSig) *NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig {
	return &NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSLScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
