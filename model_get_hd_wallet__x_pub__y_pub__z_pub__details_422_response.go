...
type GetHDWalletXPubYPubZPubDetails422Response struct {
...
func NewGetHDWalletXPubYPubZPubDetails422Response(apiVersion string, requestId string, error_ GetHDWalletXPubYPubZPubDetailsE422) *GetHDWalletXPubYPubZPubDetails422Response {
	this := GetHDWalletXPubYPubZPubDetails422Response{}
...
func (o GetHDWalletXPubYPubZPubDetails422Response) MarshalJSON() ([]byte, error) {
...
type NullableGetHDWalletXPubYPubZPubDetails422Response struct {
	value *GetHDWalletXPubYPubZPubDetails422Response
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubDetails422Response) Get() *GetHDWalletXPubYPubZPubDetails422Response {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubDetails422Response) Set(val *GetHDWalletXPubYPubZPubDetails422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubDetails422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubDetails422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubDetails422Response(val *GetHDWalletXPubYPubZPubDetails422Response) *NullableGetHDWalletXPubYPubZPubDetails422Response {
	return &NullableGetHDWalletXPubYPubZPubDetails422Response{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubDetails422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubDetails422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
