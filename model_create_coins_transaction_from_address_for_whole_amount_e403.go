...
type CreateCoinsTransactionFromAddressForWholeAmountE403 struct {
...
func BannedIpAddressAsCreateCoinsTransactionFromAddressForWholeAmountE403(v *BannedIpAddress) CreateCoinsTransactionFromAddressForWholeAmountE403 {
	return CreateCoinsTransactionFromAddressForWholeAmountE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsCreateCoinsTransactionFromAddressForWholeAmountE403(v *EndpointNotAllowedForApiKey) CreateCoinsTransactionFromAddressForWholeAmountE403 {
	return CreateCoinsTransactionFromAddressForWholeAmountE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsCreateCoinsTransactionFromAddressForWholeAmountE403(v *EndpointNotAllowedForPlan) CreateCoinsTransactionFromAddressForWholeAmountE403 {
	return CreateCoinsTransactionFromAddressForWholeAmountE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsCreateCoinsTransactionFromAddressForWholeAmountE403(v *FeatureMainnetsNotAllowedForPlan) CreateCoinsTransactionFromAddressForWholeAmountE403 {
	return CreateCoinsTransactionFromAddressForWholeAmountE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *CreateCoinsTransactionFromAddressForWholeAmountE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(CreateCoinsTransactionFromAddressForWholeAmountE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(CreateCoinsTransactionFromAddressForWholeAmountE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CreateCoinsTransactionFromAddressForWholeAmountE403) MarshalJSON() ([]byte, error) {
...
func (obj *CreateCoinsTransactionFromAddressForWholeAmountE403) GetActualInstance() (interface{}) {
...
type NullableCreateCoinsTransactionFromAddressForWholeAmountE403 struct {
	value *CreateCoinsTransactionFromAddressForWholeAmountE403
	isSet bool
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmountE403) Get() *CreateCoinsTransactionFromAddressForWholeAmountE403 {
	return v.value
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmountE403) Set(val *CreateCoinsTransactionFromAddressForWholeAmountE403) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmountE403) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmountE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCoinsTransactionFromAddressForWholeAmountE403(val *CreateCoinsTransactionFromAddressForWholeAmountE403) *NullableCreateCoinsTransactionFromAddressForWholeAmountE403 {
	return &NullableCreateCoinsTransactionFromAddressForWholeAmountE403{value: val, isSet: true}
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmountE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmountE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
