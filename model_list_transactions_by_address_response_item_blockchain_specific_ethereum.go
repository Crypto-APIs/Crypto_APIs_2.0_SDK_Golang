...
type ListTransactionsByAddressResponseItemBlockchainSpecificEthereum struct {
	// Represents the specific transaction contract.
	Contract string `json:"contract"`
	// Represents the amount of gas used by this specific transaction alone.
	GasLimit string `json:"gasLimit"`
	GasPrice ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice `json:"gasPrice"`
...
func NewListTransactionsByAddressResponseItemBlockchainSpecificEthereum(contract string, gasLimit string, gasPrice ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice, gasUsed string, inputData string, nonce int32) *ListTransactionsByAddressResponseItemBlockchainSpecificEthereum {
	this := ListTransactionsByAddressResponseItemBlockchainSpecificEthereum{}
...
func (o *ListTransactionsByAddressResponseItemBlockchainSpecificEthereum) GetGasPrice() ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice {
	if o == nil {
		var ret ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice
		return ret
	}
...
func (o ListTransactionsByAddressResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum struct {
	value *ListTransactionsByAddressResponseItemBlockchainSpecificEthereum
	isSet bool
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum) Get() *ListTransactionsByAddressResponseItemBlockchainSpecificEthereum {
	return v.value
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum) Set(val *ListTransactionsByAddressResponseItemBlockchainSpecificEthereum) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum(val *ListTransactionsByAddressResponseItemBlockchainSpecificEthereum) *NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum {
	return &NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificEthereum) UnmarshalJSON(src []byte) error {
	v.isSet = true
