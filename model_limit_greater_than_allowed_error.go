...
// LimitGreaterThanAllowedError struct for LimitGreaterThanAllowedError
type LimitGreaterThanAllowedError struct {
...
func NewLimitGreaterThanAllowedError(code string, message string) *LimitGreaterThanAllowedError {
	this := LimitGreaterThanAllowedError{}
	this.Code = code
...
func (o LimitGreaterThanAllowedError) MarshalJSON() ([]byte, error) {
...
type NullableLimitGreaterThanAllowedError struct {
	value *LimitGreaterThanAllowedError
	isSet bool
}

func (v NullableLimitGreaterThanAllowedError) Get() *LimitGreaterThanAllowedError {
	return v.value
}

func (v *NullableLimitGreaterThanAllowedError) Set(val *LimitGreaterThanAllowedError) {
	v.value = val
	v.isSet = true
}

func (v NullableLimitGreaterThanAllowedError) IsSet() bool {
	return v.isSet
}

func (v *NullableLimitGreaterThanAllowedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLimitGreaterThanAllowedError(val *LimitGreaterThanAllowedError) *NullableLimitGreaterThanAllowedError {
	return &NullableLimitGreaterThanAllowedError{value: val, isSet: true}
}

func (v NullableLimitGreaterThanAllowedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLimitGreaterThanAllowedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
