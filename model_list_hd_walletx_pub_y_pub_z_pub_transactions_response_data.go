...
// ListHDWalletxPubYPubZPubTransactionsResponseData struct for ListHDWalletxPubYPubZPubTransactionsResponseData
type ListHDWalletxPubYPubZPubTransactionsResponseData struct {
	...
	Items []ListHDWalletxPubYPubZPubTransactionsResponseItem `json:"items"`
}
...
func NewListHDWalletxPubYPubZPubTransactionsResponseData(offset int32, limit int32, total int32, items []ListHDWalletxPubYPubZPubTransactionsResponseItem) *ListHDWalletxPubYPubZPubTransactionsResponseData {
	this := ListHDWalletxPubYPubZPubTransactionsResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListHDWalletxPubYPubZPubTransactionsResponseData) GetItems() []ListHDWalletxPubYPubZPubTransactionsResponseItem {
	if o == nil {
		var ret []ListHDWalletxPubYPubZPubTransactionsResponseItem
		return ret
	}
...
func (o ListHDWalletxPubYPubZPubTransactionsResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletxPubYPubZPubTransactionsResponseData struct {
	value *ListHDWalletxPubYPubZPubTransactionsResponseData
	isSet bool
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponseData) Get() *ListHDWalletxPubYPubZPubTransactionsResponseData {
	return v.value
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponseData) Set(val *ListHDWalletxPubYPubZPubTransactionsResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletxPubYPubZPubTransactionsResponseData(val *ListHDWalletxPubYPubZPubTransactionsResponseData) *NullableListHDWalletxPubYPubZPubTransactionsResponseData {
	return &NullableListHDWalletxPubYPubZPubTransactionsResponseData{value: val, isSet: true}
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
