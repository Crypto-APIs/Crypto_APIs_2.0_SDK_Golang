...
type GetAddressBalance401Response struct {
	...
	Error GetAddressBalanceE401 `json:"error"`
}
...
func NewGetAddressBalance401Response(apiVersion string, requestId string, error_ GetAddressBalanceE401) *GetAddressBalance401Response {
	this := GetAddressBalance401Response{}
...
func (o GetAddressBalance401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressBalance401Response struct {
	value *GetAddressBalance401Response
	isSet bool
}

func (v NullableGetAddressBalance401Response) Get() *GetAddressBalance401Response {
	return v.value
}

func (v *NullableGetAddressBalance401Response) Set(val *GetAddressBalance401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressBalance401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressBalance401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressBalance401Response(val *GetAddressBalance401Response) *NullableGetAddressBalance401Response {
	return &NullableGetAddressBalance401Response{value: val, isSet: true}
}

func (v NullableGetAddressBalance401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressBalance401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
