...
// ListUnconfirmedOmniTransactionsByAddress401Response struct for ListUnconfirmedOmniTransactionsByAddress401Response
type ListUnconfirmedOmniTransactionsByAddress401Response struct {
...
func NewListUnconfirmedOmniTransactionsByAddress401Response(apiVersion string, requestId string, error_ ListUnconfirmedOmniTransactionsByAddressE401) *ListUnconfirmedOmniTransactionsByAddress401Response {
	this := ListUnconfirmedOmniTransactionsByAddress401Response{}
...
func (o ListUnconfirmedOmniTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedOmniTransactionsByAddress401Response struct {
	value *ListUnconfirmedOmniTransactionsByAddress401Response
	isSet bool
}

func (v NullableListUnconfirmedOmniTransactionsByAddress401Response) Get() *ListUnconfirmedOmniTransactionsByAddress401Response {
	return v.value
}

func (v *NullableListUnconfirmedOmniTransactionsByAddress401Response) Set(val *ListUnconfirmedOmniTransactionsByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedOmniTransactionsByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedOmniTransactionsByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedOmniTransactionsByAddress401Response(val *ListUnconfirmedOmniTransactionsByAddress401Response) *NullableListUnconfirmedOmniTransactionsByAddress401Response {
	return &NullableListUnconfirmedOmniTransactionsByAddress401Response{value: val, isSet: true}
}

func (v NullableListUnconfirmedOmniTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedOmniTransactionsByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
