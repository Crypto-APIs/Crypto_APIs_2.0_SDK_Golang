...
type GetAddressDetailsE400 struct {
...
func InvalidPaginationAsGetAddressDetailsE400(v *InvalidPagination) GetAddressDetailsE400 {
	return GetAddressDetailsE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsGetAddressDetailsE400(v *LimitGreaterThanAllowed) GetAddressDetailsE400 {
	return GetAddressDetailsE400{ LimitGreaterThanAllowed: v}
}

// UriNotFoundAsGetAddressDetailsE400 is a convenience function that returns UriNotFound wrapped in GetAddressDetailsE400
func UriNotFoundAsGetAddressDetailsE400(v *UriNotFound) GetAddressDetailsE400 {
	return GetAddressDetailsE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetAddressDetailsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetAddressDetailsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetAddressDetailsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetAddressDetailsE400) MarshalJSON() ([]byte, error) {
...
func (obj *GetAddressDetailsE400) GetActualInstance() (interface{}) {
...
type NullableGetAddressDetailsE400 struct {
	value *GetAddressDetailsE400
	isSet bool
}

func (v NullableGetAddressDetailsE400) Get() *GetAddressDetailsE400 {
	return v.value
}

func (v *NullableGetAddressDetailsE400) Set(val *GetAddressDetailsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsE400(val *GetAddressDetailsE400) *NullableGetAddressDetailsE400 {
	return &NullableGetAddressDetailsE400{value: val, isSet: true}
}

func (v NullableGetAddressDetailsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
