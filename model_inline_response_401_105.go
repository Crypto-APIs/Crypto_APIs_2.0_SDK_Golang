...
// InlineResponse401105 struct for InlineResponse401105
type InlineResponse401105 struct {
...
func (o InlineResponse401105) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse401105 struct {
	value *InlineResponse401105
	isSet bool
}

func (v NullableInlineResponse401105) Get() *InlineResponse401105 {
	return v.value
}

func (v *NullableInlineResponse401105) Set(val *InlineResponse401105) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse401105) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse401105) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse401105(val *InlineResponse401105) *NullableInlineResponse401105 {
	return &NullableInlineResponse401105{value: val, isSet: true}
}

func (v NullableInlineResponse401105) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse401105) UnmarshalJSON(src []byte) error {
	v.isSet = true
