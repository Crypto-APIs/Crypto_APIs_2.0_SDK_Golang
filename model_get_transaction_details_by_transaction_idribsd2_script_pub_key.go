...
type GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey {
	this := GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey{}
...
func (o GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey struct {
	value *GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) Get() *GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) Set(val *GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey(val *GetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) *NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey {
	return &NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSD2ScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
