...
type ListTransactionsByBlockHash401Response struct {
	...
	Error ListTransactionsByBlockHashE401 `json:"error"`
}
...
func (o *ListTransactionsByBlockHash401Response) GetError() ListTransactionsByBlockHashE401 {
	if o == nil {
		var ret ListTransactionsByBlockHashE401
		return ret
	}
...
func (o ListTransactionsByBlockHash401Response) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHash401Response struct {
	value *ListTransactionsByBlockHash401Response
	isSet bool
}

func (v NullableListTransactionsByBlockHash401Response) Get() *ListTransactionsByBlockHash401Response {
	return v.value
}

func (v *NullableListTransactionsByBlockHash401Response) Set(val *ListTransactionsByBlockHash401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHash401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHash401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHash401Response(val *ListTransactionsByBlockHash401Response) *NullableListTransactionsByBlockHash401Response {
	return &NullableListTransactionsByBlockHash401Response{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHash401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHash401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
