...
type ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey struct {
...
func NewListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey(addresses []string, asm string, hex string, type_ string) *ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey {
	this := ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey{}
...
func (o ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey struct {
	value *ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) Get() *ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) Set(val *ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey(val *ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) *NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey {
	return &NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
