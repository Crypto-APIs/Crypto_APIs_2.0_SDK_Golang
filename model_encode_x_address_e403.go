...
type EncodeXAddressE403 struct {
...
func BannedIpAddressAsEncodeXAddressE403(v *BannedIpAddress) EncodeXAddressE403 {
...
func EndpointNotAllowedForApiKeyAsEncodeXAddressE403(v *EndpointNotAllowedForApiKey) EncodeXAddressE403 {
	return EncodeXAddressE403{
...
func EndpointNotAllowedForPlanAsEncodeXAddressE403(v *EndpointNotAllowedForPlan) EncodeXAddressE403 {
	return EncodeXAddressE403{
...
func FeatureMainnetsNotAllowedForPlanAsEncodeXAddressE403(v *FeatureMainnetsNotAllowedForPlan) EncodeXAddressE403 {
	return EncodeXAddressE403{
...
func (dst *EncodeXAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(EncodeXAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(EncodeXAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src EncodeXAddressE403) MarshalJSON() ([]byte, error) {
...
func (obj *EncodeXAddressE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableEncodeXAddressE403 struct {
	value *EncodeXAddressE403
	isSet bool
}

func (v NullableEncodeXAddressE403) Get() *EncodeXAddressE403 {
	return v.value
}

func (v *NullableEncodeXAddressE403) Set(val *EncodeXAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeXAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeXAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeXAddressE403(val *EncodeXAddressE403) *NullableEncodeXAddressE403 {
	return &NullableEncodeXAddressE403{value: val, isSet: true}
}

func (v NullableEncodeXAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeXAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
