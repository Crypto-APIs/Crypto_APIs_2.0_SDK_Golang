...
// ListOmniTokensByAddressResponse struct for ListOmniTokensByAddressResponse
type ListOmniTokensByAddressResponse struct {
	...
	Data ListOmniTokensByAddressResponseData `json:"data"`
}
...
func NewListOmniTokensByAddressResponse(apiVersion string, requestId string, data ListOmniTokensByAddressResponseData) *ListOmniTokensByAddressResponse {
	this := ListOmniTokensByAddressResponse{}
...
func (o *ListOmniTokensByAddressResponse) GetData() ListOmniTokensByAddressResponseData {
	if o == nil {
		var ret ListOmniTokensByAddressResponseData
		return ret
	}
...
func (o ListOmniTokensByAddressResponse) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTokensByAddressResponse struct {
	value *ListOmniTokensByAddressResponse
	isSet bool
}

func (v NullableListOmniTokensByAddressResponse) Get() *ListOmniTokensByAddressResponse {
	return v.value
}

func (v *NullableListOmniTokensByAddressResponse) Set(val *ListOmniTokensByAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTokensByAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTokensByAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTokensByAddressResponse(val *ListOmniTokensByAddressResponse) *NullableListOmniTokensByAddressResponse {
	return &NullableListOmniTokensByAddressResponse{value: val, isSet: true}
}

func (v NullableListOmniTokensByAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTokensByAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
