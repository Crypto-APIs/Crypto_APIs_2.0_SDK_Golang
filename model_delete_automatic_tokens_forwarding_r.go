...
type DeleteAutomaticTokensForwardingR struct {
	...
	Data DeleteAutomaticTokensForwardingRData `json:"data"`
}
...
func NewDeleteAutomaticTokensForwardingR(apiVersion string, requestId string, data DeleteAutomaticTokensForwardingRData) *DeleteAutomaticTokensForwardingR {
	this := DeleteAutomaticTokensForwardingR{}
...
func (o *DeleteAutomaticTokensForwardingR) GetData() DeleteAutomaticTokensForwardingRData {
	if o == nil {
		var ret DeleteAutomaticTokensForwardingRData
		return ret
	}
...
func (o DeleteAutomaticTokensForwardingR) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticTokensForwardingR struct {
	value *DeleteAutomaticTokensForwardingR
	isSet bool
}

func (v NullableDeleteAutomaticTokensForwardingR) Get() *DeleteAutomaticTokensForwardingR {
	return v.value
}

func (v *NullableDeleteAutomaticTokensForwardingR) Set(val *DeleteAutomaticTokensForwardingR) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticTokensForwardingR) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticTokensForwardingR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticTokensForwardingR(val *DeleteAutomaticTokensForwardingR) *NullableDeleteAutomaticTokensForwardingR {
	return &NullableDeleteAutomaticTokensForwardingR{value: val, isSet: true}
}

func (v NullableDeleteAutomaticTokensForwardingR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticTokensForwardingR) UnmarshalJSON(src []byte) error {
	v.isSet = true
