...
type ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
