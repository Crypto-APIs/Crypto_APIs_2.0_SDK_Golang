...
type ListConfirmedTokensTransfersByAddressAndTimeRangeRData struct {
	...
	Items []ListConfirmedTokensTransfersByAddressAndTimeRangeRI `json:"items"`
}
...
func NewListConfirmedTokensTransfersByAddressAndTimeRangeRData(limit int32, offset int32, total int32, items []ListConfirmedTokensTransfersByAddressAndTimeRangeRI) *ListConfirmedTokensTransfersByAddressAndTimeRangeRData {
	this := ListConfirmedTokensTransfersByAddressAndTimeRangeRData{}
	this.Limit = limit
	this.Offset = offset
	this.Total = total
	this.Items = items
...
func (o *ListConfirmedTokensTransfersByAddressAndTimeRangeRData) GetItems() []ListConfirmedTokensTransfersByAddressAndTimeRangeRI {
	if o == nil {
		var ret []ListConfirmedTokensTransfersByAddressAndTimeRangeRI
		return ret
	}
...
func (o ListConfirmedTokensTransfersByAddressAndTimeRangeRData) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData struct {
	value *ListConfirmedTokensTransfersByAddressAndTimeRangeRData
	isSet bool
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData) Get() *ListConfirmedTokensTransfersByAddressAndTimeRangeRData {
	return v.value
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData) Set(val *ListConfirmedTokensTransfersByAddressAndTimeRangeRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTokensTransfersByAddressAndTimeRangeRData(val *ListConfirmedTokensTransfersByAddressAndTimeRangeRData) *NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData {
	return &NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData{value: val, isSet: true}
}

func (v NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTokensTransfersByAddressAndTimeRangeRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
