...
type ListTransactionsByBlockHashRIBSBVoutInner struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByBlockHashRIBSBVoutInner(isSpent bool, scriptPubKey ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey, value string) *ListTransactionsByBlockHashRIBSBVoutInner {
	this := ListTransactionsByBlockHashRIBSBVoutInner{}
...
func (o *ListTransactionsByBlockHashRIBSBVoutInner) GetScriptPubKey() ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey {
	if o == nil {
		var ret ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey
		return ret
	}
...
func (o ListTransactionsByBlockHashRIBSBVoutInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSBVoutInner struct {
	value *ListTransactionsByBlockHashRIBSBVoutInner
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSBVoutInner) Get() *ListTransactionsByBlockHashRIBSBVoutInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSBVoutInner) Set(val *ListTransactionsByBlockHashRIBSBVoutInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSBVoutInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSBVoutInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSBVoutInner(val *ListTransactionsByBlockHashRIBSBVoutInner) *NullableListTransactionsByBlockHashRIBSBVoutInner {
	return &NullableListTransactionsByBlockHashRIBSBVoutInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSBVoutInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSBVoutInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
