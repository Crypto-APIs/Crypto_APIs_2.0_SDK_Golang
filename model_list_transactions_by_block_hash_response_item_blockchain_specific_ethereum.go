...
type ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum(contract string, gasLimit string, gasPrice ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumGasPrice, gasUsed string, inputData string, nonce int32, transactionStatus string) *ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum) UnmarshalJSON(src []byte) error {
	v.isSet = true
