...
type GetTransactionDetailsByTransactionIDFromCallbackRIBSE struct {
...
func NewGetTransactionDetailsByTransactionIDFromCallbackRIBSE(contract string, gasLimit string, gasPrice GetTransactionDetailsByTransactionIDRIBSEGasPrice, gasUsed string, inputData string, nonce int32, transactionStatus string) *GetTransactionDetailsByTransactionIDFromCallbackRIBSE {
	this := GetTransactionDetailsByTransactionIDFromCallbackRIBSE{}
...
func (o GetTransactionDetailsByTransactionIDFromCallbackRIBSE) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackRIBSE
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE) Get() *GetTransactionDetailsByTransactionIDFromCallbackRIBSE {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE) Set(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSE) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSE) *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSE) UnmarshalJSON(src []byte) error {
	v.isSet = true
