...
type GetZilliqaTransactionDetailsByTransactionIDR struct {
	...
	Data GetZilliqaTransactionDetailsByTransactionIDRData `json:"data"`
}
...
func NewGetZilliqaTransactionDetailsByTransactionIDR(apiVersion string, requestId string, data GetZilliqaTransactionDetailsByTransactionIDRData) *GetZilliqaTransactionDetailsByTransactionIDR {
	this := GetZilliqaTransactionDetailsByTransactionIDR{}
...
func (o *GetZilliqaTransactionDetailsByTransactionIDR) GetData() GetZilliqaTransactionDetailsByTransactionIDRData {
	if o == nil {
		var ret GetZilliqaTransactionDetailsByTransactionIDRData
		return ret
	}
...
func (o GetZilliqaTransactionDetailsByTransactionIDR) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaTransactionDetailsByTransactionIDR struct {
	value *GetZilliqaTransactionDetailsByTransactionIDR
	isSet bool
}

func (v NullableGetZilliqaTransactionDetailsByTransactionIDR) Get() *GetZilliqaTransactionDetailsByTransactionIDR {
	return v.value
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionIDR) Set(val *GetZilliqaTransactionDetailsByTransactionIDR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaTransactionDetailsByTransactionIDR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionIDR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaTransactionDetailsByTransactionIDR(val *GetZilliqaTransactionDetailsByTransactionIDR) *NullableGetZilliqaTransactionDetailsByTransactionIDR {
	return &NullableGetZilliqaTransactionDetailsByTransactionIDR{value: val, isSet: true}
}

func (v NullableGetZilliqaTransactionDetailsByTransactionIDR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaTransactionDetailsByTransactionIDR) UnmarshalJSON(src []byte) error {
	v.isSet = true
