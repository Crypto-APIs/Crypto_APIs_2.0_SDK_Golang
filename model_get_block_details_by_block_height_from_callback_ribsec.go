...
type GetBlockDetailsByBlockHeightFromCallbackRIBSEC struct {
...
func NewGetBlockDetailsByBlockHeightFromCallbackRIBSEC(difficulty string, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, nonce string, sha3Uncles string, size int32, totalDifficulty string) *GetBlockDetailsByBlockHeightFromCallbackRIBSEC {
	this := GetBlockDetailsByBlockHeightFromCallbackRIBSEC{}
...
func (o GetBlockDetailsByBlockHeightFromCallbackRIBSEC) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC struct {
	value *GetBlockDetailsByBlockHeightFromCallbackRIBSEC
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC) Get() *GetBlockDetailsByBlockHeightFromCallbackRIBSEC {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC) Set(val *GetBlockDetailsByBlockHeightFromCallbackRIBSEC) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC(val *GetBlockDetailsByBlockHeightFromCallbackRIBSEC) *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC {
	return &NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSEC) UnmarshalJSON(src []byte) error {
	v.isSet = true
