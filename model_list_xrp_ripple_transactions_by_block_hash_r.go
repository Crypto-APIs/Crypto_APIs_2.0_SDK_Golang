...
type ListXRPRippleTransactionsByBlockHashR struct {
	...
	Data ListXRPRippleTransactionsByBlockHashRData `json:"data"`
}
...
func NewListXRPRippleTransactionsByBlockHashR(apiVersion string, requestId string, data ListXRPRippleTransactionsByBlockHashRData) *ListXRPRippleTransactionsByBlockHashR {
	this := ListXRPRippleTransactionsByBlockHashR{}
...
func (o *ListXRPRippleTransactionsByBlockHashR) GetData() ListXRPRippleTransactionsByBlockHashRData {
	if o == nil {
		var ret ListXRPRippleTransactionsByBlockHashRData
		return ret
	}
...
func (o ListXRPRippleTransactionsByBlockHashR) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHashR struct {
	value *ListXRPRippleTransactionsByBlockHashR
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHashR) Get() *ListXRPRippleTransactionsByBlockHashR {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHashR) Set(val *ListXRPRippleTransactionsByBlockHashR) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHashR) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHashR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHashR(val *ListXRPRippleTransactionsByBlockHashR) *NullableListXRPRippleTransactionsByBlockHashR {
	return &NullableListXRPRippleTransactionsByBlockHashR{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHashR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHashR) UnmarshalJSON(src []byte) error {
	v.isSet = true
