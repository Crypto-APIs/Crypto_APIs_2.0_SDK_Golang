...
type ListTokensTransfersByTransactionHashRI struct {
...
func NewListTokensTransfersByTransactionHashRI(contractAddress string, minedInBlockHeight int32, recipientAddress string, senderAddress string, tokenDecimals int32, tokenName string, tokenSymbol string, tokenType string, tokensAmount string, transactionHash string, transactionTimestamp int32) *ListTokensTransfersByTransactionHashRI {
	this := ListTokensTransfersByTransactionHashRI{}
...
func (o ListTokensTransfersByTransactionHashRI) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByTransactionHashRI struct {
	value *ListTokensTransfersByTransactionHashRI
	isSet bool
}

func (v NullableListTokensTransfersByTransactionHashRI) Get() *ListTokensTransfersByTransactionHashRI {
	return v.value
}

func (v *NullableListTokensTransfersByTransactionHashRI) Set(val *ListTokensTransfersByTransactionHashRI) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByTransactionHashRI) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByTransactionHashRI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByTransactionHashRI(val *ListTokensTransfersByTransactionHashRI) *NullableListTokensTransfersByTransactionHashRI {
	return &NullableListTokensTransfersByTransactionHashRI{value: val, isSet: true}
}

func (v NullableListTokensTransfersByTransactionHashRI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByTransactionHashRI) UnmarshalJSON(src []byte) error {
	v.isSet = true
