...
// ListUnconfirmedTransactionsByAddressRIBSLVin struct for ListUnconfirmedTransactionsByAddressRIBSLVin
type ListUnconfirmedTransactionsByAddressRIBSLVin struct {
	Addresses []string `json:"addresses"`
	ScriptSig ListUnconfirmedTransactionsByAddressRIBSLScriptSig `json:"scriptSig"`
...
func NewListUnconfirmedTransactionsByAddressRIBSLVin(addresses []string, scriptSig ListUnconfirmedTransactionsByAddressRIBSLScriptSig, sequence string, txid string, txinwitness []string, value string) *ListUnconfirmedTransactionsByAddressRIBSLVin {
	this := ListUnconfirmedTransactionsByAddressRIBSLVin{}
...
func (o *ListUnconfirmedTransactionsByAddressRIBSLVin) GetScriptSig() ListUnconfirmedTransactionsByAddressRIBSLScriptSig {
	if o == nil {
		var ret ListUnconfirmedTransactionsByAddressRIBSLScriptSig
		return ret
	}
...
func (o ListUnconfirmedTransactionsByAddressRIBSLVin) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSLVin struct {
	value *ListUnconfirmedTransactionsByAddressRIBSLVin
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSLVin) Get() *ListUnconfirmedTransactionsByAddressRIBSLVin {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSLVin) Set(val *ListUnconfirmedTransactionsByAddressRIBSLVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSLVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSLVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSLVin(val *ListUnconfirmedTransactionsByAddressRIBSLVin) *NullableListUnconfirmedTransactionsByAddressRIBSLVin {
	return &NullableListUnconfirmedTransactionsByAddressRIBSLVin{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSLVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSLVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
