...
type ValidateAddress403Response struct {
	...
	Error ValidateAddressE403 `json:"error"`
}
...
func (o ValidateAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableValidateAddress403Response struct {
	value *ValidateAddress403Response
	isSet bool
}

func (v NullableValidateAddress403Response) Get() *ValidateAddress403Response {
	return v.value
}

func (v *NullableValidateAddress403Response) Set(val *ValidateAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateAddress403Response(val *ValidateAddress403Response) *NullableValidateAddress403Response {
	return &NullableValidateAddress403Response{value: val, isSet: true}
}

func (v NullableValidateAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
