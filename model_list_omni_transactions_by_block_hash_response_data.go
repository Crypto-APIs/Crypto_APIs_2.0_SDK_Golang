...
// ListOmniTransactionsByBlockHashResponseData struct for ListOmniTransactionsByBlockHashResponseData
type ListOmniTransactionsByBlockHashResponseData struct {
	...
	Items []ListOmniTransactionsByBlockHashResponseItem `json:"items"`
}
...
func NewListOmniTransactionsByBlockHashResponseData(offset int32, limit int32, total int32, items []ListOmniTransactionsByBlockHashResponseItem) *ListOmniTransactionsByBlockHashResponseData {
	this := ListOmniTransactionsByBlockHashResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListOmniTransactionsByBlockHashResponseData) GetItems() []ListOmniTransactionsByBlockHashResponseItem {
	if o == nil {
		var ret []ListOmniTransactionsByBlockHashResponseItem
		return ret
	}
...
func (o ListOmniTransactionsByBlockHashResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHashResponseData struct {
	value *ListOmniTransactionsByBlockHashResponseData
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHashResponseData) Get() *ListOmniTransactionsByBlockHashResponseData {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHashResponseData) Set(val *ListOmniTransactionsByBlockHashResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHashResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHashResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHashResponseData(val *ListOmniTransactionsByBlockHashResponseData) *NullableListOmniTransactionsByBlockHashResponseData {
	return &NullableListOmniTransactionsByBlockHashResponseData{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHashResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHashResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
