...
type ListWalletTransactions403Response struct {
	...
	Error ListWalletTransactionsE403 `json:"error"`
}
...
func NewListWalletTransactions403Response(apiVersion string, requestId string, error_ ListWalletTransactionsE403) *ListWalletTransactions403Response {
	this := ListWalletTransactions403Response{}
...
func (o *ListWalletTransactions403Response) GetError() ListWalletTransactionsE403 {
	if o == nil {
		var ret ListWalletTransactionsE403
		return ret
	}
...
func (o ListWalletTransactions403Response) MarshalJSON() ([]byte, error) {
...
type NullableListWalletTransactions403Response struct {
	value *ListWalletTransactions403Response
	isSet bool
}

func (v NullableListWalletTransactions403Response) Get() *ListWalletTransactions403Response {
	return v.value
}

func (v *NullableListWalletTransactions403Response) Set(val *ListWalletTransactions403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListWalletTransactions403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListWalletTransactions403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWalletTransactions403Response(val *ListWalletTransactions403Response) *NullableListWalletTransactions403Response {
	return &NullableListWalletTransactions403Response{value: val, isSet: true}
}

func (v NullableListWalletTransactions403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWalletTransactions403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
