...
type ListAssetsDetailsResponseItemSpecificDataCryptoTypeData struct {
...
func NewListAssetsDetailsResponseItemSpecificDataCryptoTypeData(var1HourPriceChangeInPercentage string, var1WeekPriceChangeInPercentage string, var24HoursPriceChangeInPercentage string, var24HoursTradingVolume string, circulatingSupply string, marketCapInUSD string, maxSupply string) *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData {
	this := ListAssetsDetailsResponseItemSpecificDataCryptoTypeData{}
...
func (o *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData) GetVar1HourPriceChangeInPercentage() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData) GetVar24HoursPriceChangeInPercentageOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData) SetCirculatingSupply(v string) {
...
func (o ListAssetsDetailsResponseItemSpecificDataCryptoTypeData) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData struct {
	value *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData
	isSet bool
}

func (v NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData) Get() *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData {
	return v.value
}

func (v *NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData) Set(val *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData(val *ListAssetsDetailsResponseItemSpecificDataCryptoTypeData) *NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData {
	return &NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData{value: val, isSet: true}
}

func (v NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetailsResponseItemSpecificDataCryptoTypeData) UnmarshalJSON(src []byte) error {
	v.isSet = true
