...
type ActivateBlockchainEventSubscriptionRB struct {
	// In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
	Context *string `json:"context,omitempty"`
	Data ActivateBlockchainEventSubscriptionRBData `json:"data"`
}
...
func NewActivateBlockchainEventSubscriptionRB(data ActivateBlockchainEventSubscriptionRBData) *ActivateBlockchainEventSubscriptionRB {
	this := ActivateBlockchainEventSubscriptionRB{}
	this.Data = data
	return &this
}
...
func (o *ActivateBlockchainEventSubscriptionRB) GetData() ActivateBlockchainEventSubscriptionRBData {
	if o == nil {
		var ret ActivateBlockchainEventSubscriptionRBData
		return ret
	}
...
func (o ActivateBlockchainEventSubscriptionRB) MarshalJSON() ([]byte, error) {
...
type NullableActivateBlockchainEventSubscriptionRB struct {
	value *ActivateBlockchainEventSubscriptionRB
	isSet bool
}

func (v NullableActivateBlockchainEventSubscriptionRB) Get() *ActivateBlockchainEventSubscriptionRB {
	return v.value
}

func (v *NullableActivateBlockchainEventSubscriptionRB) Set(val *ActivateBlockchainEventSubscriptionRB) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateBlockchainEventSubscriptionRB) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateBlockchainEventSubscriptionRB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateBlockchainEventSubscriptionRB(val *ActivateBlockchainEventSubscriptionRB) *NullableActivateBlockchainEventSubscriptionRB {
	return &NullableActivateBlockchainEventSubscriptionRB{value: val, isSet: true}
}

func (v NullableActivateBlockchainEventSubscriptionRB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateBlockchainEventSubscriptionRB) UnmarshalJSON(src []byte) error {
	v.isSet = true
