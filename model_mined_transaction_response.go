...
// MinedTransactionResponse struct for MinedTransactionResponse
type MinedTransactionResponse struct {
	...
	Data MinedTransactionResponseData `json:"data"`
}
...
func (o *MinedTransactionResponse) GetData() MinedTransactionResponseData {
	if o == nil {
		var ret MinedTransactionResponseData
		return ret
	}
...
func (o MinedTransactionResponse) MarshalJSON() ([]byte, error) {
...
type NullableMinedTransactionResponse struct {
	value *MinedTransactionResponse
	isSet bool
}

func (v NullableMinedTransactionResponse) Get() *MinedTransactionResponse {
	return v.value
}

func (v *NullableMinedTransactionResponse) Set(val *MinedTransactionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMinedTransactionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMinedTransactionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinedTransactionResponse(val *MinedTransactionResponse) *NullableMinedTransactionResponse {
	return &NullableMinedTransactionResponse{value: val, isSet: true}
}

func (v NullableMinedTransactionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinedTransactionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
