...
type GetZilliqaAddressDetails401Response struct {
	...
	Error GetZilliqaAddressDetailsE401 `json:"error"`
}
...
func NewGetZilliqaAddressDetails401Response(apiVersion string, requestId string, error_ GetZilliqaAddressDetailsE401) *GetZilliqaAddressDetails401Response {
	this := GetZilliqaAddressDetails401Response{}
...
func (o *GetZilliqaAddressDetails401Response) GetError() GetZilliqaAddressDetailsE401 {
	if o == nil {
		var ret GetZilliqaAddressDetailsE401
		return ret
	}
...
func (o GetZilliqaAddressDetails401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaAddressDetails401Response struct {
	value *GetZilliqaAddressDetails401Response
	isSet bool
}

func (v NullableGetZilliqaAddressDetails401Response) Get() *GetZilliqaAddressDetails401Response {
	return v.value
}

func (v *NullableGetZilliqaAddressDetails401Response) Set(val *GetZilliqaAddressDetails401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaAddressDetails401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaAddressDetails401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaAddressDetails401Response(val *GetZilliqaAddressDetails401Response) *NullableGetZilliqaAddressDetails401Response {
	return &NullableGetZilliqaAddressDetails401Response{value: val, isSet: true}
}

func (v NullableGetZilliqaAddressDetails401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaAddressDetails401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
