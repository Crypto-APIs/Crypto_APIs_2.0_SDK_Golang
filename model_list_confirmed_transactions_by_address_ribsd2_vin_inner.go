...
type ListConfirmedTransactionsByAddressRIBSD2VinInner struct {
...
func NewListConfirmedTransactionsByAddressRIBSD2VinInner(addresses []string, scriptSig ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig, sequence string, txinwitness []string, vout int32) *ListConfirmedTransactionsByAddressRIBSD2VinInner {
	this := ListConfirmedTransactionsByAddressRIBSD2VinInner{}
...
func (o ListConfirmedTransactionsByAddressRIBSD2VinInner) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRIBSD2VinInner struct {
	value *ListConfirmedTransactionsByAddressRIBSD2VinInner
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRIBSD2VinInner) Get() *ListConfirmedTransactionsByAddressRIBSD2VinInner {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRIBSD2VinInner) Set(val *ListConfirmedTransactionsByAddressRIBSD2VinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRIBSD2VinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRIBSD2VinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRIBSD2VinInner(val *ListConfirmedTransactionsByAddressRIBSD2VinInner) *NullableListConfirmedTransactionsByAddressRIBSD2VinInner {
	return &NullableListConfirmedTransactionsByAddressRIBSD2VinInner{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRIBSD2VinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRIBSD2VinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
