...
// GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem struct for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem
type GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem struct {
	...
	Recipients []GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients `json:"recipients"`
...
func NewGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem(amount string, divisible bool, mined bool, propertyId int32, recipients []GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients, senders []GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders, sent bool, timestamp int32, transactionId string, type_ string, typeInt int32, version int32, fee ListUnconfirmedOmniTransactionsByAddressResponseItemFee) *GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem {
	this := GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem{}
	this.Amount = amount
...
func (o *GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) GetRecipients() []GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients {
	if o == nil {
		var ret []GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients
		return ret
	}
...
func (o GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem struct {
	value *GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem
	isSet bool
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) Get() *GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem {
	return v.value
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) Set(val *GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem(val *GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem {
	return &NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem{value: val, isSet: true}
}

func (v NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
