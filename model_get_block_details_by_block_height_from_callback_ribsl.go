...
type GetBlockDetailsByBlockHeightFromCallbackRIBSL struct {
...
func (o GetBlockDetailsByBlockHeightFromCallbackRIBSL) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL struct {
	value *GetBlockDetailsByBlockHeightFromCallbackRIBSL
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL) Get() *GetBlockDetailsByBlockHeightFromCallbackRIBSL {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL) Set(val *GetBlockDetailsByBlockHeightFromCallbackRIBSL) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightFromCallbackRIBSL(val *GetBlockDetailsByBlockHeightFromCallbackRIBSL) *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL {
	return &NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSL) UnmarshalJSON(src []byte) error {
	v.isSet = true
