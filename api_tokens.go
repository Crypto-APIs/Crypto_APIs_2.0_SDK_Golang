...
func (r ApiGetTokenDetailsByContractAddressRequest) Execute() (GetTokenDetailsByContractAddressR, *_nethttp.Response, error) {
...
*/
func (a *TokensApiService) GetTokenDetailsByContractAddress(ctx _context.Context, blockchain string, network string, contractAddress string) ApiGetTokenDetailsByContractAddressRequest {
	return ApiGetTokenDetailsByContractAddressRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *TokensApiService) GetTokenDetailsByContractAddressExecute(r ApiGetTokenDetailsByContractAddressRequest) (GetTokenDetailsByContractAddressR, *_nethttp.Response, error) {
	var (
...
func (r ApiListConfirmedTokensTransfersByAddressRequest) Execute() (ListConfirmedTokensTransfersByAddressR, *_nethttp.Response, error) {
...
*/
func (a *TokensApiService) ListConfirmedTokensTransfersByAddress(ctx _context.Context, blockchain string, network string, address string) ApiListConfirmedTokensTransfersByAddressRequest {
	return ApiListConfirmedTokensTransfersByAddressRequest{
		ApiService: a,
		ctx: ctx,
		blockchain: blockchain,
...
func (a *TokensApiService) ListConfirmedTokensTransfersByAddressExecute(r ApiListConfirmedTokensTransfersByAddressRequest) (ListConfirmedTokensTransfersByAddressR, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
