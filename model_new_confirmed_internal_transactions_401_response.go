...
type NewConfirmedInternalTransactions401Response struct {
	...
	Error NewConfirmedInternalTransactionsE401 `json:"error"`
}
...
func NewNewConfirmedInternalTransactions401Response(apiVersion string, requestId string, error_ NewConfirmedInternalTransactionsE401) *NewConfirmedInternalTransactions401Response {
	this := NewConfirmedInternalTransactions401Response{}
...
func (o *NewConfirmedInternalTransactions401Response) GetError() NewConfirmedInternalTransactionsE401 {
	if o == nil {
		var ret NewConfirmedInternalTransactionsE401
		return ret
	}
...
func (o NewConfirmedInternalTransactions401Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactions401Response struct {
	value *NewConfirmedInternalTransactions401Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactions401Response) Get() *NewConfirmedInternalTransactions401Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactions401Response) Set(val *NewConfirmedInternalTransactions401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactions401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactions401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactions401Response(val *NewConfirmedInternalTransactions401Response) *NullableNewConfirmedInternalTransactions401Response {
	return &NullableNewConfirmedInternalTransactions401Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactions401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactions401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
