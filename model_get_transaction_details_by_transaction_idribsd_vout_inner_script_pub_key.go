...
type GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey {
	this := GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey{}
...
func (o GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey struct {
	value *GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) Get() *GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) Set(val *GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey(val *GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) *NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey {
	return &NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
