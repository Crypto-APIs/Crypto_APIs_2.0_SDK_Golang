...
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash struct {
	...
	Vin []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin `json:"vin"`
	// Represents the transaction outputs.
	Vout []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout `json:"vout"`
}
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificDash(locktime int32, size int32, version int32, vin []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin, vout []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash{}
...
func (o *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) GetVin() []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin {
	if o == nil {
		var ret []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin
		return ret
	}
...
func (o *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) GetVout() []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout {
	if o == nil {
		var ret []ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout
		return ret
	}
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificDash) UnmarshalJSON(src []byte) error {
	v.isSet = true
