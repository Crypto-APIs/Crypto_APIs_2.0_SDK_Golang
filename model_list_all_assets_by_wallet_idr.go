...
type ListAllAssetsByWalletIDR struct {
	...
	Data ListAllAssetsByWalletIDRData `json:"data"`
}
...
func (o *ListAllAssetsByWalletIDR) GetData() ListAllAssetsByWalletIDRData {
	if o == nil {
		var ret ListAllAssetsByWalletIDRData
		return ret
	}
...
func (o ListAllAssetsByWalletIDR) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsByWalletIDR struct {
	value *ListAllAssetsByWalletIDR
	isSet bool
}

func (v NullableListAllAssetsByWalletIDR) Get() *ListAllAssetsByWalletIDR {
	return v.value
}

func (v *NullableListAllAssetsByWalletIDR) Set(val *ListAllAssetsByWalletIDR) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsByWalletIDR) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsByWalletIDR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsByWalletIDR(val *ListAllAssetsByWalletIDR) *NullableListAllAssetsByWalletIDR {
	return &NullableListAllAssetsByWalletIDR{value: val, isSet: true}
}

func (v NullableListAllAssetsByWalletIDR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsByWalletIDR) UnmarshalJSON(src []byte) error {
	v.isSet = true
