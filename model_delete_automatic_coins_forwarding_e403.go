...
type DeleteAutomaticCoinsForwardingE403 struct {
...
func BannedIpAddressAsDeleteAutomaticCoinsForwardingE403(v *BannedIpAddress) DeleteAutomaticCoinsForwardingE403 {
	return DeleteAutomaticCoinsForwardingE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsDeleteAutomaticCoinsForwardingE403(v *EndpointNotAllowedForApiKey) DeleteAutomaticCoinsForwardingE403 {
	return DeleteAutomaticCoinsForwardingE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsDeleteAutomaticCoinsForwardingE403(v *EndpointNotAllowedForPlan) DeleteAutomaticCoinsForwardingE403 {
	return DeleteAutomaticCoinsForwardingE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsDeleteAutomaticCoinsForwardingE403(v *FeatureMainnetsNotAllowedForPlan) DeleteAutomaticCoinsForwardingE403 {
	return DeleteAutomaticCoinsForwardingE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *DeleteAutomaticCoinsForwardingE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DeleteAutomaticCoinsForwardingE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DeleteAutomaticCoinsForwardingE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DeleteAutomaticCoinsForwardingE403) MarshalJSON() ([]byte, error) {
...
func (obj *DeleteAutomaticCoinsForwardingE403) GetActualInstance() (interface{}) {
...
type NullableDeleteAutomaticCoinsForwardingE403 struct {
	value *DeleteAutomaticCoinsForwardingE403
	isSet bool
}

func (v NullableDeleteAutomaticCoinsForwardingE403) Get() *DeleteAutomaticCoinsForwardingE403 {
	return v.value
}

func (v *NullableDeleteAutomaticCoinsForwardingE403) Set(val *DeleteAutomaticCoinsForwardingE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticCoinsForwardingE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticCoinsForwardingE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticCoinsForwardingE403(val *DeleteAutomaticCoinsForwardingE403) *NullableDeleteAutomaticCoinsForwardingE403 {
	return &NullableDeleteAutomaticCoinsForwardingE403{value: val, isSet: true}
}

func (v NullableDeleteAutomaticCoinsForwardingE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticCoinsForwardingE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
