...
type GetHDWalletXPubYPubZPubAssetsR struct {
	...
	Data GetHDWalletXPubYPubZPubAssetsRData `json:"data"`
}
...
func NewGetHDWalletXPubYPubZPubAssetsR(apiVersion string, requestId string, data GetHDWalletXPubYPubZPubAssetsRData) *GetHDWalletXPubYPubZPubAssetsR {
	this := GetHDWalletXPubYPubZPubAssetsR{}
...
func (o *GetHDWalletXPubYPubZPubAssetsR) GetData() GetHDWalletXPubYPubZPubAssetsRData {
	if o == nil {
		var ret GetHDWalletXPubYPubZPubAssetsRData
		return ret
	}
...
func (o GetHDWalletXPubYPubZPubAssetsR) MarshalJSON() ([]byte, error) {
...
type NullableGetHDWalletXPubYPubZPubAssetsR struct {
	value *GetHDWalletXPubYPubZPubAssetsR
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubAssetsR) Get() *GetHDWalletXPubYPubZPubAssetsR {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubAssetsR) Set(val *GetHDWalletXPubYPubZPubAssetsR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubAssetsR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubAssetsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubAssetsR(val *GetHDWalletXPubYPubZPubAssetsR) *NullableGetHDWalletXPubYPubZPubAssetsR {
	return &NullableGetHDWalletXPubYPubZPubAssetsR{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubAssetsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubAssetsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
