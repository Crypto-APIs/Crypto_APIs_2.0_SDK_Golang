...
type GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin struct {
...
func NewGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, versionHex string, weight int32) *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin {
	this := GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin{}
...
func (o GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin struct {
	value *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) Get() *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) Set(val *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin(val *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin {
	return &NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
