...
type DecodeRawTransactionHexRB struct {
	// In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
	Context *string `json:"context,omitempty"`
	Data DecodeRawTransactionHexRBData `json:"data"`
}
...
func (o *DecodeRawTransactionHexRB) GetData() DecodeRawTransactionHexRBData {
	if o == nil {
		var ret DecodeRawTransactionHexRBData
		return ret
	}
...
func (o DecodeRawTransactionHexRB) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRB struct {
	value *DecodeRawTransactionHexRB
	isSet bool
}

func (v NullableDecodeRawTransactionHexRB) Get() *DecodeRawTransactionHexRB {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRB) Set(val *DecodeRawTransactionHexRB) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRB) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRB(val *DecodeRawTransactionHexRB) *NullableDecodeRawTransactionHexRB {
	return &NullableDecodeRawTransactionHexRB{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRB) UnmarshalJSON(src []byte) error {
	v.isSet = true
