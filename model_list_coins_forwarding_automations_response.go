...
// ListCoinsForwardingAutomationsResponse struct for ListCoinsForwardingAutomationsResponse
type ListCoinsForwardingAutomationsResponse struct {
	...
	Data ListCoinsForwardingAutomationsResponseData `json:"data"`
}
...
func NewListCoinsForwardingAutomationsResponse(apiVersion string, requestId string, data ListCoinsForwardingAutomationsResponseData) *ListCoinsForwardingAutomationsResponse {
	this := ListCoinsForwardingAutomationsResponse{}
...
func (o *ListCoinsForwardingAutomationsResponse) GetData() ListCoinsForwardingAutomationsResponseData {
	if o == nil {
		var ret ListCoinsForwardingAutomationsResponseData
		return ret
	}
...
func (o ListCoinsForwardingAutomationsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListCoinsForwardingAutomationsResponse struct {
	value *ListCoinsForwardingAutomationsResponse
	isSet bool
}

func (v NullableListCoinsForwardingAutomationsResponse) Get() *ListCoinsForwardingAutomationsResponse {
	return v.value
}

func (v *NullableListCoinsForwardingAutomationsResponse) Set(val *ListCoinsForwardingAutomationsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoinsForwardingAutomationsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoinsForwardingAutomationsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoinsForwardingAutomationsResponse(val *ListCoinsForwardingAutomationsResponse) *NullableListCoinsForwardingAutomationsResponse {
	return &NullableListCoinsForwardingAutomationsResponse{value: val, isSet: true}
}

func (v NullableListCoinsForwardingAutomationsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoinsForwardingAutomationsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
