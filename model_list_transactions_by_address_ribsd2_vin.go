...
// ListTransactionsByAddressRIBSD2Vin struct for ListTransactionsByAddressRIBSD2Vin
type ListTransactionsByAddressRIBSD2Vin struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig ListTransactionsByAddressRIBSD2ScriptSig `json:"scriptSig"`
...
func NewListTransactionsByAddressRIBSD2Vin(addresses []string, scriptSig ListTransactionsByAddressRIBSD2ScriptSig, sequence string, txinwitness []string, vout int32) *ListTransactionsByAddressRIBSD2Vin {
	this := ListTransactionsByAddressRIBSD2Vin{}
...
func (o *ListTransactionsByAddressRIBSD2Vin) GetScriptSig() ListTransactionsByAddressRIBSD2ScriptSig {
	if o == nil {
		var ret ListTransactionsByAddressRIBSD2ScriptSig
		return ret
	}
...
func (o ListTransactionsByAddressRIBSD2Vin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSD2Vin struct {
	value *ListTransactionsByAddressRIBSD2Vin
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSD2Vin) Get() *ListTransactionsByAddressRIBSD2Vin {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSD2Vin) Set(val *ListTransactionsByAddressRIBSD2Vin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSD2Vin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSD2Vin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSD2Vin(val *ListTransactionsByAddressRIBSD2Vin) *NullableListTransactionsByAddressRIBSD2Vin {
	return &NullableListTransactionsByAddressRIBSD2Vin{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSD2Vin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSD2Vin) UnmarshalJSON(src []byte) error {
	v.isSet = true
