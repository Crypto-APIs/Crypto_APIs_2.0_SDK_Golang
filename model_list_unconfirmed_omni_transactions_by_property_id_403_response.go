...
// ListUnconfirmedOmniTransactionsByPropertyID403Response struct for ListUnconfirmedOmniTransactionsByPropertyID403Response
type ListUnconfirmedOmniTransactionsByPropertyID403Response struct {
...
func (o ListUnconfirmedOmniTransactionsByPropertyID403Response) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedOmniTransactionsByPropertyID403Response struct {
	value *ListUnconfirmedOmniTransactionsByPropertyID403Response
	isSet bool
}

func (v NullableListUnconfirmedOmniTransactionsByPropertyID403Response) Get() *ListUnconfirmedOmniTransactionsByPropertyID403Response {
	return v.value
}

func (v *NullableListUnconfirmedOmniTransactionsByPropertyID403Response) Set(val *ListUnconfirmedOmniTransactionsByPropertyID403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedOmniTransactionsByPropertyID403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedOmniTransactionsByPropertyID403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedOmniTransactionsByPropertyID403Response(val *ListUnconfirmedOmniTransactionsByPropertyID403Response) *NullableListUnconfirmedOmniTransactionsByPropertyID403Response {
	return &NullableListUnconfirmedOmniTransactionsByPropertyID403Response{value: val, isSet: true}
}

func (v NullableListUnconfirmedOmniTransactionsByPropertyID403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedOmniTransactionsByPropertyID403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
