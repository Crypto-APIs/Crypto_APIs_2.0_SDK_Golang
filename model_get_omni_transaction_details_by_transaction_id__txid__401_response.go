...
// GetOmniTransactionDetailsByTransactionIDTxid401Response struct for GetOmniTransactionDetailsByTransactionIDTxid401Response
type GetOmniTransactionDetailsByTransactionIDTxid401Response struct {
	...
	Error GetOmniTransactionDetailsByTransactionIDTxidE401 `json:"error"`
}
...
func NewGetOmniTransactionDetailsByTransactionIDTxid401Response(apiVersion string, requestId string, error_ GetOmniTransactionDetailsByTransactionIDTxidE401) *GetOmniTransactionDetailsByTransactionIDTxid401Response {
	this := GetOmniTransactionDetailsByTransactionIDTxid401Response{}
...
func (o GetOmniTransactionDetailsByTransactionIDTxid401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetOmniTransactionDetailsByTransactionIDTxid401Response struct {
	value *GetOmniTransactionDetailsByTransactionIDTxid401Response
	isSet bool
}

func (v NullableGetOmniTransactionDetailsByTransactionIDTxid401Response) Get() *GetOmniTransactionDetailsByTransactionIDTxid401Response {
	return v.value
}

func (v *NullableGetOmniTransactionDetailsByTransactionIDTxid401Response) Set(val *GetOmniTransactionDetailsByTransactionIDTxid401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOmniTransactionDetailsByTransactionIDTxid401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOmniTransactionDetailsByTransactionIDTxid401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOmniTransactionDetailsByTransactionIDTxid401Response(val *GetOmniTransactionDetailsByTransactionIDTxid401Response) *NullableGetOmniTransactionDetailsByTransactionIDTxid401Response {
	return &NullableGetOmniTransactionDetailsByTransactionIDTxid401Response{value: val, isSet: true}
}

func (v NullableGetOmniTransactionDetailsByTransactionIDTxid401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOmniTransactionDetailsByTransactionIDTxid401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
