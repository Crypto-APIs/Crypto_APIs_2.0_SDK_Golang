...
// ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit struct for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit
type ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit struct {
...
func (o ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) MarshalJSON() ([]byte, error) {
...
type NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit struct {
	value *ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit
	isSet bool
}

func (v NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) Get() *ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit {
	return v.value
}

func (v *NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) Set(val *ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit(val *ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) *NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit {
	return &NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit{value: val, isSet: true}
}

func (v NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit) UnmarshalJSON(src []byte) error {
	v.isSet = true
