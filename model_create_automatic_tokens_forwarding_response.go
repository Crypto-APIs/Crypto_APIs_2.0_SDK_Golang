...
// CreateAutomaticTokensForwardingResponse struct for CreateAutomaticTokensForwardingResponse
type CreateAutomaticTokensForwardingResponse struct {
	...
	Data CreateAutomaticTokensForwardingResponseData `json:"data"`
}
...
func NewCreateAutomaticTokensForwardingResponse(apiVersion string, requestId string, data CreateAutomaticTokensForwardingResponseData) *CreateAutomaticTokensForwardingResponse {
	this := CreateAutomaticTokensForwardingResponse{}
...
func (o *CreateAutomaticTokensForwardingResponse) GetData() CreateAutomaticTokensForwardingResponseData {
	if o == nil {
		var ret CreateAutomaticTokensForwardingResponseData
		return ret
	}
...
func (o CreateAutomaticTokensForwardingResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticTokensForwardingResponse struct {
	value *CreateAutomaticTokensForwardingResponse
	isSet bool
}

func (v NullableCreateAutomaticTokensForwardingResponse) Get() *CreateAutomaticTokensForwardingResponse {
	return v.value
}

func (v *NullableCreateAutomaticTokensForwardingResponse) Set(val *CreateAutomaticTokensForwardingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticTokensForwardingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticTokensForwardingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticTokensForwardingResponse(val *CreateAutomaticTokensForwardingResponse) *NullableCreateAutomaticTokensForwardingResponse {
	return &NullableCreateAutomaticTokensForwardingResponse{value: val, isSet: true}
}

func (v NullableCreateAutomaticTokensForwardingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticTokensForwardingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
