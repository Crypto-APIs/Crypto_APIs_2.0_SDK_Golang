...
type ListTransactionsByBlockHeightE400 struct {
...
func InvalidPaginationAsListTransactionsByBlockHeightE400(v *InvalidPagination) ListTransactionsByBlockHeightE400 {
	return ListTransactionsByBlockHeightE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsListTransactionsByBlockHeightE400(v *LimitGreaterThanAllowed) ListTransactionsByBlockHeightE400 {
	return ListTransactionsByBlockHeightE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsListTransactionsByBlockHeightE400(v *UriNotFound) ListTransactionsByBlockHeightE400 {
	return ListTransactionsByBlockHeightE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListTransactionsByBlockHeightE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListTransactionsByBlockHeightE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListTransactionsByBlockHeightE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListTransactionsByBlockHeightE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListTransactionsByBlockHeightE400) GetActualInstance() (interface{}) {
...
type NullableListTransactionsByBlockHeightE400 struct {
	value *ListTransactionsByBlockHeightE400
	isSet bool
}

func (v NullableListTransactionsByBlockHeightE400) Get() *ListTransactionsByBlockHeightE400 {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightE400) Set(val *ListTransactionsByBlockHeightE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightE400(val *ListTransactionsByBlockHeightE400) *NullableListTransactionsByBlockHeightE400 {
	return &NullableListTransactionsByBlockHeightE400{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
