...
type DecodeRawTransactionHexRISDScriptSig struct {
...
func NewDecodeRawTransactionHexRISDScriptSig() *DecodeRawTransactionHexRISDScriptSig {
	this := DecodeRawTransactionHexRISDScriptSig{}
	return &this
}
...
func (o DecodeRawTransactionHexRISDScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISDScriptSig struct {
	value *DecodeRawTransactionHexRISDScriptSig
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISDScriptSig) Get() *DecodeRawTransactionHexRISDScriptSig {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISDScriptSig) Set(val *DecodeRawTransactionHexRISDScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISDScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISDScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISDScriptSig(val *DecodeRawTransactionHexRISDScriptSig) *NullableDecodeRawTransactionHexRISDScriptSig {
	return &NullableDecodeRawTransactionHexRISDScriptSig{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISDScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISDScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
