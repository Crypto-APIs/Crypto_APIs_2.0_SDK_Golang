...
type GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig struct {
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig(asm string, hex string, type_ string) *GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig {
	this := GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) Get() *GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig(val *GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
