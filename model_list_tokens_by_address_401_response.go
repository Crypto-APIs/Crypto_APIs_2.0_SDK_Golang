...
type ListTokensByAddress401Response struct {
	...
	Error ListTokensByAddressE401 `json:"error"`
}
...
func NewListTokensByAddress401Response(apiVersion string, requestId string, error_ ListTokensByAddressE401) *ListTokensByAddress401Response {
	this := ListTokensByAddress401Response{}
...
func (o *ListTokensByAddress401Response) GetError() ListTokensByAddressE401 {
	if o == nil {
		var ret ListTokensByAddressE401
		return ret
	}
...
func (o ListTokensByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListTokensByAddress401Response struct {
	value *ListTokensByAddress401Response
	isSet bool
}

func (v NullableListTokensByAddress401Response) Get() *ListTokensByAddress401Response {
	return v.value
}

func (v *NullableListTokensByAddress401Response) Set(val *ListTokensByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensByAddress401Response(val *ListTokensByAddress401Response) *NullableListTokensByAddress401Response {
	return &NullableListTokensByAddress401Response{value: val, isSet: true}
}

func (v NullableListTokensByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
