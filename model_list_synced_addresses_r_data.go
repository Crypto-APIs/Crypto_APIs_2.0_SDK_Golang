...
type ListSyncedAddressesRData struct {
	...
	Items []ListSyncedAddressesRI `json:"items"`
}
...
func (o ListSyncedAddressesRData) MarshalJSON() ([]byte, error) {
...
type NullableListSyncedAddressesRData struct {
	value *ListSyncedAddressesRData
	isSet bool
}

func (v NullableListSyncedAddressesRData) Get() *ListSyncedAddressesRData {
	return v.value
}

func (v *NullableListSyncedAddressesRData) Set(val *ListSyncedAddressesRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListSyncedAddressesRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListSyncedAddressesRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSyncedAddressesRData(val *ListSyncedAddressesRData) *NullableListSyncedAddressesRData {
	return &NullableListSyncedAddressesRData{value: val, isSet: true}
}

func (v NullableListSyncedAddressesRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSyncedAddressesRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
