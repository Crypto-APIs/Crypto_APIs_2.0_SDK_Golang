...
type NewConfirmedCoinsTransactions401Response struct {
	...
	Error NewConfirmedCoinsTransactionsE401 `json:"error"`
}
...
func NewNewConfirmedCoinsTransactions401Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsE401) *NewConfirmedCoinsTransactions401Response {
	this := NewConfirmedCoinsTransactions401Response{}
...
func (o *NewConfirmedCoinsTransactions401Response) GetError() NewConfirmedCoinsTransactionsE401 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsE401
		return ret
	}
...
func (o NewConfirmedCoinsTransactions401Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactions401Response struct {
	value *NewConfirmedCoinsTransactions401Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactions401Response) Get() *NewConfirmedCoinsTransactions401Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactions401Response) Set(val *NewConfirmedCoinsTransactions401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactions401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactions401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactions401Response(val *NewConfirmedCoinsTransactions401Response) *NullableNewConfirmedCoinsTransactions401Response {
	return &NullableNewConfirmedCoinsTransactions401Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactions401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactions401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
