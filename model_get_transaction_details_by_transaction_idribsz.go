...
type GetTransactionDetailsByTransactionIDRIBSZ struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSZ(bindingSig string, expiryHeight int32, joinSplitPubKey string, joinSplitSig string, locktime int32, overwintered bool, size int32, vJoinSplit []GetTransactionDetailsByTransactionIDRIBSZVJoinSplit, vShieldedOutput []GetTransactionDetailsByTransactionIDRIBSZVShieldedOutput, vShieldedSpend []GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend, valueBalance string, version int32, versionGroupId string, vin []GetTransactionDetailsByTransactionIDRIBSZVin, vout []GetTransactionDetailsByTransactionIDRIBSZVout) *GetTransactionDetailsByTransactionIDRIBSZ {
	this := GetTransactionDetailsByTransactionIDRIBSZ{}
...
func (o GetTransactionDetailsByTransactionIDRIBSZ) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSZ struct {
	value *GetTransactionDetailsByTransactionIDRIBSZ
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZ) Get() *GetTransactionDetailsByTransactionIDRIBSZ {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZ) Set(val *GetTransactionDetailsByTransactionIDRIBSZ) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZ) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZ) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSZ(val *GetTransactionDetailsByTransactionIDRIBSZ) *NullableGetTransactionDetailsByTransactionIDRIBSZ {
	return &NullableGetTransactionDetailsByTransactionIDRIBSZ{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZ) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZ) UnmarshalJSON(src []byte) error {
	v.isSet = true
