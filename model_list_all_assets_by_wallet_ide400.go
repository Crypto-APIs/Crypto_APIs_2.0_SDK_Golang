...
type ListAllAssetsByWalletIDE400 struct {
...
func InvalidPaginationAsListAllAssetsByWalletIDE400(v *InvalidPagination) ListAllAssetsByWalletIDE400 {
...
func LimitGreaterThanAllowedAsListAllAssetsByWalletIDE400(v *LimitGreaterThanAllowed) ListAllAssetsByWalletIDE400 {
	return ListAllAssetsByWalletIDE400{
...
func UriNotFoundAsListAllAssetsByWalletIDE400(v *UriNotFound) ListAllAssetsByWalletIDE400 {
	return ListAllAssetsByWalletIDE400{
		UriNotFound: v,
	}
}
...
func (dst *ListAllAssetsByWalletIDE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListAllAssetsByWalletIDE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListAllAssetsByWalletIDE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListAllAssetsByWalletIDE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListAllAssetsByWalletIDE400) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableListAllAssetsByWalletIDE400 struct {
	value *ListAllAssetsByWalletIDE400
	isSet bool
}

func (v NullableListAllAssetsByWalletIDE400) Get() *ListAllAssetsByWalletIDE400 {
	return v.value
}

func (v *NullableListAllAssetsByWalletIDE400) Set(val *ListAllAssetsByWalletIDE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsByWalletIDE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsByWalletIDE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsByWalletIDE400(val *ListAllAssetsByWalletIDE400) *NullableListAllAssetsByWalletIDE400 {
	return &NullableListAllAssetsByWalletIDE400{value: val, isSet: true}
}

func (v NullableListAllAssetsByWalletIDE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsByWalletIDE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
