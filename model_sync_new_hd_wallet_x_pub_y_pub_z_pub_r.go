...
type SyncNewHDWalletXPubYPubZPubR struct {
	...
	Data SyncNewHDWalletXPubYPubZPubRData `json:"data"`
}
...
func NewSyncNewHDWalletXPubYPubZPubR(apiVersion string, requestId string, data SyncNewHDWalletXPubYPubZPubRData) *SyncNewHDWalletXPubYPubZPubR {
	this := SyncNewHDWalletXPubYPubZPubR{}
...
func (o *SyncNewHDWalletXPubYPubZPubR) GetData() SyncNewHDWalletXPubYPubZPubRData {
	if o == nil {
		var ret SyncNewHDWalletXPubYPubZPubRData
		return ret
	}
...
func (o SyncNewHDWalletXPubYPubZPubR) MarshalJSON() ([]byte, error) {
...
type NullableSyncNewHDWalletXPubYPubZPubR struct {
	value *SyncNewHDWalletXPubYPubZPubR
	isSet bool
}

func (v NullableSyncNewHDWalletXPubYPubZPubR) Get() *SyncNewHDWalletXPubYPubZPubR {
	return v.value
}

func (v *NullableSyncNewHDWalletXPubYPubZPubR) Set(val *SyncNewHDWalletXPubYPubZPubR) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncNewHDWalletXPubYPubZPubR) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncNewHDWalletXPubYPubZPubR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncNewHDWalletXPubYPubZPubR(val *SyncNewHDWalletXPubYPubZPubR) *NullableSyncNewHDWalletXPubYPubZPubR {
	return &NullableSyncNewHDWalletXPubYPubZPubR{value: val, isSet: true}
}

func (v NullableSyncNewHDWalletXPubYPubZPubR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncNewHDWalletXPubYPubZPubR) UnmarshalJSON(src []byte) error {
	v.isSet = true
