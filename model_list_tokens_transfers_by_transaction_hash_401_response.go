...
type ListTokensTransfersByTransactionHash401Response struct {
	...
	Error ListTokensTransfersByTransactionHashE401 `json:"error"`
}
...
func NewListTokensTransfersByTransactionHash401Response(apiVersion string, requestId string, error_ ListTokensTransfersByTransactionHashE401) *ListTokensTransfersByTransactionHash401Response {
	this := ListTokensTransfersByTransactionHash401Response{}
...
func (o *ListTokensTransfersByTransactionHash401Response) GetError() ListTokensTransfersByTransactionHashE401 {
	if o == nil {
		var ret ListTokensTransfersByTransactionHashE401
		return ret
	}
...
func (o ListTokensTransfersByTransactionHash401Response) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByTransactionHash401Response struct {
	value *ListTokensTransfersByTransactionHash401Response
	isSet bool
}

func (v NullableListTokensTransfersByTransactionHash401Response) Get() *ListTokensTransfersByTransactionHash401Response {
	return v.value
}

func (v *NullableListTokensTransfersByTransactionHash401Response) Set(val *ListTokensTransfersByTransactionHash401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByTransactionHash401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByTransactionHash401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByTransactionHash401Response(val *ListTokensTransfersByTransactionHash401Response) *NullableListTokensTransfersByTransactionHash401Response {
	return &NullableListTokensTransfersByTransactionHash401Response{value: val, isSet: true}
}

func (v NullableListTokensTransfersByTransactionHash401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByTransactionHash401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
