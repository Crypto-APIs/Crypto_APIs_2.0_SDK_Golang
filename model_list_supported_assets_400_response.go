...
type ListSupportedAssets400Response struct {
	...
	Error ListSupportedAssetsE400 `json:"error"`
}
...
func NewListSupportedAssets400Response(apiVersion string, requestId string, error_ ListSupportedAssetsE400) *ListSupportedAssets400Response {
	this := ListSupportedAssets400Response{}
...
func (o *ListSupportedAssets400Response) GetError() ListSupportedAssetsE400 {
	if o == nil {
		var ret ListSupportedAssetsE400
		return ret
	}
...
func (o ListSupportedAssets400Response) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedAssets400Response struct {
	value *ListSupportedAssets400Response
	isSet bool
}

func (v NullableListSupportedAssets400Response) Get() *ListSupportedAssets400Response {
	return v.value
}

func (v *NullableListSupportedAssets400Response) Set(val *ListSupportedAssets400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedAssets400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedAssets400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedAssets400Response(val *ListSupportedAssets400Response) *NullableListSupportedAssets400Response {
	return &NullableListSupportedAssets400Response{value: val, isSet: true}
}

func (v NullableListSupportedAssets400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedAssets400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
