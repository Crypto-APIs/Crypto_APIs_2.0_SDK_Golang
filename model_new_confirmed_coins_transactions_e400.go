...
type NewConfirmedCoinsTransactionsE400 struct {
...
func (dst *NewConfirmedCoinsTransactionsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedCoinsTransactionsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedCoinsTransactionsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedCoinsTransactionsE400) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsE400 struct {
	value *NewConfirmedCoinsTransactionsE400
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsE400) Get() *NewConfirmedCoinsTransactionsE400 {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsE400) Set(val *NewConfirmedCoinsTransactionsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsE400(val *NewConfirmedCoinsTransactionsE400) *NullableNewConfirmedCoinsTransactionsE400 {
	return &NullableNewConfirmedCoinsTransactionsE400{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
