...
type GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig struct {
...
func NewGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig(asm string, hex string, type_ string) *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig {
	this := GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig struct {
	value *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) Get() *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) Set(val *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig(val *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig {
	return &NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
