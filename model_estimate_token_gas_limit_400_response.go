...
type EstimateTokenGasLimit400Response struct {
	...
	Error EstimateTokenGasLimitE400 `json:"error"`
}
...
func NewEstimateTokenGasLimit400Response(apiVersion string, requestId string, error_ EstimateTokenGasLimitE400) *EstimateTokenGasLimit400Response {
	this := EstimateTokenGasLimit400Response{}
...
func (o *EstimateTokenGasLimit400Response) GetError() EstimateTokenGasLimitE400 {
	if o == nil {
		var ret EstimateTokenGasLimitE400
		return ret
	}
...
func (o EstimateTokenGasLimit400Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateTokenGasLimit400Response struct {
	value *EstimateTokenGasLimit400Response
	isSet bool
}

func (v NullableEstimateTokenGasLimit400Response) Get() *EstimateTokenGasLimit400Response {
	return v.value
}

func (v *NullableEstimateTokenGasLimit400Response) Set(val *EstimateTokenGasLimit400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTokenGasLimit400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTokenGasLimit400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTokenGasLimit400Response(val *EstimateTokenGasLimit400Response) *NullableEstimateTokenGasLimit400Response {
	return &NullableEstimateTokenGasLimit400Response{value: val, isSet: true}
}

func (v NullableEstimateTokenGasLimit400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTokenGasLimit400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
