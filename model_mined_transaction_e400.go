...
type MinedTransactionE400 struct {
...
func InvalidPaginationAsMinedTransactionE400(v *InvalidPagination) MinedTransactionE400 {
	return MinedTransactionE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsMinedTransactionE400(v *LimitGreaterThanAllowed) MinedTransactionE400 {
	return MinedTransactionE400{ LimitGreaterThanAllowed: v}
}

// UriNotFoundAsMinedTransactionE400 is a convenience function that returns UriNotFound wrapped in MinedTransactionE400
func UriNotFoundAsMinedTransactionE400(v *UriNotFound) MinedTransactionE400 {
	return MinedTransactionE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *MinedTransactionE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(MinedTransactionE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(MinedTransactionE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src MinedTransactionE400) MarshalJSON() ([]byte, error) {
...
func (obj *MinedTransactionE400) GetActualInstance() (interface{}) {
...
type NullableMinedTransactionE400 struct {
	value *MinedTransactionE400
	isSet bool
}

func (v NullableMinedTransactionE400) Get() *MinedTransactionE400 {
	return v.value
}

func (v *NullableMinedTransactionE400) Set(val *MinedTransactionE400) {
	v.value = val
	v.isSet = true
}

func (v NullableMinedTransactionE400) IsSet() bool {
	return v.isSet
}

func (v *NullableMinedTransactionE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinedTransactionE400(val *MinedTransactionE400) *NullableMinedTransactionE400 {
	return &NullableMinedTransactionE400{value: val, isSet: true}
}

func (v NullableMinedTransactionE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinedTransactionE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
