...
type ListTokensByAddress403Response struct {
...
func (o ListTokensByAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableListTokensByAddress403Response struct {
	value *ListTokensByAddress403Response
	isSet bool
}

func (v NullableListTokensByAddress403Response) Get() *ListTokensByAddress403Response {
	return v.value
}

func (v *NullableListTokensByAddress403Response) Set(val *ListTokensByAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensByAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensByAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensByAddress403Response(val *ListTokensByAddress403Response) *NullableListTokensByAddress403Response {
	return &NullableListTokensByAddress403Response{value: val, isSet: true}
}

func (v NullableListTokensByAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensByAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
