...
type GetBlockchainEventSubscriptionDetailsByReferenceID403Response struct {
	...
	Error GetBlockchainEventSubscriptionDetailsByReferenceIDE403 `json:"error"`
}
...
func (o GetBlockchainEventSubscriptionDetailsByReferenceID403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response struct {
	value *GetBlockchainEventSubscriptionDetailsByReferenceID403Response
	isSet bool
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response) Get() *GetBlockchainEventSubscriptionDetailsByReferenceID403Response {
	return v.value
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response) Set(val *GetBlockchainEventSubscriptionDetailsByReferenceID403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response(val *GetBlockchainEventSubscriptionDetailsByReferenceID403Response) *NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response {
	return &NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response{value: val, isSet: true}
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
