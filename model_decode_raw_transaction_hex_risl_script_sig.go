...
type DecodeRawTransactionHexRISLScriptSig struct {
...
func (o DecodeRawTransactionHexRISLScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISLScriptSig struct {
	value *DecodeRawTransactionHexRISLScriptSig
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISLScriptSig) Get() *DecodeRawTransactionHexRISLScriptSig {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISLScriptSig) Set(val *DecodeRawTransactionHexRISLScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISLScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISLScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISLScriptSig(val *DecodeRawTransactionHexRISLScriptSig) *NullableDecodeRawTransactionHexRISLScriptSig {
	return &NullableDecodeRawTransactionHexRISLScriptSig{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISLScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISLScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
