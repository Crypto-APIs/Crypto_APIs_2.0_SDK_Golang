...
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey struct {
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey{}
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
