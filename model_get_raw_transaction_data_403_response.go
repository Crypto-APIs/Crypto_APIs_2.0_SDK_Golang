...
type GetRawTransactionData403Response struct {
	...
	Error GetRawTransactionDataE403 `json:"error"`
}
...
func NewGetRawTransactionData403Response(apiVersion string, requestId string, error_ GetRawTransactionDataE403) *GetRawTransactionData403Response {
	this := GetRawTransactionData403Response{}
...
func (o *GetRawTransactionData403Response) GetError() GetRawTransactionDataE403 {
	if o == nil {
		var ret GetRawTransactionDataE403
		return ret
	}
...
func (o GetRawTransactionData403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetRawTransactionData403Response struct {
	value *GetRawTransactionData403Response
	isSet bool
}

func (v NullableGetRawTransactionData403Response) Get() *GetRawTransactionData403Response {
	return v.value
}

func (v *NullableGetRawTransactionData403Response) Set(val *GetRawTransactionData403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRawTransactionData403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRawTransactionData403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRawTransactionData403Response(val *GetRawTransactionData403Response) *NullableGetRawTransactionData403Response {
	return &NullableGetRawTransactionData403Response{value: val, isSet: true}
}

func (v NullableGetRawTransactionData403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRawTransactionData403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
