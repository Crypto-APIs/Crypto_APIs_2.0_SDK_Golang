...
type NewUnconfirmedTokensTransactionsR struct {
	...
	Data NewUnconfirmedTokensTransactionsRData `json:"data"`
}
...
func NewNewUnconfirmedTokensTransactionsR(apiVersion string, requestId string, data NewUnconfirmedTokensTransactionsRData) *NewUnconfirmedTokensTransactionsR {
	this := NewUnconfirmedTokensTransactionsR{}
...
func (o *NewUnconfirmedTokensTransactionsR) GetData() NewUnconfirmedTokensTransactionsRData {
	if o == nil {
		var ret NewUnconfirmedTokensTransactionsRData
		return ret
	}
...
func (o NewUnconfirmedTokensTransactionsR) MarshalJSON() ([]byte, error) {
...
type NullableNewUnconfirmedTokensTransactionsR struct {
	value *NewUnconfirmedTokensTransactionsR
	isSet bool
}

func (v NullableNewUnconfirmedTokensTransactionsR) Get() *NewUnconfirmedTokensTransactionsR {
	return v.value
}

func (v *NullableNewUnconfirmedTokensTransactionsR) Set(val *NewUnconfirmedTokensTransactionsR) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUnconfirmedTokensTransactionsR) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUnconfirmedTokensTransactionsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUnconfirmedTokensTransactionsR(val *NewUnconfirmedTokensTransactionsR) *NullableNewUnconfirmedTokensTransactionsR {
	return &NullableNewUnconfirmedTokensTransactionsR{value: val, isSet: true}
}

func (v NullableNewUnconfirmedTokensTransactionsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUnconfirmedTokensTransactionsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
