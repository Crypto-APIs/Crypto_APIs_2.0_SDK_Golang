...
type EstimateGasLimit401Response struct {
	...
	Error EstimateGasLimitE401 `json:"error"`
}
...
func NewEstimateGasLimit401Response(apiVersion string, requestId string, error_ EstimateGasLimitE401) *EstimateGasLimit401Response {
	this := EstimateGasLimit401Response{}
...
func (o EstimateGasLimit401Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateGasLimit401Response struct {
	value *EstimateGasLimit401Response
	isSet bool
}

func (v NullableEstimateGasLimit401Response) Get() *EstimateGasLimit401Response {
	return v.value
}

func (v *NullableEstimateGasLimit401Response) Set(val *EstimateGasLimit401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateGasLimit401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateGasLimit401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateGasLimit401Response(val *EstimateGasLimit401Response) *NullableEstimateGasLimit401Response {
	return &NullableEstimateGasLimit401Response{value: val, isSet: true}
}

func (v NullableEstimateGasLimit401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateGasLimit401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
