...
// NewUnconfirmedCoinsTransactionsResponseItem struct for NewUnconfirmedCoinsTransactionsResponseItem
type NewUnconfirmedCoinsTransactionsResponseItem struct {
...
func NewNewUnconfirmedCoinsTransactionsResponseItem(callbackSecretKey string, callbackUrl string, confirmationsCount int32, createdTimestamp int32, eventType string, isActive bool, referenceId string, transactionId string) *NewUnconfirmedCoinsTransactionsResponseItem {
	this := NewUnconfirmedCoinsTransactionsResponseItem{}
...
func (o NewUnconfirmedCoinsTransactionsResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableNewUnconfirmedCoinsTransactionsResponseItem struct {
	value *NewUnconfirmedCoinsTransactionsResponseItem
	isSet bool
}

func (v NullableNewUnconfirmedCoinsTransactionsResponseItem) Get() *NewUnconfirmedCoinsTransactionsResponseItem {
	return v.value
}

func (v *NullableNewUnconfirmedCoinsTransactionsResponseItem) Set(val *NewUnconfirmedCoinsTransactionsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUnconfirmedCoinsTransactionsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUnconfirmedCoinsTransactionsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUnconfirmedCoinsTransactionsResponseItem(val *NewUnconfirmedCoinsTransactionsResponseItem) *NullableNewUnconfirmedCoinsTransactionsResponseItem {
	return &NullableNewUnconfirmedCoinsTransactionsResponseItem{value: val, isSet: true}
}

func (v NullableNewUnconfirmedCoinsTransactionsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUnconfirmedCoinsTransactionsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
