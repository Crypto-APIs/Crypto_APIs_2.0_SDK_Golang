...
// DecodeRawTransactionHexRISD2Vin struct for DecodeRawTransactionHexRISD2Vin
type DecodeRawTransactionHexRISD2Vin struct {
	...
	ScriptSig DecodeRawTransactionHexRISD2ScriptSig `json:"scriptSig"`
...
func NewDecodeRawTransactionHexRISD2Vin(scriptSig DecodeRawTransactionHexRISD2ScriptSig) *DecodeRawTransactionHexRISD2Vin {
	this := DecodeRawTransactionHexRISD2Vin{}
...
func (o *DecodeRawTransactionHexRISD2Vin) GetScriptSig() DecodeRawTransactionHexRISD2ScriptSig {
	if o == nil {
		var ret DecodeRawTransactionHexRISD2ScriptSig
		return ret
	}
...
func (o DecodeRawTransactionHexRISD2Vin) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISD2Vin struct {
	value *DecodeRawTransactionHexRISD2Vin
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISD2Vin) Get() *DecodeRawTransactionHexRISD2Vin {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISD2Vin) Set(val *DecodeRawTransactionHexRISD2Vin) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISD2Vin) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISD2Vin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISD2Vin(val *DecodeRawTransactionHexRISD2Vin) *NullableDecodeRawTransactionHexRISD2Vin {
	return &NullableDecodeRawTransactionHexRISD2Vin{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISD2Vin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISD2Vin) UnmarshalJSON(src []byte) error {
	v.isSet = true
