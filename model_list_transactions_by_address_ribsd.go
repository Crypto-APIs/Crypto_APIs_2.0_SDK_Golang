...
type ListTransactionsByAddressRIBSD struct {
	...
	Vin []ListTransactionsByAddressRIBSDVin `json:"vin"`
...
func NewListTransactionsByAddressRIBSD(locktime int32, size int32, version int32, vin []ListTransactionsByAddressRIBSDVin, vout []GetTransactionDetailsByTransactionIDRIBSDVout) *ListTransactionsByAddressRIBSD {
	this := ListTransactionsByAddressRIBSD{}
...
func (o *ListTransactionsByAddressRIBSD) GetVin() []ListTransactionsByAddressRIBSDVin {
	if o == nil {
		var ret []ListTransactionsByAddressRIBSDVin
		return ret
	}
...
func (o ListTransactionsByAddressRIBSD) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSD struct {
	value *ListTransactionsByAddressRIBSD
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSD) Get() *ListTransactionsByAddressRIBSD {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSD) Set(val *ListTransactionsByAddressRIBSD) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSD) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSD) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSD(val *ListTransactionsByAddressRIBSD) *NullableListTransactionsByAddressRIBSD {
	return &NullableListTransactionsByAddressRIBSD{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSD) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSD) UnmarshalJSON(src []byte) error {
	v.isSet = true
