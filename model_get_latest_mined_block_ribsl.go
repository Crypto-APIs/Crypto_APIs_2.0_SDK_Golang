...
type GetLatestMinedBlockRIBSL struct {
...
func (o GetLatestMinedBlockRIBSL) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockRIBSL struct {
	value *GetLatestMinedBlockRIBSL
	isSet bool
}

func (v NullableGetLatestMinedBlockRIBSL) Get() *GetLatestMinedBlockRIBSL {
	return v.value
}

func (v *NullableGetLatestMinedBlockRIBSL) Set(val *GetLatestMinedBlockRIBSL) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockRIBSL) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockRIBSL) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockRIBSL(val *GetLatestMinedBlockRIBSL) *NullableGetLatestMinedBlockRIBSL {
	return &NullableGetLatestMinedBlockRIBSL{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockRIBSL) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockRIBSL) UnmarshalJSON(src []byte) error {
	v.isSet = true
