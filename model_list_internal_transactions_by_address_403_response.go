...
type ListInternalTransactionsByAddress403Response struct {
	...
	Error ListInternalTransactionsByAddressE403 `json:"error"`
}
...
func NewListInternalTransactionsByAddress403Response(apiVersion string, requestId string, error_ ListInternalTransactionsByAddressE403) *ListInternalTransactionsByAddress403Response {
	this := ListInternalTransactionsByAddress403Response{}
...
func (o *ListInternalTransactionsByAddress403Response) GetError() ListInternalTransactionsByAddressE403 {
	if o == nil {
		var ret ListInternalTransactionsByAddressE403
		return ret
	}
...
func (o ListInternalTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionsByAddress403Response struct {
	value *ListInternalTransactionsByAddress403Response
	isSet bool
}

func (v NullableListInternalTransactionsByAddress403Response) Get() *ListInternalTransactionsByAddress403Response {
	return v.value
}

func (v *NullableListInternalTransactionsByAddress403Response) Set(val *ListInternalTransactionsByAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddress403Response(val *ListInternalTransactionsByAddress403Response) *NullableListInternalTransactionsByAddress403Response {
	return &NullableListInternalTransactionsByAddress403Response{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
