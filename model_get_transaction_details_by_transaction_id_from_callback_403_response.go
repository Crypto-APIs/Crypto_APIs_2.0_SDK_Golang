...
type GetTransactionDetailsByTransactionIDFromCallback403Response struct {
	...
	Error GetTransactionDetailsByTransactionIDFromCallbackE403 `json:"error"`
}
...
func NewGetTransactionDetailsByTransactionIDFromCallback403Response(apiVersion string, requestId string, error_ GetTransactionDetailsByTransactionIDFromCallbackE403) *GetTransactionDetailsByTransactionIDFromCallback403Response {
	this := GetTransactionDetailsByTransactionIDFromCallback403Response{}
...
func (o *GetTransactionDetailsByTransactionIDFromCallback403Response) GetError() GetTransactionDetailsByTransactionIDFromCallbackE403 {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDFromCallbackE403
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDFromCallback403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallback403Response struct {
	value *GetTransactionDetailsByTransactionIDFromCallback403Response
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallback403Response) Get() *GetTransactionDetailsByTransactionIDFromCallback403Response {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallback403Response) Set(val *GetTransactionDetailsByTransactionIDFromCallback403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallback403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallback403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallback403Response(val *GetTransactionDetailsByTransactionIDFromCallback403Response) *NullableGetTransactionDetailsByTransactionIDFromCallback403Response {
	return &NullableGetTransactionDetailsByTransactionIDFromCallback403Response{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallback403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallback403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
