...
// RequestLimitReachedError struct for RequestLimitReachedError
type RequestLimitReachedError struct {
...
func (o RequestLimitReachedError) MarshalJSON() ([]byte, error) {
...
type NullableRequestLimitReachedError struct {
	value *RequestLimitReachedError
	isSet bool
}

func (v NullableRequestLimitReachedError) Get() *RequestLimitReachedError {
	return v.value
}

func (v *NullableRequestLimitReachedError) Set(val *RequestLimitReachedError) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestLimitReachedError) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestLimitReachedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestLimitReachedError(val *RequestLimitReachedError) *NullableRequestLimitReachedError {
	return &NullableRequestLimitReachedError{value: val, isSet: true}
}

func (v NullableRequestLimitReachedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestLimitReachedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
