...
type GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin struct {
...
func NewGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, weight int32) *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin {
	this := GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin{}
...
func (o GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin struct {
	value *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) Get() *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) Set(val *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin(val *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin {
	return &NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
