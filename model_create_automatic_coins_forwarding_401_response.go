...
type CreateAutomaticCoinsForwarding401Response struct {
	...
	Error CreateAutomaticCoinsForwardingE401 `json:"error"`
}
...
func NewCreateAutomaticCoinsForwarding401Response(apiVersion string, requestId string, error_ CreateAutomaticCoinsForwardingE401) *CreateAutomaticCoinsForwarding401Response {
	this := CreateAutomaticCoinsForwarding401Response{}
...
func (o *CreateAutomaticCoinsForwarding401Response) GetError() CreateAutomaticCoinsForwardingE401 {
	if o == nil {
		var ret CreateAutomaticCoinsForwardingE401
		return ret
	}
...
func (o CreateAutomaticCoinsForwarding401Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticCoinsForwarding401Response struct {
	value *CreateAutomaticCoinsForwarding401Response
	isSet bool
}

func (v NullableCreateAutomaticCoinsForwarding401Response) Get() *CreateAutomaticCoinsForwarding401Response {
	return v.value
}

func (v *NullableCreateAutomaticCoinsForwarding401Response) Set(val *CreateAutomaticCoinsForwarding401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticCoinsForwarding401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticCoinsForwarding401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticCoinsForwarding401Response(val *CreateAutomaticCoinsForwarding401Response) *NullableCreateAutomaticCoinsForwarding401Response {
	return &NullableCreateAutomaticCoinsForwarding401Response{value: val, isSet: true}
}

func (v NullableCreateAutomaticCoinsForwarding401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticCoinsForwarding401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
