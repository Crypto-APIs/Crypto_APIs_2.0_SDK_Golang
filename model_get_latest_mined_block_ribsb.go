...
type GetLatestMinedBlockRIBSB struct {
...
func (o GetLatestMinedBlockRIBSB) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockRIBSB struct {
	value *GetLatestMinedBlockRIBSB
	isSet bool
}

func (v NullableGetLatestMinedBlockRIBSB) Get() *GetLatestMinedBlockRIBSB {
	return v.value
}

func (v *NullableGetLatestMinedBlockRIBSB) Set(val *GetLatestMinedBlockRIBSB) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockRIBSB) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockRIBSB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockRIBSB(val *GetLatestMinedBlockRIBSB) *NullableGetLatestMinedBlockRIBSB {
	return &NullableGetLatestMinedBlockRIBSB{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockRIBSB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockRIBSB) UnmarshalJSON(src []byte) error {
	v.isSet = true
