...
type GetLatestMinedBlockResponseItemBlockchainSpecificDash struct {
...
func NewGetLatestMinedBlockResponseItemBlockchainSpecificDash(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, version int32, versionHex string) *GetLatestMinedBlockResponseItemBlockchainSpecificDash {
	this := GetLatestMinedBlockResponseItemBlockchainSpecificDash{}
...
func (o GetLatestMinedBlockResponseItemBlockchainSpecificDash) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash struct {
	value *GetLatestMinedBlockResponseItemBlockchainSpecificDash
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash) Get() *GetLatestMinedBlockResponseItemBlockchainSpecificDash {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash) Set(val *GetLatestMinedBlockResponseItemBlockchainSpecificDash) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItemBlockchainSpecificDash(val *GetLatestMinedBlockResponseItemBlockchainSpecificDash) *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash {
	return &NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificDash) UnmarshalJSON(src []byte) error {
	v.isSet = true
