...
type GetTokenDetailsByContractAddress401Response struct {
	...
	Error GetTokenDetailsByContractAddressE401 `json:"error"`
}
...
func NewGetTokenDetailsByContractAddress401Response(apiVersion string, requestId string, error_ GetTokenDetailsByContractAddressE401) *GetTokenDetailsByContractAddress401Response {
	this := GetTokenDetailsByContractAddress401Response{}
...
func (o *GetTokenDetailsByContractAddress401Response) GetError() GetTokenDetailsByContractAddressE401 {
	if o == nil {
		var ret GetTokenDetailsByContractAddressE401
		return ret
	}
...
func (o GetTokenDetailsByContractAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTokenDetailsByContractAddress401Response struct {
	value *GetTokenDetailsByContractAddress401Response
	isSet bool
}

func (v NullableGetTokenDetailsByContractAddress401Response) Get() *GetTokenDetailsByContractAddress401Response {
	return v.value
}

func (v *NullableGetTokenDetailsByContractAddress401Response) Set(val *GetTokenDetailsByContractAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTokenDetailsByContractAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTokenDetailsByContractAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTokenDetailsByContractAddress401Response(val *GetTokenDetailsByContractAddress401Response) *NullableGetTokenDetailsByContractAddress401Response {
	return &NullableGetTokenDetailsByContractAddress401Response{value: val, isSet: true}
}

func (v NullableGetTokenDetailsByContractAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTokenDetailsByContractAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
