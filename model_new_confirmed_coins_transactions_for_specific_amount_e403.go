...
type NewConfirmedCoinsTransactionsForSpecificAmountE403 struct {
...
func BannedIpAddressAsNewConfirmedCoinsTransactionsForSpecificAmountE403(v *BannedIpAddress) NewConfirmedCoinsTransactionsForSpecificAmountE403 {
...
func BlockchainEventsCallbacksLimitReachedAsNewConfirmedCoinsTransactionsForSpecificAmountE403(v *BlockchainEventsCallbacksLimitReached) NewConfirmedCoinsTransactionsForSpecificAmountE403 {
	return NewConfirmedCoinsTransactionsForSpecificAmountE403{
...
func EndpointNotAllowedForApiKeyAsNewConfirmedCoinsTransactionsForSpecificAmountE403(v *EndpointNotAllowedForApiKey) NewConfirmedCoinsTransactionsForSpecificAmountE403 {
	return NewConfirmedCoinsTransactionsForSpecificAmountE403{
...
func EndpointNotAllowedForPlanAsNewConfirmedCoinsTransactionsForSpecificAmountE403(v *EndpointNotAllowedForPlan) NewConfirmedCoinsTransactionsForSpecificAmountE403 {
	return NewConfirmedCoinsTransactionsForSpecificAmountE403{
...
func FeatureMainnetsNotAllowedForPlanAsNewConfirmedCoinsTransactionsForSpecificAmountE403(v *FeatureMainnetsNotAllowedForPlan) NewConfirmedCoinsTransactionsForSpecificAmountE403 {
	return NewConfirmedCoinsTransactionsForSpecificAmountE403{
...
func (dst *NewConfirmedCoinsTransactionsForSpecificAmountE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedCoinsTransactionsForSpecificAmountE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedCoinsTransactionsForSpecificAmountE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedCoinsTransactionsForSpecificAmountE403) MarshalJSON() ([]byte, error) {
...
func (obj *NewConfirmedCoinsTransactionsForSpecificAmountE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableNewConfirmedCoinsTransactionsForSpecificAmountE403 struct {
	value *NewConfirmedCoinsTransactionsForSpecificAmountE403
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmountE403) Get() *NewConfirmedCoinsTransactionsForSpecificAmountE403 {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmountE403) Set(val *NewConfirmedCoinsTransactionsForSpecificAmountE403) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmountE403) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmountE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsForSpecificAmountE403(val *NewConfirmedCoinsTransactionsForSpecificAmountE403) *NullableNewConfirmedCoinsTransactionsForSpecificAmountE403 {
	return &NullableNewConfirmedCoinsTransactionsForSpecificAmountE403{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsForSpecificAmountE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsForSpecificAmountE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
