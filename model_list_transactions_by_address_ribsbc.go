...
type ListTransactionsByAddressRIBSBC struct {
	...
	Vin []ListTransactionsByAddressRIBSBCVin `json:"vin"`
...
func NewListTransactionsByAddressRIBSBC(locktime int32, size int32, version int32, vin []ListTransactionsByAddressRIBSBCVin, vout []GetTransactionDetailsByTransactionIDRIBSBCVout) *ListTransactionsByAddressRIBSBC {
	this := ListTransactionsByAddressRIBSBC{}
...
func (o *ListTransactionsByAddressRIBSBC) GetVin() []ListTransactionsByAddressRIBSBCVin {
	if o == nil {
		var ret []ListTransactionsByAddressRIBSBCVin
		return ret
	}
...
func (o ListTransactionsByAddressRIBSBC) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSBC struct {
	value *ListTransactionsByAddressRIBSBC
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSBC) Get() *ListTransactionsByAddressRIBSBC {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSBC) Set(val *ListTransactionsByAddressRIBSBC) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSBC) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSBC) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSBC(val *ListTransactionsByAddressRIBSBC) *NullableListTransactionsByAddressRIBSBC {
	return &NullableListTransactionsByAddressRIBSBC{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSBC) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSBC) UnmarshalJSON(src []byte) error {
	v.isSet = true
