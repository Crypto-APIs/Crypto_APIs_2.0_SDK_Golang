...
func (o *ListInternalTransactionDetailsByTransactionHashRData) GetItems() []ListInternalTransactionDetailsByTransactionHashRI {
	if o == nil {
		var ret []ListInternalTransactionDetailsByTransactionHashRI
		return ret
	}
...
type NullableListInternalTransactionDetailsByTransactionHashRData struct {
	value *ListInternalTransactionDetailsByTransactionHashRData
	isSet bool
}

func (v NullableListInternalTransactionDetailsByTransactionHashRData) Get() *ListInternalTransactionDetailsByTransactionHashRData {
	return v.value
}

func (v *NullableListInternalTransactionDetailsByTransactionHashRData) Set(val *ListInternalTransactionDetailsByTransactionHashRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionDetailsByTransactionHashRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionDetailsByTransactionHashRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionDetailsByTransactionHashRData(val *ListInternalTransactionDetailsByTransactionHashRData) *NullableListInternalTransactionDetailsByTransactionHashRData {
	return &NullableListInternalTransactionDetailsByTransactionHashRData{value: val, isSet: true}
}

func (v NullableListInternalTransactionDetailsByTransactionHashRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionDetailsByTransactionHashRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
