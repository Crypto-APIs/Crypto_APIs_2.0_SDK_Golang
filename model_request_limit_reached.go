...
// RequestLimitReached struct for RequestLimitReached
type RequestLimitReached struct {
	...
	Error RequestLimitReachedError `json:"error"`
}
...
func (o *RequestLimitReached) GetError() RequestLimitReachedError {
	if o == nil {
		var ret RequestLimitReachedError
		return ret
	}
...
func (o RequestLimitReached) MarshalJSON() ([]byte, error) {
...
type NullableRequestLimitReached struct {
	value *RequestLimitReached
	isSet bool
}

func (v NullableRequestLimitReached) Get() *RequestLimitReached {
	return v.value
}

func (v *NullableRequestLimitReached) Set(val *RequestLimitReached) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestLimitReached) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestLimitReached) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestLimitReached(val *RequestLimitReached) *NullableRequestLimitReached {
	return &NullableRequestLimitReached{value: val, isSet: true}
}

func (v NullableRequestLimitReached) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestLimitReached) UnmarshalJSON(src []byte) error {
	v.isSet = true
