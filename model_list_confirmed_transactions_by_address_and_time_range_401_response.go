...
type ListConfirmedTransactionsByAddressAndTimeRange401Response struct {
	...
	Error ListConfirmedTransactionsByAddressAndTimeRangeE401 `json:"error"`
}
...
func NewListConfirmedTransactionsByAddressAndTimeRange401Response(apiVersion string, requestId string, error_ ListConfirmedTransactionsByAddressAndTimeRangeE401) *ListConfirmedTransactionsByAddressAndTimeRange401Response {
	this := ListConfirmedTransactionsByAddressAndTimeRange401Response{}
...
func (o *ListConfirmedTransactionsByAddressAndTimeRange401Response) GetError() ListConfirmedTransactionsByAddressAndTimeRangeE401 {
	if o == nil {
		var ret ListConfirmedTransactionsByAddressAndTimeRangeE401
		return ret
	}
...
func (o ListConfirmedTransactionsByAddressAndTimeRange401Response) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressAndTimeRange401Response struct {
	value *ListConfirmedTransactionsByAddressAndTimeRange401Response
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange401Response) Get() *ListConfirmedTransactionsByAddressAndTimeRange401Response {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange401Response) Set(val *ListConfirmedTransactionsByAddressAndTimeRange401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressAndTimeRange401Response(val *ListConfirmedTransactionsByAddressAndTimeRange401Response) *NullableListConfirmedTransactionsByAddressAndTimeRange401Response {
	return &NullableListConfirmedTransactionsByAddressAndTimeRange401Response{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
