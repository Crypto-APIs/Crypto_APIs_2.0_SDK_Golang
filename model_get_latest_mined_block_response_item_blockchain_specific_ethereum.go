...
type GetLatestMinedBlockResponseItemBlockchainSpecificEthereum struct {
...
func NewGetLatestMinedBlockResponseItemBlockchainSpecificEthereum(difficulty string, nonce string, size int32, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, sha3Uncles string, totalDifficulty string) *GetLatestMinedBlockResponseItemBlockchainSpecificEthereum {
	this := GetLatestMinedBlockResponseItemBlockchainSpecificEthereum{}
...
func (o GetLatestMinedBlockResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum struct {
	value *GetLatestMinedBlockResponseItemBlockchainSpecificEthereum
	isSet bool
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum) Get() *GetLatestMinedBlockResponseItemBlockchainSpecificEthereum {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum) Set(val *GetLatestMinedBlockResponseItemBlockchainSpecificEthereum) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum(val *GetLatestMinedBlockResponseItemBlockchainSpecificEthereum) *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum {
	return &NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponseItemBlockchainSpecificEthereum) UnmarshalJSON(src []byte) error {
	v.isSet = true
