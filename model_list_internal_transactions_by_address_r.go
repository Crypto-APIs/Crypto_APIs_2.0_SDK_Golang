...
type ListInternalTransactionsByAddressR struct {
	...
	Data ListInternalTransactionsByAddressRData `json:"data"`
}
...
func NewListInternalTransactionsByAddressR(apiVersion string, requestId string, data ListInternalTransactionsByAddressRData) *ListInternalTransactionsByAddressR {
	this := ListInternalTransactionsByAddressR{}
...
func (o *ListInternalTransactionsByAddressR) GetData() ListInternalTransactionsByAddressRData {
	if o == nil {
		var ret ListInternalTransactionsByAddressRData
		return ret
	}
...
func (o ListInternalTransactionsByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionsByAddressR struct {
	value *ListInternalTransactionsByAddressR
	isSet bool
}

func (v NullableListInternalTransactionsByAddressR) Get() *ListInternalTransactionsByAddressR {
	return v.value
}

func (v *NullableListInternalTransactionsByAddressR) Set(val *ListInternalTransactionsByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddressR(val *ListInternalTransactionsByAddressR) *NullableListInternalTransactionsByAddressR {
	return &NullableListInternalTransactionsByAddressR{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
