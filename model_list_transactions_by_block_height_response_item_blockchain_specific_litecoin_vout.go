...
// ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout struct for ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout(isSpent bool, scriptPubKey ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptPubKey, value string) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout{}
...
func (o *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) GetScriptPubKey() ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptPubKey {
	if o == nil {
		var ret ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptPubKey
		return ret
	}
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
