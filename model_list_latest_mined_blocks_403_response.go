...
type ListLatestMinedBlocks403Response struct {
	...
	Error ListLatestMinedBlocksE403 `json:"error"`
}
...
func NewListLatestMinedBlocks403Response(apiVersion string, requestId string, error_ ListLatestMinedBlocksE403) *ListLatestMinedBlocks403Response {
	this := ListLatestMinedBlocks403Response{}
...
func (o *ListLatestMinedBlocks403Response) GetError() ListLatestMinedBlocksE403 {
	if o == nil {
		var ret ListLatestMinedBlocksE403
		return ret
	}
...
func (o ListLatestMinedBlocks403Response) MarshalJSON() ([]byte, error) {
...
type NullableListLatestMinedBlocks403Response struct {
	value *ListLatestMinedBlocks403Response
	isSet bool
}

func (v NullableListLatestMinedBlocks403Response) Get() *ListLatestMinedBlocks403Response {
	return v.value
}

func (v *NullableListLatestMinedBlocks403Response) Set(val *ListLatestMinedBlocks403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListLatestMinedBlocks403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListLatestMinedBlocks403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLatestMinedBlocks403Response(val *ListLatestMinedBlocks403Response) *NullableListLatestMinedBlocks403Response {
	return &NullableListLatestMinedBlocks403Response{value: val, isSet: true}
}

func (v NullableListLatestMinedBlocks403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLatestMinedBlocks403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
