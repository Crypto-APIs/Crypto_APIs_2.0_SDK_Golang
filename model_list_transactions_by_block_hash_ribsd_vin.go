...
// ListTransactionsByBlockHashRIBSDVin struct for ListTransactionsByBlockHashRIBSDVin
type ListTransactionsByBlockHashRIBSDVin struct {
...
func NewListTransactionsByBlockHashRIBSDVin(addresses []string, scriptSig GetTransactionDetailsByTransactionIDRIBSDScriptSig, sequence string, txinwitness []string, value string) *ListTransactionsByBlockHashRIBSDVin {
	this := ListTransactionsByBlockHashRIBSDVin{}
...
func (o ListTransactionsByBlockHashRIBSDVin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSDVin struct {
	value *ListTransactionsByBlockHashRIBSDVin
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSDVin) Get() *ListTransactionsByBlockHashRIBSDVin {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSDVin) Set(val *ListTransactionsByBlockHashRIBSDVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSDVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSDVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSDVin(val *ListTransactionsByBlockHashRIBSDVin) *NullableListTransactionsByBlockHashRIBSDVin {
	return &NullableListTransactionsByBlockHashRIBSDVin{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSDVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSDVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
