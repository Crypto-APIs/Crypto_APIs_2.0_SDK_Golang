...
type ListUnspentTransactionOutputsByAddressE403 struct {
...
func BannedIpAddressAsListUnspentTransactionOutputsByAddressE403(v *BannedIpAddress) ListUnspentTransactionOutputsByAddressE403 {
	return ListUnspentTransactionOutputsByAddressE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListUnspentTransactionOutputsByAddressE403(v *EndpointNotAllowedForApiKey) ListUnspentTransactionOutputsByAddressE403 {
	return ListUnspentTransactionOutputsByAddressE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListUnspentTransactionOutputsByAddressE403(v *EndpointNotAllowedForPlan) ListUnspentTransactionOutputsByAddressE403 {
	return ListUnspentTransactionOutputsByAddressE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListUnspentTransactionOutputsByAddressE403(v *FeatureMainnetsNotAllowedForPlan) ListUnspentTransactionOutputsByAddressE403 {
	return ListUnspentTransactionOutputsByAddressE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListUnspentTransactionOutputsByAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListUnspentTransactionOutputsByAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListUnspentTransactionOutputsByAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListUnspentTransactionOutputsByAddressE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListUnspentTransactionOutputsByAddressE403) GetActualInstance() (interface{}) {
...
type NullableListUnspentTransactionOutputsByAddressE403 struct {
	value *ListUnspentTransactionOutputsByAddressE403
	isSet bool
}

func (v NullableListUnspentTransactionOutputsByAddressE403) Get() *ListUnspentTransactionOutputsByAddressE403 {
	return v.value
}

func (v *NullableListUnspentTransactionOutputsByAddressE403) Set(val *ListUnspentTransactionOutputsByAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnspentTransactionOutputsByAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnspentTransactionOutputsByAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnspentTransactionOutputsByAddressE403(val *ListUnspentTransactionOutputsByAddressE403) *NullableListUnspentTransactionOutputsByAddressE403 {
	return &NullableListUnspentTransactionOutputsByAddressE403{value: val, isSet: true}
}

func (v NullableListUnspentTransactionOutputsByAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnspentTransactionOutputsByAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
