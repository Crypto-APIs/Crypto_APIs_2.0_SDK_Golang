...
type BroadcastLocallySignedTransaction403Response struct {
	...
	Error BroadcastLocallySignedTransactionE403 `json:"error"`
}
...
func NewBroadcastLocallySignedTransaction403Response(apiVersion string, requestId string, error_ BroadcastLocallySignedTransactionE403) *BroadcastLocallySignedTransaction403Response {
	this := BroadcastLocallySignedTransaction403Response{}
...
func (o *BroadcastLocallySignedTransaction403Response) GetError() BroadcastLocallySignedTransactionE403 {
	if o == nil {
		var ret BroadcastLocallySignedTransactionE403
		return ret
	}
...
func (o BroadcastLocallySignedTransaction403Response) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastLocallySignedTransaction403Response struct {
	value *BroadcastLocallySignedTransaction403Response
	isSet bool
}

func (v NullableBroadcastLocallySignedTransaction403Response) Get() *BroadcastLocallySignedTransaction403Response {
	return v.value
}

func (v *NullableBroadcastLocallySignedTransaction403Response) Set(val *BroadcastLocallySignedTransaction403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastLocallySignedTransaction403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastLocallySignedTransaction403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastLocallySignedTransaction403Response(val *BroadcastLocallySignedTransaction403Response) *NullableBroadcastLocallySignedTransaction403Response {
	return &NullableBroadcastLocallySignedTransaction403Response{value: val, isSet: true}
}

func (v NullableBroadcastLocallySignedTransaction403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastLocallySignedTransaction403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
