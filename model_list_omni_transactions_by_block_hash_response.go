...
// ListOmniTransactionsByBlockHashResponse struct for ListOmniTransactionsByBlockHashResponse
type ListOmniTransactionsByBlockHashResponse struct {
	...
	Data ListOmniTransactionsByBlockHashResponseData `json:"data"`
}
...
func NewListOmniTransactionsByBlockHashResponse(apiVersion string, requestId string, data ListOmniTransactionsByBlockHashResponseData) *ListOmniTransactionsByBlockHashResponse {
	this := ListOmniTransactionsByBlockHashResponse{}
...
func (o *ListOmniTransactionsByBlockHashResponse) GetData() ListOmniTransactionsByBlockHashResponseData {
	if o == nil {
		var ret ListOmniTransactionsByBlockHashResponseData
		return ret
	}
...
func (o ListOmniTransactionsByBlockHashResponse) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHashResponse struct {
	value *ListOmniTransactionsByBlockHashResponse
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHashResponse) Get() *ListOmniTransactionsByBlockHashResponse {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHashResponse) Set(val *ListOmniTransactionsByBlockHashResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHashResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHashResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHashResponse(val *ListOmniTransactionsByBlockHashResponse) *NullableListOmniTransactionsByBlockHashResponse {
	return &NullableListOmniTransactionsByBlockHashResponse{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHashResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHashResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
