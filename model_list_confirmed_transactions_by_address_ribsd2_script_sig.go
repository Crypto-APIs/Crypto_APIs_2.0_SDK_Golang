...
type ListConfirmedTransactionsByAddressRIBSD2ScriptSig struct {
...
func NewListConfirmedTransactionsByAddressRIBSD2ScriptSig(asm string, hex string, type_ string) *ListConfirmedTransactionsByAddressRIBSD2ScriptSig {
	this := ListConfirmedTransactionsByAddressRIBSD2ScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListConfirmedTransactionsByAddressRIBSD2ScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig struct {
	value *ListConfirmedTransactionsByAddressRIBSD2ScriptSig
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig) Get() *ListConfirmedTransactionsByAddressRIBSD2ScriptSig {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig) Set(val *ListConfirmedTransactionsByAddressRIBSD2ScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRIBSD2ScriptSig(val *ListConfirmedTransactionsByAddressRIBSD2ScriptSig) *NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig {
	return &NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRIBSD2ScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
