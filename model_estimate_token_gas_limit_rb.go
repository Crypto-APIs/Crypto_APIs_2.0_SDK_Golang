...
type EstimateTokenGasLimitRB struct {
	// In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
	Context *string `json:"context,omitempty"`
	Data EstimateTokenGasLimitRBData `json:"data"`
}
...
func (o *EstimateTokenGasLimitRB) GetData() EstimateTokenGasLimitRBData {
	if o == nil {
		var ret EstimateTokenGasLimitRBData
		return ret
	}
...
func (o EstimateTokenGasLimitRB) MarshalJSON() ([]byte, error) {
...
type NullableEstimateTokenGasLimitRB struct {
	value *EstimateTokenGasLimitRB
	isSet bool
}

func (v NullableEstimateTokenGasLimitRB) Get() *EstimateTokenGasLimitRB {
	return v.value
}

func (v *NullableEstimateTokenGasLimitRB) Set(val *EstimateTokenGasLimitRB) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTokenGasLimitRB) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTokenGasLimitRB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTokenGasLimitRB(val *EstimateTokenGasLimitRB) *NullableEstimateTokenGasLimitRB {
	return &NullableEstimateTokenGasLimitRB{value: val, isSet: true}
}

func (v NullableEstimateTokenGasLimitRB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTokenGasLimitRB) UnmarshalJSON(src []byte) error {
	v.isSet = true
