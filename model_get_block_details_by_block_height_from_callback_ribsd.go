...
type GetBlockDetailsByBlockHeightFromCallbackRIBSD struct {
...
func NewGetBlockDetailsByBlockHeightFromCallbackRIBSD(bits string, chainwork string, difficulty string, merkleRoot string, nonce int64, size int32, version int32, versionHex string) *GetBlockDetailsByBlockHeightFromCallbackRIBSD {
	this := GetBlockDetailsByBlockHeightFromCallbackRIBSD{}
	this.Bits = bits
...
func (o GetBlockDetailsByBlockHeightFromCallbackRIBSD) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD struct {
	value *GetBlockDetailsByBlockHeightFromCallbackRIBSD
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD) Get() *GetBlockDetailsByBlockHeightFromCallbackRIBSD {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD) Set(val *GetBlockDetailsByBlockHeightFromCallbackRIBSD) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightFromCallbackRIBSD(val *GetBlockDetailsByBlockHeightFromCallbackRIBSD) *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD {
	return &NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightFromCallbackRIBSD) UnmarshalJSON(src []byte) error {
	v.isSet = true
