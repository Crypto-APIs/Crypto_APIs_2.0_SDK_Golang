...
// WalletAsAServiceDepositAddressesLimitReachedError struct for WalletAsAServiceDepositAddressesLimitReachedError
type WalletAsAServiceDepositAddressesLimitReachedError struct {
...
func NewWalletAsAServiceDepositAddressesLimitReachedError(code string, message string) *WalletAsAServiceDepositAddressesLimitReachedError {
	this := WalletAsAServiceDepositAddressesLimitReachedError{}
	this.Code = code
...
func (o WalletAsAServiceDepositAddressesLimitReachedError) MarshalJSON() ([]byte, error) {
...
type NullableWalletAsAServiceDepositAddressesLimitReachedError struct {
	value *WalletAsAServiceDepositAddressesLimitReachedError
	isSet bool
}

func (v NullableWalletAsAServiceDepositAddressesLimitReachedError) Get() *WalletAsAServiceDepositAddressesLimitReachedError {
	return v.value
}

func (v *NullableWalletAsAServiceDepositAddressesLimitReachedError) Set(val *WalletAsAServiceDepositAddressesLimitReachedError) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletAsAServiceDepositAddressesLimitReachedError) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletAsAServiceDepositAddressesLimitReachedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletAsAServiceDepositAddressesLimitReachedError(val *WalletAsAServiceDepositAddressesLimitReachedError) *NullableWalletAsAServiceDepositAddressesLimitReachedError {
	return &NullableWalletAsAServiceDepositAddressesLimitReachedError{value: val, isSet: true}
}

func (v NullableWalletAsAServiceDepositAddressesLimitReachedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletAsAServiceDepositAddressesLimitReachedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
