...
// ListOmniTransactionsByBlockHeight401Response struct for ListOmniTransactionsByBlockHeight401Response
type ListOmniTransactionsByBlockHeight401Response struct {
	...
	Error ListOmniTransactionsByBlockHeightE401 `json:"error"`
}
...
func NewListOmniTransactionsByBlockHeight401Response(apiVersion string, requestId string, error_ ListOmniTransactionsByBlockHeightE401) *ListOmniTransactionsByBlockHeight401Response {
	this := ListOmniTransactionsByBlockHeight401Response{}
...
func (o *ListOmniTransactionsByBlockHeight401Response) GetError() ListOmniTransactionsByBlockHeightE401 {
	if o == nil {
		var ret ListOmniTransactionsByBlockHeightE401
		return ret
	}
...
func (o ListOmniTransactionsByBlockHeight401Response) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHeight401Response struct {
	value *ListOmniTransactionsByBlockHeight401Response
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHeight401Response) Get() *ListOmniTransactionsByBlockHeight401Response {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHeight401Response) Set(val *ListOmniTransactionsByBlockHeight401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHeight401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHeight401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHeight401Response(val *ListOmniTransactionsByBlockHeight401Response) *NullableListOmniTransactionsByBlockHeight401Response {
	return &NullableListOmniTransactionsByBlockHeight401Response{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHeight401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHeight401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
