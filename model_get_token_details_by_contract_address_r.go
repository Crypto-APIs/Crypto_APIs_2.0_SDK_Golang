...
type GetTokenDetailsByContractAddressR struct {
	...
	Data GetTokenDetailsByContractAddressRData `json:"data"`
}
...
func NewGetTokenDetailsByContractAddressR(apiVersion string, requestId string, data GetTokenDetailsByContractAddressRData) *GetTokenDetailsByContractAddressR {
	this := GetTokenDetailsByContractAddressR{}
...
func (o *GetTokenDetailsByContractAddressR) GetData() GetTokenDetailsByContractAddressRData {
	if o == nil {
		var ret GetTokenDetailsByContractAddressRData
		return ret
	}
...
func (o GetTokenDetailsByContractAddressR) MarshalJSON() ([]byte, error) {
...
type NullableGetTokenDetailsByContractAddressR struct {
	value *GetTokenDetailsByContractAddressR
	isSet bool
}

func (v NullableGetTokenDetailsByContractAddressR) Get() *GetTokenDetailsByContractAddressR {
	return v.value
}

func (v *NullableGetTokenDetailsByContractAddressR) Set(val *GetTokenDetailsByContractAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTokenDetailsByContractAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTokenDetailsByContractAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTokenDetailsByContractAddressR(val *GetTokenDetailsByContractAddressR) *NullableGetTokenDetailsByContractAddressR {
	return &NullableGetTokenDetailsByContractAddressR{value: val, isSet: true}
}

func (v NullableGetTokenDetailsByContractAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTokenDetailsByContractAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
