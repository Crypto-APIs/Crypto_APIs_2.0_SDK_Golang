...
type ConvertBitcoinCashAddress401Response struct {
	...
	Error ConvertBitcoinCashAddressE401 `json:"error"`
}
...
func NewConvertBitcoinCashAddress401Response(apiVersion string, requestId string, error_ ConvertBitcoinCashAddressE401) *ConvertBitcoinCashAddress401Response {
	this := ConvertBitcoinCashAddress401Response{}
...
func (o *ConvertBitcoinCashAddress401Response) GetError() ConvertBitcoinCashAddressE401 {
	if o == nil {
		var ret ConvertBitcoinCashAddressE401
		return ret
	}
...
func (o ConvertBitcoinCashAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress401Response struct {
	value *ConvertBitcoinCashAddress401Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress401Response) Get() *ConvertBitcoinCashAddress401Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress401Response) Set(val *ConvertBitcoinCashAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress401Response(val *ConvertBitcoinCashAddress401Response) *NullableConvertBitcoinCashAddress401Response {
	return &NullableConvertBitcoinCashAddress401Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
