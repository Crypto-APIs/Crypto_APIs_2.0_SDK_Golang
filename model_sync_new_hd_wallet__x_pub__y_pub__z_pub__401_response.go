...
type SyncNewHDWalletXPubYPubZPub401Response struct {
	...
	Error SyncNewHDWalletXPubYPubZPubE401 `json:"error"`
}
...
func NewSyncNewHDWalletXPubYPubZPub401Response(apiVersion string, requestId string, error_ SyncNewHDWalletXPubYPubZPubE401) *SyncNewHDWalletXPubYPubZPub401Response {
	this := SyncNewHDWalletXPubYPubZPub401Response{}
...
func (o *SyncNewHDWalletXPubYPubZPub401Response) GetError() SyncNewHDWalletXPubYPubZPubE401 {
	if o == nil {
		var ret SyncNewHDWalletXPubYPubZPubE401
		return ret
	}
...
func (o SyncNewHDWalletXPubYPubZPub401Response) MarshalJSON() ([]byte, error) {
...
type NullableSyncNewHDWalletXPubYPubZPub401Response struct {
	value *SyncNewHDWalletXPubYPubZPub401Response
	isSet bool
}

func (v NullableSyncNewHDWalletXPubYPubZPub401Response) Get() *SyncNewHDWalletXPubYPubZPub401Response {
	return v.value
}

func (v *NullableSyncNewHDWalletXPubYPubZPub401Response) Set(val *SyncNewHDWalletXPubYPubZPub401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncNewHDWalletXPubYPubZPub401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncNewHDWalletXPubYPubZPub401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncNewHDWalletXPubYPubZPub401Response(val *SyncNewHDWalletXPubYPubZPub401Response) *NullableSyncNewHDWalletXPubYPubZPub401Response {
	return &NullableSyncNewHDWalletXPubYPubZPub401Response{value: val, isSet: true}
}

func (v NullableSyncNewHDWalletXPubYPubZPub401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncNewHDWalletXPubYPubZPub401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
