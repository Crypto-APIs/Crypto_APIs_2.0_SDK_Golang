...
type GetXRPRippleAddressDetailsE403 struct {
...
func BannedIpAddressAsGetXRPRippleAddressDetailsE403(v *BannedIpAddress) GetXRPRippleAddressDetailsE403 {
	return GetXRPRippleAddressDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetXRPRippleAddressDetailsE403(v *EndpointNotAllowedForApiKey) GetXRPRippleAddressDetailsE403 {
	return GetXRPRippleAddressDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetXRPRippleAddressDetailsE403(v *EndpointNotAllowedForPlan) GetXRPRippleAddressDetailsE403 {
	return GetXRPRippleAddressDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetXRPRippleAddressDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetXRPRippleAddressDetailsE403 {
	return GetXRPRippleAddressDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetXRPRippleAddressDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetXRPRippleAddressDetailsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetXRPRippleAddressDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetXRPRippleAddressDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetXRPRippleAddressDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetXRPRippleAddressDetailsE403 struct {
	value *GetXRPRippleAddressDetailsE403
	isSet bool
}

func (v NullableGetXRPRippleAddressDetailsE403) Get() *GetXRPRippleAddressDetailsE403 {
	return v.value
}

func (v *NullableGetXRPRippleAddressDetailsE403) Set(val *GetXRPRippleAddressDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetXRPRippleAddressDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetXRPRippleAddressDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetXRPRippleAddressDetailsE403(val *GetXRPRippleAddressDetailsE403) *NullableGetXRPRippleAddressDetailsE403 {
	return &NullableGetXRPRippleAddressDetailsE403{value: val, isSet: true}
}

func (v NullableGetXRPRippleAddressDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetXRPRippleAddressDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
