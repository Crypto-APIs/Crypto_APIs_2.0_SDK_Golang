...
// CoinsForwardingAutomationsLimitReachedError struct for CoinsForwardingAutomationsLimitReachedError
type CoinsForwardingAutomationsLimitReachedError struct {
...
func NewCoinsForwardingAutomationsLimitReachedError(code string, message string) *CoinsForwardingAutomationsLimitReachedError {
	this := CoinsForwardingAutomationsLimitReachedError{}
	this.Code = code
...
func (o CoinsForwardingAutomationsLimitReachedError) MarshalJSON() ([]byte, error) {
...
type NullableCoinsForwardingAutomationsLimitReachedError struct {
	value *CoinsForwardingAutomationsLimitReachedError
	isSet bool
}

func (v NullableCoinsForwardingAutomationsLimitReachedError) Get() *CoinsForwardingAutomationsLimitReachedError {
	return v.value
}

func (v *NullableCoinsForwardingAutomationsLimitReachedError) Set(val *CoinsForwardingAutomationsLimitReachedError) {
	v.value = val
	v.isSet = true
}

func (v NullableCoinsForwardingAutomationsLimitReachedError) IsSet() bool {
	return v.isSet
}

func (v *NullableCoinsForwardingAutomationsLimitReachedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoinsForwardingAutomationsLimitReachedError(val *CoinsForwardingAutomationsLimitReachedError) *NullableCoinsForwardingAutomationsLimitReachedError {
	return &NullableCoinsForwardingAutomationsLimitReachedError{value: val, isSet: true}
}

func (v NullableCoinsForwardingAutomationsLimitReachedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoinsForwardingAutomationsLimitReachedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
