...
// ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients struct for ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients
type ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients struct {
...
func NewListHDWalletxPubYPubZPubTransactionsResponseItemRecipients(address string, amount string, isMember bool) *ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients {
	this := ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients{}
...
func (o ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients struct {
	value *ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients
	isSet bool
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) Get() *ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients {
	return v.value
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) Set(val *ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients(val *ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) *NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients {
	return &NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients{value: val, isSet: true}
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponseItemRecipients) UnmarshalJSON(src []byte) error {
	v.isSet = true
