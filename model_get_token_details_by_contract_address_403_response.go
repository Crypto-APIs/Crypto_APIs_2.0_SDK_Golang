...
type GetTokenDetailsByContractAddress403Response struct {
	...
	Error GetTokenDetailsByContractAddressE403 `json:"error"`
}
...
func (o *GetTokenDetailsByContractAddress403Response) GetError() GetTokenDetailsByContractAddressE403 {
	if o == nil {
		var ret GetTokenDetailsByContractAddressE403
		return ret
	}
...
func (o GetTokenDetailsByContractAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTokenDetailsByContractAddress403Response struct {
	value *GetTokenDetailsByContractAddress403Response
	isSet bool
}

func (v NullableGetTokenDetailsByContractAddress403Response) Get() *GetTokenDetailsByContractAddress403Response {
	return v.value
}

func (v *NullableGetTokenDetailsByContractAddress403Response) Set(val *GetTokenDetailsByContractAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTokenDetailsByContractAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTokenDetailsByContractAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTokenDetailsByContractAddress403Response(val *GetTokenDetailsByContractAddress403Response) *NullableGetTokenDetailsByContractAddress403Response {
	return &NullableGetTokenDetailsByContractAddress403Response{value: val, isSet: true}
}

func (v NullableGetTokenDetailsByContractAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTokenDetailsByContractAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
