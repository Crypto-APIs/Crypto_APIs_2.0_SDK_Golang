...
type GetLastMinedBlock403Response struct {
	...
	Error GetLastMinedBlockE403 `json:"error"`
}
...
func NewGetLastMinedBlock403Response(apiVersion string, requestId string, error_ GetLastMinedBlockE403) *GetLastMinedBlock403Response {
	this := GetLastMinedBlock403Response{}
...
func (o GetLastMinedBlock403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetLastMinedBlock403Response struct {
	value *GetLastMinedBlock403Response
	isSet bool
}

func (v NullableGetLastMinedBlock403Response) Get() *GetLastMinedBlock403Response {
	return v.value
}

func (v *NullableGetLastMinedBlock403Response) Set(val *GetLastMinedBlock403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastMinedBlock403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastMinedBlock403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastMinedBlock403Response(val *GetLastMinedBlock403Response) *NullableGetLastMinedBlock403Response {
	return &NullableGetLastMinedBlock403Response{value: val, isSet: true}
}

func (v NullableGetLastMinedBlock403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastMinedBlock403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
