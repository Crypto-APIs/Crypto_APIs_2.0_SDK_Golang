...
type GetLatestMinedZilliqaBlockE403 struct {
...
func BannedIpAddressAsGetLatestMinedZilliqaBlockE403(v *BannedIpAddress) GetLatestMinedZilliqaBlockE403 {
	return GetLatestMinedZilliqaBlockE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetLatestMinedZilliqaBlockE403(v *EndpointNotAllowedForApiKey) GetLatestMinedZilliqaBlockE403 {
	return GetLatestMinedZilliqaBlockE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetLatestMinedZilliqaBlockE403(v *EndpointNotAllowedForPlan) GetLatestMinedZilliqaBlockE403 {
	return GetLatestMinedZilliqaBlockE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetLatestMinedZilliqaBlockE403(v *FeatureMainnetsNotAllowedForPlan) GetLatestMinedZilliqaBlockE403 {
	return GetLatestMinedZilliqaBlockE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetLatestMinedZilliqaBlockE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetLatestMinedZilliqaBlockE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetLatestMinedZilliqaBlockE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetLatestMinedZilliqaBlockE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetLatestMinedZilliqaBlockE403) GetActualInstance() (interface{}) {
...
type NullableGetLatestMinedZilliqaBlockE403 struct {
	value *GetLatestMinedZilliqaBlockE403
	isSet bool
}

func (v NullableGetLatestMinedZilliqaBlockE403) Get() *GetLatestMinedZilliqaBlockE403 {
	return v.value
}

func (v *NullableGetLatestMinedZilliqaBlockE403) Set(val *GetLatestMinedZilliqaBlockE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedZilliqaBlockE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedZilliqaBlockE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedZilliqaBlockE403(val *GetLatestMinedZilliqaBlockE403) *NullableGetLatestMinedZilliqaBlockE403 {
	return &NullableGetLatestMinedZilliqaBlockE403{value: val, isSet: true}
}

func (v NullableGetLatestMinedZilliqaBlockE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedZilliqaBlockE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
