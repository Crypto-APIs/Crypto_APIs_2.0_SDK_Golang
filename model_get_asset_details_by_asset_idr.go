...
type GetAssetDetailsByAssetIDR struct {
	...
	Data GetAssetDetailsByAssetIDRData `json:"data"`
}
...
func NewGetAssetDetailsByAssetIDR(apiVersion string, requestId string, data GetAssetDetailsByAssetIDRData) *GetAssetDetailsByAssetIDR {
	this := GetAssetDetailsByAssetIDR{}
...
func (o *GetAssetDetailsByAssetIDR) GetData() GetAssetDetailsByAssetIDRData {
	if o == nil {
		var ret GetAssetDetailsByAssetIDRData
		return ret
	}
...
func (o GetAssetDetailsByAssetIDR) MarshalJSON() ([]byte, error) {
...
type NullableGetAssetDetailsByAssetIDR struct {
	value *GetAssetDetailsByAssetIDR
	isSet bool
}

func (v NullableGetAssetDetailsByAssetIDR) Get() *GetAssetDetailsByAssetIDR {
	return v.value
}

func (v *NullableGetAssetDetailsByAssetIDR) Set(val *GetAssetDetailsByAssetIDR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetDetailsByAssetIDR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetDetailsByAssetIDR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetDetailsByAssetIDR(val *GetAssetDetailsByAssetIDR) *NullableGetAssetDetailsByAssetIDR {
	return &NullableGetAssetDetailsByAssetIDR{value: val, isSet: true}
}

func (v NullableGetAssetDetailsByAssetIDR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetDetailsByAssetIDR) UnmarshalJSON(src []byte) error {
	v.isSet = true
