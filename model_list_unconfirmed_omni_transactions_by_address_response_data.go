...
// ListUnconfirmedOmniTransactionsByAddressResponseData struct for ListUnconfirmedOmniTransactionsByAddressResponseData
type ListUnconfirmedOmniTransactionsByAddressResponseData struct {
	...
	Items []ListUnconfirmedOmniTransactionsByAddressResponseItem `json:"items"`
}
...
func NewListUnconfirmedOmniTransactionsByAddressResponseData(offset int32, limit int32, total int32, items []ListUnconfirmedOmniTransactionsByAddressResponseItem) *ListUnconfirmedOmniTransactionsByAddressResponseData {
	this := ListUnconfirmedOmniTransactionsByAddressResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListUnconfirmedOmniTransactionsByAddressResponseData) GetItems() []ListUnconfirmedOmniTransactionsByAddressResponseItem {
	if o == nil {
		var ret []ListUnconfirmedOmniTransactionsByAddressResponseItem
		return ret
	}
...
func (o ListUnconfirmedOmniTransactionsByAddressResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedOmniTransactionsByAddressResponseData struct {
	value *ListUnconfirmedOmniTransactionsByAddressResponseData
	isSet bool
}

func (v NullableListUnconfirmedOmniTransactionsByAddressResponseData) Get() *ListUnconfirmedOmniTransactionsByAddressResponseData {
	return v.value
}

func (v *NullableListUnconfirmedOmniTransactionsByAddressResponseData) Set(val *ListUnconfirmedOmniTransactionsByAddressResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedOmniTransactionsByAddressResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedOmniTransactionsByAddressResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedOmniTransactionsByAddressResponseData(val *ListUnconfirmedOmniTransactionsByAddressResponseData) *NullableListUnconfirmedOmniTransactionsByAddressResponseData {
	return &NullableListUnconfirmedOmniTransactionsByAddressResponseData{value: val, isSet: true}
}

func (v NullableListUnconfirmedOmniTransactionsByAddressResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedOmniTransactionsByAddressResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
