...
// BannedIpAddressError struct for BannedIpAddressError
type BannedIpAddressError struct {
...
func (o BannedIpAddressError) MarshalJSON() ([]byte, error) {
...
type NullableBannedIpAddressError struct {
	value *BannedIpAddressError
	isSet bool
}

func (v NullableBannedIpAddressError) Get() *BannedIpAddressError {
	return v.value
}

func (v *NullableBannedIpAddressError) Set(val *BannedIpAddressError) {
	v.value = val
	v.isSet = true
}

func (v NullableBannedIpAddressError) IsSet() bool {
	return v.isSet
}

func (v *NullableBannedIpAddressError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBannedIpAddressError(val *BannedIpAddressError) *NullableBannedIpAddressError {
	return &NullableBannedIpAddressError{value: val, isSet: true}
}

func (v NullableBannedIpAddressError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBannedIpAddressError) UnmarshalJSON(src []byte) error {
	v.isSet = true
