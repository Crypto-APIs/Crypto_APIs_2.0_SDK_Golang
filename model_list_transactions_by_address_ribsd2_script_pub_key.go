...
type ListTransactionsByAddressRIBSD2ScriptPubKey struct {
...
func NewListTransactionsByAddressRIBSD2ScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByAddressRIBSD2ScriptPubKey {
	this := ListTransactionsByAddressRIBSD2ScriptPubKey{}
...
func (o ListTransactionsByAddressRIBSD2ScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSD2ScriptPubKey struct {
	value *ListTransactionsByAddressRIBSD2ScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSD2ScriptPubKey) Get() *ListTransactionsByAddressRIBSD2ScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSD2ScriptPubKey) Set(val *ListTransactionsByAddressRIBSD2ScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSD2ScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSD2ScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSD2ScriptPubKey(val *ListTransactionsByAddressRIBSD2ScriptPubKey) *NullableListTransactionsByAddressRIBSD2ScriptPubKey {
	return &NullableListTransactionsByAddressRIBSD2ScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSD2ScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSD2ScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
