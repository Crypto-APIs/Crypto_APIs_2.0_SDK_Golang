...
type NewConfirmedInternalTransactionsAndEachConfirmationE401 struct {
...
func (dst *NewConfirmedInternalTransactionsAndEachConfirmationE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedInternalTransactionsAndEachConfirmationE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedInternalTransactionsAndEachConfirmationE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedInternalTransactionsAndEachConfirmationE401) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsAndEachConfirmationE401 struct {
	value *NewConfirmedInternalTransactionsAndEachConfirmationE401
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmationE401) Get() *NewConfirmedInternalTransactionsAndEachConfirmationE401 {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmationE401) Set(val *NewConfirmedInternalTransactionsAndEachConfirmationE401) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmationE401) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmationE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsAndEachConfirmationE401(val *NewConfirmedInternalTransactionsAndEachConfirmationE401) *NullableNewConfirmedInternalTransactionsAndEachConfirmationE401 {
	return &NullableNewConfirmedInternalTransactionsAndEachConfirmationE401{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmationE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmationE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
