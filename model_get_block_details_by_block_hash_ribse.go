...
type GetBlockDetailsByBlockHashRIBSE struct {
...
func NewGetBlockDetailsByBlockHashRIBSE(difficulty string, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, nonce string, sha3Uncles string, size int32, totalDifficulty string, uncles []string) *GetBlockDetailsByBlockHashRIBSE {
	this := GetBlockDetailsByBlockHashRIBSE{}
...
func (o GetBlockDetailsByBlockHashRIBSE) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashRIBSE struct {
	value *GetBlockDetailsByBlockHashRIBSE
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashRIBSE) Get() *GetBlockDetailsByBlockHashRIBSE {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashRIBSE) Set(val *GetBlockDetailsByBlockHashRIBSE) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashRIBSE) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashRIBSE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashRIBSE(val *GetBlockDetailsByBlockHashRIBSE) *NullableGetBlockDetailsByBlockHashRIBSE {
	return &NullableGetBlockDetailsByBlockHashRIBSE{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashRIBSE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashRIBSE) UnmarshalJSON(src []byte) error {
	v.isSet = true
