...
type GetLastMinedBlock400Response struct {
	...
	Error GetLastMinedBlockE400 `json:"error"`
}
...
func NewGetLastMinedBlock400Response(apiVersion string, requestId string, error_ GetLastMinedBlockE400) *GetLastMinedBlock400Response {
	this := GetLastMinedBlock400Response{}
...
func (o GetLastMinedBlock400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetLastMinedBlock400Response struct {
	value *GetLastMinedBlock400Response
	isSet bool
}

func (v NullableGetLastMinedBlock400Response) Get() *GetLastMinedBlock400Response {
	return v.value
}

func (v *NullableGetLastMinedBlock400Response) Set(val *GetLastMinedBlock400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastMinedBlock400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastMinedBlock400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastMinedBlock400Response(val *GetLastMinedBlock400Response) *NullableGetLastMinedBlock400Response {
	return &NullableGetLastMinedBlock400Response{value: val, isSet: true}
}

func (v NullableGetLastMinedBlock400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastMinedBlock400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
