...
type ListUnconfirmedTokensTransfersByAddress403Response struct {
	...
	Error ListUnconfirmedTokensTransfersByAddressE403 `json:"error"`
}
...
func NewListUnconfirmedTokensTransfersByAddress403Response(apiVersion string, requestId string, error_ ListUnconfirmedTokensTransfersByAddressE403) *ListUnconfirmedTokensTransfersByAddress403Response {
	this := ListUnconfirmedTokensTransfersByAddress403Response{}
...
func (o ListUnconfirmedTokensTransfersByAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTokensTransfersByAddress403Response struct {
	value *ListUnconfirmedTokensTransfersByAddress403Response
	isSet bool
}

func (v NullableListUnconfirmedTokensTransfersByAddress403Response) Get() *ListUnconfirmedTokensTransfersByAddress403Response {
	return v.value
}

func (v *NullableListUnconfirmedTokensTransfersByAddress403Response) Set(val *ListUnconfirmedTokensTransfersByAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTokensTransfersByAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTokensTransfersByAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTokensTransfersByAddress403Response(val *ListUnconfirmedTokensTransfersByAddress403Response) *NullableListUnconfirmedTokensTransfersByAddress403Response {
	return &NullableListUnconfirmedTokensTransfersByAddress403Response{value: val, isSet: true}
}

func (v NullableListUnconfirmedTokensTransfersByAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTokensTransfersByAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
