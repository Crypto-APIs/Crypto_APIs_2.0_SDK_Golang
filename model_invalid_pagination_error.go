...
// InvalidPaginationError struct for InvalidPaginationError
...
func (o InvalidPaginationError) MarshalJSON() ([]byte, error) {
...
type NullableInvalidPaginationError struct {
	value *InvalidPaginationError
	isSet bool
}

func (v NullableInvalidPaginationError) Get() *InvalidPaginationError {
	return v.value
}

func (v *NullableInvalidPaginationError) Set(val *InvalidPaginationError) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidPaginationError) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidPaginationError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidPaginationError(val *InvalidPaginationError) *NullableInvalidPaginationError {
	return &NullableInvalidPaginationError{value: val, isSet: true}
}

func (v NullableInvalidPaginationError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidPaginationError) UnmarshalJSON(src []byte) error {
	v.isSet = true
