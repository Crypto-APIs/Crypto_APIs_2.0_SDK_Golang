...
type ListTokensTransfersByTransactionHashR struct {
	...
	Data ListTokensTransfersByTransactionHashRData `json:"data"`
}
...
func NewListTokensTransfersByTransactionHashR(apiVersion string, requestId string, data ListTokensTransfersByTransactionHashRData) *ListTokensTransfersByTransactionHashR {
	this := ListTokensTransfersByTransactionHashR{}
...
func (o *ListTokensTransfersByTransactionHashR) GetData() ListTokensTransfersByTransactionHashRData {
	if o == nil {
		var ret ListTokensTransfersByTransactionHashRData
		return ret
	}
...
func (o ListTokensTransfersByTransactionHashR) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByTransactionHashR struct {
	value *ListTokensTransfersByTransactionHashR
	isSet bool
}

func (v NullableListTokensTransfersByTransactionHashR) Get() *ListTokensTransfersByTransactionHashR {
	return v.value
}

func (v *NullableListTokensTransfersByTransactionHashR) Set(val *ListTokensTransfersByTransactionHashR) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByTransactionHashR) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByTransactionHashR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByTransactionHashR(val *ListTokensTransfersByTransactionHashR) *NullableListTokensTransfersByTransactionHashR {
	return &NullableListTokensTransfersByTransactionHashR{value: val, isSet: true}
}

func (v NullableListTokensTransfersByTransactionHashR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByTransactionHashR) UnmarshalJSON(src []byte) error {
	v.isSet = true
