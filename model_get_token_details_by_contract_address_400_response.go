...
type GetTokenDetailsByContractAddress400Response struct {
...
func NewGetTokenDetailsByContractAddress400Response(apiVersion string, requestId string, error_ GetTokenDetailsByContractAddressE400) *GetTokenDetailsByContractAddress400Response {
	this := GetTokenDetailsByContractAddress400Response{}
...
func (o GetTokenDetailsByContractAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTokenDetailsByContractAddress400Response struct {
	value *GetTokenDetailsByContractAddress400Response
	isSet bool
}

func (v NullableGetTokenDetailsByContractAddress400Response) Get() *GetTokenDetailsByContractAddress400Response {
	return v.value
}

func (v *NullableGetTokenDetailsByContractAddress400Response) Set(val *GetTokenDetailsByContractAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTokenDetailsByContractAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTokenDetailsByContractAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTokenDetailsByContractAddress400Response(val *GetTokenDetailsByContractAddress400Response) *NullableGetTokenDetailsByContractAddress400Response {
	return &NullableGetTokenDetailsByContractAddress400Response{value: val, isSet: true}
}

func (v NullableGetTokenDetailsByContractAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTokenDetailsByContractAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
