...
type GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig struct {
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig(asm string, hex string, type_ string) *GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig {
	this := GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) Get() *GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig(val *GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) *NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
