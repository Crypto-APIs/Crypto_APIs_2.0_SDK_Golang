...
type GetRawTransactionData400Response struct {
	...
	Error GetRawTransactionDataE400 `json:"error"`
}
...
func NewGetRawTransactionData400Response(apiVersion string, requestId string, error_ GetRawTransactionDataE400) *GetRawTransactionData400Response {
	this := GetRawTransactionData400Response{}
...
func (o *GetRawTransactionData400Response) GetError() GetRawTransactionDataE400 {
	if o == nil {
		var ret GetRawTransactionDataE400
		return ret
	}
...
func (o GetRawTransactionData400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetRawTransactionData400Response struct {
	value *GetRawTransactionData400Response
	isSet bool
}

func (v NullableGetRawTransactionData400Response) Get() *GetRawTransactionData400Response {
	return v.value
}

func (v *NullableGetRawTransactionData400Response) Set(val *GetRawTransactionData400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRawTransactionData400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRawTransactionData400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRawTransactionData400Response(val *GetRawTransactionData400Response) *NullableGetRawTransactionData400Response {
	return &NullableGetRawTransactionData400Response{value: val, isSet: true}
}

func (v NullableGetRawTransactionData400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRawTransactionData400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
