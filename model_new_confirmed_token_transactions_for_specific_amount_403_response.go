...
type NewConfirmedTokenTransactionsForSpecificAmount403Response struct {
	...
	Error NewConfirmedTokenTransactionsForSpecificAmountE403 `json:"error"`
}
...
func NewNewConfirmedTokenTransactionsForSpecificAmount403Response(apiVersion string, requestId string, error_ NewConfirmedTokenTransactionsForSpecificAmountE403) *NewConfirmedTokenTransactionsForSpecificAmount403Response {
	this := NewConfirmedTokenTransactionsForSpecificAmount403Response{}
...
func (o *NewConfirmedTokenTransactionsForSpecificAmount403Response) GetError() NewConfirmedTokenTransactionsForSpecificAmountE403 {
	if o == nil {
		var ret NewConfirmedTokenTransactionsForSpecificAmountE403
		return ret
	}
...
func (o NewConfirmedTokenTransactionsForSpecificAmount403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokenTransactionsForSpecificAmount403Response struct {
	value *NewConfirmedTokenTransactionsForSpecificAmount403Response
	isSet bool
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount403Response) Get() *NewConfirmedTokenTransactionsForSpecificAmount403Response {
	return v.value
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount403Response) Set(val *NewConfirmedTokenTransactionsForSpecificAmount403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokenTransactionsForSpecificAmount403Response(val *NewConfirmedTokenTransactionsForSpecificAmount403Response) *NullableNewConfirmedTokenTransactionsForSpecificAmount403Response {
	return &NullableNewConfirmedTokenTransactionsForSpecificAmount403Response{value: val, isSet: true}
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
