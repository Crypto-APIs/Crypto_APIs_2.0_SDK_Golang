...
type CreateAutomaticCoinsForwarding400Response struct {
	...
	Error CreateAutomaticCoinsForwardingE400 `json:"error"`
}
...
func NewCreateAutomaticCoinsForwarding400Response(apiVersion string, requestId string, error_ CreateAutomaticCoinsForwardingE400) *CreateAutomaticCoinsForwarding400Response {
	this := CreateAutomaticCoinsForwarding400Response{}
...
func (o *CreateAutomaticCoinsForwarding400Response) GetError() CreateAutomaticCoinsForwardingE400 {
	if o == nil {
		var ret CreateAutomaticCoinsForwardingE400
		return ret
	}
...
func (o CreateAutomaticCoinsForwarding400Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticCoinsForwarding400Response struct {
	value *CreateAutomaticCoinsForwarding400Response
	isSet bool
}

func (v NullableCreateAutomaticCoinsForwarding400Response) Get() *CreateAutomaticCoinsForwarding400Response {
	return v.value
}

func (v *NullableCreateAutomaticCoinsForwarding400Response) Set(val *CreateAutomaticCoinsForwarding400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticCoinsForwarding400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticCoinsForwarding400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticCoinsForwarding400Response(val *CreateAutomaticCoinsForwarding400Response) *NullableCreateAutomaticCoinsForwarding400Response {
	return &NullableCreateAutomaticCoinsForwarding400Response{value: val, isSet: true}
}

func (v NullableCreateAutomaticCoinsForwarding400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticCoinsForwarding400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
