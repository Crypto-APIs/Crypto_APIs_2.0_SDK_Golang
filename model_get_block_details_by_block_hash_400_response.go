...
type GetBlockDetailsByBlockHash400Response struct {
	...
	Error GetBlockDetailsByBlockHashE400 `json:"error"`
}
...
func NewGetBlockDetailsByBlockHash400Response(apiVersion string, requestId string, error_ GetBlockDetailsByBlockHashE400) *GetBlockDetailsByBlockHash400Response {
	this := GetBlockDetailsByBlockHash400Response{}
...
func (o *GetBlockDetailsByBlockHash400Response) GetError() GetBlockDetailsByBlockHashE400 {
	if o == nil {
		var ret GetBlockDetailsByBlockHashE400
		return ret
	}
...
func (o GetBlockDetailsByBlockHash400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHash400Response struct {
	value *GetBlockDetailsByBlockHash400Response
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHash400Response) Get() *GetBlockDetailsByBlockHash400Response {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHash400Response) Set(val *GetBlockDetailsByBlockHash400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHash400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHash400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHash400Response(val *GetBlockDetailsByBlockHash400Response) *NullableGetBlockDetailsByBlockHash400Response {
	return &NullableGetBlockDetailsByBlockHash400Response{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHash400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHash400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
