...
// UnexpectedServerError struct for UnexpectedServerError
type UnexpectedServerError struct {
	...
	Error UnexpectedServerErrorError `json:"error"`
}
...
func (o *UnexpectedServerError) GetError() UnexpectedServerErrorError {
	if o == nil {
		var ret UnexpectedServerErrorError
		return ret
	}
...
func (o UnexpectedServerError) MarshalJSON() ([]byte, error) {
...
type NullableUnexpectedServerError struct {
	value *UnexpectedServerError
	isSet bool
}

func (v NullableUnexpectedServerError) Get() *UnexpectedServerError {
	return v.value
}

func (v *NullableUnexpectedServerError) Set(val *UnexpectedServerError) {
	v.value = val
	v.isSet = true
}

func (v NullableUnexpectedServerError) IsSet() bool {
	return v.isSet
}

func (v *NullableUnexpectedServerError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnexpectedServerError(val *UnexpectedServerError) *NullableUnexpectedServerError {
	return &NullableUnexpectedServerError{value: val, isSet: true}
}

func (v NullableUnexpectedServerError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnexpectedServerError) UnmarshalJSON(src []byte) error {
	v.isSet = true
