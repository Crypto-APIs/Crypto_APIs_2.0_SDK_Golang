...
type ListZilliqaTransactionsByBlockHashE400 struct {
...
func InvalidPaginationAsListZilliqaTransactionsByBlockHashE400(v *InvalidPagination) ListZilliqaTransactionsByBlockHashE400 {
	return ListZilliqaTransactionsByBlockHashE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsListZilliqaTransactionsByBlockHashE400(v *LimitGreaterThanAllowed) ListZilliqaTransactionsByBlockHashE400 {
	return ListZilliqaTransactionsByBlockHashE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsListZilliqaTransactionsByBlockHashE400(v *UriNotFound) ListZilliqaTransactionsByBlockHashE400 {
	return ListZilliqaTransactionsByBlockHashE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListZilliqaTransactionsByBlockHashE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListZilliqaTransactionsByBlockHashE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListZilliqaTransactionsByBlockHashE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListZilliqaTransactionsByBlockHashE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListZilliqaTransactionsByBlockHashE400) GetActualInstance() (interface{}) {
...
type NullableListZilliqaTransactionsByBlockHashE400 struct {
	value *ListZilliqaTransactionsByBlockHashE400
	isSet bool
}

func (v NullableListZilliqaTransactionsByBlockHashE400) Get() *ListZilliqaTransactionsByBlockHashE400 {
	return v.value
}

func (v *NullableListZilliqaTransactionsByBlockHashE400) Set(val *ListZilliqaTransactionsByBlockHashE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByBlockHashE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByBlockHashE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByBlockHashE400(val *ListZilliqaTransactionsByBlockHashE400) *NullableListZilliqaTransactionsByBlockHashE400 {
	return &NullableListZilliqaTransactionsByBlockHashE400{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByBlockHashE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByBlockHashE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
