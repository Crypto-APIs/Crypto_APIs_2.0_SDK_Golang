...
// NewConfirmedTokensTransactionsResponseItem struct for NewConfirmedTokensTransactionsResponseItem
type NewConfirmedTokensTransactionsResponseItem struct {
...
func NewNewConfirmedTokensTransactionsResponseItem(address string, callbackSecretKey string, callbackUrl string, confirmationsCount string, createdTimestamp int32, eventType string, isActive bool, referenceId string, transactionId string) *NewConfirmedTokensTransactionsResponseItem {
	this := NewConfirmedTokensTransactionsResponseItem{}
...
func (o NewConfirmedTokensTransactionsResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokensTransactionsResponseItem struct {
	value *NewConfirmedTokensTransactionsResponseItem
	isSet bool
}

func (v NullableNewConfirmedTokensTransactionsResponseItem) Get() *NewConfirmedTokensTransactionsResponseItem {
	return v.value
}

func (v *NullableNewConfirmedTokensTransactionsResponseItem) Set(val *NewConfirmedTokensTransactionsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokensTransactionsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokensTransactionsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokensTransactionsResponseItem(val *NewConfirmedTokensTransactionsResponseItem) *NullableNewConfirmedTokensTransactionsResponseItem {
	return &NullableNewConfirmedTokensTransactionsResponseItem{value: val, isSet: true}
}

func (v NullableNewConfirmedTokensTransactionsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokensTransactionsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
