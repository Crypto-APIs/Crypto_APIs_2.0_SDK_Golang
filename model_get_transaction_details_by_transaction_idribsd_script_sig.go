...
type GetTransactionDetailsByTransactionIDRIBSDScriptSig struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSDScriptSig(asm string, hex string, type_ string) *GetTransactionDetailsByTransactionIDRIBSDScriptSig {
	this := GetTransactionDetailsByTransactionIDRIBSDScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetTransactionDetailsByTransactionIDRIBSDScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig struct {
	value *GetTransactionDetailsByTransactionIDRIBSDScriptSig
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig) Get() *GetTransactionDetailsByTransactionIDRIBSDScriptSig {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig) Set(val *GetTransactionDetailsByTransactionIDRIBSDScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSDScriptSig(val *GetTransactionDetailsByTransactionIDRIBSDScriptSig) *NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig {
	return &NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSDScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
