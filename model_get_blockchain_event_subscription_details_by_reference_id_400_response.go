...
type GetBlockchainEventSubscriptionDetailsByReferenceID400Response struct {
	...
	Error GetBlockchainEventSubscriptionDetailsByReferenceIDE400 `json:"error"`
}
...
func (o *GetBlockchainEventSubscriptionDetailsByReferenceID400Response) GetError() GetBlockchainEventSubscriptionDetailsByReferenceIDE400 {
	if o == nil {
		var ret GetBlockchainEventSubscriptionDetailsByReferenceIDE400
		return ret
	}
...
func (o GetBlockchainEventSubscriptionDetailsByReferenceID400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response struct {
	value *GetBlockchainEventSubscriptionDetailsByReferenceID400Response
	isSet bool
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response) Get() *GetBlockchainEventSubscriptionDetailsByReferenceID400Response {
	return v.value
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response) Set(val *GetBlockchainEventSubscriptionDetailsByReferenceID400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response(val *GetBlockchainEventSubscriptionDetailsByReferenceID400Response) *NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response {
	return &NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response{value: val, isSet: true}
}

func (v NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockchainEventSubscriptionDetailsByReferenceID400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
