...
// ListAllUnconfirmedTransactionsRIBSBCVinInner struct for ListAllUnconfirmedTransactionsRIBSBCVinInner
type ListAllUnconfirmedTransactionsRIBSBCVinInner struct {
...
func (o ListAllUnconfirmedTransactionsRIBSBCVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListAllUnconfirmedTransactionsRIBSBCVinInner struct {
	value *ListAllUnconfirmedTransactionsRIBSBCVinInner
	isSet bool
}

func (v NullableListAllUnconfirmedTransactionsRIBSBCVinInner) Get() *ListAllUnconfirmedTransactionsRIBSBCVinInner {
	return v.value
}

func (v *NullableListAllUnconfirmedTransactionsRIBSBCVinInner) Set(val *ListAllUnconfirmedTransactionsRIBSBCVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllUnconfirmedTransactionsRIBSBCVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllUnconfirmedTransactionsRIBSBCVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllUnconfirmedTransactionsRIBSBCVinInner(val *ListAllUnconfirmedTransactionsRIBSBCVinInner) *NullableListAllUnconfirmedTransactionsRIBSBCVinInner {
	return &NullableListAllUnconfirmedTransactionsRIBSBCVinInner{value: val, isSet: true}
}

func (v NullableListAllUnconfirmedTransactionsRIBSBCVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllUnconfirmedTransactionsRIBSBCVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
