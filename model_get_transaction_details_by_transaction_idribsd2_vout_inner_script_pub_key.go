...
type GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey struct {
...
func (o GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey struct {
	value *GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) Get() *GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) Set(val *GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey(val *GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) *NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey {
	return &NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
