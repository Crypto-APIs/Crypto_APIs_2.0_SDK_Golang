...
// CreateTokensTransactionRequestFromAddressR struct for CreateTokensTransactionRequestFromAddressR
type CreateTokensTransactionRequestFromAddressR struct {
	...
	Data CreateTokensTransactionRequestFromAddressRData `json:"data"`
}
...
func NewCreateTokensTransactionRequestFromAddressR(apiVersion string, requestId string, data CreateTokensTransactionRequestFromAddressRData) *CreateTokensTransactionRequestFromAddressR {
	this := CreateTokensTransactionRequestFromAddressR{}
...
func (o *CreateTokensTransactionRequestFromAddressR) GetData() CreateTokensTransactionRequestFromAddressRData {
	if o == nil {
		var ret CreateTokensTransactionRequestFromAddressRData
		return ret
	}
...
func (o CreateTokensTransactionRequestFromAddressR) MarshalJSON() ([]byte, error) {
...
type NullableCreateTokensTransactionRequestFromAddressR struct {
	value *CreateTokensTransactionRequestFromAddressR
	isSet bool
}

func (v NullableCreateTokensTransactionRequestFromAddressR) Get() *CreateTokensTransactionRequestFromAddressR {
	return v.value
}

func (v *NullableCreateTokensTransactionRequestFromAddressR) Set(val *CreateTokensTransactionRequestFromAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTokensTransactionRequestFromAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTokensTransactionRequestFromAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTokensTransactionRequestFromAddressR(val *CreateTokensTransactionRequestFromAddressR) *NullableCreateTokensTransactionRequestFromAddressR {
	return &NullableCreateTokensTransactionRequestFromAddressR{value: val, isSet: true}
}

func (v NullableCreateTokensTransactionRequestFromAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTokensTransactionRequestFromAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
