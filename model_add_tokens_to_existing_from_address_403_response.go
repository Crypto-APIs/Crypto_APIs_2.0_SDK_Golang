...
type AddTokensToExistingFromAddress403Response struct {
	...
	Error AddTokensToExistingFromAddressE403 `json:"error"`
}
...
func NewAddTokensToExistingFromAddress403Response(apiVersion string, requestId string, error_ AddTokensToExistingFromAddressE403) *AddTokensToExistingFromAddress403Response {
	this := AddTokensToExistingFromAddress403Response{}
...
func (o *AddTokensToExistingFromAddress403Response) GetError() AddTokensToExistingFromAddressE403 {
	if o == nil {
		var ret AddTokensToExistingFromAddressE403
		return ret
	}
...
func (o AddTokensToExistingFromAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableAddTokensToExistingFromAddress403Response struct {
	value *AddTokensToExistingFromAddress403Response
	isSet bool
}

func (v NullableAddTokensToExistingFromAddress403Response) Get() *AddTokensToExistingFromAddress403Response {
	return v.value
}

func (v *NullableAddTokensToExistingFromAddress403Response) Set(val *AddTokensToExistingFromAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddTokensToExistingFromAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddTokensToExistingFromAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddTokensToExistingFromAddress403Response(val *AddTokensToExistingFromAddress403Response) *NullableAddTokensToExistingFromAddress403Response {
	return &NullableAddTokensToExistingFromAddress403Response{value: val, isSet: true}
}

func (v NullableAddTokensToExistingFromAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddTokensToExistingFromAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
