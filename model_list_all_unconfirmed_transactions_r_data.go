...
// ListAllUnconfirmedTransactionsRData struct for ListAllUnconfirmedTransactionsRData
type ListAllUnconfirmedTransactionsRData struct {
	...
	Items []ListAllUnconfirmedTransactionsRI `json:"items"`
}
...
func NewListAllUnconfirmedTransactionsRData(offset int32, limit int32, total int32, items []ListAllUnconfirmedTransactionsRI) *ListAllUnconfirmedTransactionsRData {
	this := ListAllUnconfirmedTransactionsRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListAllUnconfirmedTransactionsRData) GetItems() []ListAllUnconfirmedTransactionsRI {
	if o == nil {
		var ret []ListAllUnconfirmedTransactionsRI
		return ret
	}
...
func (o ListAllUnconfirmedTransactionsRData) MarshalJSON() ([]byte, error) {
...
type NullableListAllUnconfirmedTransactionsRData struct {
	value *ListAllUnconfirmedTransactionsRData
	isSet bool
}

func (v NullableListAllUnconfirmedTransactionsRData) Get() *ListAllUnconfirmedTransactionsRData {
	return v.value
}

func (v *NullableListAllUnconfirmedTransactionsRData) Set(val *ListAllUnconfirmedTransactionsRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllUnconfirmedTransactionsRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllUnconfirmedTransactionsRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllUnconfirmedTransactionsRData(val *ListAllUnconfirmedTransactionsRData) *NullableListAllUnconfirmedTransactionsRData {
	return &NullableListAllUnconfirmedTransactionsRData{value: val, isSet: true}
}

func (v NullableListAllUnconfirmedTransactionsRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllUnconfirmedTransactionsRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
