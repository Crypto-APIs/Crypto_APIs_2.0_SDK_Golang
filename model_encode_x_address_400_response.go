...
type EncodeXAddress400Response struct {
	...
	Error EncodeXAddressE400 `json:"error"`
}
...
func NewEncodeXAddress400Response(apiVersion string, requestId string, error_ EncodeXAddressE400) *EncodeXAddress400Response {
	this := EncodeXAddress400Response{}
...
func (o EncodeXAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableEncodeXAddress400Response struct {
	value *EncodeXAddress400Response
	isSet bool
}

func (v NullableEncodeXAddress400Response) Get() *EncodeXAddress400Response {
	return v.value
}

func (v *NullableEncodeXAddress400Response) Set(val *EncodeXAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeXAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeXAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeXAddress400Response(val *EncodeXAddress400Response) *NullableEncodeXAddress400Response {
	return &NullableEncodeXAddress400Response{value: val, isSet: true}
}

func (v NullableEncodeXAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeXAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
