...
// CouldNotCalculateRateForPair struct for CouldNotCalculateRateForPair
type CouldNotCalculateRateForPair struct {
	...
	Error CouldNotCalculateRateForPairError `json:"error"`
}
...
func (o *CouldNotCalculateRateForPair) GetError() CouldNotCalculateRateForPairError {
	if o == nil {
		var ret CouldNotCalculateRateForPairError
		return ret
	}
