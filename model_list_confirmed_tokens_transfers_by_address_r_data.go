...
type ListConfirmedTokensTransfersByAddressRData struct {
	...
	Items []ListConfirmedTokensTransfersByAddressRI `json:"items"`
}
...
func (o *ListConfirmedTokensTransfersByAddressRData) GetItems() []ListConfirmedTokensTransfersByAddressRI {
	if o == nil {
		var ret []ListConfirmedTokensTransfersByAddressRI
		return ret
	}
...
func (o ListConfirmedTokensTransfersByAddressRData) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTokensTransfersByAddressRData struct {
	value *ListConfirmedTokensTransfersByAddressRData
	isSet bool
}

func (v NullableListConfirmedTokensTransfersByAddressRData) Get() *ListConfirmedTokensTransfersByAddressRData {
	return v.value
}

func (v *NullableListConfirmedTokensTransfersByAddressRData) Set(val *ListConfirmedTokensTransfersByAddressRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTokensTransfersByAddressRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTokensTransfersByAddressRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTokensTransfersByAddressRData(val *ListConfirmedTokensTransfersByAddressRData) *NullableListConfirmedTokensTransfersByAddressRData {
	return &NullableListConfirmedTokensTransfersByAddressRData{value: val, isSet: true}
}

func (v NullableListConfirmedTokensTransfersByAddressRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTokensTransfersByAddressRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
