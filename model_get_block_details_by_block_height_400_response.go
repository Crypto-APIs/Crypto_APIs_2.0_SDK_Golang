...
type GetBlockDetailsByBlockHeight400Response struct {
...
func NewGetBlockDetailsByBlockHeight400Response(apiVersion string, requestId string, error_ GetBlockDetailsByBlockHeightE400) *GetBlockDetailsByBlockHeight400Response {
	this := GetBlockDetailsByBlockHeight400Response{}
...
func (o GetBlockDetailsByBlockHeight400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeight400Response struct {
	value *GetBlockDetailsByBlockHeight400Response
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeight400Response) Get() *GetBlockDetailsByBlockHeight400Response {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeight400Response) Set(val *GetBlockDetailsByBlockHeight400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeight400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeight400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeight400Response(val *GetBlockDetailsByBlockHeight400Response) *NullableGetBlockDetailsByBlockHeight400Response {
	return &NullableGetBlockDetailsByBlockHeight400Response{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeight400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeight400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
