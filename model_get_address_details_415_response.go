...
// GetAddressDetails415Response struct for GetAddressDetails415Response
type GetAddressDetails415Response struct {
...
func NewGetAddressDetails415Response(apiVersion string, requestId string, error_ UnsupportedMediaType) *GetAddressDetails415Response {
	this := GetAddressDetails415Response{}
...
func (o GetAddressDetails415Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetails415Response struct {
	value *GetAddressDetails415Response
	isSet bool
}

func (v NullableGetAddressDetails415Response) Get() *GetAddressDetails415Response {
	return v.value
}

func (v *NullableGetAddressDetails415Response) Set(val *GetAddressDetails415Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetails415Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetails415Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetails415Response(val *GetAddressDetails415Response) *NullableGetAddressDetails415Response {
	return &NullableGetAddressDetails415Response{value: val, isSet: true}
}

func (v NullableGetAddressDetails415Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetails415Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
