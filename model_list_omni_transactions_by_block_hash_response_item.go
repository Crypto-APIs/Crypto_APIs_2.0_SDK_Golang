...
// ListOmniTransactionsByBlockHashResponseItem struct for ListOmniTransactionsByBlockHashResponseItem
type ListOmniTransactionsByBlockHashResponseItem struct {
	...
	Fee ListOmniTransactionsByBlockHashResponseItemFee `json:"fee"`
}
...
func NewListOmniTransactionsByBlockHashResponseItem(amount string, divisible bool, minedInBlockHash string, minedInBlockHeight int32, positionInBlock int32, propertyId int32, recipients []ListOmniTransactionsByAddressResponseItemRecipients, senders []ListOmniTransactionsByAddressResponseItemSenders, timestamp int32, transactionId string, type_ string, typeInt int32, valid bool, version int32, fee ListOmniTransactionsByBlockHashResponseItemFee) *ListOmniTransactionsByBlockHashResponseItem {
	this := ListOmniTransactionsByBlockHashResponseItem{}
	this.Amount = amount
...
func (o *ListOmniTransactionsByBlockHashResponseItem) GetFee() ListOmniTransactionsByBlockHashResponseItemFee {
	if o == nil {
		var ret ListOmniTransactionsByBlockHashResponseItemFee
		return ret
	}
...
func (o ListOmniTransactionsByBlockHashResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHashResponseItem struct {
	value *ListOmniTransactionsByBlockHashResponseItem
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHashResponseItem) Get() *ListOmniTransactionsByBlockHashResponseItem {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHashResponseItem) Set(val *ListOmniTransactionsByBlockHashResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHashResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHashResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHashResponseItem(val *ListOmniTransactionsByBlockHashResponseItem) *NullableListOmniTransactionsByBlockHashResponseItem {
	return &NullableListOmniTransactionsByBlockHashResponseItem{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHashResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHashResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
