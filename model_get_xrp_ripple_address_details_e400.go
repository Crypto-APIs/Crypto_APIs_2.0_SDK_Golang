...
type GetXRPRippleAddressDetailsE400 struct {
...
func InvalidPaginationAsGetXRPRippleAddressDetailsE400(v *InvalidPagination) GetXRPRippleAddressDetailsE400 {
	return GetXRPRippleAddressDetailsE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsGetXRPRippleAddressDetailsE400(v *LimitGreaterThanAllowed) GetXRPRippleAddressDetailsE400 {
	return GetXRPRippleAddressDetailsE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsGetXRPRippleAddressDetailsE400(v *UriNotFound) GetXRPRippleAddressDetailsE400 {
	return GetXRPRippleAddressDetailsE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetXRPRippleAddressDetailsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetXRPRippleAddressDetailsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetXRPRippleAddressDetailsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetXRPRippleAddressDetailsE400) MarshalJSON() ([]byte, error) {
...
func (obj *GetXRPRippleAddressDetailsE400) GetActualInstance() (interface{}) {
...
type NullableGetXRPRippleAddressDetailsE400 struct {
	value *GetXRPRippleAddressDetailsE400
	isSet bool
}

func (v NullableGetXRPRippleAddressDetailsE400) Get() *GetXRPRippleAddressDetailsE400 {
	return v.value
}

func (v *NullableGetXRPRippleAddressDetailsE400) Set(val *GetXRPRippleAddressDetailsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetXRPRippleAddressDetailsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetXRPRippleAddressDetailsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetXRPRippleAddressDetailsE400(val *GetXRPRippleAddressDetailsE400) *NullableGetXRPRippleAddressDetailsE400 {
	return &NullableGetXRPRippleAddressDetailsE400{value: val, isSet: true}
}

func (v NullableGetXRPRippleAddressDetailsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetXRPRippleAddressDetailsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
