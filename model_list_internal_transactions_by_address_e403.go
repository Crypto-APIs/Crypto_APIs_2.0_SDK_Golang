...
type ListInternalTransactionsByAddressE403 struct {
...
func BannedIpAddressAsListInternalTransactionsByAddressE403(v *BannedIpAddress) ListInternalTransactionsByAddressE403 {
	return ListInternalTransactionsByAddressE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListInternalTransactionsByAddressE403(v *EndpointNotAllowedForApiKey) ListInternalTransactionsByAddressE403 {
	return ListInternalTransactionsByAddressE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListInternalTransactionsByAddressE403(v *EndpointNotAllowedForPlan) ListInternalTransactionsByAddressE403 {
	return ListInternalTransactionsByAddressE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListInternalTransactionsByAddressE403(v *FeatureMainnetsNotAllowedForPlan) ListInternalTransactionsByAddressE403 {
	return ListInternalTransactionsByAddressE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListInternalTransactionsByAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListInternalTransactionsByAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListInternalTransactionsByAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListInternalTransactionsByAddressE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListInternalTransactionsByAddressE403) GetActualInstance() (interface{}) {
...
type NullableListInternalTransactionsByAddressE403 struct {
	value *ListInternalTransactionsByAddressE403
	isSet bool
}

func (v NullableListInternalTransactionsByAddressE403) Get() *ListInternalTransactionsByAddressE403 {
	return v.value
}

func (v *NullableListInternalTransactionsByAddressE403) Set(val *ListInternalTransactionsByAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddressE403(val *ListInternalTransactionsByAddressE403) *NullableListInternalTransactionsByAddressE403 {
	return &NullableListInternalTransactionsByAddressE403{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
