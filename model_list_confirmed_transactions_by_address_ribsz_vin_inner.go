...
type ListConfirmedTransactionsByAddressRIBSZVinInner struct {
...
func NewListConfirmedTransactionsByAddressRIBSZVinInner(addresses []string, coinbase string, scriptSig GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig, sequence int64, txid string, txinwitness []string, value string, vout int32) *ListConfirmedTransactionsByAddressRIBSZVinInner {
	this := ListConfirmedTransactionsByAddressRIBSZVinInner{}
...
func (o ListConfirmedTransactionsByAddressRIBSZVinInner) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRIBSZVinInner struct {
	value *ListConfirmedTransactionsByAddressRIBSZVinInner
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRIBSZVinInner) Get() *ListConfirmedTransactionsByAddressRIBSZVinInner {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRIBSZVinInner) Set(val *ListConfirmedTransactionsByAddressRIBSZVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRIBSZVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRIBSZVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRIBSZVinInner(val *ListConfirmedTransactionsByAddressRIBSZVinInner) *NullableListConfirmedTransactionsByAddressRIBSZVinInner {
	return &NullableListConfirmedTransactionsByAddressRIBSZVinInner{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRIBSZVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRIBSZVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
