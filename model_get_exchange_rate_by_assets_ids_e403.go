...
type GetExchangeRateByAssetsIDsE403 struct {
...
func BannedIpAddressAsGetExchangeRateByAssetsIDsE403(v *BannedIpAddress) GetExchangeRateByAssetsIDsE403 {
	return GetExchangeRateByAssetsIDsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetExchangeRateByAssetsIDsE403(v *EndpointNotAllowedForApiKey) GetExchangeRateByAssetsIDsE403 {
	return GetExchangeRateByAssetsIDsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetExchangeRateByAssetsIDsE403(v *EndpointNotAllowedForPlan) GetExchangeRateByAssetsIDsE403 {
	return GetExchangeRateByAssetsIDsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetExchangeRateByAssetsIDsE403(v *FeatureMainnetsNotAllowedForPlan) GetExchangeRateByAssetsIDsE403 {
	return GetExchangeRateByAssetsIDsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetExchangeRateByAssetsIDsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetExchangeRateByAssetsIDsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetExchangeRateByAssetsIDsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetExchangeRateByAssetsIDsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetExchangeRateByAssetsIDsE403) GetActualInstance() (interface{}) {
...
type NullableGetExchangeRateByAssetsIDsE403 struct {
	value *GetExchangeRateByAssetsIDsE403
	isSet bool
}

func (v NullableGetExchangeRateByAssetsIDsE403) Get() *GetExchangeRateByAssetsIDsE403 {
	return v.value
}

func (v *NullableGetExchangeRateByAssetsIDsE403) Set(val *GetExchangeRateByAssetsIDsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExchangeRateByAssetsIDsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExchangeRateByAssetsIDsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExchangeRateByAssetsIDsE403(val *GetExchangeRateByAssetsIDsE403) *NullableGetExchangeRateByAssetsIDsE403 {
	return &NullableGetExchangeRateByAssetsIDsE403{value: val, isSet: true}
}

func (v NullableGetExchangeRateByAssetsIDsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExchangeRateByAssetsIDsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
