...
type EstimateTransactionSmartFee400Response struct {
	...
	Error EstimateTransactionSmartFeeE400 `json:"error"`
}
...
func NewEstimateTransactionSmartFee400Response(apiVersion string, requestId string, error_ EstimateTransactionSmartFeeE400) *EstimateTransactionSmartFee400Response {
	this := EstimateTransactionSmartFee400Response{}
...
func (o *EstimateTransactionSmartFee400Response) GetError() EstimateTransactionSmartFeeE400 {
	if o == nil {
		var ret EstimateTransactionSmartFeeE400
		return ret
	}
...
func (o EstimateTransactionSmartFee400Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateTransactionSmartFee400Response struct {
	value *EstimateTransactionSmartFee400Response
	isSet bool
}

func (v NullableEstimateTransactionSmartFee400Response) Get() *EstimateTransactionSmartFee400Response {
	return v.value
}

func (v *NullableEstimateTransactionSmartFee400Response) Set(val *EstimateTransactionSmartFee400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTransactionSmartFee400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTransactionSmartFee400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTransactionSmartFee400Response(val *EstimateTransactionSmartFee400Response) *NullableEstimateTransactionSmartFee400Response {
	return &NullableEstimateTransactionSmartFee400Response{value: val, isSet: true}
}

func (v NullableEstimateTransactionSmartFee400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTransactionSmartFee400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
