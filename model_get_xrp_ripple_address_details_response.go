...
// GetXRPRippleAddressDetailsResponse struct for GetXRPRippleAddressDetailsResponse
type GetXRPRippleAddressDetailsResponse struct {
	...
	Data GetXRPRippleAddressDetailsResponseData `json:"data"`
}
...
func NewGetXRPRippleAddressDetailsResponse(apiVersion string, requestId string, data GetXRPRippleAddressDetailsResponseData) *GetXRPRippleAddressDetailsResponse {
	this := GetXRPRippleAddressDetailsResponse{}
...
func (o *GetXRPRippleAddressDetailsResponse) GetData() GetXRPRippleAddressDetailsResponseData {
	if o == nil {
		var ret GetXRPRippleAddressDetailsResponseData
		return ret
	}
...
func (o GetXRPRippleAddressDetailsResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetXRPRippleAddressDetailsResponse struct {
	value *GetXRPRippleAddressDetailsResponse
	isSet bool
}

func (v NullableGetXRPRippleAddressDetailsResponse) Get() *GetXRPRippleAddressDetailsResponse {
	return v.value
}

func (v *NullableGetXRPRippleAddressDetailsResponse) Set(val *GetXRPRippleAddressDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetXRPRippleAddressDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetXRPRippleAddressDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetXRPRippleAddressDetailsResponse(val *GetXRPRippleAddressDetailsResponse) *NullableGetXRPRippleAddressDetailsResponse {
	return &NullableGetXRPRippleAddressDetailsResponse{value: val, isSet: true}
}

func (v NullableGetXRPRippleAddressDetailsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetXRPRippleAddressDetailsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
