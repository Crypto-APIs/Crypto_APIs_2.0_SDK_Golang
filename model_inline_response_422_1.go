...
// InlineResponse4221 struct for InlineResponse4221
type InlineResponse4221 struct {
...
func (o InlineResponse4221) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse4221 struct {
	value *InlineResponse4221
	isSet bool
}

func (v NullableInlineResponse4221) Get() *InlineResponse4221 {
	return v.value
}

func (v *NullableInlineResponse4221) Set(val *InlineResponse4221) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse4221) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse4221) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse4221(val *InlineResponse4221) *NullableInlineResponse4221 {
	return &NullableInlineResponse4221{value: val, isSet: true}
}

func (v NullableInlineResponse4221) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse4221) UnmarshalJSON(src []byte) error {
	v.isSet = true
