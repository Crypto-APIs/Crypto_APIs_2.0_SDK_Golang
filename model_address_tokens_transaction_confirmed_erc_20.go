...
type AddressTokensTransactionConfirmedErc20 struct {
...
func NewAddressTokensTransactionConfirmedErc20(name string, symbol string, amount string, contractAddress string) *AddressTokensTransactionConfirmedErc20 {
	this := AddressTokensTransactionConfirmedErc20{}
	this.Name = name
	this.Symbol = symbol
	this.Amount = amount
...
func (o AddressTokensTransactionConfirmedErc20) MarshalJSON() ([]byte, error) {
...
type NullableAddressTokensTransactionConfirmedErc20 struct {
	value *AddressTokensTransactionConfirmedErc20
	isSet bool
}

func (v NullableAddressTokensTransactionConfirmedErc20) Get() *AddressTokensTransactionConfirmedErc20 {
	return v.value
}

func (v *NullableAddressTokensTransactionConfirmedErc20) Set(val *AddressTokensTransactionConfirmedErc20) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressTokensTransactionConfirmedErc20) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressTokensTransactionConfirmedErc20) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressTokensTransactionConfirmedErc20(val *AddressTokensTransactionConfirmedErc20) *NullableAddressTokensTransactionConfirmedErc20 {
	return &NullableAddressTokensTransactionConfirmedErc20{value: val, isSet: true}
}

func (v NullableAddressTokensTransactionConfirmedErc20) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressTokensTransactionConfirmedErc20) UnmarshalJSON(src []byte) error {
	v.isSet = true
