...
func main() {
    ...
    resp, r, err := api_client.ManageSubscriptionsApi.ActivateBlockchainEventSubscription(context.Background(), referenceId).Context(context).ActivateBlockchainEventSubscriptionRB(activateBlockchainEventSubscriptionRB).Execute()
    if err != nil {
