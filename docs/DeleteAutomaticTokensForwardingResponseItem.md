...
`func (o *DeleteAutomaticTokensForwardingResponseItem) SetCreatedTimestamp(v int32)`
...
`func (o *DeleteAutomaticTokensForwardingResponseItem) SetFromAddress(v string)`
