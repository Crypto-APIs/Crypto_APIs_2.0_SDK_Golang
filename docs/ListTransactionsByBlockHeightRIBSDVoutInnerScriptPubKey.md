...
### NewListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey

`func NewListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey(addresses []string, asm string, hex string, type_ string, ) *ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey`
...
`func (o *ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey) HasReqSigs() bool`
