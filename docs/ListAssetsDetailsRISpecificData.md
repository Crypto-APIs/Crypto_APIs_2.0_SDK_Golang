...
### NewListAssetsDetailsRISpecificData

`func NewListAssetsDetailsRISpecificData(var1HourPriceChangeInPercentage string, var1WeekPriceChangeInPercentage string, var24HoursPriceChangeInPercentage string, var24HoursTradingVolume string, assetType string, circulatingSupply string, marketCapInUSD string, maxSupply string, ) *ListAssetsDetailsRISpecificData`

NewListAssetsDetailsRISpecificData instantiates a new ListAssetsDetailsRISpecificData object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewListAssetsDetailsRISpecificDataWithDefaults

`func NewListAssetsDetailsRISpecificDataWithDefaults() *ListAssetsDetailsRISpecificData`

NewListAssetsDetailsRISpecificDataWithDefaults instantiates a new ListAssetsDetailsRISpecificData object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetVar1HourPriceChangeInPercentage

`func (o *ListAssetsDetailsRISpecificData) GetVar1HourPriceChangeInPercentage() string`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar1HourPriceChangeInPercentageOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetVar1HourPriceChangeInPercentage(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar1WeekPriceChangeInPercentage() string`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar1WeekPriceChangeInPercentageOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetVar1WeekPriceChangeInPercentage(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar24HoursPriceChangeInPercentage() string`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar24HoursPriceChangeInPercentageOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetVar24HoursPriceChangeInPercentage(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar24HoursTradingVolume() string`
...
`func (o *ListAssetsDetailsRISpecificData) GetVar24HoursTradingVolumeOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetVar24HoursTradingVolume(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetAssetType() string`

GetAssetType returns the AssetType field if non-nil, zero value otherwise.

### GetAssetTypeOk

`func (o *ListAssetsDetailsRISpecificData) GetAssetTypeOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetAssetType(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetCirculatingSupply() string`

GetCirculatingSupply returns the CirculatingSupply field if non-nil, zero value otherwise.

### GetCirculatingSupplyOk

`func (o *ListAssetsDetailsRISpecificData) GetCirculatingSupplyOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetCirculatingSupply(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetMarketCapInUSD() string`

GetMarketCapInUSD returns the MarketCapInUSD field if non-nil, zero value otherwise.

### GetMarketCapInUSDOk

`func (o *ListAssetsDetailsRISpecificData) GetMarketCapInUSDOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetMarketCapInUSD(v string)`
...
`func (o *ListAssetsDetailsRISpecificData) GetMaxSupply() string`

GetMaxSupply returns the MaxSupply field if non-nil, zero value otherwise.

### GetMaxSupplyOk

`func (o *ListAssetsDetailsRISpecificData) GetMaxSupplyOk() (*string, bool)`
...
`func (o *ListAssetsDetailsRISpecificData) SetMaxSupply(v string)`
