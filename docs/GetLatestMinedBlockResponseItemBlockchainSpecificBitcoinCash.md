...
`func (o *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) GetDifficulty() string`
...
`func (o *GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash) SetMerkleRoot(v string)`
