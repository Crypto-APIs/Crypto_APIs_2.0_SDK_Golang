...
### NewListAssetsDetailsResponseItemSpecificData

`func NewListAssetsDetailsResponseItemSpecificData(var1HourPriceChangeInPercentage string, var1WeekPriceChangeInPercentage string, var24HoursPriceChangeInPercentage string, var24HoursTradingVolume string, circulatingSupply string, marketCapInUSD string, maxSupply string, ) *ListAssetsDetailsResponseItemSpecificData`

NewListAssetsDetailsResponseItemSpecificData instantiates a new ListAssetsDetailsResponseItemSpecificData object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewListAssetsDetailsResponseItemSpecificDataWithDefaults

`func NewListAssetsDetailsResponseItemSpecificDataWithDefaults() *ListAssetsDetailsResponseItemSpecificData`

NewListAssetsDetailsResponseItemSpecificDataWithDefaults instantiates a new ListAssetsDetailsResponseItemSpecificData object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetVar1HourPriceChangeInPercentage

`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar1HourPriceChangeInPercentage() string`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar1HourPriceChangeInPercentageOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetVar1HourPriceChangeInPercentage(v string)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar1WeekPriceChangeInPercentage() string`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar1WeekPriceChangeInPercentageOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetVar1WeekPriceChangeInPercentage(v string)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar24HoursPriceChangeInPercentage() string`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar24HoursPriceChangeInPercentageOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetVar24HoursPriceChangeInPercentage(v string)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar24HoursTradingVolume() string`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetVar24HoursTradingVolumeOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetVar24HoursTradingVolume(v string)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetCirculatingSupply() string`

GetCirculatingSupply returns the CirculatingSupply field if non-nil, zero value otherwise.

### GetCirculatingSupplyOk

`func (o *ListAssetsDetailsResponseItemSpecificData) GetCirculatingSupplyOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetCirculatingSupply(v string)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetMarketCapInUSD() string`

GetMarketCapInUSD returns the MarketCapInUSD field if non-nil, zero value otherwise.

### GetMarketCapInUSDOk

`func (o *ListAssetsDetailsResponseItemSpecificData) GetMarketCapInUSDOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetMarketCapInUSD(v string)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) GetMaxSupply() string`

GetMaxSupply returns the MaxSupply field if non-nil, zero value otherwise.

### GetMaxSupplyOk

`func (o *ListAssetsDetailsResponseItemSpecificData) GetMaxSupplyOk() (*string, bool)`
...
`func (o *ListAssetsDetailsResponseItemSpecificData) SetMaxSupply(v string)`
