...
`func NewListLatestMinedBlocksRIBSD2(bits string, chainwork string, difficulty string, merkleRoot string, nonce int32, size int32, strippedSize int32, version int32, weight int32, ) *ListLatestMinedBlocksRIBSD2`
...
`func (o *ListLatestMinedBlocksRIBSD2) GetNonce() int32`

GetNonce returns the Nonce field if non-nil, zero value otherwise.

### GetNonceOk

`func (o *ListLatestMinedBlocksRIBSD2) GetNonceOk() (*int32, bool)`
...
`func (o *ListLatestMinedBlocksRIBSD2) SetNonce(v int32)`
