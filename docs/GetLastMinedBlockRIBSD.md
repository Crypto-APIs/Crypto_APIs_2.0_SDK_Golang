...
`func NewGetLastMinedBlockRIBSD(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, weight int32, ) *GetLastMinedBlockRIBSD`
...
`func (o *GetLastMinedBlockRIBSD) GetNonce() string`

GetNonce returns the Nonce field if non-nil, zero value otherwise.

### GetNonceOk

`func (o *GetLastMinedBlockRIBSD) GetNonceOk() (*string, bool)`
...
`func (o *GetLastMinedBlockRIBSD) SetNonce(v string)`
