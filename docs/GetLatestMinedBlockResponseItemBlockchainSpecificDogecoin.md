...
`func (o *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) GetDifficulty() string`
...
`func (o *GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin) SetMerkleRoot(v string)`
