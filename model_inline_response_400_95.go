...
// InlineResponse40095 struct for InlineResponse40095
type InlineResponse40095 struct {
...
func (o InlineResponse40095) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse40095 struct {
	value *InlineResponse40095
	isSet bool
}

func (v NullableInlineResponse40095) Get() *InlineResponse40095 {
	return v.value
}

func (v *NullableInlineResponse40095) Set(val *InlineResponse40095) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse40095) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse40095) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse40095(val *InlineResponse40095) *NullableInlineResponse40095 {
	return &NullableInlineResponse40095{value: val, isSet: true}
}

func (v NullableInlineResponse40095) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse40095) UnmarshalJSON(src []byte) error {
	v.isSet = true
