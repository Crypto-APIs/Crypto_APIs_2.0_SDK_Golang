...
type NewConfirmedTokensTransactions403Response struct {
...
func NewNewConfirmedTokensTransactions403Response(apiVersion string, requestId string, error_ NewConfirmedTokensTransactionsE403) *NewConfirmedTokensTransactions403Response {
	this := NewConfirmedTokensTransactions403Response{}
...
func (o NewConfirmedTokensTransactions403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokensTransactions403Response struct {
	value *NewConfirmedTokensTransactions403Response
	isSet bool
}

func (v NullableNewConfirmedTokensTransactions403Response) Get() *NewConfirmedTokensTransactions403Response {
	return v.value
}

func (v *NullableNewConfirmedTokensTransactions403Response) Set(val *NewConfirmedTokensTransactions403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokensTransactions403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokensTransactions403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokensTransactions403Response(val *NewConfirmedTokensTransactions403Response) *NullableNewConfirmedTokensTransactions403Response {
	return &NullableNewConfirmedTokensTransactions403Response{value: val, isSet: true}
}

func (v NullableNewConfirmedTokensTransactions403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokensTransactions403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
