...
type ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig struct {
...
func NewListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig(asm string, hex string, type_ string) *ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig {
	this := ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig struct {
	value *ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) Get() *ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) Set(val *ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig(val *ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) *NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig {
	return &NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
