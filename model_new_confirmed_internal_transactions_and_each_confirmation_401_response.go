...
type NewConfirmedInternalTransactionsAndEachConfirmation401Response struct {
...
func NewNewConfirmedInternalTransactionsAndEachConfirmation401Response(apiVersion string, requestId string, error_ NewConfirmedInternalTransactionsAndEachConfirmationE401) *NewConfirmedInternalTransactionsAndEachConfirmation401Response {
	this := NewConfirmedInternalTransactionsAndEachConfirmation401Response{}
...
func (o NewConfirmedInternalTransactionsAndEachConfirmation401Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response struct {
	value *NewConfirmedInternalTransactionsAndEachConfirmation401Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response) Get() *NewConfirmedInternalTransactionsAndEachConfirmation401Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response) Set(val *NewConfirmedInternalTransactionsAndEachConfirmation401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsAndEachConfirmation401Response(val *NewConfirmedInternalTransactionsAndEachConfirmation401Response) *NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response {
	return &NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
