...
// FeatureMainnetsNotAllowedForPlanError struct for FeatureMainnetsNotAllowedForPlanError
type FeatureMainnetsNotAllowedForPlanError struct {
...
func NewFeatureMainnetsNotAllowedForPlanError(code string, message string) *FeatureMainnetsNotAllowedForPlanError {
	this := FeatureMainnetsNotAllowedForPlanError{}
	this.Code = code
...
func (o FeatureMainnetsNotAllowedForPlanError) MarshalJSON() ([]byte, error) {
...
type NullableFeatureMainnetsNotAllowedForPlanError struct {
	value *FeatureMainnetsNotAllowedForPlanError
	isSet bool
}

func (v NullableFeatureMainnetsNotAllowedForPlanError) Get() *FeatureMainnetsNotAllowedForPlanError {
	return v.value
}

func (v *NullableFeatureMainnetsNotAllowedForPlanError) Set(val *FeatureMainnetsNotAllowedForPlanError) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureMainnetsNotAllowedForPlanError) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureMainnetsNotAllowedForPlanError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureMainnetsNotAllowedForPlanError(val *FeatureMainnetsNotAllowedForPlanError) *NullableFeatureMainnetsNotAllowedForPlanError {
	return &NullableFeatureMainnetsNotAllowedForPlanError{value: val, isSet: true}
}

func (v NullableFeatureMainnetsNotAllowedForPlanError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureMainnetsNotAllowedForPlanError) UnmarshalJSON(src []byte) error {
	v.isSet = true
