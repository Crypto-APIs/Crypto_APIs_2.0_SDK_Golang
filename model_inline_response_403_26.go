...
// InlineResponse40326 struct for InlineResponse40326
...
func (o InlineResponse40326) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse40326 struct {
	value *InlineResponse40326
	isSet bool
}

func (v NullableInlineResponse40326) Get() *InlineResponse40326 {
	return v.value
}

func (v *NullableInlineResponse40326) Set(val *InlineResponse40326) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse40326) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse40326) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse40326(val *InlineResponse40326) *NullableInlineResponse40326 {
	return &NullableInlineResponse40326{value: val, isSet: true}
}

func (v NullableInlineResponse40326) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse40326) UnmarshalJSON(src []byte) error {
	v.isSet = true
