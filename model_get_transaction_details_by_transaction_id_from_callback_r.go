...
type GetTransactionDetailsByTransactionIDFromCallbackR struct {
	...
	Data GetTransactionDetailsByTransactionIDFromCallbackRData `json:"data"`
}
...
func NewGetTransactionDetailsByTransactionIDFromCallbackR(apiVersion string, requestId string, data GetTransactionDetailsByTransactionIDFromCallbackRData) *GetTransactionDetailsByTransactionIDFromCallbackR {
	this := GetTransactionDetailsByTransactionIDFromCallbackR{}
...
func (o *GetTransactionDetailsByTransactionIDFromCallbackR) GetData() GetTransactionDetailsByTransactionIDFromCallbackRData {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDFromCallbackRData
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDFromCallbackR) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackR struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackR
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackR) Get() *GetTransactionDetailsByTransactionIDFromCallbackR {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackR) Set(val *GetTransactionDetailsByTransactionIDFromCallbackR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackR(val *GetTransactionDetailsByTransactionIDFromCallbackR) *NullableGetTransactionDetailsByTransactionIDFromCallbackR {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackR{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackR) UnmarshalJSON(src []byte) error {
	v.isSet = true
