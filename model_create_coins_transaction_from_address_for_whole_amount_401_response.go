...
type CreateCoinsTransactionFromAddressForWholeAmount401Response struct {
	...
	Error CreateCoinsTransactionFromAddressForWholeAmountE401 `json:"error"`
}
...
func NewCreateCoinsTransactionFromAddressForWholeAmount401Response(apiVersion string, requestId string, error_ CreateCoinsTransactionFromAddressForWholeAmountE401) *CreateCoinsTransactionFromAddressForWholeAmount401Response {
	this := CreateCoinsTransactionFromAddressForWholeAmount401Response{}
...
func (o CreateCoinsTransactionFromAddressForWholeAmount401Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateCoinsTransactionFromAddressForWholeAmount401Response struct {
	value *CreateCoinsTransactionFromAddressForWholeAmount401Response
	isSet bool
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmount401Response) Get() *CreateCoinsTransactionFromAddressForWholeAmount401Response {
	return v.value
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmount401Response) Set(val *CreateCoinsTransactionFromAddressForWholeAmount401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmount401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmount401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCoinsTransactionFromAddressForWholeAmount401Response(val *CreateCoinsTransactionFromAddressForWholeAmount401Response) *NullableCreateCoinsTransactionFromAddressForWholeAmount401Response {
	return &NullableCreateCoinsTransactionFromAddressForWholeAmount401Response{value: val, isSet: true}
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmount401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmount401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
