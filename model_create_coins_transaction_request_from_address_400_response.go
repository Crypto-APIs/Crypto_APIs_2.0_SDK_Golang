...
type CreateCoinsTransactionRequestFromAddress400Response struct {
	...
	Error CreateCoinsTransactionRequestFromAddressE400 `json:"error"`
}
...
func NewCreateCoinsTransactionRequestFromAddress400Response(apiVersion string, requestId string, error_ CreateCoinsTransactionRequestFromAddressE400) *CreateCoinsTransactionRequestFromAddress400Response {
	this := CreateCoinsTransactionRequestFromAddress400Response{}
...
func (o CreateCoinsTransactionRequestFromAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateCoinsTransactionRequestFromAddress400Response struct {
	value *CreateCoinsTransactionRequestFromAddress400Response
	isSet bool
}

func (v NullableCreateCoinsTransactionRequestFromAddress400Response) Get() *CreateCoinsTransactionRequestFromAddress400Response {
	return v.value
}

func (v *NullableCreateCoinsTransactionRequestFromAddress400Response) Set(val *CreateCoinsTransactionRequestFromAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCoinsTransactionRequestFromAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCoinsTransactionRequestFromAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCoinsTransactionRequestFromAddress400Response(val *CreateCoinsTransactionRequestFromAddress400Response) *NullableCreateCoinsTransactionRequestFromAddress400Response {
	return &NullableCreateCoinsTransactionRequestFromAddress400Response{value: val, isSet: true}
}

func (v NullableCreateCoinsTransactionRequestFromAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCoinsTransactionRequestFromAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
