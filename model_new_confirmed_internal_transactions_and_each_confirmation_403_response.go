...
type NewConfirmedInternalTransactionsAndEachConfirmation403Response struct {
	...
	Error NewConfirmedInternalTransactionsAndEachConfirmationE403 `json:"error"`
}
...
func (o *NewConfirmedInternalTransactionsAndEachConfirmation403Response) GetError() NewConfirmedInternalTransactionsAndEachConfirmationE403 {
	if o == nil {
		var ret NewConfirmedInternalTransactionsAndEachConfirmationE403
		return ret
	}
...
func (o NewConfirmedInternalTransactionsAndEachConfirmation403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response struct {
	value *NewConfirmedInternalTransactionsAndEachConfirmation403Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response) Get() *NewConfirmedInternalTransactionsAndEachConfirmation403Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response) Set(val *NewConfirmedInternalTransactionsAndEachConfirmation403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsAndEachConfirmation403Response(val *NewConfirmedInternalTransactionsAndEachConfirmation403Response) *NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response {
	return &NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
