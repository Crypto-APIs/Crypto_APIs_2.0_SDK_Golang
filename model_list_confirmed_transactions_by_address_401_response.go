...
type ListConfirmedTransactionsByAddress401Response struct {
	...
	Error ListConfirmedTransactionsByAddressE401 `json:"error"`
}
...
func (o *ListConfirmedTransactionsByAddress401Response) GetError() ListConfirmedTransactionsByAddressE401 {
	if o == nil {
		var ret ListConfirmedTransactionsByAddressE401
		return ret
	}
...
func (o ListConfirmedTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddress401Response struct {
	value *ListConfirmedTransactionsByAddress401Response
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddress401Response) Get() *ListConfirmedTransactionsByAddress401Response {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddress401Response) Set(val *ListConfirmedTransactionsByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddress401Response(val *ListConfirmedTransactionsByAddress401Response) *NullableListConfirmedTransactionsByAddress401Response {
	return &NullableListConfirmedTransactionsByAddress401Response{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
