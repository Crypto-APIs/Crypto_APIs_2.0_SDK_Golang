...
// GetFeeAddressDetailsResponse struct for GetFeeAddressDetailsResponse
type GetFeeAddressDetailsResponse struct {
	...
	Data GetFeeAddressDetailsResponseData `json:"data"`
}
...
func NewGetFeeAddressDetailsResponse(apiVersion string, requestId string, data GetFeeAddressDetailsResponseData) *GetFeeAddressDetailsResponse {
	this := GetFeeAddressDetailsResponse{}
...
func (o *GetFeeAddressDetailsResponse) GetData() GetFeeAddressDetailsResponseData {
	if o == nil {
		var ret GetFeeAddressDetailsResponseData
		return ret
	}
...
func (o GetFeeAddressDetailsResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetFeeAddressDetailsResponse struct {
	value *GetFeeAddressDetailsResponse
	isSet bool
}

func (v NullableGetFeeAddressDetailsResponse) Get() *GetFeeAddressDetailsResponse {
	return v.value
}

func (v *NullableGetFeeAddressDetailsResponse) Set(val *GetFeeAddressDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeAddressDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeAddressDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeAddressDetailsResponse(val *GetFeeAddressDetailsResponse) *NullableGetFeeAddressDetailsResponse {
	return &NullableGetFeeAddressDetailsResponse{value: val, isSet: true}
}

func (v NullableGetFeeAddressDetailsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeAddressDetailsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
