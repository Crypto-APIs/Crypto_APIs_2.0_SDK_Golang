...
type GetXRPRippleBlockDetailsByBlockHashR struct {
	...
	Data GetXRPRippleBlockDetailsByBlockHashRData `json:"data"`
}
...
func NewGetXRPRippleBlockDetailsByBlockHashR(apiVersion string, requestId string, data GetXRPRippleBlockDetailsByBlockHashRData) *GetXRPRippleBlockDetailsByBlockHashR {
	this := GetXRPRippleBlockDetailsByBlockHashR{}
...
func (o *GetXRPRippleBlockDetailsByBlockHashR) GetData() GetXRPRippleBlockDetailsByBlockHashRData {
	if o == nil {
		var ret GetXRPRippleBlockDetailsByBlockHashRData
		return ret
	}
...
func (o GetXRPRippleBlockDetailsByBlockHashR) MarshalJSON() ([]byte, error) {
...
type NullableGetXRPRippleBlockDetailsByBlockHashR struct {
	value *GetXRPRippleBlockDetailsByBlockHashR
	isSet bool
}

func (v NullableGetXRPRippleBlockDetailsByBlockHashR) Get() *GetXRPRippleBlockDetailsByBlockHashR {
	return v.value
}

func (v *NullableGetXRPRippleBlockDetailsByBlockHashR) Set(val *GetXRPRippleBlockDetailsByBlockHashR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetXRPRippleBlockDetailsByBlockHashR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetXRPRippleBlockDetailsByBlockHashR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetXRPRippleBlockDetailsByBlockHashR(val *GetXRPRippleBlockDetailsByBlockHashR) *NullableGetXRPRippleBlockDetailsByBlockHashR {
	return &NullableGetXRPRippleBlockDetailsByBlockHashR{value: val, isSet: true}
}

func (v NullableGetXRPRippleBlockDetailsByBlockHashR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetXRPRippleBlockDetailsByBlockHashR) UnmarshalJSON(src []byte) error {
	v.isSet = true
