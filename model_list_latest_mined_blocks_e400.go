...
type ListLatestMinedBlocksE400 struct {
...
func InvalidPaginationAsListLatestMinedBlocksE400(v *InvalidPagination) ListLatestMinedBlocksE400 {
	return ListLatestMinedBlocksE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsListLatestMinedBlocksE400(v *LimitGreaterThanAllowed) ListLatestMinedBlocksE400 {
	return ListLatestMinedBlocksE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsListLatestMinedBlocksE400(v *UriNotFound) ListLatestMinedBlocksE400 {
	return ListLatestMinedBlocksE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListLatestMinedBlocksE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListLatestMinedBlocksE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListLatestMinedBlocksE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListLatestMinedBlocksE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListLatestMinedBlocksE400) GetActualInstance() (interface{}) {
...
type NullableListLatestMinedBlocksE400 struct {
	value *ListLatestMinedBlocksE400
	isSet bool
}

func (v NullableListLatestMinedBlocksE400) Get() *ListLatestMinedBlocksE400 {
	return v.value
}

func (v *NullableListLatestMinedBlocksE400) Set(val *ListLatestMinedBlocksE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListLatestMinedBlocksE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListLatestMinedBlocksE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLatestMinedBlocksE400(val *ListLatestMinedBlocksE400) *NullableListLatestMinedBlocksE400 {
	return &NullableListLatestMinedBlocksE400{value: val, isSet: true}
}

func (v NullableListLatestMinedBlocksE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLatestMinedBlocksE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
