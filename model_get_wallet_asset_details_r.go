...
type GetWalletAssetDetailsR struct {
	...
	Data GetWalletAssetDetailsRData `json:"data"`
}
...
func (o *GetWalletAssetDetailsR) GetData() GetWalletAssetDetailsRData {
	if o == nil {
		var ret GetWalletAssetDetailsRData
		return ret
	}
...
func (o GetWalletAssetDetailsR) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletAssetDetailsR struct {
	value *GetWalletAssetDetailsR
	isSet bool
}

func (v NullableGetWalletAssetDetailsR) Get() *GetWalletAssetDetailsR {
	return v.value
}

func (v *NullableGetWalletAssetDetailsR) Set(val *GetWalletAssetDetailsR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletAssetDetailsR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletAssetDetailsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletAssetDetailsR(val *GetWalletAssetDetailsR) *NullableGetWalletAssetDetailsR {
	return &NullableGetWalletAssetDetailsR{value: val, isSet: true}
}

func (v NullableGetWalletAssetDetailsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletAssetDetailsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
