...
type GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum struct {
...
func NewGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum(difficulty string, nonce string, size int32, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, sha3Uncles string, totalDifficulty string, uncles []string) *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum {
	this := GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum{}
...
func (o GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum struct {
	value *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) Get() *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) Set(val *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum(val *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum {
	return &NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum) UnmarshalJSON(src []byte) error {
	v.isSet = true
