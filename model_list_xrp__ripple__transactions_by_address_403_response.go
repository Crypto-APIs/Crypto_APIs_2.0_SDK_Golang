...
type ListXRPRippleTransactionsByAddress403Response struct {
	...
	Error ListXRPRippleTransactionsByAddressE403 `json:"error"`
}
...
func NewListXRPRippleTransactionsByAddress403Response(apiVersion string, requestId string, error_ ListXRPRippleTransactionsByAddressE403) *ListXRPRippleTransactionsByAddress403Response {
	this := ListXRPRippleTransactionsByAddress403Response{}
...
func (o *ListXRPRippleTransactionsByAddress403Response) GetError() ListXRPRippleTransactionsByAddressE403 {
	if o == nil {
		var ret ListXRPRippleTransactionsByAddressE403
		return ret
	}
...
func (o ListXRPRippleTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByAddress403Response struct {
	value *ListXRPRippleTransactionsByAddress403Response
	isSet bool
}

func (v NullableListXRPRippleTransactionsByAddress403Response) Get() *ListXRPRippleTransactionsByAddress403Response {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByAddress403Response) Set(val *ListXRPRippleTransactionsByAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByAddress403Response(val *ListXRPRippleTransactionsByAddress403Response) *NullableListXRPRippleTransactionsByAddress403Response {
	return &NullableListXRPRippleTransactionsByAddress403Response{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
