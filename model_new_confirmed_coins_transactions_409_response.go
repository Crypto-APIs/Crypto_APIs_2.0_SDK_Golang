...
type NewConfirmedCoinsTransactions409Response struct {
...
func NewNewConfirmedCoinsTransactions409Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsE409) *NewConfirmedCoinsTransactions409Response {
	this := NewConfirmedCoinsTransactions409Response{}
...
func (o NewConfirmedCoinsTransactions409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactions409Response struct {
	value *NewConfirmedCoinsTransactions409Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactions409Response) Get() *NewConfirmedCoinsTransactions409Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactions409Response) Set(val *NewConfirmedCoinsTransactions409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactions409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactions409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactions409Response(val *NewConfirmedCoinsTransactions409Response) *NullableNewConfirmedCoinsTransactions409Response {
	return &NullableNewConfirmedCoinsTransactions409Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactions409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactions409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
