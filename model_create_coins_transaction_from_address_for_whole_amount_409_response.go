...
type CreateCoinsTransactionFromAddressForWholeAmount409Response struct {
...
func (o CreateCoinsTransactionFromAddressForWholeAmount409Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateCoinsTransactionFromAddressForWholeAmount409Response struct {
	value *CreateCoinsTransactionFromAddressForWholeAmount409Response
	isSet bool
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmount409Response) Get() *CreateCoinsTransactionFromAddressForWholeAmount409Response {
	return v.value
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmount409Response) Set(val *CreateCoinsTransactionFromAddressForWholeAmount409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmount409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmount409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCoinsTransactionFromAddressForWholeAmount409Response(val *CreateCoinsTransactionFromAddressForWholeAmount409Response) *NullableCreateCoinsTransactionFromAddressForWholeAmount409Response {
	return &NullableCreateCoinsTransactionFromAddressForWholeAmount409Response{value: val, isSet: true}
}

func (v NullableCreateCoinsTransactionFromAddressForWholeAmount409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCoinsTransactionFromAddressForWholeAmount409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
