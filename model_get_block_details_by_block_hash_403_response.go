...
type GetBlockDetailsByBlockHash403Response struct {
	...
	Error GetBlockDetailsByBlockHashE403 `json:"error"`
}
...
func NewGetBlockDetailsByBlockHash403Response(apiVersion string, requestId string, error_ GetBlockDetailsByBlockHashE403) *GetBlockDetailsByBlockHash403Response {
	this := GetBlockDetailsByBlockHash403Response{}
...
func (o *GetBlockDetailsByBlockHash403Response) GetError() GetBlockDetailsByBlockHashE403 {
	if o == nil {
		var ret GetBlockDetailsByBlockHashE403
		return ret
	}
...
func (o GetBlockDetailsByBlockHash403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHash403Response struct {
	value *GetBlockDetailsByBlockHash403Response
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHash403Response) Get() *GetBlockDetailsByBlockHash403Response {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHash403Response) Set(val *GetBlockDetailsByBlockHash403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHash403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHash403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHash403Response(val *GetBlockDetailsByBlockHash403Response) *NullableGetBlockDetailsByBlockHash403Response {
	return &NullableGetBlockDetailsByBlockHash403Response{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHash403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHash403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
