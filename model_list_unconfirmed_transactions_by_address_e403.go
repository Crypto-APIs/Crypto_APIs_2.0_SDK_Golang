...
type ListUnconfirmedTransactionsByAddressE403 struct {
...
func BannedIpAddressAsListUnconfirmedTransactionsByAddressE403(v *BannedIpAddress) ListUnconfirmedTransactionsByAddressE403 {
	return ListUnconfirmedTransactionsByAddressE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListUnconfirmedTransactionsByAddressE403(v *EndpointNotAllowedForApiKey) ListUnconfirmedTransactionsByAddressE403 {
	return ListUnconfirmedTransactionsByAddressE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListUnconfirmedTransactionsByAddressE403(v *EndpointNotAllowedForPlan) ListUnconfirmedTransactionsByAddressE403 {
	return ListUnconfirmedTransactionsByAddressE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListUnconfirmedTransactionsByAddressE403(v *FeatureMainnetsNotAllowedForPlan) ListUnconfirmedTransactionsByAddressE403 {
	return ListUnconfirmedTransactionsByAddressE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListUnconfirmedTransactionsByAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListUnconfirmedTransactionsByAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListUnconfirmedTransactionsByAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListUnconfirmedTransactionsByAddressE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListUnconfirmedTransactionsByAddressE403) GetActualInstance() (interface{}) {
...
type NullableListUnconfirmedTransactionsByAddressE403 struct {
	value *ListUnconfirmedTransactionsByAddressE403
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressE403) Get() *ListUnconfirmedTransactionsByAddressE403 {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressE403) Set(val *ListUnconfirmedTransactionsByAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressE403(val *ListUnconfirmedTransactionsByAddressE403) *NullableListUnconfirmedTransactionsByAddressE403 {
	return &NullableListUnconfirmedTransactionsByAddressE403{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
