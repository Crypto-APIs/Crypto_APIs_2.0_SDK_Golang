...
type NewConfirmedInternalTransactionsAndEachConfirmation409Response struct {
...
func NewNewConfirmedInternalTransactionsAndEachConfirmation409Response(apiVersion string, requestId string, error_ NewConfirmedInternalTransactionsAndEachConfirmationE409) *NewConfirmedInternalTransactionsAndEachConfirmation409Response {
	this := NewConfirmedInternalTransactionsAndEachConfirmation409Response{}
...
func (o NewConfirmedInternalTransactionsAndEachConfirmation409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response struct {
	value *NewConfirmedInternalTransactionsAndEachConfirmation409Response
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response) Get() *NewConfirmedInternalTransactionsAndEachConfirmation409Response {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response) Set(val *NewConfirmedInternalTransactionsAndEachConfirmation409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsAndEachConfirmation409Response(val *NewConfirmedInternalTransactionsAndEachConfirmation409Response) *NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response {
	return &NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmation409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
