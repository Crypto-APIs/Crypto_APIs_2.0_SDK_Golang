...
type ListTransactionsByBlockHeightRIBSDVinInnerScriptSig struct {
...
func (o ListTransactionsByBlockHeightRIBSDVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig struct {
	value *ListTransactionsByBlockHeightRIBSDVinInnerScriptSig
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig) Get() *ListTransactionsByBlockHeightRIBSDVinInnerScriptSig {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig) Set(val *ListTransactionsByBlockHeightRIBSDVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig(val *ListTransactionsByBlockHeightRIBSDVinInnerScriptSig) *NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig {
	return &NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSDVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
