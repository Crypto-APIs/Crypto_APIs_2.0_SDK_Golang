...
type GetWalletAssetDetailsE403 struct {
...
func BannedIpAddressAsGetWalletAssetDetailsE403(v *BannedIpAddress) GetWalletAssetDetailsE403 {
	return GetWalletAssetDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetWalletAssetDetailsE403(v *EndpointNotAllowedForApiKey) GetWalletAssetDetailsE403 {
	return GetWalletAssetDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetWalletAssetDetailsE403(v *EndpointNotAllowedForPlan) GetWalletAssetDetailsE403 {
	return GetWalletAssetDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetWalletAssetDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetWalletAssetDetailsE403 {
	return GetWalletAssetDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetWalletAssetDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data failed to match schemas in oneOf(GetWalletAssetDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetWalletAssetDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetWalletAssetDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetWalletAssetDetailsE403 struct {
	value *GetWalletAssetDetailsE403
	isSet bool
}

func (v NullableGetWalletAssetDetailsE403) Get() *GetWalletAssetDetailsE403 {
	return v.value
}

func (v *NullableGetWalletAssetDetailsE403) Set(val *GetWalletAssetDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletAssetDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletAssetDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletAssetDetailsE403(val *GetWalletAssetDetailsE403) *NullableGetWalletAssetDetailsE403 {
	return &NullableGetWalletAssetDetailsE403{value: val, isSet: true}
}

func (v NullableGetWalletAssetDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletAssetDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
