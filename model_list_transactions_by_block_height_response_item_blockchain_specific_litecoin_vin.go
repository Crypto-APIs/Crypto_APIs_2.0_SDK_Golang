...
// ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin struct for ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin
type ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig `json:"scriptSig"`
...
func NewListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin(addresses []string, scriptSig ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig, sequence string, txid string, txinwitness []string, value string, vout int32) *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin {
	this := ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin{}
...
func (o *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) GetScriptSig() ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig {
	if o == nil {
		var ret ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig
		return ret
	}
...
func (o ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin struct {
	value *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) Get() *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) Set(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin(val *ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin {
	return &NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
