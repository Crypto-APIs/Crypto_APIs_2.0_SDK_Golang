...
type ListInternalTransactionDetailsByTransactionHash401Response struct {
	...
	Error ListInternalTransactionDetailsByTransactionHashE401 `json:"error"`
}
...
func NewListInternalTransactionDetailsByTransactionHash401Response(apiVersion string, requestId string, error_ ListInternalTransactionDetailsByTransactionHashE401) *ListInternalTransactionDetailsByTransactionHash401Response {
	this := ListInternalTransactionDetailsByTransactionHash401Response{}
...
func (o *ListInternalTransactionDetailsByTransactionHash401Response) GetError() ListInternalTransactionDetailsByTransactionHashE401 {
	if o == nil {
		var ret ListInternalTransactionDetailsByTransactionHashE401
		return ret
	}
...
func (o ListInternalTransactionDetailsByTransactionHash401Response) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionDetailsByTransactionHash401Response struct {
	value *ListInternalTransactionDetailsByTransactionHash401Response
	isSet bool
}

func (v NullableListInternalTransactionDetailsByTransactionHash401Response) Get() *ListInternalTransactionDetailsByTransactionHash401Response {
	return v.value
}

func (v *NullableListInternalTransactionDetailsByTransactionHash401Response) Set(val *ListInternalTransactionDetailsByTransactionHash401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionDetailsByTransactionHash401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionDetailsByTransactionHash401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionDetailsByTransactionHash401Response(val *ListInternalTransactionDetailsByTransactionHash401Response) *NullableListInternalTransactionDetailsByTransactionHash401Response {
	return &NullableListInternalTransactionDetailsByTransactionHash401Response{value: val, isSet: true}
}

func (v NullableListInternalTransactionDetailsByTransactionHash401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionDetailsByTransactionHash401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
