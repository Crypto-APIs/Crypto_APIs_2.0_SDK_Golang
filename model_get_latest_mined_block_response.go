...
// GetLatestMinedBlockResponse struct for GetLatestMinedBlockResponse
type GetLatestMinedBlockResponse struct {
	...
	Data GetLatestMinedBlockResponseData `json:"data"`
}
...
func NewGetLatestMinedBlockResponse(apiVersion string, requestId string, data GetLatestMinedBlockResponseData) *GetLatestMinedBlockResponse {
	this := GetLatestMinedBlockResponse{}
...
func (o *GetLatestMinedBlockResponse) GetData() GetLatestMinedBlockResponseData {
	if o == nil {
		var ret GetLatestMinedBlockResponseData
		return ret
	}
...
func (o GetLatestMinedBlockResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedBlockResponse struct {
	value *GetLatestMinedBlockResponse
	isSet bool
}

func (v NullableGetLatestMinedBlockResponse) Get() *GetLatestMinedBlockResponse {
	return v.value
}

func (v *NullableGetLatestMinedBlockResponse) Set(val *GetLatestMinedBlockResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedBlockResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedBlockResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedBlockResponse(val *GetLatestMinedBlockResponse) *NullableGetLatestMinedBlockResponse {
	return &NullableGetLatestMinedBlockResponse{value: val, isSet: true}
}

func (v NullableGetLatestMinedBlockResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedBlockResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
