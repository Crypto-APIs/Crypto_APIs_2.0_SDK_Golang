...
type ListSupportedAssetsE400 struct {
...
func InvalidPaginationAsListSupportedAssetsE400(v *InvalidPagination) ListSupportedAssetsE400 {
	return ListSupportedAssetsE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsListSupportedAssetsE400(v *LimitGreaterThanAllowed) ListSupportedAssetsE400 {
	return ListSupportedAssetsE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsListSupportedAssetsE400(v *UriNotFound) ListSupportedAssetsE400 {
	return ListSupportedAssetsE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListSupportedAssetsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListSupportedAssetsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListSupportedAssetsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListSupportedAssetsE400) MarshalJSON() ([]byte, error) {
...
func (obj *ListSupportedAssetsE400) GetActualInstance() (interface{}) {
...
type NullableListSupportedAssetsE400 struct {
	value *ListSupportedAssetsE400
	isSet bool
}

func (v NullableListSupportedAssetsE400) Get() *ListSupportedAssetsE400 {
	return v.value
}

func (v *NullableListSupportedAssetsE400) Set(val *ListSupportedAssetsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedAssetsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedAssetsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedAssetsE400(val *ListSupportedAssetsE400) *NullableListSupportedAssetsE400 {
	return &NullableListSupportedAssetsE400{value: val, isSet: true}
}

func (v NullableListSupportedAssetsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedAssetsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
