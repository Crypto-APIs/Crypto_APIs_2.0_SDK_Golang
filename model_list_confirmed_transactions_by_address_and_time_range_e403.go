...
type ListConfirmedTransactionsByAddressAndTimeRangeE403 struct {
...
func BannedIpAddressAsListConfirmedTransactionsByAddressAndTimeRangeE403(v *BannedIpAddress) ListConfirmedTransactionsByAddressAndTimeRangeE403 {
...
func EndpointNotAllowedForApiKeyAsListConfirmedTransactionsByAddressAndTimeRangeE403(v *EndpointNotAllowedForApiKey) ListConfirmedTransactionsByAddressAndTimeRangeE403 {
	return ListConfirmedTransactionsByAddressAndTimeRangeE403{
...
func EndpointNotAllowedForPlanAsListConfirmedTransactionsByAddressAndTimeRangeE403(v *EndpointNotAllowedForPlan) ListConfirmedTransactionsByAddressAndTimeRangeE403 {
	return ListConfirmedTransactionsByAddressAndTimeRangeE403{
...
func FeatureMainnetsNotAllowedForPlanAsListConfirmedTransactionsByAddressAndTimeRangeE403(v *FeatureMainnetsNotAllowedForPlan) ListConfirmedTransactionsByAddressAndTimeRangeE403 {
	return ListConfirmedTransactionsByAddressAndTimeRangeE403{
...
func (dst *ListConfirmedTransactionsByAddressAndTimeRangeE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListConfirmedTransactionsByAddressAndTimeRangeE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListConfirmedTransactionsByAddressAndTimeRangeE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListConfirmedTransactionsByAddressAndTimeRangeE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListConfirmedTransactionsByAddressAndTimeRangeE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableListConfirmedTransactionsByAddressAndTimeRangeE403 struct {
	value *ListConfirmedTransactionsByAddressAndTimeRangeE403
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeE403) Get() *ListConfirmedTransactionsByAddressAndTimeRangeE403 {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeE403) Set(val *ListConfirmedTransactionsByAddressAndTimeRangeE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressAndTimeRangeE403(val *ListConfirmedTransactionsByAddressAndTimeRangeE403) *NullableListConfirmedTransactionsByAddressAndTimeRangeE403 {
	return &NullableListConfirmedTransactionsByAddressAndTimeRangeE403{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
