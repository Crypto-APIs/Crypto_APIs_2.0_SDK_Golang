...
type GetAddressBalanceE400 struct {
...
func InvalidPaginationAsGetAddressBalanceE400(v *InvalidPagination) GetAddressBalanceE400 {
...
func LimitGreaterThanAllowedAsGetAddressBalanceE400(v *LimitGreaterThanAllowed) GetAddressBalanceE400 {
	return GetAddressBalanceE400{
...
func UriNotFoundAsGetAddressBalanceE400(v *UriNotFound) GetAddressBalanceE400 {
	return GetAddressBalanceE400{
		UriNotFound: v,
	}
}
...
func (dst *GetAddressBalanceE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetAddressBalanceE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetAddressBalanceE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetAddressBalanceE400) MarshalJSON() ([]byte, error) {
...
func (obj *GetAddressBalanceE400) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableGetAddressBalanceE400 struct {
	value *GetAddressBalanceE400
	isSet bool
}

func (v NullableGetAddressBalanceE400) Get() *GetAddressBalanceE400 {
	return v.value
}

func (v *NullableGetAddressBalanceE400) Set(val *GetAddressBalanceE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressBalanceE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressBalanceE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressBalanceE400(val *GetAddressBalanceE400) *NullableGetAddressBalanceE400 {
	return &NullableGetAddressBalanceE400{value: val, isSet: true}
}

func (v NullableGetAddressBalanceE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressBalanceE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
