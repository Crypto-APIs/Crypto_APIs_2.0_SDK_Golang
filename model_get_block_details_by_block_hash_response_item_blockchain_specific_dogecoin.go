...
type GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin struct {
...
func NewGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, strippedSize int32, version int32, weight int32) *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin {
	this := GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin{}
...
func (o GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin struct {
	value *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) Get() *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) Set(val *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin(val *GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin {
	return &NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
