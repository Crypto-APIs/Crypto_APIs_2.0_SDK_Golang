...
// BlockchainDataBlockNotFound struct for BlockchainDataBlockNotFound
type BlockchainDataBlockNotFound struct {
	...
	Error BlockchainDataBlockNotFoundError `json:"error"`
}
...
func NewBlockchainDataBlockNotFound(apiVersion string, requestId string, error_ BlockchainDataBlockNotFoundError) *BlockchainDataBlockNotFound {
	this := BlockchainDataBlockNotFound{}
...
func (o *BlockchainDataBlockNotFound) GetError() BlockchainDataBlockNotFoundError {
	if o == nil {
		var ret BlockchainDataBlockNotFoundError
		return ret
	}
...
func (o BlockchainDataBlockNotFound) MarshalJSON() ([]byte, error) {
...
type NullableBlockchainDataBlockNotFound struct {
	value *BlockchainDataBlockNotFound
	isSet bool
}

func (v NullableBlockchainDataBlockNotFound) Get() *BlockchainDataBlockNotFound {
	return v.value
}

func (v *NullableBlockchainDataBlockNotFound) Set(val *BlockchainDataBlockNotFound) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockchainDataBlockNotFound) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockchainDataBlockNotFound) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockchainDataBlockNotFound(val *BlockchainDataBlockNotFound) *NullableBlockchainDataBlockNotFound {
	return &NullableBlockchainDataBlockNotFound{value: val, isSet: true}
}

func (v NullableBlockchainDataBlockNotFound) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockchainDataBlockNotFound) UnmarshalJSON(src []byte) error {
	v.isSet = true
