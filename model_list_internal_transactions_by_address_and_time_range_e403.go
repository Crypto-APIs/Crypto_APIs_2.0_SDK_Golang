...
type ListInternalTransactionsByAddressAndTimeRangeE403 struct {
...
func BannedIpAddressAsListInternalTransactionsByAddressAndTimeRangeE403(v *BannedIpAddress) ListInternalTransactionsByAddressAndTimeRangeE403 {
...
func EndpointNotAllowedForApiKeyAsListInternalTransactionsByAddressAndTimeRangeE403(v *EndpointNotAllowedForApiKey) ListInternalTransactionsByAddressAndTimeRangeE403 {
	return ListInternalTransactionsByAddressAndTimeRangeE403{
...
func EndpointNotAllowedForPlanAsListInternalTransactionsByAddressAndTimeRangeE403(v *EndpointNotAllowedForPlan) ListInternalTransactionsByAddressAndTimeRangeE403 {
	return ListInternalTransactionsByAddressAndTimeRangeE403{
...
func FeatureMainnetsNotAllowedForPlanAsListInternalTransactionsByAddressAndTimeRangeE403(v *FeatureMainnetsNotAllowedForPlan) ListInternalTransactionsByAddressAndTimeRangeE403 {
	return ListInternalTransactionsByAddressAndTimeRangeE403{
...
func (dst *ListInternalTransactionsByAddressAndTimeRangeE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListInternalTransactionsByAddressAndTimeRangeE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListInternalTransactionsByAddressAndTimeRangeE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListInternalTransactionsByAddressAndTimeRangeE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListInternalTransactionsByAddressAndTimeRangeE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableListInternalTransactionsByAddressAndTimeRangeE403 struct {
	value *ListInternalTransactionsByAddressAndTimeRangeE403
	isSet bool
}

func (v NullableListInternalTransactionsByAddressAndTimeRangeE403) Get() *ListInternalTransactionsByAddressAndTimeRangeE403 {
	return v.value
}

func (v *NullableListInternalTransactionsByAddressAndTimeRangeE403) Set(val *ListInternalTransactionsByAddressAndTimeRangeE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddressAndTimeRangeE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddressAndTimeRangeE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddressAndTimeRangeE403(val *ListInternalTransactionsByAddressAndTimeRangeE403) *NullableListInternalTransactionsByAddressAndTimeRangeE403 {
	return &NullableListInternalTransactionsByAddressAndTimeRangeE403{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddressAndTimeRangeE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddressAndTimeRangeE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
