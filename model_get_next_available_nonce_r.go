...
type GetNextAvailableNonceR struct {
	...
	Data GetNextAvailableNonceRData `json:"data"`
}
...
func (o *GetNextAvailableNonceR) GetData() GetNextAvailableNonceRData {
	if o == nil {
		var ret GetNextAvailableNonceRData
		return ret
	}
...
func (o GetNextAvailableNonceR) MarshalJSON() ([]byte, error) {
...
type NullableGetNextAvailableNonceR struct {
	value *GetNextAvailableNonceR
	isSet bool
}

func (v NullableGetNextAvailableNonceR) Get() *GetNextAvailableNonceR {
	return v.value
}

func (v *NullableGetNextAvailableNonceR) Set(val *GetNextAvailableNonceR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNextAvailableNonceR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNextAvailableNonceR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNextAvailableNonceR(val *GetNextAvailableNonceR) *NullableGetNextAvailableNonceR {
	return &NullableGetNextAvailableNonceR{value: val, isSet: true}
}

func (v NullableGetNextAvailableNonceR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNextAvailableNonceR) UnmarshalJSON(src []byte) error {
	v.isSet = true
