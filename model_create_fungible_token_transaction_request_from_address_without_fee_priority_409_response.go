...
type CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response struct {
	...
	Error CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409 `json:"error"`
}
...
func NewCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response(apiVersion string, requestId string, error_ CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409) *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response {
	this := CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response{}
...
func (o *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) GetError() CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409 {
	if o == nil {
		var ret CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409
		return ret
	}
...
func (o CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response struct {
	value *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response
	isSet bool
}

func (v NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) Get() *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response {
	return v.value
}

func (v *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) Set(val *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response(val *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response {
	return &NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response{value: val, isSet: true}
}

func (v NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
