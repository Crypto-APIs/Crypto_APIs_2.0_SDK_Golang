...
type GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash struct {
...
func NewGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, version int32, versionHex string) *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash {
	this := GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash{}
...
func (o GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash struct {
	value *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) Get() *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) Set(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash {
	return &NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash) UnmarshalJSON(src []byte) error {
	v.isSet = true
