...
type ActivateBlockchainEventSubscription403Response struct {
	...
	Error ActivateBlockchainEventSubscriptionE403 `json:"error"`
}
...
func (o *ActivateBlockchainEventSubscription403Response) GetError() ActivateBlockchainEventSubscriptionE403 {
	if o == nil {
		var ret ActivateBlockchainEventSubscriptionE403
		return ret
	}
...
func (o ActivateBlockchainEventSubscription403Response) MarshalJSON() ([]byte, error) {
...
type NullableActivateBlockchainEventSubscription403Response struct {
	value *ActivateBlockchainEventSubscription403Response
	isSet bool
}

func (v NullableActivateBlockchainEventSubscription403Response) Get() *ActivateBlockchainEventSubscription403Response {
	return v.value
}

func (v *NullableActivateBlockchainEventSubscription403Response) Set(val *ActivateBlockchainEventSubscription403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateBlockchainEventSubscription403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateBlockchainEventSubscription403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateBlockchainEventSubscription403Response(val *ActivateBlockchainEventSubscription403Response) *NullableActivateBlockchainEventSubscription403Response {
	return &NullableActivateBlockchainEventSubscription403Response{value: val, isSet: true}
}

func (v NullableActivateBlockchainEventSubscription403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateBlockchainEventSubscription403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
