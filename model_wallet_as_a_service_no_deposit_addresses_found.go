...
// WalletAsAServiceNoDepositAddressesFound struct for WalletAsAServiceNoDepositAddressesFound
type WalletAsAServiceNoDepositAddressesFound struct {
	...
	Error WalletAsAServiceNoDepositAddressesFoundError `json:"error"`
}
...
func (o *WalletAsAServiceNoDepositAddressesFound) GetError() WalletAsAServiceNoDepositAddressesFoundError {
	if o == nil {
		var ret WalletAsAServiceNoDepositAddressesFoundError
		return ret
	}
