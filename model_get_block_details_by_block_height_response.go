...
// GetBlockDetailsByBlockHeightResponse struct for GetBlockDetailsByBlockHeightResponse
type GetBlockDetailsByBlockHeightResponse struct {
	...
	Data GetBlockDetailsByBlockHeightResponseData `json:"data"`
}
...
func NewGetBlockDetailsByBlockHeightResponse(apiVersion string, requestId string, data GetBlockDetailsByBlockHeightResponseData) *GetBlockDetailsByBlockHeightResponse {
	this := GetBlockDetailsByBlockHeightResponse{}
...
func (o *GetBlockDetailsByBlockHeightResponse) GetData() GetBlockDetailsByBlockHeightResponseData {
	if o == nil {
		var ret GetBlockDetailsByBlockHeightResponseData
		return ret
	}
...
func (o GetBlockDetailsByBlockHeightResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponse struct {
	value *GetBlockDetailsByBlockHeightResponse
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponse) Get() *GetBlockDetailsByBlockHeightResponse {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponse) Set(val *GetBlockDetailsByBlockHeightResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponse(val *GetBlockDetailsByBlockHeightResponse) *NullableGetBlockDetailsByBlockHeightResponse {
	return &NullableGetBlockDetailsByBlockHeightResponse{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
