...
type GetFeeRecommendationsE400 struct {
...
func InvalidPaginationAsGetFeeRecommendationsE400(v *InvalidPagination) GetFeeRecommendationsE400 {
	return GetFeeRecommendationsE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsGetFeeRecommendationsE400(v *LimitGreaterThanAllowed) GetFeeRecommendationsE400 {
	return GetFeeRecommendationsE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsGetFeeRecommendationsE400(v *UriNotFound) GetFeeRecommendationsE400 {
	return GetFeeRecommendationsE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetFeeRecommendationsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetFeeRecommendationsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetFeeRecommendationsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetFeeRecommendationsE400) MarshalJSON() ([]byte, error) {
...
func (obj *GetFeeRecommendationsE400) GetActualInstance() (interface{}) {
...
type NullableGetFeeRecommendationsE400 struct {
	value *GetFeeRecommendationsE400
	isSet bool
}

func (v NullableGetFeeRecommendationsE400) Get() *GetFeeRecommendationsE400 {
	return v.value
}

func (v *NullableGetFeeRecommendationsE400) Set(val *GetFeeRecommendationsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeRecommendationsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeRecommendationsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeRecommendationsE400(val *GetFeeRecommendationsE400) *NullableGetFeeRecommendationsE400 {
	return &NullableGetFeeRecommendationsE400{value: val, isSet: true}
}

func (v NullableGetFeeRecommendationsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeRecommendationsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
