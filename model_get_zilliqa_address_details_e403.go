...
type GetZilliqaAddressDetailsE403 struct {
...
func BannedIpAddressAsGetZilliqaAddressDetailsE403(v *BannedIpAddress) GetZilliqaAddressDetailsE403 {
	return GetZilliqaAddressDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetZilliqaAddressDetailsE403(v *EndpointNotAllowedForApiKey) GetZilliqaAddressDetailsE403 {
	return GetZilliqaAddressDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetZilliqaAddressDetailsE403(v *EndpointNotAllowedForPlan) GetZilliqaAddressDetailsE403 {
	return GetZilliqaAddressDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetZilliqaAddressDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetZilliqaAddressDetailsE403 {
	return GetZilliqaAddressDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetZilliqaAddressDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetZilliqaAddressDetailsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetZilliqaAddressDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetZilliqaAddressDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetZilliqaAddressDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetZilliqaAddressDetailsE403 struct {
	value *GetZilliqaAddressDetailsE403
	isSet bool
}

func (v NullableGetZilliqaAddressDetailsE403) Get() *GetZilliqaAddressDetailsE403 {
	return v.value
}

func (v *NullableGetZilliqaAddressDetailsE403) Set(val *GetZilliqaAddressDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaAddressDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaAddressDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaAddressDetailsE403(val *GetZilliqaAddressDetailsE403) *NullableGetZilliqaAddressDetailsE403 {
	return &NullableGetZilliqaAddressDetailsE403{value: val, isSet: true}
}

func (v NullableGetZilliqaAddressDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaAddressDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
