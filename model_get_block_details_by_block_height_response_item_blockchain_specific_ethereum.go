...
type GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum struct {
...
func NewGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum(difficulty string, nonce string, size int32, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, sha3Uncles string, totalDifficulty string) *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum {
	this := GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum{}
...
func (o GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum struct {
	value *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) Get() *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) Set(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum {
	return &NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum) UnmarshalJSON(src []byte) error {
	v.isSet = true
