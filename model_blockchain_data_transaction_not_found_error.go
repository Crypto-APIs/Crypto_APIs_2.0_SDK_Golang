...
// BlockchainDataTransactionNotFoundError struct for BlockchainDataTransactionNotFoundError
type BlockchainDataTransactionNotFoundError struct {
...
func NewBlockchainDataTransactionNotFoundError(code string, message string) *BlockchainDataTransactionNotFoundError {
	this := BlockchainDataTransactionNotFoundError{}
	this.Code = code
...
func (o BlockchainDataTransactionNotFoundError) MarshalJSON() ([]byte, error) {
...
type NullableBlockchainDataTransactionNotFoundError struct {
	value *BlockchainDataTransactionNotFoundError
	isSet bool
}

func (v NullableBlockchainDataTransactionNotFoundError) Get() *BlockchainDataTransactionNotFoundError {
	return v.value
}

func (v *NullableBlockchainDataTransactionNotFoundError) Set(val *BlockchainDataTransactionNotFoundError) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockchainDataTransactionNotFoundError) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockchainDataTransactionNotFoundError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockchainDataTransactionNotFoundError(val *BlockchainDataTransactionNotFoundError) *NullableBlockchainDataTransactionNotFoundError {
	return &NullableBlockchainDataTransactionNotFoundError{value: val, isSet: true}
}

func (v NullableBlockchainDataTransactionNotFoundError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockchainDataTransactionNotFoundError) UnmarshalJSON(src []byte) error {
	v.isSet = true
