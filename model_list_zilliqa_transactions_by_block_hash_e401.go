...
type ListZilliqaTransactionsByBlockHashE401 struct {
...
func (dst *ListZilliqaTransactionsByBlockHashE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListZilliqaTransactionsByBlockHashE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListZilliqaTransactionsByBlockHashE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListZilliqaTransactionsByBlockHashE401) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByBlockHashE401 struct {
	value *ListZilliqaTransactionsByBlockHashE401
	isSet bool
}

func (v NullableListZilliqaTransactionsByBlockHashE401) Get() *ListZilliqaTransactionsByBlockHashE401 {
	return v.value
}

func (v *NullableListZilliqaTransactionsByBlockHashE401) Set(val *ListZilliqaTransactionsByBlockHashE401) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByBlockHashE401) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByBlockHashE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByBlockHashE401(val *ListZilliqaTransactionsByBlockHashE401) *NullableListZilliqaTransactionsByBlockHashE401 {
	return &NullableListZilliqaTransactionsByBlockHashE401{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByBlockHashE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByBlockHashE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
