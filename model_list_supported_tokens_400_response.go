...
type ListSupportedTokens400Response struct {
	...
	Error ListSupportedTokensE400 `json:"error"`
}
...
func NewListSupportedTokens400Response(apiVersion string, requestId string, error_ ListSupportedTokensE400) *ListSupportedTokens400Response {
	this := ListSupportedTokens400Response{}
...
func (o *ListSupportedTokens400Response) GetError() ListSupportedTokensE400 {
	if o == nil {
		var ret ListSupportedTokensE400
		return ret
	}
...
func (o ListSupportedTokens400Response) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedTokens400Response struct {
	value *ListSupportedTokens400Response
	isSet bool
}

func (v NullableListSupportedTokens400Response) Get() *ListSupportedTokens400Response {
	return v.value
}

func (v *NullableListSupportedTokens400Response) Set(val *ListSupportedTokens400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedTokens400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedTokens400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedTokens400Response(val *ListSupportedTokens400Response) *NullableListSupportedTokens400Response {
	return &NullableListSupportedTokens400Response{value: val, isSet: true}
}

func (v NullableListSupportedTokens400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedTokens400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
