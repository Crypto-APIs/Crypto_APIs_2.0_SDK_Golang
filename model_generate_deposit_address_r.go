...
type GenerateDepositAddressR struct {
	...
	Data GenerateDepositAddressRData `json:"data"`
}
...
func (o *GenerateDepositAddressR) GetData() GenerateDepositAddressRData {
	if o == nil {
		var ret GenerateDepositAddressRData
		return ret
	}
...
func (o GenerateDepositAddressR) MarshalJSON() ([]byte, error) {
...
type NullableGenerateDepositAddressR struct {
	value *GenerateDepositAddressR
	isSet bool
}

func (v NullableGenerateDepositAddressR) Get() *GenerateDepositAddressR {
	return v.value
}

func (v *NullableGenerateDepositAddressR) Set(val *GenerateDepositAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateDepositAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateDepositAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateDepositAddressR(val *GenerateDepositAddressR) *NullableGenerateDepositAddressR {
	return &NullableGenerateDepositAddressR{value: val, isSet: true}
}

func (v NullableGenerateDepositAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateDepositAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
