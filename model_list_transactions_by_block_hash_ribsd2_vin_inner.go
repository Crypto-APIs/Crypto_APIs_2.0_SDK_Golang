...
type ListTransactionsByBlockHashRIBSD2VinInner struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig ListTransactionsByBlockHashRIBSD2VinInnerScriptSig `json:"scriptSig"`
...
func NewListTransactionsByBlockHashRIBSD2VinInner(addresses []string, scriptSig ListTransactionsByBlockHashRIBSD2VinInnerScriptSig, sequence string, txinwitness []string, vout int32) *ListTransactionsByBlockHashRIBSD2VinInner {
	this := ListTransactionsByBlockHashRIBSD2VinInner{}
...
func (o *ListTransactionsByBlockHashRIBSD2VinInner) GetScriptSig() ListTransactionsByBlockHashRIBSD2VinInnerScriptSig {
	if o == nil {
		var ret ListTransactionsByBlockHashRIBSD2VinInnerScriptSig
		return ret
	}
...
func (o ListTransactionsByBlockHashRIBSD2VinInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSD2VinInner struct {
	value *ListTransactionsByBlockHashRIBSD2VinInner
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSD2VinInner) Get() *ListTransactionsByBlockHashRIBSD2VinInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSD2VinInner) Set(val *ListTransactionsByBlockHashRIBSD2VinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSD2VinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSD2VinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSD2VinInner(val *ListTransactionsByBlockHashRIBSD2VinInner) *NullableListTransactionsByBlockHashRIBSD2VinInner {
	return &NullableListTransactionsByBlockHashRIBSD2VinInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSD2VinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSD2VinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
