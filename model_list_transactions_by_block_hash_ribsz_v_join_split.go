...
// ListTransactionsByBlockHashRIBSZVJoinSplit struct for ListTransactionsByBlockHashRIBSZVJoinSplit
type ListTransactionsByBlockHashRIBSZVJoinSplit struct {
...
func (o ListTransactionsByBlockHashRIBSZVJoinSplit) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSZVJoinSplit struct {
	value *ListTransactionsByBlockHashRIBSZVJoinSplit
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSZVJoinSplit) Get() *ListTransactionsByBlockHashRIBSZVJoinSplit {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSZVJoinSplit) Set(val *ListTransactionsByBlockHashRIBSZVJoinSplit) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSZVJoinSplit) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSZVJoinSplit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSZVJoinSplit(val *ListTransactionsByBlockHashRIBSZVJoinSplit) *NullableListTransactionsByBlockHashRIBSZVJoinSplit {
	return &NullableListTransactionsByBlockHashRIBSZVJoinSplit{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSZVJoinSplit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSZVJoinSplit) UnmarshalJSON(src []byte) error {
	v.isSet = true
