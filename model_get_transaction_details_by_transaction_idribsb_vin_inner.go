...
type GetTransactionDetailsByTransactionIDRIBSBVinInner struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSBVinInner(addresses []string, scriptSig GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig, sequence int64, txinwitness []string) *GetTransactionDetailsByTransactionIDRIBSBVinInner {
	this := GetTransactionDetailsByTransactionIDRIBSBVinInner{}
...
func (o GetTransactionDetailsByTransactionIDRIBSBVinInner) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSBVinInner struct {
	value *GetTransactionDetailsByTransactionIDRIBSBVinInner
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBVinInner) Get() *GetTransactionDetailsByTransactionIDRIBSBVinInner {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBVinInner) Set(val *GetTransactionDetailsByTransactionIDRIBSBVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSBVinInner(val *GetTransactionDetailsByTransactionIDRIBSBVinInner) *NullableGetTransactionDetailsByTransactionIDRIBSBVinInner {
	return &NullableGetTransactionDetailsByTransactionIDRIBSBVinInner{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
