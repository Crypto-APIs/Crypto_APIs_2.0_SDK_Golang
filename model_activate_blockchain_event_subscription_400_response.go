...
type ActivateBlockchainEventSubscription400Response struct {
	...
	Error ActivateBlockchainEventSubscriptionE400 `json:"error"`
}
...
func (o *ActivateBlockchainEventSubscription400Response) GetError() ActivateBlockchainEventSubscriptionE400 {
	if o == nil {
		var ret ActivateBlockchainEventSubscriptionE400
		return ret
	}
...
func (o ActivateBlockchainEventSubscription400Response) MarshalJSON() ([]byte, error) {
...
type NullableActivateBlockchainEventSubscription400Response struct {
	value *ActivateBlockchainEventSubscription400Response
	isSet bool
}

func (v NullableActivateBlockchainEventSubscription400Response) Get() *ActivateBlockchainEventSubscription400Response {
	return v.value
}

func (v *NullableActivateBlockchainEventSubscription400Response) Set(val *ActivateBlockchainEventSubscription400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateBlockchainEventSubscription400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateBlockchainEventSubscription400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateBlockchainEventSubscription400Response(val *ActivateBlockchainEventSubscription400Response) *NullableActivateBlockchainEventSubscription400Response {
	return &NullableActivateBlockchainEventSubscription400Response{value: val, isSet: true}
}

func (v NullableActivateBlockchainEventSubscription400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateBlockchainEventSubscription400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
