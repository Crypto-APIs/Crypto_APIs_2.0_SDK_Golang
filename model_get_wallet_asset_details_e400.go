...
type GetWalletAssetDetailsE400 struct {
...
func InvalidPaginationAsGetWalletAssetDetailsE400(v *InvalidPagination) GetWalletAssetDetailsE400 {
	return GetWalletAssetDetailsE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsGetWalletAssetDetailsE400(v *LimitGreaterThanAllowed) GetWalletAssetDetailsE400 {
	return GetWalletAssetDetailsE400{ LimitGreaterThanAllowed: v}
}
...
func UriNotFoundAsGetWalletAssetDetailsE400(v *UriNotFound) GetWalletAssetDetailsE400 {
	return GetWalletAssetDetailsE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetWalletAssetDetailsE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetWalletAssetDetailsE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetWalletAssetDetailsE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetWalletAssetDetailsE400) MarshalJSON() ([]byte, error) {
...
func (obj *GetWalletAssetDetailsE400) GetActualInstance() (interface{}) {
...
type NullableGetWalletAssetDetailsE400 struct {
	value *GetWalletAssetDetailsE400
	isSet bool
}

func (v NullableGetWalletAssetDetailsE400) Get() *GetWalletAssetDetailsE400 {
	return v.value
}

func (v *NullableGetWalletAssetDetailsE400) Set(val *GetWalletAssetDetailsE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletAssetDetailsE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletAssetDetailsE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletAssetDetailsE400(val *GetWalletAssetDetailsE400) *NullableGetWalletAssetDetailsE400 {
	return &NullableGetWalletAssetDetailsE400{value: val, isSet: true}
}

func (v NullableGetWalletAssetDetailsE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletAssetDetailsE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
