...
type NewConfirmedCoinsTransactionsAndEachConfirmation409Response struct {
	...
	Error NewConfirmedCoinsTransactionsAndEachConfirmationE409 `json:"error"`
}
...
func NewNewConfirmedCoinsTransactionsAndEachConfirmation409Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsAndEachConfirmationE409) *NewConfirmedCoinsTransactionsAndEachConfirmation409Response {
	this := NewConfirmedCoinsTransactionsAndEachConfirmation409Response{}
...
func (o *NewConfirmedCoinsTransactionsAndEachConfirmation409Response) GetError() NewConfirmedCoinsTransactionsAndEachConfirmationE409 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsAndEachConfirmationE409
		return ret
	}
...
func (o NewConfirmedCoinsTransactionsAndEachConfirmation409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response struct {
	value *NewConfirmedCoinsTransactionsAndEachConfirmation409Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response) Get() *NewConfirmedCoinsTransactionsAndEachConfirmation409Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response) Set(val *NewConfirmedCoinsTransactionsAndEachConfirmation409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response(val *NewConfirmedCoinsTransactionsAndEachConfirmation409Response) *NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response {
	return &NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsAndEachConfirmation409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
