...
// ListAssetsDetailsResponse struct for ListAssetsDetailsResponse
type ListAssetsDetailsResponse struct {
	...
	Data ListAssetsDetailsResponseData `json:"data"`
}
...
func NewListAssetsDetailsResponse(apiVersion string, requestId string, data ListAssetsDetailsResponseData) *ListAssetsDetailsResponse {
	this := ListAssetsDetailsResponse{}
...
func (o *ListAssetsDetailsResponse) GetData() ListAssetsDetailsResponseData {
	if o == nil {
		var ret ListAssetsDetailsResponseData
		return ret
	}
...
func (o ListAssetsDetailsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetailsResponse struct {
	value *ListAssetsDetailsResponse
	isSet bool
}

func (v NullableListAssetsDetailsResponse) Get() *ListAssetsDetailsResponse {
	return v.value
}

func (v *NullableListAssetsDetailsResponse) Set(val *ListAssetsDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetailsResponse(val *ListAssetsDetailsResponse) *NullableListAssetsDetailsResponse {
	return &NullableListAssetsDetailsResponse{value: val, isSet: true}
}

func (v NullableListAssetsDetailsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetailsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
