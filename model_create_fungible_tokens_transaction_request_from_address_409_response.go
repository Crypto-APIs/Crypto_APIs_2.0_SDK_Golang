...
type CreateFungibleTokensTransactionRequestFromAddress409Response struct {
...
func NewCreateFungibleTokensTransactionRequestFromAddress409Response(apiVersion string, requestId string, error_ CreateFungibleTokensTransactionRequestFromAddressE409) *CreateFungibleTokensTransactionRequestFromAddress409Response {
	this := CreateFungibleTokensTransactionRequestFromAddress409Response{}
...
func (o CreateFungibleTokensTransactionRequestFromAddress409Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateFungibleTokensTransactionRequestFromAddress409Response struct {
	value *CreateFungibleTokensTransactionRequestFromAddress409Response
	isSet bool
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddress409Response) Get() *CreateFungibleTokensTransactionRequestFromAddress409Response {
	return v.value
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddress409Response) Set(val *CreateFungibleTokensTransactionRequestFromAddress409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddress409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddress409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFungibleTokensTransactionRequestFromAddress409Response(val *CreateFungibleTokensTransactionRequestFromAddress409Response) *NullableCreateFungibleTokensTransactionRequestFromAddress409Response {
	return &NullableCreateFungibleTokensTransactionRequestFromAddress409Response{value: val, isSet: true}
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddress409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddress409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
