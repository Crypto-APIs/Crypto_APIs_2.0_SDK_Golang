...
// ListTokensTransfersByTransactionHashResponse struct for ListTokensTransfersByTransactionHashResponse
type ListTokensTransfersByTransactionHashResponse struct {
	...
	Data ListTokensTransfersByTransactionHashResponseData `json:"data"`
}
...
func NewListTokensTransfersByTransactionHashResponse(apiVersion string, requestId string, data ListTokensTransfersByTransactionHashResponseData) *ListTokensTransfersByTransactionHashResponse {
	this := ListTokensTransfersByTransactionHashResponse{}
...
func (o *ListTokensTransfersByTransactionHashResponse) GetData() ListTokensTransfersByTransactionHashResponseData {
	if o == nil {
		var ret ListTokensTransfersByTransactionHashResponseData
		return ret
	}
...
func (o ListTokensTransfersByTransactionHashResponse) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByTransactionHashResponse struct {
	value *ListTokensTransfersByTransactionHashResponse
	isSet bool
}

func (v NullableListTokensTransfersByTransactionHashResponse) Get() *ListTokensTransfersByTransactionHashResponse {
	return v.value
}

func (v *NullableListTokensTransfersByTransactionHashResponse) Set(val *ListTokensTransfersByTransactionHashResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByTransactionHashResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByTransactionHashResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByTransactionHashResponse(val *ListTokensTransfersByTransactionHashResponse) *NullableListTokensTransfersByTransactionHashResponse {
	return &NullableListTokensTransfersByTransactionHashResponse{value: val, isSet: true}
}

func (v NullableListTokensTransfersByTransactionHashResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByTransactionHashResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
