...
type MinedTransaction401Response struct {
	...
	Error MinedTransactionE401 `json:"error"`
}
...
func NewMinedTransaction401Response(apiVersion string, requestId string, error_ MinedTransactionE401) *MinedTransaction401Response {
	this := MinedTransaction401Response{}
...
func (o MinedTransaction401Response) MarshalJSON() ([]byte, error) {
...
type NullableMinedTransaction401Response struct {
	value *MinedTransaction401Response
	isSet bool
}

func (v NullableMinedTransaction401Response) Get() *MinedTransaction401Response {
	return v.value
}

func (v *NullableMinedTransaction401Response) Set(val *MinedTransaction401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMinedTransaction401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMinedTransaction401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinedTransaction401Response(val *MinedTransaction401Response) *NullableMinedTransaction401Response {
	return &NullableMinedTransaction401Response{value: val, isSet: true}
}

func (v NullableMinedTransaction401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinedTransaction401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
