...
type DecodeRawTransactionHexRISLVoutInnerScriptPubKey struct {
...
func NewDecodeRawTransactionHexRISLVoutInnerScriptPubKey(address string) *DecodeRawTransactionHexRISLVoutInnerScriptPubKey {
	this := DecodeRawTransactionHexRISLVoutInnerScriptPubKey{}
...
func (o DecodeRawTransactionHexRISLVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey struct {
	value *DecodeRawTransactionHexRISLVoutInnerScriptPubKey
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey) Get() *DecodeRawTransactionHexRISLVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey) Set(val *DecodeRawTransactionHexRISLVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey(val *DecodeRawTransactionHexRISLVoutInnerScriptPubKey) *NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey {
	return &NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISLVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
