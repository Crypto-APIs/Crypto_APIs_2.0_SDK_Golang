...
type ListXRPRippleTransactionsByBlockHeightRIValue struct {
...
func NewListXRPRippleTransactionsByBlockHeightRIValue(amount string, unit string) *ListXRPRippleTransactionsByBlockHeightRIValue {
	this := ListXRPRippleTransactionsByBlockHeightRIValue{}
	this.Amount = amount
	this.Unit = unit
	return &this
}
...
func (o ListXRPRippleTransactionsByBlockHeightRIValue) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHeightRIValue struct {
	value *ListXRPRippleTransactionsByBlockHeightRIValue
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHeightRIValue) Get() *ListXRPRippleTransactionsByBlockHeightRIValue {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHeightRIValue) Set(val *ListXRPRippleTransactionsByBlockHeightRIValue) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHeightRIValue) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHeightRIValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHeightRIValue(val *ListXRPRippleTransactionsByBlockHeightRIValue) *NullableListXRPRippleTransactionsByBlockHeightRIValue {
	return &NullableListXRPRippleTransactionsByBlockHeightRIValue{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHeightRIValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHeightRIValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
