...
type BroadcastLocallySignedTransaction400Response struct {
	...
	Error BroadcastLocallySignedTransactionE400 `json:"error"`
}
...
func NewBroadcastLocallySignedTransaction400Response(apiVersion string, requestId string, error_ BroadcastLocallySignedTransactionE400) *BroadcastLocallySignedTransaction400Response {
	this := BroadcastLocallySignedTransaction400Response{}
...
func (o *BroadcastLocallySignedTransaction400Response) GetError() BroadcastLocallySignedTransactionE400 {
	if o == nil {
		var ret BroadcastLocallySignedTransactionE400
		return ret
	}
...
func (o BroadcastLocallySignedTransaction400Response) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastLocallySignedTransaction400Response struct {
	value *BroadcastLocallySignedTransaction400Response
	isSet bool
}

func (v NullableBroadcastLocallySignedTransaction400Response) Get() *BroadcastLocallySignedTransaction400Response {
	return v.value
}

func (v *NullableBroadcastLocallySignedTransaction400Response) Set(val *BroadcastLocallySignedTransaction400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastLocallySignedTransaction400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastLocallySignedTransaction400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastLocallySignedTransaction400Response(val *BroadcastLocallySignedTransaction400Response) *NullableBroadcastLocallySignedTransaction400Response {
	return &NullableBroadcastLocallySignedTransaction400Response{value: val, isSet: true}
}

func (v NullableBroadcastLocallySignedTransaction400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastLocallySignedTransaction400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
