...
// ListBlockchainEventsSubscriptionsResponse struct for ListBlockchainEventsSubscriptionsResponse
type ListBlockchainEventsSubscriptionsResponse struct {
	...
	Data ListBlockchainEventsSubscriptionsResponseData `json:"data"`
}
...
func NewListBlockchainEventsSubscriptionsResponse(apiVersion string, requestId string, data ListBlockchainEventsSubscriptionsResponseData) *ListBlockchainEventsSubscriptionsResponse {
	this := ListBlockchainEventsSubscriptionsResponse{}
...
func (o *ListBlockchainEventsSubscriptionsResponse) GetData() ListBlockchainEventsSubscriptionsResponseData {
	if o == nil {
		var ret ListBlockchainEventsSubscriptionsResponseData
		return ret
	}
...
func (o ListBlockchainEventsSubscriptionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListBlockchainEventsSubscriptionsResponse struct {
	value *ListBlockchainEventsSubscriptionsResponse
	isSet bool
}

func (v NullableListBlockchainEventsSubscriptionsResponse) Get() *ListBlockchainEventsSubscriptionsResponse {
	return v.value
}

func (v *NullableListBlockchainEventsSubscriptionsResponse) Set(val *ListBlockchainEventsSubscriptionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListBlockchainEventsSubscriptionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListBlockchainEventsSubscriptionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListBlockchainEventsSubscriptionsResponse(val *ListBlockchainEventsSubscriptionsResponse) *NullableListBlockchainEventsSubscriptionsResponse {
	return &NullableListBlockchainEventsSubscriptionsResponse{value: val, isSet: true}
}

func (v NullableListBlockchainEventsSubscriptionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListBlockchainEventsSubscriptionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
