...
type GetZilliqaBlockDetailsByBlockHashE403 struct {
...
func BannedIpAddressAsGetZilliqaBlockDetailsByBlockHashE403(v *BannedIpAddress) GetZilliqaBlockDetailsByBlockHashE403 {
	return GetZilliqaBlockDetailsByBlockHashE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetZilliqaBlockDetailsByBlockHashE403(v *EndpointNotAllowedForApiKey) GetZilliqaBlockDetailsByBlockHashE403 {
	return GetZilliqaBlockDetailsByBlockHashE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetZilliqaBlockDetailsByBlockHashE403(v *EndpointNotAllowedForPlan) GetZilliqaBlockDetailsByBlockHashE403 {
	return GetZilliqaBlockDetailsByBlockHashE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetZilliqaBlockDetailsByBlockHashE403(v *FeatureMainnetsNotAllowedForPlan) GetZilliqaBlockDetailsByBlockHashE403 {
	return GetZilliqaBlockDetailsByBlockHashE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetZilliqaBlockDetailsByBlockHashE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetZilliqaBlockDetailsByBlockHashE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetZilliqaBlockDetailsByBlockHashE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetZilliqaBlockDetailsByBlockHashE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetZilliqaBlockDetailsByBlockHashE403) GetActualInstance() (interface{}) {
...
type NullableGetZilliqaBlockDetailsByBlockHashE403 struct {
	value *GetZilliqaBlockDetailsByBlockHashE403
	isSet bool
}

func (v NullableGetZilliqaBlockDetailsByBlockHashE403) Get() *GetZilliqaBlockDetailsByBlockHashE403 {
	return v.value
}

func (v *NullableGetZilliqaBlockDetailsByBlockHashE403) Set(val *GetZilliqaBlockDetailsByBlockHashE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaBlockDetailsByBlockHashE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaBlockDetailsByBlockHashE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaBlockDetailsByBlockHashE403(val *GetZilliqaBlockDetailsByBlockHashE403) *NullableGetZilliqaBlockDetailsByBlockHashE403 {
	return &NullableGetZilliqaBlockDetailsByBlockHashE403{value: val, isSet: true}
}

func (v NullableGetZilliqaBlockDetailsByBlockHashE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaBlockDetailsByBlockHashE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
