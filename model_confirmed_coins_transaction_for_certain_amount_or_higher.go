...
type ConfirmedCoinsTransactionForCertainAmountOrHigher struct {
	...
	Data ConfirmedCoinsTransactionForCertainAmountOrHigherData `json:"data"`
}
...
func NewConfirmedCoinsTransactionForCertainAmountOrHigher(apiVersion string, referenceId string, idempotencyKey string, data ConfirmedCoinsTransactionForCertainAmountOrHigherData) *ConfirmedCoinsTransactionForCertainAmountOrHigher {
	this := ConfirmedCoinsTransactionForCertainAmountOrHigher{}
...
func (o *ConfirmedCoinsTransactionForCertainAmountOrHigher) GetData() ConfirmedCoinsTransactionForCertainAmountOrHigherData {
	if o == nil {
		var ret ConfirmedCoinsTransactionForCertainAmountOrHigherData
		return ret
	}
...
func (o ConfirmedCoinsTransactionForCertainAmountOrHigher) MarshalJSON() ([]byte, error) {
...
type NullableConfirmedCoinsTransactionForCertainAmountOrHigher struct {
	value *ConfirmedCoinsTransactionForCertainAmountOrHigher
	isSet bool
}

func (v NullableConfirmedCoinsTransactionForCertainAmountOrHigher) Get() *ConfirmedCoinsTransactionForCertainAmountOrHigher {
	return v.value
}

func (v *NullableConfirmedCoinsTransactionForCertainAmountOrHigher) Set(val *ConfirmedCoinsTransactionForCertainAmountOrHigher) {
	v.value = val
	v.isSet = true
}

func (v NullableConfirmedCoinsTransactionForCertainAmountOrHigher) IsSet() bool {
	return v.isSet
}

func (v *NullableConfirmedCoinsTransactionForCertainAmountOrHigher) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfirmedCoinsTransactionForCertainAmountOrHigher(val *ConfirmedCoinsTransactionForCertainAmountOrHigher) *NullableConfirmedCoinsTransactionForCertainAmountOrHigher {
	return &NullableConfirmedCoinsTransactionForCertainAmountOrHigher{value: val, isSet: true}
}

func (v NullableConfirmedCoinsTransactionForCertainAmountOrHigher) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfirmedCoinsTransactionForCertainAmountOrHigher) UnmarshalJSON(src []byte) error {
	v.isSet = true
