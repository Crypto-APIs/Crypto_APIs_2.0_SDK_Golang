...
type GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig struct {
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig(asm string, hex string, type_ string) *GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig {
	this := GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) Get() *GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig(val *GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) *NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSLScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
