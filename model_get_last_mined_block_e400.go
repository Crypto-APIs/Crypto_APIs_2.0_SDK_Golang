...
type GetLastMinedBlockE400 struct {
...
func InvalidPaginationAsGetLastMinedBlockE400(v *InvalidPagination) GetLastMinedBlockE400 {
	return GetLastMinedBlockE400{ InvalidPagination: v}
}
...
func LimitGreaterThanAllowedAsGetLastMinedBlockE400(v *LimitGreaterThanAllowed) GetLastMinedBlockE400 {
	return GetLastMinedBlockE400{ LimitGreaterThanAllowed: v}
}

// UriNotFoundAsGetLastMinedBlockE400 is a convenience function that returns UriNotFound wrapped in GetLastMinedBlockE400
func UriNotFoundAsGetLastMinedBlockE400(v *UriNotFound) GetLastMinedBlockE400 {
	return GetLastMinedBlockE400{ UriNotFound: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetLastMinedBlockE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetLastMinedBlockE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetLastMinedBlockE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetLastMinedBlockE400) MarshalJSON() ([]byte, error) {
...
func (obj *GetLastMinedBlockE400) GetActualInstance() (interface{}) {
...
type NullableGetLastMinedBlockE400 struct {
	value *GetLastMinedBlockE400
	isSet bool
}

func (v NullableGetLastMinedBlockE400) Get() *GetLastMinedBlockE400 {
	return v.value
}

func (v *NullableGetLastMinedBlockE400) Set(val *GetLastMinedBlockE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastMinedBlockE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastMinedBlockE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastMinedBlockE400(val *GetLastMinedBlockE400) *NullableGetLastMinedBlockE400 {
	return &NullableGetLastMinedBlockE400{value: val, isSet: true}
}

func (v NullableGetLastMinedBlockE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastMinedBlockE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
