...
type GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey struct {
...
func NewGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey {
	this := GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey{}
...
func (o GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) Get() *GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) Set(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
