...
type CreateAutomaticCoinsForwarding403Response struct {
	...
	Error CreateAutomaticCoinsForwardingE403 `json:"error"`
}
...
func NewCreateAutomaticCoinsForwarding403Response(apiVersion string, requestId string, error_ CreateAutomaticCoinsForwardingE403) *CreateAutomaticCoinsForwarding403Response {
	this := CreateAutomaticCoinsForwarding403Response{}
...
func (o *CreateAutomaticCoinsForwarding403Response) GetError() CreateAutomaticCoinsForwardingE403 {
	if o == nil {
		var ret CreateAutomaticCoinsForwardingE403
		return ret
	}
...
func (o CreateAutomaticCoinsForwarding403Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticCoinsForwarding403Response struct {
	value *CreateAutomaticCoinsForwarding403Response
	isSet bool
}

func (v NullableCreateAutomaticCoinsForwarding403Response) Get() *CreateAutomaticCoinsForwarding403Response {
	return v.value
}

func (v *NullableCreateAutomaticCoinsForwarding403Response) Set(val *CreateAutomaticCoinsForwarding403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticCoinsForwarding403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticCoinsForwarding403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticCoinsForwarding403Response(val *CreateAutomaticCoinsForwarding403Response) *NullableCreateAutomaticCoinsForwarding403Response {
	return &NullableCreateAutomaticCoinsForwarding403Response{value: val, isSet: true}
}

func (v NullableCreateAutomaticCoinsForwarding403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticCoinsForwarding403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
