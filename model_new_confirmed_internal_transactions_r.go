...
type NewConfirmedInternalTransactionsR struct {
	...
	Data NewConfirmedInternalTransactionsRData `json:"data"`
}
...
func NewNewConfirmedInternalTransactionsR(apiVersion string, requestId string, data NewConfirmedInternalTransactionsRData) *NewConfirmedInternalTransactionsR {
	this := NewConfirmedInternalTransactionsR{}
...
func (o *NewConfirmedInternalTransactionsR) GetData() NewConfirmedInternalTransactionsRData {
	if o == nil {
		var ret NewConfirmedInternalTransactionsRData
		return ret
	}
...
func (o NewConfirmedInternalTransactionsR) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsR struct {
	value *NewConfirmedInternalTransactionsR
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsR) Get() *NewConfirmedInternalTransactionsR {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsR) Set(val *NewConfirmedInternalTransactionsR) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsR) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsR(val *NewConfirmedInternalTransactionsR) *NullableNewConfirmedInternalTransactionsR {
	return &NullableNewConfirmedInternalTransactionsR{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
