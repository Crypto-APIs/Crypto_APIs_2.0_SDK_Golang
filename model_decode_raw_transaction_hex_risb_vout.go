...
// DecodeRawTransactionHexRISBVout struct for DecodeRawTransactionHexRISBVout
type DecodeRawTransactionHexRISBVout struct {
	ScriptPubKey DecodeRawTransactionHexRISBScriptPubKey `json:"scriptPubKey"`
...
func NewDecodeRawTransactionHexRISBVout(scriptPubKey DecodeRawTransactionHexRISBScriptPubKey) *DecodeRawTransactionHexRISBVout {
	this := DecodeRawTransactionHexRISBVout{}
...
func (o *DecodeRawTransactionHexRISBVout) GetScriptPubKey() DecodeRawTransactionHexRISBScriptPubKey {
	if o == nil {
		var ret DecodeRawTransactionHexRISBScriptPubKey
		return ret
	}
...
func (o DecodeRawTransactionHexRISBVout) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISBVout struct {
	value *DecodeRawTransactionHexRISBVout
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISBVout) Get() *DecodeRawTransactionHexRISBVout {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISBVout) Set(val *DecodeRawTransactionHexRISBVout) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISBVout) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISBVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISBVout(val *DecodeRawTransactionHexRISBVout) *NullableDecodeRawTransactionHexRISBVout {
	return &NullableDecodeRawTransactionHexRISBVout{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISBVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISBVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
