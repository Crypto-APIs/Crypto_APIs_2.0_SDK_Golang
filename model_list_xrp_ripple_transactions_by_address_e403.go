...
type ListXRPRippleTransactionsByAddressE403 struct {
...
func BannedIpAddressAsListXRPRippleTransactionsByAddressE403(v *BannedIpAddress) ListXRPRippleTransactionsByAddressE403 {
	return ListXRPRippleTransactionsByAddressE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListXRPRippleTransactionsByAddressE403(v *EndpointNotAllowedForApiKey) ListXRPRippleTransactionsByAddressE403 {
	return ListXRPRippleTransactionsByAddressE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListXRPRippleTransactionsByAddressE403(v *EndpointNotAllowedForPlan) ListXRPRippleTransactionsByAddressE403 {
	return ListXRPRippleTransactionsByAddressE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListXRPRippleTransactionsByAddressE403(v *FeatureMainnetsNotAllowedForPlan) ListXRPRippleTransactionsByAddressE403 {
	return ListXRPRippleTransactionsByAddressE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListXRPRippleTransactionsByAddressE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListXRPRippleTransactionsByAddressE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListXRPRippleTransactionsByAddressE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListXRPRippleTransactionsByAddressE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListXRPRippleTransactionsByAddressE403) GetActualInstance() (interface{}) {
...
type NullableListXRPRippleTransactionsByAddressE403 struct {
	value *ListXRPRippleTransactionsByAddressE403
	isSet bool
}

func (v NullableListXRPRippleTransactionsByAddressE403) Get() *ListXRPRippleTransactionsByAddressE403 {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByAddressE403) Set(val *ListXRPRippleTransactionsByAddressE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByAddressE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByAddressE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByAddressE403(val *ListXRPRippleTransactionsByAddressE403) *NullableListXRPRippleTransactionsByAddressE403 {
	return &NullableListXRPRippleTransactionsByAddressE403{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByAddressE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByAddressE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
