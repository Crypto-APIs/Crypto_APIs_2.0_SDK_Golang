...
type SyncNewHDWalletXPubYPubZPub400Response struct {
	...
	Error SyncNewHDWalletXPubYPubZPubE400 `json:"error"`
}
...
func NewSyncNewHDWalletXPubYPubZPub400Response(apiVersion string, requestId string, error_ SyncNewHDWalletXPubYPubZPubE400) *SyncNewHDWalletXPubYPubZPub400Response {
	this := SyncNewHDWalletXPubYPubZPub400Response{}
...
func (o *SyncNewHDWalletXPubYPubZPub400Response) GetError() SyncNewHDWalletXPubYPubZPubE400 {
	if o == nil {
		var ret SyncNewHDWalletXPubYPubZPubE400
		return ret
	}
...
func (o SyncNewHDWalletXPubYPubZPub400Response) MarshalJSON() ([]byte, error) {
...
type NullableSyncNewHDWalletXPubYPubZPub400Response struct {
	value *SyncNewHDWalletXPubYPubZPub400Response
	isSet bool
}

func (v NullableSyncNewHDWalletXPubYPubZPub400Response) Get() *SyncNewHDWalletXPubYPubZPub400Response {
	return v.value
}

func (v *NullableSyncNewHDWalletXPubYPubZPub400Response) Set(val *SyncNewHDWalletXPubYPubZPub400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncNewHDWalletXPubYPubZPub400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncNewHDWalletXPubYPubZPub400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncNewHDWalletXPubYPubZPub400Response(val *SyncNewHDWalletXPubYPubZPub400Response) *NullableSyncNewHDWalletXPubYPubZPub400Response {
	return &NullableSyncNewHDWalletXPubYPubZPub400Response{value: val, isSet: true}
}

func (v NullableSyncNewHDWalletXPubYPubZPub400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncNewHDWalletXPubYPubZPub400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
