...
type ListXRPRippleTransactionsByBlockHash401Response struct {
...
func (o ListXRPRippleTransactionsByBlockHash401Response) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHash401Response struct {
	value *ListXRPRippleTransactionsByBlockHash401Response
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHash401Response) Get() *ListXRPRippleTransactionsByBlockHash401Response {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHash401Response) Set(val *ListXRPRippleTransactionsByBlockHash401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHash401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHash401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHash401Response(val *ListXRPRippleTransactionsByBlockHash401Response) *NullableListXRPRippleTransactionsByBlockHash401Response {
	return &NullableListXRPRippleTransactionsByBlockHash401Response{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHash401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHash401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
