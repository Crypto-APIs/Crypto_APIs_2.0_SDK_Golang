...
type ListZilliqaTransactionsByAddress403Response struct {
	...
	Error ListZilliqaTransactionsByAddressE403 `json:"error"`
}
...
func (o *ListZilliqaTransactionsByAddress403Response) GetError() ListZilliqaTransactionsByAddressE403 {
	if o == nil {
		var ret ListZilliqaTransactionsByAddressE403
		return ret
	}
...
func (o ListZilliqaTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByAddress403Response struct {
	value *ListZilliqaTransactionsByAddress403Response
	isSet bool
}

func (v NullableListZilliqaTransactionsByAddress403Response) Get() *ListZilliqaTransactionsByAddress403Response {
	return v.value
}

func (v *NullableListZilliqaTransactionsByAddress403Response) Set(val *ListZilliqaTransactionsByAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByAddress403Response(val *ListZilliqaTransactionsByAddress403Response) *NullableListZilliqaTransactionsByAddress403Response {
	return &NullableListZilliqaTransactionsByAddress403Response{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
