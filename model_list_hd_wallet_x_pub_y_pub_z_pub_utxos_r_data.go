...
type ListHDWalletXPubYPubZPubUTXOsRData struct {
	...
	Items []ListHDWalletXPubYPubZPubUTXOsRI `json:"items"`
}
...
func (o *ListHDWalletXPubYPubZPubUTXOsRData) GetItems() []ListHDWalletXPubYPubZPubUTXOsRI {
	if o == nil {
		var ret []ListHDWalletXPubYPubZPubUTXOsRI
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubUTXOsRData) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubUTXOsRData struct {
	value *ListHDWalletXPubYPubZPubUTXOsRData
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubUTXOsRData) Get() *ListHDWalletXPubYPubZPubUTXOsRData {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubUTXOsRData) Set(val *ListHDWalletXPubYPubZPubUTXOsRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubUTXOsRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubUTXOsRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubUTXOsRData(val *ListHDWalletXPubYPubZPubUTXOsRData) *NullableListHDWalletXPubYPubZPubUTXOsRData {
	return &NullableListHDWalletXPubYPubZPubUTXOsRData{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubUTXOsRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubUTXOsRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
