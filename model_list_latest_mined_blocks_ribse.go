...
type ListLatestMinedBlocksRIBSE struct {
...
func NewListLatestMinedBlocksRIBSE(difficulty string, extraData string, gasLimit string, gasUsed string, minedInSeconds int32, nonce string, sha3Uncles string, size int32, totalDifficulty string, uncles []string) *ListLatestMinedBlocksRIBSE {
	this := ListLatestMinedBlocksRIBSE{}
...
func (o ListLatestMinedBlocksRIBSE) MarshalJSON() ([]byte, error) {
...
type NullableListLatestMinedBlocksRIBSE struct {
	value *ListLatestMinedBlocksRIBSE
	isSet bool
}

func (v NullableListLatestMinedBlocksRIBSE) Get() *ListLatestMinedBlocksRIBSE {
	return v.value
}

func (v *NullableListLatestMinedBlocksRIBSE) Set(val *ListLatestMinedBlocksRIBSE) {
	v.value = val
	v.isSet = true
}

func (v NullableListLatestMinedBlocksRIBSE) IsSet() bool {
	return v.isSet
}

func (v *NullableListLatestMinedBlocksRIBSE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLatestMinedBlocksRIBSE(val *ListLatestMinedBlocksRIBSE) *NullableListLatestMinedBlocksRIBSE {
	return &NullableListLatestMinedBlocksRIBSE{value: val, isSet: true}
}

func (v NullableListLatestMinedBlocksRIBSE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLatestMinedBlocksRIBSE) UnmarshalJSON(src []byte) error {
	v.isSet = true
