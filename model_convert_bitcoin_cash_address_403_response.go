...
type ConvertBitcoinCashAddress403Response struct {
	...
	Error ConvertBitcoinCashAddressE403 `json:"error"`
}
...
func NewConvertBitcoinCashAddress403Response(apiVersion string, requestId string, error_ ConvertBitcoinCashAddressE403) *ConvertBitcoinCashAddress403Response {
	this := ConvertBitcoinCashAddress403Response{}
...
func (o *ConvertBitcoinCashAddress403Response) GetError() ConvertBitcoinCashAddressE403 {
	if o == nil {
		var ret ConvertBitcoinCashAddressE403
		return ret
	}
...
func (o ConvertBitcoinCashAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress403Response struct {
	value *ConvertBitcoinCashAddress403Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress403Response) Get() *ConvertBitcoinCashAddress403Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress403Response) Set(val *ConvertBitcoinCashAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress403Response(val *ConvertBitcoinCashAddress403Response) *NullableConvertBitcoinCashAddress403Response {
	return &NullableConvertBitcoinCashAddress403Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
