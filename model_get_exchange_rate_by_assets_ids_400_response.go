...
type GetExchangeRateByAssetsIDs400Response struct {
	...
	Error GetExchangeRateByAssetsIDsE400 `json:"error"`
}
...
func NewGetExchangeRateByAssetsIDs400Response(apiVersion string, requestId string, error_ GetExchangeRateByAssetsIDsE400) *GetExchangeRateByAssetsIDs400Response {
	this := GetExchangeRateByAssetsIDs400Response{}
...
func (o *GetExchangeRateByAssetsIDs400Response) GetError() GetExchangeRateByAssetsIDsE400 {
	if o == nil {
		var ret GetExchangeRateByAssetsIDsE400
		return ret
	}
...
func (o GetExchangeRateByAssetsIDs400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetExchangeRateByAssetsIDs400Response struct {
	value *GetExchangeRateByAssetsIDs400Response
	isSet bool
}

func (v NullableGetExchangeRateByAssetsIDs400Response) Get() *GetExchangeRateByAssetsIDs400Response {
	return v.value
}

func (v *NullableGetExchangeRateByAssetsIDs400Response) Set(val *GetExchangeRateByAssetsIDs400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExchangeRateByAssetsIDs400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExchangeRateByAssetsIDs400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExchangeRateByAssetsIDs400Response(val *GetExchangeRateByAssetsIDs400Response) *NullableGetExchangeRateByAssetsIDs400Response {
	return &NullableGetExchangeRateByAssetsIDs400Response{value: val, isSet: true}
}

func (v NullableGetExchangeRateByAssetsIDs400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExchangeRateByAssetsIDs400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
