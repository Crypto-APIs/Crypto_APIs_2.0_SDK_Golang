...
// GetTransactionDetailsByTransactionIDRIBSBCVout struct for GetTransactionDetailsByTransactionIDRIBSBCVout
type GetTransactionDetailsByTransactionIDRIBSBCVout struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSBCVout(isSpent bool, scriptPubKey GetTransactionDetailsByTransactionIDRIBSBCScriptPubKey, value string) *GetTransactionDetailsByTransactionIDRIBSBCVout {
	this := GetTransactionDetailsByTransactionIDRIBSBCVout{}
...
func (o GetTransactionDetailsByTransactionIDRIBSBCVout) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSBCVout struct {
	value *GetTransactionDetailsByTransactionIDRIBSBCVout
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBCVout) Get() *GetTransactionDetailsByTransactionIDRIBSBCVout {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBCVout) Set(val *GetTransactionDetailsByTransactionIDRIBSBCVout) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBCVout) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBCVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSBCVout(val *GetTransactionDetailsByTransactionIDRIBSBCVout) *NullableGetTransactionDetailsByTransactionIDRIBSBCVout {
	return &NullableGetTransactionDetailsByTransactionIDRIBSBCVout{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSBCVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSBCVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
