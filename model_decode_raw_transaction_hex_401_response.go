...
type DecodeRawTransactionHex401Response struct {
	...
	Error DecodeRawTransactionHexE401 `json:"error"`
}
...
func NewDecodeRawTransactionHex401Response(apiVersion string, requestId string, error_ DecodeRawTransactionHexE401) *DecodeRawTransactionHex401Response {
	this := DecodeRawTransactionHex401Response{}
...
func (o *DecodeRawTransactionHex401Response) GetError() DecodeRawTransactionHexE401 {
	if o == nil {
		var ret DecodeRawTransactionHexE401
		return ret
	}
...
func (o DecodeRawTransactionHex401Response) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHex401Response struct {
	value *DecodeRawTransactionHex401Response
	isSet bool
}

func (v NullableDecodeRawTransactionHex401Response) Get() *DecodeRawTransactionHex401Response {
	return v.value
}

func (v *NullableDecodeRawTransactionHex401Response) Set(val *DecodeRawTransactionHex401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHex401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHex401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHex401Response(val *DecodeRawTransactionHex401Response) *NullableDecodeRawTransactionHex401Response {
	return &NullableDecodeRawTransactionHex401Response{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHex401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHex401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
