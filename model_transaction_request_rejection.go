...
type TransactionRequestRejection struct {
	...
	Data TransactionRequestRejectionData `json:"data"`
}
...
func NewTransactionRequestRejection(apiVersion string, referenceId string, idempotencyKey string, data TransactionRequestRejectionData) *TransactionRequestRejection {
	this := TransactionRequestRejection{}
...
func (o *TransactionRequestRejection) GetData() TransactionRequestRejectionData {
	if o == nil {
		var ret TransactionRequestRejectionData
		return ret
	}
...
func (o TransactionRequestRejection) MarshalJSON() ([]byte, error) {
...
type NullableTransactionRequestRejection struct {
	value *TransactionRequestRejection
	isSet bool
}

func (v NullableTransactionRequestRejection) Get() *TransactionRequestRejection {
	return v.value
}

func (v *NullableTransactionRequestRejection) Set(val *TransactionRequestRejection) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRequestRejection) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRequestRejection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRequestRejection(val *TransactionRequestRejection) *NullableTransactionRequestRejection {
	return &NullableTransactionRequestRejection{value: val, isSet: true}
}

func (v NullableTransactionRequestRejection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRequestRejection) UnmarshalJSON(src []byte) error {
	v.isSet = true
