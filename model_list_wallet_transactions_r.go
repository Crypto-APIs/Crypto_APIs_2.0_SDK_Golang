...
type ListWalletTransactionsR struct {
	...
	Data ListWalletTransactionsRData `json:"data"`
}
...
func (o *ListWalletTransactionsR) GetData() ListWalletTransactionsRData {
	if o == nil {
		var ret ListWalletTransactionsRData
		return ret
	}
...
func (o ListWalletTransactionsR) MarshalJSON() ([]byte, error) {
...
type NullableListWalletTransactionsR struct {
	value *ListWalletTransactionsR
	isSet bool
}

func (v NullableListWalletTransactionsR) Get() *ListWalletTransactionsR {
	return v.value
}

func (v *NullableListWalletTransactionsR) Set(val *ListWalletTransactionsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListWalletTransactionsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListWalletTransactionsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWalletTransactionsR(val *ListWalletTransactionsR) *NullableListWalletTransactionsR {
	return &NullableListWalletTransactionsR{value: val, isSet: true}
}

func (v NullableListWalletTransactionsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWalletTransactionsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
