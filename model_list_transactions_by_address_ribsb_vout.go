...
// ListTransactionsByAddressRIBSBVout struct for ListTransactionsByAddressRIBSBVout
type ListTransactionsByAddressRIBSBVout struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByAddressRIBSBScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByAddressRIBSBVout(isSpent bool, scriptPubKey ListTransactionsByAddressRIBSBScriptPubKey, value string) *ListTransactionsByAddressRIBSBVout {
	this := ListTransactionsByAddressRIBSBVout{}
...
func (o *ListTransactionsByAddressRIBSBVout) GetScriptPubKey() ListTransactionsByAddressRIBSBScriptPubKey {
	if o == nil {
		var ret ListTransactionsByAddressRIBSBScriptPubKey
		return ret
	}
...
func (o ListTransactionsByAddressRIBSBVout) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSBVout struct {
	value *ListTransactionsByAddressRIBSBVout
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSBVout) Get() *ListTransactionsByAddressRIBSBVout {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSBVout) Set(val *ListTransactionsByAddressRIBSBVout) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSBVout) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSBVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSBVout(val *ListTransactionsByAddressRIBSBVout) *NullableListTransactionsByAddressRIBSBVout {
	return &NullableListTransactionsByAddressRIBSBVout{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSBVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSBVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
