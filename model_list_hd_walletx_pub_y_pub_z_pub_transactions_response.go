...
// ListHDWalletxPubYPubZPubTransactionsResponse struct for ListHDWalletxPubYPubZPubTransactionsResponse
type ListHDWalletxPubYPubZPubTransactionsResponse struct {
	...
	Data ListHDWalletxPubYPubZPubTransactionsResponseData `json:"data"`
}
...
func NewListHDWalletxPubYPubZPubTransactionsResponse(apiVersion string, requestId string, data ListHDWalletxPubYPubZPubTransactionsResponseData) *ListHDWalletxPubYPubZPubTransactionsResponse {
	this := ListHDWalletxPubYPubZPubTransactionsResponse{}
...
func (o *ListHDWalletxPubYPubZPubTransactionsResponse) GetData() ListHDWalletxPubYPubZPubTransactionsResponseData {
	if o == nil {
		var ret ListHDWalletxPubYPubZPubTransactionsResponseData
		return ret
	}
...
func (o ListHDWalletxPubYPubZPubTransactionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletxPubYPubZPubTransactionsResponse struct {
	value *ListHDWalletxPubYPubZPubTransactionsResponse
	isSet bool
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponse) Get() *ListHDWalletxPubYPubZPubTransactionsResponse {
	return v.value
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponse) Set(val *ListHDWalletxPubYPubZPubTransactionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletxPubYPubZPubTransactionsResponse(val *ListHDWalletxPubYPubZPubTransactionsResponse) *NullableListHDWalletxPubYPubZPubTransactionsResponse {
	return &NullableListHDWalletxPubYPubZPubTransactionsResponse{value: val, isSet: true}
}

func (v NullableListHDWalletxPubYPubZPubTransactionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletxPubYPubZPubTransactionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
