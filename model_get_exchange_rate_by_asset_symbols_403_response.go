...
type GetExchangeRateByAssetSymbols403Response struct {
...
func NewGetExchangeRateByAssetSymbols403Response(apiVersion string, requestId string, error_ GetExchangeRateByAssetSymbolsE403) *GetExchangeRateByAssetSymbols403Response {
	this := GetExchangeRateByAssetSymbols403Response{}
...
func (o GetExchangeRateByAssetSymbols403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetExchangeRateByAssetSymbols403Response struct {
	value *GetExchangeRateByAssetSymbols403Response
	isSet bool
}

func (v NullableGetExchangeRateByAssetSymbols403Response) Get() *GetExchangeRateByAssetSymbols403Response {
	return v.value
}

func (v *NullableGetExchangeRateByAssetSymbols403Response) Set(val *GetExchangeRateByAssetSymbols403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExchangeRateByAssetSymbols403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExchangeRateByAssetSymbols403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExchangeRateByAssetSymbols403Response(val *GetExchangeRateByAssetSymbols403Response) *NullableGetExchangeRateByAssetSymbols403Response {
	return &NullableGetExchangeRateByAssetSymbols403Response{value: val, isSet: true}
}

func (v NullableGetExchangeRateByAssetSymbols403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExchangeRateByAssetSymbols403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
