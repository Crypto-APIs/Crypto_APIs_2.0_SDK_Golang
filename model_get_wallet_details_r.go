...
// GetWalletDetailsR struct for GetWalletDetailsR
type GetWalletDetailsR struct {
	...
	Data GetWalletDetailsRData `json:"data"`
}
...
func (o GetWalletDetailsR) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletDetailsR struct {
	value *GetWalletDetailsR
	isSet bool
}

func (v NullableGetWalletDetailsR) Get() *GetWalletDetailsR {
	return v.value
}

func (v *NullableGetWalletDetailsR) Set(val *GetWalletDetailsR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletDetailsR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletDetailsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletDetailsR(val *GetWalletDetailsR) *NullableGetWalletDetailsR {
	return &NullableGetWalletDetailsR{value: val, isSet: true}
}

func (v NullableGetWalletDetailsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletDetailsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
