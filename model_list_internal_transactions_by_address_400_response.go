...
type ListInternalTransactionsByAddress400Response struct {
	...
	Error ListInternalTransactionsByAddressE400 `json:"error"`
}
...
func NewListInternalTransactionsByAddress400Response(apiVersion string, requestId string, error_ ListInternalTransactionsByAddressE400) *ListInternalTransactionsByAddress400Response {
	this := ListInternalTransactionsByAddress400Response{}
...
func (o ListInternalTransactionsByAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionsByAddress400Response struct {
	value *ListInternalTransactionsByAddress400Response
	isSet bool
}

func (v NullableListInternalTransactionsByAddress400Response) Get() *ListInternalTransactionsByAddress400Response {
	return v.value
}

func (v *NullableListInternalTransactionsByAddress400Response) Set(val *ListInternalTransactionsByAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddress400Response(val *ListInternalTransactionsByAddress400Response) *NullableListInternalTransactionsByAddress400Response {
	return &NullableListInternalTransactionsByAddress400Response{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
