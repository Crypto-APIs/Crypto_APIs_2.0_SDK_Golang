...
// InvalidBlockchainError struct for InvalidBlockchainError
type InvalidBlockchainError struct {
...
func (o InvalidBlockchainError) MarshalJSON() ([]byte, error) {
...
type NullableInvalidBlockchainError struct {
	value *InvalidBlockchainError
	isSet bool
}

func (v NullableInvalidBlockchainError) Get() *InvalidBlockchainError {
	return v.value
}

func (v *NullableInvalidBlockchainError) Set(val *InvalidBlockchainError) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidBlockchainError) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidBlockchainError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidBlockchainError(val *InvalidBlockchainError) *NullableInvalidBlockchainError {
	return &NullableInvalidBlockchainError{value: val, isSet: true}
}

func (v NullableInvalidBlockchainError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidBlockchainError) UnmarshalJSON(src []byte) error {
	v.isSet = true
