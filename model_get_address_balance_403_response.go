...
type GetAddressBalance403Response struct {
	...
	Error GetAddressBalanceE403 `json:"error"`
}
...
func NewGetAddressBalance403Response(apiVersion string, requestId string, error_ GetAddressBalanceE403) *GetAddressBalance403Response {
	this := GetAddressBalance403Response{}
...
func (o GetAddressBalance403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressBalance403Response struct {
	value *GetAddressBalance403Response
	isSet bool
}

func (v NullableGetAddressBalance403Response) Get() *GetAddressBalance403Response {
	return v.value
}

func (v *NullableGetAddressBalance403Response) Set(val *GetAddressBalance403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressBalance403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressBalance403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressBalance403Response(val *GetAddressBalance403Response) *NullableGetAddressBalance403Response {
	return &NullableGetAddressBalance403Response{value: val, isSet: true}
}

func (v NullableGetAddressBalance403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressBalance403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
