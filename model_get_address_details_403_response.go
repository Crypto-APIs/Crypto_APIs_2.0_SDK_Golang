...
type GetAddressDetails403Response struct {
...
func NewGetAddressDetails403Response(apiVersion string, requestId string, error_ GetAddressDetailsE403) *GetAddressDetails403Response {
	this := GetAddressDetails403Response{}
...
func (o GetAddressDetails403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetails403Response struct {
	value *GetAddressDetails403Response
	isSet bool
}

func (v NullableGetAddressDetails403Response) Get() *GetAddressDetails403Response {
	return v.value
}

func (v *NullableGetAddressDetails403Response) Set(val *GetAddressDetails403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetails403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetails403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetails403Response(val *GetAddressDetails403Response) *NullableGetAddressDetails403Response {
	return &NullableGetAddressDetails403Response{value: val, isSet: true}
}

func (v NullableGetAddressDetails403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetails403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
