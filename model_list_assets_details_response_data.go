...
// ListAssetsDetailsResponseData struct for ListAssetsDetailsResponseData
type ListAssetsDetailsResponseData struct {
	...
	Items []ListAssetsDetailsResponseItem `json:"items"`
}
...
func NewListAssetsDetailsResponseData(offset int32, limit int32, total int32, items []ListAssetsDetailsResponseItem) *ListAssetsDetailsResponseData {
	this := ListAssetsDetailsResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListAssetsDetailsResponseData) GetItems() []ListAssetsDetailsResponseItem {
	if o == nil {
		var ret []ListAssetsDetailsResponseItem
		return ret
	}
...
func (o ListAssetsDetailsResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetailsResponseData struct {
	value *ListAssetsDetailsResponseData
	isSet bool
}

func (v NullableListAssetsDetailsResponseData) Get() *ListAssetsDetailsResponseData {
	return v.value
}

func (v *NullableListAssetsDetailsResponseData) Set(val *ListAssetsDetailsResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetailsResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetailsResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetailsResponseData(val *ListAssetsDetailsResponseData) *NullableListAssetsDetailsResponseData {
	return &NullableListAssetsDetailsResponseData{value: val, isSet: true}
}

func (v NullableListAssetsDetailsResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetailsResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
