...
type DeriveAndSyncNewChangeAddresses401Response struct {
	...
	Error DeriveAndSyncNewChangeAddressesE401 `json:"error"`
}
...
func NewDeriveAndSyncNewChangeAddresses401Response(apiVersion string, requestId string, error_ DeriveAndSyncNewChangeAddressesE401) *DeriveAndSyncNewChangeAddresses401Response {
	this := DeriveAndSyncNewChangeAddresses401Response{}
...
func (o *DeriveAndSyncNewChangeAddresses401Response) GetError() DeriveAndSyncNewChangeAddressesE401 {
	if o == nil {
		var ret DeriveAndSyncNewChangeAddressesE401
		return ret
	}
...
func (o DeriveAndSyncNewChangeAddresses401Response) MarshalJSON() ([]byte, error) {
...
type NullableDeriveAndSyncNewChangeAddresses401Response struct {
	value *DeriveAndSyncNewChangeAddresses401Response
	isSet bool
}

func (v NullableDeriveAndSyncNewChangeAddresses401Response) Get() *DeriveAndSyncNewChangeAddresses401Response {
	return v.value
}

func (v *NullableDeriveAndSyncNewChangeAddresses401Response) Set(val *DeriveAndSyncNewChangeAddresses401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewChangeAddresses401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewChangeAddresses401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewChangeAddresses401Response(val *DeriveAndSyncNewChangeAddresses401Response) *NullableDeriveAndSyncNewChangeAddresses401Response {
	return &NullableDeriveAndSyncNewChangeAddresses401Response{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewChangeAddresses401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewChangeAddresses401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
