...
type ListConfirmedTransactionsByAddressAndTimeRange403Response struct {
...
func NewListConfirmedTransactionsByAddressAndTimeRange403Response(apiVersion string, requestId string, error_ ListConfirmedTransactionsByAddressAndTimeRangeE403) *ListConfirmedTransactionsByAddressAndTimeRange403Response {
	this := ListConfirmedTransactionsByAddressAndTimeRange403Response{}
...
func (o ListConfirmedTransactionsByAddressAndTimeRange403Response) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressAndTimeRange403Response struct {
	value *ListConfirmedTransactionsByAddressAndTimeRange403Response
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange403Response) Get() *ListConfirmedTransactionsByAddressAndTimeRange403Response {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange403Response) Set(val *ListConfirmedTransactionsByAddressAndTimeRange403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressAndTimeRange403Response(val *ListConfirmedTransactionsByAddressAndTimeRange403Response) *NullableListConfirmedTransactionsByAddressAndTimeRange403Response {
	return &NullableListConfirmedTransactionsByAddressAndTimeRange403Response{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRange403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRange403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
