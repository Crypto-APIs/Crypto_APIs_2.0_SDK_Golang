...
type GetAddressDetailsFromCallback401Response struct {
	...
	Error GetAddressDetailsFromCallbackE401 `json:"error"`
}
...
func NewGetAddressDetailsFromCallback401Response(apiVersion string, requestId string, error_ GetAddressDetailsFromCallbackE401) *GetAddressDetailsFromCallback401Response {
	this := GetAddressDetailsFromCallback401Response{}
...
func (o *GetAddressDetailsFromCallback401Response) GetError() GetAddressDetailsFromCallbackE401 {
	if o == nil {
		var ret GetAddressDetailsFromCallbackE401
		return ret
	}
...
func (o GetAddressDetailsFromCallback401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetailsFromCallback401Response struct {
	value *GetAddressDetailsFromCallback401Response
	isSet bool
}

func (v NullableGetAddressDetailsFromCallback401Response) Get() *GetAddressDetailsFromCallback401Response {
	return v.value
}

func (v *NullableGetAddressDetailsFromCallback401Response) Set(val *GetAddressDetailsFromCallback401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsFromCallback401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsFromCallback401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsFromCallback401Response(val *GetAddressDetailsFromCallback401Response) *NullableGetAddressDetailsFromCallback401Response {
	return &NullableGetAddressDetailsFromCallback401Response{value: val, isSet: true}
}

func (v NullableGetAddressDetailsFromCallback401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsFromCallback401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
