...
// ListTokensForwardingAutomationsResponseItem struct for ListTokensForwardingAutomationsResponseItem
type ListTokensForwardingAutomationsResponseItem struct {
	...
	TokenData ListTokensForwardingAutomationsResponseItemTokenData `json:"tokenData"`
}
...
func NewListTokensForwardingAutomationsResponseItem(callbackUrl string, createdTimestamp int32, feeAddress string, feePriority string, fromAddress string, minimumTransferAmount string, referenceId string, toAddress string, tokenData ListTokensForwardingAutomationsResponseItemTokenData) *ListTokensForwardingAutomationsResponseItem {
	this := ListTokensForwardingAutomationsResponseItem{}
...
func (o *ListTokensForwardingAutomationsResponseItem) GetTokenData() ListTokensForwardingAutomationsResponseItemTokenData {
	if o == nil {
		var ret ListTokensForwardingAutomationsResponseItemTokenData
		return ret
	}
...
func (o ListTokensForwardingAutomationsResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableListTokensForwardingAutomationsResponseItem struct {
	value *ListTokensForwardingAutomationsResponseItem
	isSet bool
}

func (v NullableListTokensForwardingAutomationsResponseItem) Get() *ListTokensForwardingAutomationsResponseItem {
	return v.value
}

func (v *NullableListTokensForwardingAutomationsResponseItem) Set(val *ListTokensForwardingAutomationsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensForwardingAutomationsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensForwardingAutomationsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensForwardingAutomationsResponseItem(val *ListTokensForwardingAutomationsResponseItem) *NullableListTokensForwardingAutomationsResponseItem {
	return &NullableListTokensForwardingAutomationsResponseItem{value: val, isSet: true}
}

func (v NullableListTokensForwardingAutomationsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensForwardingAutomationsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
