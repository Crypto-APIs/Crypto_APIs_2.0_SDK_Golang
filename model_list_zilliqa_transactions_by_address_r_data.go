...
type ListZilliqaTransactionsByAddressRData struct {
	...
	Items []ListZilliqaTransactionsByAddressRI `json:"items"`
}
...
func NewListZilliqaTransactionsByAddressRData(limit int32, offset int32, total int32, items []ListZilliqaTransactionsByAddressRI) *ListZilliqaTransactionsByAddressRData {
	this := ListZilliqaTransactionsByAddressRData{}
	this.Limit = limit
	this.Offset = offset
	this.Total = total
	this.Items = items
...
func (o *ListZilliqaTransactionsByAddressRData) GetItems() []ListZilliqaTransactionsByAddressRI {
	if o == nil {
		var ret []ListZilliqaTransactionsByAddressRI
		return ret
	}
...
func (o ListZilliqaTransactionsByAddressRData) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByAddressRData struct {
	value *ListZilliqaTransactionsByAddressRData
	isSet bool
}

func (v NullableListZilliqaTransactionsByAddressRData) Get() *ListZilliqaTransactionsByAddressRData {
	return v.value
}

func (v *NullableListZilliqaTransactionsByAddressRData) Set(val *ListZilliqaTransactionsByAddressRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByAddressRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByAddressRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByAddressRData(val *ListZilliqaTransactionsByAddressRData) *NullableListZilliqaTransactionsByAddressRData {
	return &NullableListZilliqaTransactionsByAddressRData{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByAddressRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByAddressRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
