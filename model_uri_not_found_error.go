...
// UriNotFoundError struct for UriNotFoundError
...
func (o UriNotFoundError) MarshalJSON() ([]byte, error) {
...
type NullableUriNotFoundError struct {
	value *UriNotFoundError
	isSet bool
}

func (v NullableUriNotFoundError) Get() *UriNotFoundError {
	return v.value
}

func (v *NullableUriNotFoundError) Set(val *UriNotFoundError) {
	v.value = val
	v.isSet = true
}

func (v NullableUriNotFoundError) IsSet() bool {
	return v.isSet
}

func (v *NullableUriNotFoundError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUriNotFoundError(val *UriNotFoundError) *NullableUriNotFoundError {
	return &NullableUriNotFoundError{value: val, isSet: true}
}

func (v NullableUriNotFoundError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUriNotFoundError) UnmarshalJSON(src []byte) error {
	v.isSet = true
