...
// NewConfirmedCoinsTransactionsResponse struct for NewConfirmedCoinsTransactionsResponse
type NewConfirmedCoinsTransactionsResponse struct {
	...
	Data NewConfirmedCoinsTransactionsResponseData `json:"data"`
}
...
func NewNewConfirmedCoinsTransactionsResponse(apiVersion string, requestId string, data NewConfirmedCoinsTransactionsResponseData) *NewConfirmedCoinsTransactionsResponse {
	this := NewConfirmedCoinsTransactionsResponse{}
...
func (o *NewConfirmedCoinsTransactionsResponse) GetData() NewConfirmedCoinsTransactionsResponseData {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsResponseData
		return ret
	}
...
func (o NewConfirmedCoinsTransactionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactionsResponse struct {
	value *NewConfirmedCoinsTransactionsResponse
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactionsResponse) Get() *NewConfirmedCoinsTransactionsResponse {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactionsResponse) Set(val *NewConfirmedCoinsTransactionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactionsResponse(val *NewConfirmedCoinsTransactionsResponse) *NullableNewConfirmedCoinsTransactionsResponse {
	return &NullableNewConfirmedCoinsTransactionsResponse{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
