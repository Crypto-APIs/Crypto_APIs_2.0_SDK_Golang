...
type GetZilliqaAddressDetails403Response struct {
	...
	Error GetZilliqaAddressDetailsE403 `json:"error"`
}
...
func NewGetZilliqaAddressDetails403Response(apiVersion string, requestId string, error_ GetZilliqaAddressDetailsE403) *GetZilliqaAddressDetails403Response {
	this := GetZilliqaAddressDetails403Response{}
...
func (o *GetZilliqaAddressDetails403Response) GetError() GetZilliqaAddressDetailsE403 {
	if o == nil {
		var ret GetZilliqaAddressDetailsE403
		return ret
	}
...
func (o GetZilliqaAddressDetails403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaAddressDetails403Response struct {
	value *GetZilliqaAddressDetails403Response
	isSet bool
}

func (v NullableGetZilliqaAddressDetails403Response) Get() *GetZilliqaAddressDetails403Response {
	return v.value
}

func (v *NullableGetZilliqaAddressDetails403Response) Set(val *GetZilliqaAddressDetails403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaAddressDetails403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaAddressDetails403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaAddressDetails403Response(val *GetZilliqaAddressDetails403Response) *NullableGetZilliqaAddressDetails403Response {
	return &NullableGetZilliqaAddressDetails403Response{value: val, isSet: true}
}

func (v NullableGetZilliqaAddressDetails403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaAddressDetails403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
