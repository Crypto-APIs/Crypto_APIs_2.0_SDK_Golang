...
func (r ApiGetContractDetailsByAddressRequest) Execute() (GetContractDetailsByAddressResponse, *_nethttp.Response, error) {
 ...
 * @param blockchain
 * @param network
 * @param contractAddress String identifier of the token
 * @return ApiGetContractDetailsByAddressRequest
 */
func (a *DefaultApiService) GetContractDetailsByAddress(ctx _context.Context, blockchain string, network string, contractAddress string) ApiGetContractDetailsByAddressRequest {
	return ApiGetContractDetailsByAddressRequest{
		ApiService: a,
		ctx: ctx,
 ...
 */
func (a *DefaultApiService) GetContractDetailsByAddressExecute(r ApiGetContractDetailsByAddressRequest) (GetContractDetailsByAddressResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  GetContractDetailsByAddressResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetContractDetailsByAddress")
	if err != nil {
