...
type GenerateDepositAddress401Response struct {
...
func NewGenerateDepositAddress401Response(apiVersion string, requestId string, error_ GenerateDepositAddressE401) *GenerateDepositAddress401Response {
	this := GenerateDepositAddress401Response{}
...
func (o GenerateDepositAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableGenerateDepositAddress401Response struct {
	value *GenerateDepositAddress401Response
	isSet bool
}

func (v NullableGenerateDepositAddress401Response) Get() *GenerateDepositAddress401Response {
	return v.value
}

func (v *NullableGenerateDepositAddress401Response) Set(val *GenerateDepositAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateDepositAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateDepositAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateDepositAddress401Response(val *GenerateDepositAddress401Response) *NullableGenerateDepositAddress401Response {
	return &NullableGenerateDepositAddress401Response{value: val, isSet: true}
}

func (v NullableGenerateDepositAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateDepositAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
