...
type GetAddressDetails400Response struct {
	...
	Error GetAddressDetailsE400 `json:"error"`
}
...
func NewGetAddressDetails400Response(apiVersion string, requestId string, error_ GetAddressDetailsE400) *GetAddressDetails400Response {
	this := GetAddressDetails400Response{}
...
func (o GetAddressDetails400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetails400Response struct {
	value *GetAddressDetails400Response
	isSet bool
}

func (v NullableGetAddressDetails400Response) Get() *GetAddressDetails400Response {
	return v.value
}

func (v *NullableGetAddressDetails400Response) Set(val *GetAddressDetails400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetails400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetails400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetails400Response(val *GetAddressDetails400Response) *NullableGetAddressDetails400Response {
	return &NullableGetAddressDetails400Response{value: val, isSet: true}
}

func (v NullableGetAddressDetails400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetails400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
