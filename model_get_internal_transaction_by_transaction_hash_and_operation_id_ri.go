...
type GetInternalTransactionByTransactionHashAndOperationIdRI struct {
...
func NewGetInternalTransactionByTransactionHashAndOperationIdRI(amount string, blockHash string, blockHeight int32, operationType string, parentHash string, recipient string, sender string, timestamp int32) *GetInternalTransactionByTransactionHashAndOperationIdRI {
	this := GetInternalTransactionByTransactionHashAndOperationIdRI{}
	this.Amount = amount
...
func (o GetInternalTransactionByTransactionHashAndOperationIdRI) MarshalJSON() ([]byte, error) {
...
type NullableGetInternalTransactionByTransactionHashAndOperationIdRI struct {
	value *GetInternalTransactionByTransactionHashAndOperationIdRI
	isSet bool
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationIdRI) Get() *GetInternalTransactionByTransactionHashAndOperationIdRI {
	return v.value
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationIdRI) Set(val *GetInternalTransactionByTransactionHashAndOperationIdRI) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationIdRI) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationIdRI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInternalTransactionByTransactionHashAndOperationIdRI(val *GetInternalTransactionByTransactionHashAndOperationIdRI) *NullableGetInternalTransactionByTransactionHashAndOperationIdRI {
	return &NullableGetInternalTransactionByTransactionHashAndOperationIdRI{value: val, isSet: true}
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationIdRI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationIdRI) UnmarshalJSON(src []byte) error {
	v.isSet = true
