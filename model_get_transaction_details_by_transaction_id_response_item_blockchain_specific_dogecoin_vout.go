...
// GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout struct for GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout
type GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey `json:"scriptPubKey"`
...
func NewGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout(isSpent bool, scriptPubKey GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey, value string) *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout {
	this := GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout{}
...
func (o *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) GetScriptPubKey() GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout struct {
	value *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) Get() *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) Set(val *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout(val *GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout {
	return &NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
