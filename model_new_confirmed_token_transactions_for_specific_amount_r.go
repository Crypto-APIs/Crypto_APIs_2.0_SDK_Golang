...
type NewConfirmedTokenTransactionsForSpecificAmountR struct {
	...
	Data NewConfirmedTokenTransactionsForSpecificAmountRData `json:"data"`
}
...
func NewNewConfirmedTokenTransactionsForSpecificAmountR(apiVersion string, requestId string, data NewConfirmedTokenTransactionsForSpecificAmountRData) *NewConfirmedTokenTransactionsForSpecificAmountR {
	this := NewConfirmedTokenTransactionsForSpecificAmountR{}
...
func (o *NewConfirmedTokenTransactionsForSpecificAmountR) GetData() NewConfirmedTokenTransactionsForSpecificAmountRData {
	if o == nil {
		var ret NewConfirmedTokenTransactionsForSpecificAmountRData
		return ret
	}
...
func (o NewConfirmedTokenTransactionsForSpecificAmountR) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokenTransactionsForSpecificAmountR struct {
	value *NewConfirmedTokenTransactionsForSpecificAmountR
	isSet bool
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmountR) Get() *NewConfirmedTokenTransactionsForSpecificAmountR {
	return v.value
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmountR) Set(val *NewConfirmedTokenTransactionsForSpecificAmountR) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmountR) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmountR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokenTransactionsForSpecificAmountR(val *NewConfirmedTokenTransactionsForSpecificAmountR) *NullableNewConfirmedTokenTransactionsForSpecificAmountR {
	return &NullableNewConfirmedTokenTransactionsForSpecificAmountR{value: val, isSet: true}
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmountR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmountR) UnmarshalJSON(src []byte) error {
	v.isSet = true
