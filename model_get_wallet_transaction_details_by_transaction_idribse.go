...
type GetWalletTransactionDetailsByTransactionIDRIBSE struct {
	// Represents the specific transaction contract.
	Contract string `json:"contract"`
	// Represents the amount of gas used by this specific transaction alone.
	GasLimit string `json:"gasLimit"`
	GasPrice GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice `json:"gasPrice"`
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSE(contract string, gasLimit string, gasPrice GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice, gasUsed string, inputData string, nonce int32, transactionStatus string) *GetWalletTransactionDetailsByTransactionIDRIBSE {
	this := GetWalletTransactionDetailsByTransactionIDRIBSE{}
...
func (o *GetWalletTransactionDetailsByTransactionIDRIBSE) GetGasPrice() GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice {
	if o == nil {
		var ret GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice
		return ret
	}
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSE) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSE struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSE
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSE) Get() *GetWalletTransactionDetailsByTransactionIDRIBSE {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSE) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSE) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSE) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSE) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSE(val *GetWalletTransactionDetailsByTransactionIDRIBSE) *NullableGetWalletTransactionDetailsByTransactionIDRIBSE {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSE{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSE) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSE) UnmarshalJSON(src []byte) error {
	v.isSet = true
