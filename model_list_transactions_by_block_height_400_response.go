...
type ListTransactionsByBlockHeight400Response struct {
	...
	Error ListTransactionsByBlockHeightE400 `json:"error"`
}
...
func NewListTransactionsByBlockHeight400Response(apiVersion string, requestId string, error_ ListTransactionsByBlockHeightE400) *ListTransactionsByBlockHeight400Response {
	this := ListTransactionsByBlockHeight400Response{}
...
func (o *ListTransactionsByBlockHeight400Response) GetError() ListTransactionsByBlockHeightE400 {
	if o == nil {
		var ret ListTransactionsByBlockHeightE400
		return ret
	}
...
func (o ListTransactionsByBlockHeight400Response) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeight400Response struct {
	value *ListTransactionsByBlockHeight400Response
	isSet bool
}

func (v NullableListTransactionsByBlockHeight400Response) Get() *ListTransactionsByBlockHeight400Response {
	return v.value
}

func (v *NullableListTransactionsByBlockHeight400Response) Set(val *ListTransactionsByBlockHeight400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeight400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeight400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeight400Response(val *ListTransactionsByBlockHeight400Response) *NullableListTransactionsByBlockHeight400Response {
	return &NullableListTransactionsByBlockHeight400Response{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeight400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeight400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
