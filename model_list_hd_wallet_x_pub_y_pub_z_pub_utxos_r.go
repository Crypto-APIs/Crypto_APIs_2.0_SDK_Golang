...
type ListHDWalletXPubYPubZPubUTXOsR struct {
	...
	Data ListHDWalletXPubYPubZPubUTXOsRData `json:"data"`
}
...
func NewListHDWalletXPubYPubZPubUTXOsR(apiVersion string, requestId string, data ListHDWalletXPubYPubZPubUTXOsRData) *ListHDWalletXPubYPubZPubUTXOsR {
	this := ListHDWalletXPubYPubZPubUTXOsR{}
...
func (o *ListHDWalletXPubYPubZPubUTXOsR) GetData() ListHDWalletXPubYPubZPubUTXOsRData {
	if o == nil {
		var ret ListHDWalletXPubYPubZPubUTXOsRData
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubUTXOsR) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubUTXOsR struct {
	value *ListHDWalletXPubYPubZPubUTXOsR
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubUTXOsR) Get() *ListHDWalletXPubYPubZPubUTXOsR {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubUTXOsR) Set(val *ListHDWalletXPubYPubZPubUTXOsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubUTXOsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubUTXOsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubUTXOsR(val *ListHDWalletXPubYPubZPubUTXOsR) *NullableListHDWalletXPubYPubZPubUTXOsR {
	return &NullableListHDWalletXPubYPubZPubUTXOsR{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubUTXOsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubUTXOsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
