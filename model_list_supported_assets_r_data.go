...
type ListSupportedAssetsRData struct {
	...
	Items []ListSupportedAssetsRI `json:"items"`
}
...
func (o ListSupportedAssetsRData) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedAssetsRData struct {
	value *ListSupportedAssetsRData
	isSet bool
}

func (v NullableListSupportedAssetsRData) Get() *ListSupportedAssetsRData {
	return v.value
}

func (v *NullableListSupportedAssetsRData) Set(val *ListSupportedAssetsRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedAssetsRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedAssetsRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedAssetsRData(val *ListSupportedAssetsRData) *NullableListSupportedAssetsRData {
	return &NullableListSupportedAssetsRData{value: val, isSet: true}
}

func (v NullableListSupportedAssetsRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedAssetsRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
