...
type GetAddressDetailsFromCallback400Response struct {
	...
	Error GetAddressDetailsFromCallbackE400 `json:"error"`
}
...
func NewGetAddressDetailsFromCallback400Response(apiVersion string, requestId string, error_ GetAddressDetailsFromCallbackE400) *GetAddressDetailsFromCallback400Response {
	this := GetAddressDetailsFromCallback400Response{}
...
func (o GetAddressDetailsFromCallback400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetailsFromCallback400Response struct {
	value *GetAddressDetailsFromCallback400Response
	isSet bool
}

func (v NullableGetAddressDetailsFromCallback400Response) Get() *GetAddressDetailsFromCallback400Response {
	return v.value
}

func (v *NullableGetAddressDetailsFromCallback400Response) Set(val *GetAddressDetailsFromCallback400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsFromCallback400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsFromCallback400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsFromCallback400Response(val *GetAddressDetailsFromCallback400Response) *NullableGetAddressDetailsFromCallback400Response {
	return &NullableGetAddressDetailsFromCallback400Response{value: val, isSet: true}
}

func (v NullableGetAddressDetailsFromCallback400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsFromCallback400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
