...
type GetTransactionDetailsByTransactionIDFromCallbackE403 struct {
...
func BannedIpAddressAsGetTransactionDetailsByTransactionIDFromCallbackE403(v *BannedIpAddress) GetTransactionDetailsByTransactionIDFromCallbackE403 {
	return GetTransactionDetailsByTransactionIDFromCallbackE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetTransactionDetailsByTransactionIDFromCallbackE403(v *EndpointNotAllowedForApiKey) GetTransactionDetailsByTransactionIDFromCallbackE403 {
	return GetTransactionDetailsByTransactionIDFromCallbackE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetTransactionDetailsByTransactionIDFromCallbackE403(v *EndpointNotAllowedForPlan) GetTransactionDetailsByTransactionIDFromCallbackE403 {
	return GetTransactionDetailsByTransactionIDFromCallbackE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetTransactionDetailsByTransactionIDFromCallbackE403(v *FeatureMainnetsNotAllowedForPlan) GetTransactionDetailsByTransactionIDFromCallbackE403 {
	return GetTransactionDetailsByTransactionIDFromCallbackE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetTransactionDetailsByTransactionIDFromCallbackE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetTransactionDetailsByTransactionIDFromCallbackE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetTransactionDetailsByTransactionIDFromCallbackE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetTransactionDetailsByTransactionIDFromCallbackE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetTransactionDetailsByTransactionIDFromCallbackE403) GetActualInstance() (interface{}) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackE403 struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackE403
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackE403) Get() *GetTransactionDetailsByTransactionIDFromCallbackE403 {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackE403) Set(val *GetTransactionDetailsByTransactionIDFromCallbackE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackE403(val *GetTransactionDetailsByTransactionIDFromCallbackE403) *NullableGetTransactionDetailsByTransactionIDFromCallbackE403 {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackE403{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
