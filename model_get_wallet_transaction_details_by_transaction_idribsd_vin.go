...
// GetWalletTransactionDetailsByTransactionIDRIBSDVin struct for GetWalletTransactionDetailsByTransactionIDRIBSDVin
type GetWalletTransactionDetailsByTransactionIDRIBSDVin struct {
	Addresses []string `json:"addresses"`
	// Represents the coinbase hex.
	Coinbase *string `json:"coinbase,omitempty"`
	ScriptSig GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig `json:"scriptSig"`
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSDVin(addresses []string, scriptSig GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig, sequence int32, value string) *GetWalletTransactionDetailsByTransactionIDRIBSDVin {
	this := GetWalletTransactionDetailsByTransactionIDRIBSDVin{}
...
func (o *GetWalletTransactionDetailsByTransactionIDRIBSDVin) GetScriptSig() GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig {
	if o == nil {
		var ret GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig
		return ret
	}
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSDVin) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSDVin
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin) Get() *GetWalletTransactionDetailsByTransactionIDRIBSDVin {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSDVin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSDVin(val *GetWalletTransactionDetailsByTransactionIDRIBSDVin) *NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSDVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
