...
type NewUnconfirmedCoinsTransactions400Response struct {
	...
	Error NewUnconfirmedCoinsTransactionsE400 `json:"error"`
}
...
func (o *NewUnconfirmedCoinsTransactions400Response) GetError() NewUnconfirmedCoinsTransactionsE400 {
	if o == nil {
		var ret NewUnconfirmedCoinsTransactionsE400
		return ret
	}
...
func (o NewUnconfirmedCoinsTransactions400Response) MarshalJSON() ([]byte, error) {
...
type NullableNewUnconfirmedCoinsTransactions400Response struct {
	value *NewUnconfirmedCoinsTransactions400Response
	isSet bool
}

func (v NullableNewUnconfirmedCoinsTransactions400Response) Get() *NewUnconfirmedCoinsTransactions400Response {
	return v.value
}

func (v *NullableNewUnconfirmedCoinsTransactions400Response) Set(val *NewUnconfirmedCoinsTransactions400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUnconfirmedCoinsTransactions400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUnconfirmedCoinsTransactions400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUnconfirmedCoinsTransactions400Response(val *NewUnconfirmedCoinsTransactions400Response) *NullableNewUnconfirmedCoinsTransactions400Response {
	return &NullableNewUnconfirmedCoinsTransactions400Response{value: val, isSet: true}
}

func (v NullableNewUnconfirmedCoinsTransactions400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUnconfirmedCoinsTransactions400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
