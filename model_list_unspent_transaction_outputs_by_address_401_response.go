...
type ListUnspentTransactionOutputsByAddress401Response struct {
	...
	Error ListUnspentTransactionOutputsByAddressE401 `json:"error"`
}
...
func (o *ListUnspentTransactionOutputsByAddress401Response) GetError() ListUnspentTransactionOutputsByAddressE401 {
	if o == nil {
		var ret ListUnspentTransactionOutputsByAddressE401
		return ret
	}
...
func (o ListUnspentTransactionOutputsByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListUnspentTransactionOutputsByAddress401Response struct {
	value *ListUnspentTransactionOutputsByAddress401Response
	isSet bool
}

func (v NullableListUnspentTransactionOutputsByAddress401Response) Get() *ListUnspentTransactionOutputsByAddress401Response {
	return v.value
}

func (v *NullableListUnspentTransactionOutputsByAddress401Response) Set(val *ListUnspentTransactionOutputsByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnspentTransactionOutputsByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnspentTransactionOutputsByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnspentTransactionOutputsByAddress401Response(val *ListUnspentTransactionOutputsByAddress401Response) *NullableListUnspentTransactionOutputsByAddress401Response {
	return &NullableListUnspentTransactionOutputsByAddress401Response{value: val, isSet: true}
}

func (v NullableListUnspentTransactionOutputsByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnspentTransactionOutputsByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
