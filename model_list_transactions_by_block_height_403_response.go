...
type ListTransactionsByBlockHeight403Response struct {
	...
	Error ListTransactionsByBlockHeightE403 `json:"error"`
}
...
func (o *ListTransactionsByBlockHeight403Response) GetError() ListTransactionsByBlockHeightE403 {
	if o == nil {
		var ret ListTransactionsByBlockHeightE403
		return ret
	}
...
func (o ListTransactionsByBlockHeight403Response) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeight403Response struct {
	value *ListTransactionsByBlockHeight403Response
	isSet bool
}

func (v NullableListTransactionsByBlockHeight403Response) Get() *ListTransactionsByBlockHeight403Response {
	return v.value
}

func (v *NullableListTransactionsByBlockHeight403Response) Set(val *ListTransactionsByBlockHeight403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeight403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeight403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeight403Response(val *ListTransactionsByBlockHeight403Response) *NullableListTransactionsByBlockHeight403Response {
	return &NullableListTransactionsByBlockHeight403Response{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeight403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeight403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
