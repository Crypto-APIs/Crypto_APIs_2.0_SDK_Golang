...
// ListReceivingAddressesRData struct for ListReceivingAddressesRData
type ListReceivingAddressesRData struct {
	...
	Items []ListReceivingAddressesRI `json:"items"`
}
...
func NewListReceivingAddressesRData(offset int32, limit int32, total int32, items []ListReceivingAddressesRI) *ListReceivingAddressesRData {
	this := ListReceivingAddressesRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListReceivingAddressesRData) GetItems() []ListReceivingAddressesRI {
	if o == nil {
		var ret []ListReceivingAddressesRI
		return ret
	}
...
func (o ListReceivingAddressesRData) MarshalJSON() ([]byte, error) {
...
type NullableListReceivingAddressesRData struct {
	value *ListReceivingAddressesRData
	isSet bool
}

func (v NullableListReceivingAddressesRData) Get() *ListReceivingAddressesRData {
	return v.value
}

func (v *NullableListReceivingAddressesRData) Set(val *ListReceivingAddressesRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListReceivingAddressesRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListReceivingAddressesRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListReceivingAddressesRData(val *ListReceivingAddressesRData) *NullableListReceivingAddressesRData {
	return &NullableListReceivingAddressesRData{value: val, isSet: true}
}

func (v NullableListReceivingAddressesRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListReceivingAddressesRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
