...
// ListCoinsForwardingAutomationsResponseData struct for ListCoinsForwardingAutomationsResponseData
type ListCoinsForwardingAutomationsResponseData struct {
	...
	Items []ListCoinsForwardingAutomationsResponseItem `json:"items"`
}
...
func NewListCoinsForwardingAutomationsResponseData(offset int32, limit int32, total int32, items []ListCoinsForwardingAutomationsResponseItem) *ListCoinsForwardingAutomationsResponseData {
	this := ListCoinsForwardingAutomationsResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListCoinsForwardingAutomationsResponseData) GetItems() []ListCoinsForwardingAutomationsResponseItem {
	if o == nil {
		var ret []ListCoinsForwardingAutomationsResponseItem
		return ret
	}
...
func (o ListCoinsForwardingAutomationsResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListCoinsForwardingAutomationsResponseData struct {
	value *ListCoinsForwardingAutomationsResponseData
	isSet bool
}

func (v NullableListCoinsForwardingAutomationsResponseData) Get() *ListCoinsForwardingAutomationsResponseData {
	return v.value
}

func (v *NullableListCoinsForwardingAutomationsResponseData) Set(val *ListCoinsForwardingAutomationsResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoinsForwardingAutomationsResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoinsForwardingAutomationsResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoinsForwardingAutomationsResponseData(val *ListCoinsForwardingAutomationsResponseData) *NullableListCoinsForwardingAutomationsResponseData {
	return &NullableListCoinsForwardingAutomationsResponseData{value: val, isSet: true}
}

func (v NullableListCoinsForwardingAutomationsResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoinsForwardingAutomationsResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
