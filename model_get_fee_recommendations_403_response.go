...
type GetFeeRecommendations403Response struct {
	...
	Error GetFeeRecommendationsE403 `json:"error"`
}
...
func NewGetFeeRecommendations403Response(apiVersion string, requestId string, error_ GetFeeRecommendationsE403) *GetFeeRecommendations403Response {
	this := GetFeeRecommendations403Response{}
...
func (o *GetFeeRecommendations403Response) GetError() GetFeeRecommendationsE403 {
	if o == nil {
		var ret GetFeeRecommendationsE403
		return ret
	}
...
func (o GetFeeRecommendations403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetFeeRecommendations403Response struct {
	value *GetFeeRecommendations403Response
	isSet bool
}

func (v NullableGetFeeRecommendations403Response) Get() *GetFeeRecommendations403Response {
	return v.value
}

func (v *NullableGetFeeRecommendations403Response) Set(val *GetFeeRecommendations403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeRecommendations403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeRecommendations403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeRecommendations403Response(val *GetFeeRecommendations403Response) *NullableGetFeeRecommendations403Response {
	return &NullableGetFeeRecommendations403Response{value: val, isSet: true}
}

func (v NullableGetFeeRecommendations403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeRecommendations403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
