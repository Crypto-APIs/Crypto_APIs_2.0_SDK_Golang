...
type GetTransactionDetailsByTransactionIDRIBSZVinInner struct {
...
func NewGetTransactionDetailsByTransactionIDRIBSZVinInner(addresses []string, scriptSig GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig, sequence int64, txid string, txinwitness []string, value string, vout int32) *GetTransactionDetailsByTransactionIDRIBSZVinInner {
	this := GetTransactionDetailsByTransactionIDRIBSZVinInner{}
...
func (o GetTransactionDetailsByTransactionIDRIBSZVinInner) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDRIBSZVinInner struct {
	value *GetTransactionDetailsByTransactionIDRIBSZVinInner
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZVinInner) Get() *GetTransactionDetailsByTransactionIDRIBSZVinInner {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZVinInner) Set(val *GetTransactionDetailsByTransactionIDRIBSZVinInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZVinInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZVinInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDRIBSZVinInner(val *GetTransactionDetailsByTransactionIDRIBSZVinInner) *NullableGetTransactionDetailsByTransactionIDRIBSZVinInner {
	return &NullableGetTransactionDetailsByTransactionIDRIBSZVinInner{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDRIBSZVinInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDRIBSZVinInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
