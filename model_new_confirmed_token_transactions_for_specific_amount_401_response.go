...
type NewConfirmedTokenTransactionsForSpecificAmount401Response struct {
	...
	Error NewConfirmedTokenTransactionsForSpecificAmountE401 `json:"error"`
}
...
func NewNewConfirmedTokenTransactionsForSpecificAmount401Response(apiVersion string, requestId string, error_ NewConfirmedTokenTransactionsForSpecificAmountE401) *NewConfirmedTokenTransactionsForSpecificAmount401Response {
	this := NewConfirmedTokenTransactionsForSpecificAmount401Response{}
...
func (o *NewConfirmedTokenTransactionsForSpecificAmount401Response) GetError() NewConfirmedTokenTransactionsForSpecificAmountE401 {
	if o == nil {
		var ret NewConfirmedTokenTransactionsForSpecificAmountE401
		return ret
	}
...
func (o NewConfirmedTokenTransactionsForSpecificAmount401Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokenTransactionsForSpecificAmount401Response struct {
	value *NewConfirmedTokenTransactionsForSpecificAmount401Response
	isSet bool
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount401Response) Get() *NewConfirmedTokenTransactionsForSpecificAmount401Response {
	return v.value
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount401Response) Set(val *NewConfirmedTokenTransactionsForSpecificAmount401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokenTransactionsForSpecificAmount401Response(val *NewConfirmedTokenTransactionsForSpecificAmount401Response) *NullableNewConfirmedTokenTransactionsForSpecificAmount401Response {
	return &NullableNewConfirmedTokenTransactionsForSpecificAmount401Response{value: val, isSet: true}
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmount401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmount401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
