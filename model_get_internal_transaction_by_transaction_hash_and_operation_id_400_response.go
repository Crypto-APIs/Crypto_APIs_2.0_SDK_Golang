...
type GetInternalTransactionByTransactionHashAndOperationId400Response struct {
	...
	Error GetInternalTransactionByTransactionHashAndOperationIdE400 `json:"error"`
}
...
func NewGetInternalTransactionByTransactionHashAndOperationId400Response(apiVersion string, requestId string, error_ GetInternalTransactionByTransactionHashAndOperationIdE400) *GetInternalTransactionByTransactionHashAndOperationId400Response {
	this := GetInternalTransactionByTransactionHashAndOperationId400Response{}
...
func (o GetInternalTransactionByTransactionHashAndOperationId400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetInternalTransactionByTransactionHashAndOperationId400Response struct {
	value *GetInternalTransactionByTransactionHashAndOperationId400Response
	isSet bool
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationId400Response) Get() *GetInternalTransactionByTransactionHashAndOperationId400Response {
	return v.value
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationId400Response) Set(val *GetInternalTransactionByTransactionHashAndOperationId400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationId400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationId400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInternalTransactionByTransactionHashAndOperationId400Response(val *GetInternalTransactionByTransactionHashAndOperationId400Response) *NullableGetInternalTransactionByTransactionHashAndOperationId400Response {
	return &NullableGetInternalTransactionByTransactionHashAndOperationId400Response{value: val, isSet: true}
}

func (v NullableGetInternalTransactionByTransactionHashAndOperationId400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInternalTransactionByTransactionHashAndOperationId400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
