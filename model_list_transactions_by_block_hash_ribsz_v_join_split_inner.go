...
type ListTransactionsByBlockHashRIBSZVJoinSplitInner struct {
...
func (o ListTransactionsByBlockHashRIBSZVJoinSplitInner) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSZVJoinSplitInner struct {
	value *ListTransactionsByBlockHashRIBSZVJoinSplitInner
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSZVJoinSplitInner) Get() *ListTransactionsByBlockHashRIBSZVJoinSplitInner {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSZVJoinSplitInner) Set(val *ListTransactionsByBlockHashRIBSZVJoinSplitInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSZVJoinSplitInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSZVJoinSplitInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSZVJoinSplitInner(val *ListTransactionsByBlockHashRIBSZVJoinSplitInner) *NullableListTransactionsByBlockHashRIBSZVJoinSplitInner {
	return &NullableListTransactionsByBlockHashRIBSZVJoinSplitInner{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSZVJoinSplitInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSZVJoinSplitInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
