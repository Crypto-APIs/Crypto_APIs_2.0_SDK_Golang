...
// DeleteAutomaticTokensForwardingResponseItem struct for DeleteAutomaticTokensForwardingResponseItem
type DeleteAutomaticTokensForwardingResponseItem struct {
	...
	TokenData DeleteAutomaticTokensForwardingResponseItemTokenData `json:"tokenData"`
}
...
func NewDeleteAutomaticTokensForwardingResponseItem(callbackUrl string, confirmationsCount int32, createdTimestamp int32, feeAddress string, feePriority string, fromAddress string, minimumTransferAmount string, referenceId string, toAddress string, tokenData DeleteAutomaticTokensForwardingResponseItemTokenData) *DeleteAutomaticTokensForwardingResponseItem {
	this := DeleteAutomaticTokensForwardingResponseItem{}
...
func (o *DeleteAutomaticTokensForwardingResponseItem) GetTokenData() DeleteAutomaticTokensForwardingResponseItemTokenData {
	if o == nil {
		var ret DeleteAutomaticTokensForwardingResponseItemTokenData
		return ret
	}
...
func (o DeleteAutomaticTokensForwardingResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticTokensForwardingResponseItem struct {
	value *DeleteAutomaticTokensForwardingResponseItem
	isSet bool
}

func (v NullableDeleteAutomaticTokensForwardingResponseItem) Get() *DeleteAutomaticTokensForwardingResponseItem {
	return v.value
}

func (v *NullableDeleteAutomaticTokensForwardingResponseItem) Set(val *DeleteAutomaticTokensForwardingResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticTokensForwardingResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticTokensForwardingResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticTokensForwardingResponseItem(val *DeleteAutomaticTokensForwardingResponseItem) *NullableDeleteAutomaticTokensForwardingResponseItem {
	return &NullableDeleteAutomaticTokensForwardingResponseItem{value: val, isSet: true}
}

func (v NullableDeleteAutomaticTokensForwardingResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticTokensForwardingResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
