...
func (a *ManageSubscriptionsApiService) ActivateBlockchainEventSubscriptionExecute(r ApiActivateBlockchainEventSubscriptionRequest) (*ActivateBlockchainEventSubscriptionR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ActivateBlockchainEventSubscription400Response
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v ActivateBlockchainEventSubscription401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v ActivateBlockchainEventSubscription403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *ManageSubscriptionsApiService) DeleteBlockchainEventSubscriptionExecute(r ApiDeleteBlockchainEventSubscriptionRequest) (*DeleteBlockchainEventSubscriptionR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v DeleteBlockchainEventSubscription400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v DeleteBlockchainEventSubscription401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v DeleteBlockchainEventSubscription403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *ManageSubscriptionsApiService) GetBlockchainEventSubscriptionDetailsByReferenceIDExecute(r ApiGetBlockchainEventSubscriptionDetailsByReferenceIDRequest) (*GetBlockchainEventSubscriptionDetailsByReferenceIDR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v GetBlockchainEventSubscriptionDetailsByReferenceID400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v GetBlockchainEventSubscriptionDetailsByReferenceID401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v GetBlockchainEventSubscriptionDetailsByReferenceID403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiListBlockchainEventsSubscriptionsRequest) Limit(limit int64) ApiListBlockchainEventsSubscriptionsRequest {
	r.limit = &limit
	return r
}

// The starting index of the response items, i.e. where the response should start listing the returned items.
func (r ApiListBlockchainEventsSubscriptionsRequest) Offset(offset int64) ApiListBlockchainEventsSubscriptionsRequest {
	r.offset = &offset
	return r
}
...
func (a *ManageSubscriptionsApiService) ListBlockchainEventsSubscriptionsExecute(r ApiListBlockchainEventsSubscriptionsRequest) (*ListBlockchainEventsSubscriptionsR, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ListBlockchainEventsSubscriptions400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v ListBlockchainEventsSubscriptions401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v ListBlockchainEventsSubscriptions403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
