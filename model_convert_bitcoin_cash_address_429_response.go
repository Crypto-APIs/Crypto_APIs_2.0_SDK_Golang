...
type ConvertBitcoinCashAddress429Response struct {
	...
	Error RequestLimitReached `json:"error"`
}
...
func NewConvertBitcoinCashAddress429Response(apiVersion string, requestId string, error_ RequestLimitReached) *ConvertBitcoinCashAddress429Response {
	this := ConvertBitcoinCashAddress429Response{}
...
func (o ConvertBitcoinCashAddress429Response) MarshalJSON() ([]byte, error) {
...
type NullableConvertBitcoinCashAddress429Response struct {
	value *ConvertBitcoinCashAddress429Response
	isSet bool
}

func (v NullableConvertBitcoinCashAddress429Response) Get() *ConvertBitcoinCashAddress429Response {
	return v.value
}

func (v *NullableConvertBitcoinCashAddress429Response) Set(val *ConvertBitcoinCashAddress429Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertBitcoinCashAddress429Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertBitcoinCashAddress429Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertBitcoinCashAddress429Response(val *ConvertBitcoinCashAddress429Response) *NullableConvertBitcoinCashAddress429Response {
	return &NullableConvertBitcoinCashAddress429Response{value: val, isSet: true}
}

func (v NullableConvertBitcoinCashAddress429Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertBitcoinCashAddress429Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
