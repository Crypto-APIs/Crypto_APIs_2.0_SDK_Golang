...
// TransactionRequestRejectDataItem struct for TransactionRequestRejectDataItem
type TransactionRequestRejectDataItem struct {
...
func NewTransactionRequestRejectDataItem(blockchain string, network string, requiredApproves int32, requiredRejects int32, currentApproves int32, currentRejects int32) *TransactionRequestRejectDataItem {
	this := TransactionRequestRejectDataItem{}
...
func (o TransactionRequestRejectDataItem) MarshalJSON() ([]byte, error) {
...
type NullableTransactionRequestRejectDataItem struct {
	value *TransactionRequestRejectDataItem
	isSet bool
}

func (v NullableTransactionRequestRejectDataItem) Get() *TransactionRequestRejectDataItem {
	return v.value
}

func (v *NullableTransactionRequestRejectDataItem) Set(val *TransactionRequestRejectDataItem) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRequestRejectDataItem) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRequestRejectDataItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRequestRejectDataItem(val *TransactionRequestRejectDataItem) *NullableTransactionRequestRejectDataItem {
	return &NullableTransactionRequestRejectDataItem{value: val, isSet: true}
}

func (v NullableTransactionRequestRejectDataItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRequestRejectDataItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
