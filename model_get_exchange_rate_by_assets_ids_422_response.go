...
type GetExchangeRateByAssetsIDs422Response struct {
	...
	Error GetExchangeRateByAssetsIDsE422 `json:"error"`
}
...
func NewGetExchangeRateByAssetsIDs422Response(apiVersion string, requestId string, error_ GetExchangeRateByAssetsIDsE422) *GetExchangeRateByAssetsIDs422Response {
	this := GetExchangeRateByAssetsIDs422Response{}
...
func (o *GetExchangeRateByAssetsIDs422Response) GetError() GetExchangeRateByAssetsIDsE422 {
	if o == nil {
		var ret GetExchangeRateByAssetsIDsE422
		return ret
	}
...
func (o GetExchangeRateByAssetsIDs422Response) MarshalJSON() ([]byte, error) {
...
type NullableGetExchangeRateByAssetsIDs422Response struct {
	value *GetExchangeRateByAssetsIDs422Response
	isSet bool
}

func (v NullableGetExchangeRateByAssetsIDs422Response) Get() *GetExchangeRateByAssetsIDs422Response {
	return v.value
}

func (v *NullableGetExchangeRateByAssetsIDs422Response) Set(val *GetExchangeRateByAssetsIDs422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExchangeRateByAssetsIDs422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExchangeRateByAssetsIDs422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExchangeRateByAssetsIDs422Response(val *GetExchangeRateByAssetsIDs422Response) *NullableGetExchangeRateByAssetsIDs422Response {
	return &NullableGetExchangeRateByAssetsIDs422Response{value: val, isSet: true}
}

func (v NullableGetExchangeRateByAssetsIDs422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExchangeRateByAssetsIDs422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
