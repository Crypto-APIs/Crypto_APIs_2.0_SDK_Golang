...
type AddressInternalTransactionConfirmedDataItemMinedInBlock struct {
...
func NewAddressInternalTransactionConfirmedDataItemMinedInBlock(height int32, hash string, timestamp int32) *AddressInternalTransactionConfirmedDataItemMinedInBlock {
	this := AddressInternalTransactionConfirmedDataItemMinedInBlock{}
	this.Height = height
	this.Hash = hash
...
func (o AddressInternalTransactionConfirmedDataItemMinedInBlock) MarshalJSON() ([]byte, error) {
...
type NullableAddressInternalTransactionConfirmedDataItemMinedInBlock struct {
	value *AddressInternalTransactionConfirmedDataItemMinedInBlock
	isSet bool
}

func (v NullableAddressInternalTransactionConfirmedDataItemMinedInBlock) Get() *AddressInternalTransactionConfirmedDataItemMinedInBlock {
	return v.value
}

func (v *NullableAddressInternalTransactionConfirmedDataItemMinedInBlock) Set(val *AddressInternalTransactionConfirmedDataItemMinedInBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressInternalTransactionConfirmedDataItemMinedInBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressInternalTransactionConfirmedDataItemMinedInBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressInternalTransactionConfirmedDataItemMinedInBlock(val *AddressInternalTransactionConfirmedDataItemMinedInBlock) *NullableAddressInternalTransactionConfirmedDataItemMinedInBlock {
	return &NullableAddressInternalTransactionConfirmedDataItemMinedInBlock{value: val, isSet: true}
}

func (v NullableAddressInternalTransactionConfirmedDataItemMinedInBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressInternalTransactionConfirmedDataItemMinedInBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
