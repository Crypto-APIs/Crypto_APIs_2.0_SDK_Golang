...
type CreateAutomaticCoinsForwarding409Response struct {
	...
	Error CreateAutomaticCoinsForwardingE409 `json:"error"`
}
...
func NewCreateAutomaticCoinsForwarding409Response(apiVersion string, requestId string, error_ CreateAutomaticCoinsForwardingE409) *CreateAutomaticCoinsForwarding409Response {
	this := CreateAutomaticCoinsForwarding409Response{}
...
func (o *CreateAutomaticCoinsForwarding409Response) GetError() CreateAutomaticCoinsForwardingE409 {
	if o == nil {
		var ret CreateAutomaticCoinsForwardingE409
		return ret
	}
...
func (o CreateAutomaticCoinsForwarding409Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticCoinsForwarding409Response struct {
	value *CreateAutomaticCoinsForwarding409Response
	isSet bool
}

func (v NullableCreateAutomaticCoinsForwarding409Response) Get() *CreateAutomaticCoinsForwarding409Response {
	return v.value
}

func (v *NullableCreateAutomaticCoinsForwarding409Response) Set(val *CreateAutomaticCoinsForwarding409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticCoinsForwarding409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticCoinsForwarding409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticCoinsForwarding409Response(val *CreateAutomaticCoinsForwarding409Response) *NullableCreateAutomaticCoinsForwarding409Response {
	return &NullableCreateAutomaticCoinsForwarding409Response{value: val, isSet: true}
}

func (v NullableCreateAutomaticCoinsForwarding409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticCoinsForwarding409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
