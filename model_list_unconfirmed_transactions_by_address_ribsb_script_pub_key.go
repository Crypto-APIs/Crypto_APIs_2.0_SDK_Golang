...
type ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey struct {
...
func NewListUnconfirmedTransactionsByAddressRIBSBScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey {
	this := ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey{}
...
func (o ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey struct {
	value *ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) Get() *ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) Set(val *ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey(val *ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) *NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey {
	return &NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
