...
// TransactionRequestApproveDataItem struct for TransactionRequestApproveDataItem
type TransactionRequestApproveDataItem struct {
...
func NewTransactionRequestApproveDataItem(blockchain string, network string, requiredApproves int32, requiredRejects int32, currentApproves int32, currentRejects int32) *TransactionRequestApproveDataItem {
	this := TransactionRequestApproveDataItem{}
...
func (o TransactionRequestApproveDataItem) MarshalJSON() ([]byte, error) {
...
type NullableTransactionRequestApproveDataItem struct {
	value *TransactionRequestApproveDataItem
	isSet bool
}

func (v NullableTransactionRequestApproveDataItem) Get() *TransactionRequestApproveDataItem {
	return v.value
}

func (v *NullableTransactionRequestApproveDataItem) Set(val *TransactionRequestApproveDataItem) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRequestApproveDataItem) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRequestApproveDataItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRequestApproveDataItem(val *TransactionRequestApproveDataItem) *NullableTransactionRequestApproveDataItem {
	return &NullableTransactionRequestApproveDataItem{value: val, isSet: true}
}

func (v NullableTransactionRequestApproveDataItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRequestApproveDataItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
