...
type ListInternalTransactionsByAddress401Response struct {
	...
	Error ListInternalTransactionsByAddressE401 `json:"error"`
}
...
func NewListInternalTransactionsByAddress401Response(apiVersion string, requestId string, error_ ListInternalTransactionsByAddressE401) *ListInternalTransactionsByAddress401Response {
	this := ListInternalTransactionsByAddress401Response{}
...
func (o *ListInternalTransactionsByAddress401Response) GetError() ListInternalTransactionsByAddressE401 {
	if o == nil {
		var ret ListInternalTransactionsByAddressE401
		return ret
	}
...
func (o ListInternalTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionsByAddress401Response struct {
	value *ListInternalTransactionsByAddress401Response
	isSet bool
}

func (v NullableListInternalTransactionsByAddress401Response) Get() *ListInternalTransactionsByAddress401Response {
	return v.value
}

func (v *NullableListInternalTransactionsByAddress401Response) Set(val *ListInternalTransactionsByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddress401Response(val *ListInternalTransactionsByAddress401Response) *NullableListInternalTransactionsByAddress401Response {
	return &NullableListInternalTransactionsByAddress401Response{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
