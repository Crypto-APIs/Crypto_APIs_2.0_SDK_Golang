...
type DeleteBlockchainEventSubscription401Response struct {
	...
	Error DeleteBlockchainEventSubscriptionE401 `json:"error"`
}
...
func NewDeleteBlockchainEventSubscription401Response(apiVersion string, requestId string, error_ DeleteBlockchainEventSubscriptionE401) *DeleteBlockchainEventSubscription401Response {
	this := DeleteBlockchainEventSubscription401Response{}
...
func (o *DeleteBlockchainEventSubscription401Response) GetError() DeleteBlockchainEventSubscriptionE401 {
	if o == nil {
		var ret DeleteBlockchainEventSubscriptionE401
		return ret
	}
...
func (o DeleteBlockchainEventSubscription401Response) MarshalJSON() ([]byte, error) {
...
type NullableDeleteBlockchainEventSubscription401Response struct {
	value *DeleteBlockchainEventSubscription401Response
	isSet bool
}

func (v NullableDeleteBlockchainEventSubscription401Response) Get() *DeleteBlockchainEventSubscription401Response {
	return v.value
}

func (v *NullableDeleteBlockchainEventSubscription401Response) Set(val *DeleteBlockchainEventSubscription401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBlockchainEventSubscription401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBlockchainEventSubscription401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBlockchainEventSubscription401Response(val *DeleteBlockchainEventSubscription401Response) *NullableDeleteBlockchainEventSubscription401Response {
	return &NullableDeleteBlockchainEventSubscription401Response{value: val, isSet: true}
}

func (v NullableDeleteBlockchainEventSubscription401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBlockchainEventSubscription401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
