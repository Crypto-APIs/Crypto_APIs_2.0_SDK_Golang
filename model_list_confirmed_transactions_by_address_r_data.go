...
type ListConfirmedTransactionsByAddressRData struct {
	...
	Items []ListConfirmedTransactionsByAddressRI `json:"items"`
}
...
func NewListConfirmedTransactionsByAddressRData(offset int32, limit int32, total int32, items []ListConfirmedTransactionsByAddressRI) *ListConfirmedTransactionsByAddressRData {
	this := ListConfirmedTransactionsByAddressRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListConfirmedTransactionsByAddressRData) GetItems() []ListConfirmedTransactionsByAddressRI {
	if o == nil {
		var ret []ListConfirmedTransactionsByAddressRI
		return ret
	}
...
func (o ListConfirmedTransactionsByAddressRData) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressRData struct {
	value *ListConfirmedTransactionsByAddressRData
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressRData) Get() *ListConfirmedTransactionsByAddressRData {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressRData) Set(val *ListConfirmedTransactionsByAddressRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressRData(val *ListConfirmedTransactionsByAddressRData) *NullableListConfirmedTransactionsByAddressRData {
	return &NullableListConfirmedTransactionsByAddressRData{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
