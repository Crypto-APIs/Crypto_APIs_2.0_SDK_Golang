...
// ListBlockchainEventsSubscriptionsResponseData struct for ListBlockchainEventsSubscriptionsResponseData
type ListBlockchainEventsSubscriptionsResponseData struct {
	...
	Items []ListBlockchainEventsSubscriptionsResponseItem `json:"items"`
}
...
func NewListBlockchainEventsSubscriptionsResponseData(offset int32, limit int32, total int32, items []ListBlockchainEventsSubscriptionsResponseItem) *ListBlockchainEventsSubscriptionsResponseData {
	this := ListBlockchainEventsSubscriptionsResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListBlockchainEventsSubscriptionsResponseData) GetItems() []ListBlockchainEventsSubscriptionsResponseItem {
	if o == nil {
		var ret []ListBlockchainEventsSubscriptionsResponseItem
		return ret
	}
...
func (o ListBlockchainEventsSubscriptionsResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListBlockchainEventsSubscriptionsResponseData struct {
	value *ListBlockchainEventsSubscriptionsResponseData
	isSet bool
}

func (v NullableListBlockchainEventsSubscriptionsResponseData) Get() *ListBlockchainEventsSubscriptionsResponseData {
	return v.value
}

func (v *NullableListBlockchainEventsSubscriptionsResponseData) Set(val *ListBlockchainEventsSubscriptionsResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListBlockchainEventsSubscriptionsResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListBlockchainEventsSubscriptionsResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListBlockchainEventsSubscriptionsResponseData(val *ListBlockchainEventsSubscriptionsResponseData) *NullableListBlockchainEventsSubscriptionsResponseData {
	return &NullableListBlockchainEventsSubscriptionsResponseData{value: val, isSet: true}
}

func (v NullableListBlockchainEventsSubscriptionsResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListBlockchainEventsSubscriptionsResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
