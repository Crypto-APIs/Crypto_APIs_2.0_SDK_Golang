...
// ListSupportedAssetsResponse struct for ListSupportedAssetsResponse
type ListSupportedAssetsResponse struct {
	...
	Data ListSupportedAssetsResponseData `json:"data"`
}
...
func NewListSupportedAssetsResponse(apiVersion string, requestId string, data ListSupportedAssetsResponseData) *ListSupportedAssetsResponse {
	this := ListSupportedAssetsResponse{}
...
func (o *ListSupportedAssetsResponse) GetData() ListSupportedAssetsResponseData {
	if o == nil {
		var ret ListSupportedAssetsResponseData
		return ret
	}
...
func (o ListSupportedAssetsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedAssetsResponse struct {
	value *ListSupportedAssetsResponse
	isSet bool
}

func (v NullableListSupportedAssetsResponse) Get() *ListSupportedAssetsResponse {
	return v.value
}

func (v *NullableListSupportedAssetsResponse) Set(val *ListSupportedAssetsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedAssetsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedAssetsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedAssetsResponse(val *ListSupportedAssetsResponse) *NullableListSupportedAssetsResponse {
	return &NullableListSupportedAssetsResponse{value: val, isSet: true}
}

func (v NullableListSupportedAssetsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedAssetsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
