...
// ListTokensByAddressResponse struct for ListTokensByAddressResponse
type ListTokensByAddressResponse struct {
	...
	Data ListTokensByAddressResponseData `json:"data"`
}
...
func NewListTokensByAddressResponse(apiVersion string, requestId string, data ListTokensByAddressResponseData) *ListTokensByAddressResponse {
	this := ListTokensByAddressResponse{}
...
func (o *ListTokensByAddressResponse) GetData() ListTokensByAddressResponseData {
	if o == nil {
		var ret ListTokensByAddressResponseData
		return ret
	}
...
func (o ListTokensByAddressResponse) MarshalJSON() ([]byte, error) {
...
type NullableListTokensByAddressResponse struct {
	value *ListTokensByAddressResponse
	isSet bool
}

func (v NullableListTokensByAddressResponse) Get() *ListTokensByAddressResponse {
	return v.value
}

func (v *NullableListTokensByAddressResponse) Set(val *ListTokensByAddressResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensByAddressResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensByAddressResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensByAddressResponse(val *ListTokensByAddressResponse) *NullableListTokensByAddressResponse {
	return &NullableListTokensByAddressResponse{value: val, isSet: true}
}

func (v NullableListTokensByAddressResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensByAddressResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
