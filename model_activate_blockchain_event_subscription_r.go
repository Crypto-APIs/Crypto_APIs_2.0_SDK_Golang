...
type ActivateBlockchainEventSubscriptionR struct {
	...
	Data ActivateBlockchainEventSubscriptionRData `json:"data"`
}
...
func NewActivateBlockchainEventSubscriptionR(apiVersion string, requestId string, data ActivateBlockchainEventSubscriptionRData) *ActivateBlockchainEventSubscriptionR {
	this := ActivateBlockchainEventSubscriptionR{}
...
func (o *ActivateBlockchainEventSubscriptionR) GetData() ActivateBlockchainEventSubscriptionRData {
	if o == nil {
		var ret ActivateBlockchainEventSubscriptionRData
		return ret
	}
...
func (o ActivateBlockchainEventSubscriptionR) MarshalJSON() ([]byte, error) {
...
type NullableActivateBlockchainEventSubscriptionR struct {
	value *ActivateBlockchainEventSubscriptionR
	isSet bool
}

func (v NullableActivateBlockchainEventSubscriptionR) Get() *ActivateBlockchainEventSubscriptionR {
	return v.value
}

func (v *NullableActivateBlockchainEventSubscriptionR) Set(val *ActivateBlockchainEventSubscriptionR) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateBlockchainEventSubscriptionR) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateBlockchainEventSubscriptionR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateBlockchainEventSubscriptionR(val *ActivateBlockchainEventSubscriptionR) *NullableActivateBlockchainEventSubscriptionR {
	return &NullableActivateBlockchainEventSubscriptionR{value: val, isSet: true}
}

func (v NullableActivateBlockchainEventSubscriptionR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateBlockchainEventSubscriptionR) UnmarshalJSON(src []byte) error {
	v.isSet = true
