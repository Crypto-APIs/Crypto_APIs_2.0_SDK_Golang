...
// UriNotFound struct for UriNotFound
type UriNotFound struct {
	...
	Error UriNotFoundError `json:"error"`
}
...
func (o UriNotFound) MarshalJSON() ([]byte, error) {
...
type NullableUriNotFound struct {
	value *UriNotFound
	isSet bool
}

func (v NullableUriNotFound) Get() *UriNotFound {
	return v.value
}

func (v *NullableUriNotFound) Set(val *UriNotFound) {
	v.value = val
	v.isSet = true
}

func (v NullableUriNotFound) IsSet() bool {
	return v.isSet
}

func (v *NullableUriNotFound) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUriNotFound(val *UriNotFound) *NullableUriNotFound {
	return &NullableUriNotFound{value: val, isSet: true}
}

func (v NullableUriNotFound) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUriNotFound) UnmarshalJSON(src []byte) error {
	v.isSet = true
