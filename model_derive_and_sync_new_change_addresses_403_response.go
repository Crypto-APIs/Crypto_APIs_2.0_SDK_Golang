...
type DeriveAndSyncNewChangeAddresses403Response struct {
	...
	Error DeriveAndSyncNewChangeAddressesE403 `json:"error"`
}
...
func NewDeriveAndSyncNewChangeAddresses403Response(apiVersion string, requestId string, error_ DeriveAndSyncNewChangeAddressesE403) *DeriveAndSyncNewChangeAddresses403Response {
	this := DeriveAndSyncNewChangeAddresses403Response{}
...
func (o *DeriveAndSyncNewChangeAddresses403Response) GetError() DeriveAndSyncNewChangeAddressesE403 {
	if o == nil {
		var ret DeriveAndSyncNewChangeAddressesE403
		return ret
	}
...
func (o DeriveAndSyncNewChangeAddresses403Response) MarshalJSON() ([]byte, error) {
...
type NullableDeriveAndSyncNewChangeAddresses403Response struct {
	value *DeriveAndSyncNewChangeAddresses403Response
	isSet bool
}

func (v NullableDeriveAndSyncNewChangeAddresses403Response) Get() *DeriveAndSyncNewChangeAddresses403Response {
	return v.value
}

func (v *NullableDeriveAndSyncNewChangeAddresses403Response) Set(val *DeriveAndSyncNewChangeAddresses403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveAndSyncNewChangeAddresses403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveAndSyncNewChangeAddresses403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveAndSyncNewChangeAddresses403Response(val *DeriveAndSyncNewChangeAddresses403Response) *NullableDeriveAndSyncNewChangeAddresses403Response {
	return &NullableDeriveAndSyncNewChangeAddresses403Response{value: val, isSet: true}
}

func (v NullableDeriveAndSyncNewChangeAddresses403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveAndSyncNewChangeAddresses403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
