...
// DeleteAutomaticTokensForwardingResponse struct for DeleteAutomaticTokensForwardingResponse
type DeleteAutomaticTokensForwardingResponse struct {
	...
	Data DeleteAutomaticTokensForwardingResponseData `json:"data"`
}
...
func NewDeleteAutomaticTokensForwardingResponse(apiVersion string, requestId string, data DeleteAutomaticTokensForwardingResponseData) *DeleteAutomaticTokensForwardingResponse {
	this := DeleteAutomaticTokensForwardingResponse{}
...
func (o *DeleteAutomaticTokensForwardingResponse) GetData() DeleteAutomaticTokensForwardingResponseData {
	if o == nil {
		var ret DeleteAutomaticTokensForwardingResponseData
		return ret
	}
...
func (o DeleteAutomaticTokensForwardingResponse) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticTokensForwardingResponse struct {
	value *DeleteAutomaticTokensForwardingResponse
	isSet bool
}

func (v NullableDeleteAutomaticTokensForwardingResponse) Get() *DeleteAutomaticTokensForwardingResponse {
	return v.value
}

func (v *NullableDeleteAutomaticTokensForwardingResponse) Set(val *DeleteAutomaticTokensForwardingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticTokensForwardingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticTokensForwardingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticTokensForwardingResponse(val *DeleteAutomaticTokensForwardingResponse) *NullableDeleteAutomaticTokensForwardingResponse {
	return &NullableDeleteAutomaticTokensForwardingResponse{value: val, isSet: true}
}

func (v NullableDeleteAutomaticTokensForwardingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticTokensForwardingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
