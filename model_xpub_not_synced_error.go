...
// XpubNotSyncedError struct for XpubNotSyncedError
type XpubNotSyncedError struct {
...
func (o XpubNotSyncedError) MarshalJSON() ([]byte, error) {
...
type NullableXpubNotSyncedError struct {
	value *XpubNotSyncedError
	isSet bool
}

func (v NullableXpubNotSyncedError) Get() *XpubNotSyncedError {
	return v.value
}

func (v *NullableXpubNotSyncedError) Set(val *XpubNotSyncedError) {
	v.value = val
	v.isSet = true
}

func (v NullableXpubNotSyncedError) IsSet() bool {
	return v.isSet
}

func (v *NullableXpubNotSyncedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXpubNotSyncedError(val *XpubNotSyncedError) *NullableXpubNotSyncedError {
	return &NullableXpubNotSyncedError{value: val, isSet: true}
}

func (v NullableXpubNotSyncedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXpubNotSyncedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
