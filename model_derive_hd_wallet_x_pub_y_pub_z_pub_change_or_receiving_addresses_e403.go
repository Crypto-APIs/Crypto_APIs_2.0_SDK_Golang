...
type DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 struct {
...
func BannedIpAddressAsDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(v *BannedIpAddress) DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
...
func EndpointNotAllowedForApiKeyAsDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(v *EndpointNotAllowedForApiKey) DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
	return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403{
...
func EndpointNotAllowedForPlanAsDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(v *EndpointNotAllowedForPlan) DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
	return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403{
...
func FeatureMainnetsNotAllowedForPlanAsDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(v *FeatureMainnetsNotAllowedForPlan) DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
	return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403{
...
func (dst *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) MarshalJSON() ([]byte, error) {
...
func (obj *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 struct {
	value *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403
	isSet bool
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) Get() *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
	return v.value
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) Set(val *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) {
	v.value = val
	v.isSet = true
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) IsSet() bool {
	return v.isSet
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403(val *DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
	return &NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403{value: val, isSet: true}
}

func (v NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
