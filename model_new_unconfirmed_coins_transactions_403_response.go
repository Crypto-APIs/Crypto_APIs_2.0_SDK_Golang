...
type NewUnconfirmedCoinsTransactions403Response struct {
	...
	Error NewUnconfirmedCoinsTransactionsE403 `json:"error"`
}
...
func NewNewUnconfirmedCoinsTransactions403Response(apiVersion string, requestId string, error_ NewUnconfirmedCoinsTransactionsE403) *NewUnconfirmedCoinsTransactions403Response {
	this := NewUnconfirmedCoinsTransactions403Response{}
...
func (o *NewUnconfirmedCoinsTransactions403Response) GetError() NewUnconfirmedCoinsTransactionsE403 {
	if o == nil {
		var ret NewUnconfirmedCoinsTransactionsE403
		return ret
	}
...
func (o NewUnconfirmedCoinsTransactions403Response) MarshalJSON() ([]byte, error) {
...
type NullableNewUnconfirmedCoinsTransactions403Response struct {
	value *NewUnconfirmedCoinsTransactions403Response
	isSet bool
}

func (v NullableNewUnconfirmedCoinsTransactions403Response) Get() *NewUnconfirmedCoinsTransactions403Response {
	return v.value
}

func (v *NullableNewUnconfirmedCoinsTransactions403Response) Set(val *NewUnconfirmedCoinsTransactions403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUnconfirmedCoinsTransactions403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUnconfirmedCoinsTransactions403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUnconfirmedCoinsTransactions403Response(val *NewUnconfirmedCoinsTransactions403Response) *NullableNewUnconfirmedCoinsTransactions403Response {
	return &NullableNewUnconfirmedCoinsTransactions403Response{value: val, isSet: true}
}

func (v NullableNewUnconfirmedCoinsTransactions403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUnconfirmedCoinsTransactions403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
