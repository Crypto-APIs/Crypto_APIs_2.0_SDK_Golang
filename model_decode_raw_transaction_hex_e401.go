...
type DecodeRawTransactionHexE401 struct {
...
func (dst *DecodeRawTransactionHexE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(DecodeRawTransactionHexE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(DecodeRawTransactionHexE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DecodeRawTransactionHexE401) MarshalJSON() ([]byte, error) {
...
func (obj *DecodeRawTransactionHexE401) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableDecodeRawTransactionHexE401 struct {
	value *DecodeRawTransactionHexE401
	isSet bool
}

func (v NullableDecodeRawTransactionHexE401) Get() *DecodeRawTransactionHexE401 {
	return v.value
}

func (v *NullableDecodeRawTransactionHexE401) Set(val *DecodeRawTransactionHexE401) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexE401) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexE401(val *DecodeRawTransactionHexE401) *NullableDecodeRawTransactionHexE401 {
	return &NullableDecodeRawTransactionHexE401{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
