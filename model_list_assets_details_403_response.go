...
// ListAssetsDetails403Response struct for ListAssetsDetails403Response
type ListAssetsDetails403Response struct {
	...
	Error ListAssetsDetailsE403 `json:"error"`
}
...
func NewListAssetsDetails403Response(apiVersion string, requestId string, error_ ListAssetsDetailsE403) *ListAssetsDetails403Response {
	this := ListAssetsDetails403Response{}
...
func (o ListAssetsDetails403Response) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetails403Response struct {
	value *ListAssetsDetails403Response
	isSet bool
}

func (v NullableListAssetsDetails403Response) Get() *ListAssetsDetails403Response {
	return v.value
}

func (v *NullableListAssetsDetails403Response) Set(val *ListAssetsDetails403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetails403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetails403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetails403Response(val *ListAssetsDetails403Response) *NullableListAssetsDetails403Response {
	return &NullableListAssetsDetails403Response{value: val, isSet: true}
}

func (v NullableListAssetsDetails403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetails403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
