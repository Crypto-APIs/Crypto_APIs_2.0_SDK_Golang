...
// ListOmniTransactionsByBlockHeightE401 - struct for ListOmniTransactionsByBlockHeightE401
type ListOmniTransactionsByBlockHeightE401 struct {
...
func (dst *ListOmniTransactionsByBlockHeightE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListOmniTransactionsByBlockHeightE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListOmniTransactionsByBlockHeightE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListOmniTransactionsByBlockHeightE401) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHeightE401 struct {
	value *ListOmniTransactionsByBlockHeightE401
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHeightE401) Get() *ListOmniTransactionsByBlockHeightE401 {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHeightE401) Set(val *ListOmniTransactionsByBlockHeightE401) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHeightE401) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHeightE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHeightE401(val *ListOmniTransactionsByBlockHeightE401) *NullableListOmniTransactionsByBlockHeightE401 {
	return &NullableListOmniTransactionsByBlockHeightE401{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHeightE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHeightE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
