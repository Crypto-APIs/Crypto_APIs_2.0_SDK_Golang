...
type ListTransactionsByAddressRIBSD2ScriptSig struct {
...
func NewListTransactionsByAddressRIBSD2ScriptSig(asm string, hex string, type_ string) *ListTransactionsByAddressRIBSD2ScriptSig {
	this := ListTransactionsByAddressRIBSD2ScriptSig{}
	this.Asm = asm
	this.Hex = hex
	this.Type = type_
	return &this
...
func (o ListTransactionsByAddressRIBSD2ScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSD2ScriptSig struct {
	value *ListTransactionsByAddressRIBSD2ScriptSig
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSD2ScriptSig) Get() *ListTransactionsByAddressRIBSD2ScriptSig {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSD2ScriptSig) Set(val *ListTransactionsByAddressRIBSD2ScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSD2ScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSD2ScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSD2ScriptSig(val *ListTransactionsByAddressRIBSD2ScriptSig) *NullableListTransactionsByAddressRIBSD2ScriptSig {
	return &NullableListTransactionsByAddressRIBSD2ScriptSig{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSD2ScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSD2ScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
