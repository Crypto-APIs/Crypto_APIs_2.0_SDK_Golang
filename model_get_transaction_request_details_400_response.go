...
type GetTransactionRequestDetails400Response struct {
	...
	Error GetTransactionRequestDetailsE400 `json:"error"`
}
...
func NewGetTransactionRequestDetails400Response(apiVersion string, requestId string, error_ GetTransactionRequestDetailsE400) *GetTransactionRequestDetails400Response {
	this := GetTransactionRequestDetails400Response{}
...
func (o *GetTransactionRequestDetails400Response) GetError() GetTransactionRequestDetailsE400 {
	if o == nil {
		var ret GetTransactionRequestDetailsE400
		return ret
	}
...
func (o GetTransactionRequestDetails400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionRequestDetails400Response struct {
	value *GetTransactionRequestDetails400Response
	isSet bool
}

func (v NullableGetTransactionRequestDetails400Response) Get() *GetTransactionRequestDetails400Response {
	return v.value
}

func (v *NullableGetTransactionRequestDetails400Response) Set(val *GetTransactionRequestDetails400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionRequestDetails400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionRequestDetails400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionRequestDetails400Response(val *GetTransactionRequestDetails400Response) *NullableGetTransactionRequestDetails400Response {
	return &NullableGetTransactionRequestDetails400Response{value: val, isSet: true}
}

func (v NullableGetTransactionRequestDetails400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionRequestDetails400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
