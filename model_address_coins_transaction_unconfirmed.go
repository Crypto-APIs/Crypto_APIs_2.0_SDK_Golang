...
type AddressCoinsTransactionUnconfirmed struct {
	...
	Data AddressCoinsTransactionUnconfirmedData `json:"data"`
}
...
func NewAddressCoinsTransactionUnconfirmed(apiVersion string, referenceId string, idempotencyKey string, data AddressCoinsTransactionUnconfirmedData) *AddressCoinsTransactionUnconfirmed {
	this := AddressCoinsTransactionUnconfirmed{}
...
func (o *AddressCoinsTransactionUnconfirmed) GetData() AddressCoinsTransactionUnconfirmedData {
	if o == nil {
		var ret AddressCoinsTransactionUnconfirmedData
		return ret
	}
...
func (o AddressCoinsTransactionUnconfirmed) MarshalJSON() ([]byte, error) {
...
type NullableAddressCoinsTransactionUnconfirmed struct {
	value *AddressCoinsTransactionUnconfirmed
	isSet bool
}

func (v NullableAddressCoinsTransactionUnconfirmed) Get() *AddressCoinsTransactionUnconfirmed {
	return v.value
}

func (v *NullableAddressCoinsTransactionUnconfirmed) Set(val *AddressCoinsTransactionUnconfirmed) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressCoinsTransactionUnconfirmed) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressCoinsTransactionUnconfirmed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressCoinsTransactionUnconfirmed(val *AddressCoinsTransactionUnconfirmed) *NullableAddressCoinsTransactionUnconfirmed {
	return &NullableAddressCoinsTransactionUnconfirmed{value: val, isSet: true}
}

func (v NullableAddressCoinsTransactionUnconfirmed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressCoinsTransactionUnconfirmed) UnmarshalJSON(src []byte) error {
	v.isSet = true
