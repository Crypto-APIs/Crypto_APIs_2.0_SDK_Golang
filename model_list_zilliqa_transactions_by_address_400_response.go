...
type ListZilliqaTransactionsByAddress400Response struct {
	...
	Error ListZilliqaTransactionsByAddressE400 `json:"error"`
}
...
func NewListZilliqaTransactionsByAddress400Response(apiVersion string, requestId string, error_ ListZilliqaTransactionsByAddressE400) *ListZilliqaTransactionsByAddress400Response {
	this := ListZilliqaTransactionsByAddress400Response{}
...
func (o *ListZilliqaTransactionsByAddress400Response) GetError() ListZilliqaTransactionsByAddressE400 {
	if o == nil {
		var ret ListZilliqaTransactionsByAddressE400
		return ret
	}
...
func (o ListZilliqaTransactionsByAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByAddress400Response struct {
	value *ListZilliqaTransactionsByAddress400Response
	isSet bool
}

func (v NullableListZilliqaTransactionsByAddress400Response) Get() *ListZilliqaTransactionsByAddress400Response {
	return v.value
}

func (v *NullableListZilliqaTransactionsByAddress400Response) Set(val *ListZilliqaTransactionsByAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByAddress400Response(val *ListZilliqaTransactionsByAddress400Response) *NullableListZilliqaTransactionsByAddress400Response {
	return &NullableListZilliqaTransactionsByAddress400Response{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
