...
type GetAssetDetailsByAssetSymbolE403 struct {
...
func (dst *GetAssetDetailsByAssetSymbolE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetAssetDetailsByAssetSymbolE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetAssetDetailsByAssetSymbolE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetAssetDetailsByAssetSymbolE403) MarshalJSON() ([]byte, error) {
...
type NullableGetAssetDetailsByAssetSymbolE403 struct {
	value *GetAssetDetailsByAssetSymbolE403
	isSet bool
}

func (v NullableGetAssetDetailsByAssetSymbolE403) Get() *GetAssetDetailsByAssetSymbolE403 {
	return v.value
}

func (v *NullableGetAssetDetailsByAssetSymbolE403) Set(val *GetAssetDetailsByAssetSymbolE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetDetailsByAssetSymbolE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetDetailsByAssetSymbolE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetDetailsByAssetSymbolE403(val *GetAssetDetailsByAssetSymbolE403) *NullableGetAssetDetailsByAssetSymbolE403 {
	return &NullableGetAssetDetailsByAssetSymbolE403{value: val, isSet: true}
}

func (v NullableGetAssetDetailsByAssetSymbolE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetDetailsByAssetSymbolE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
