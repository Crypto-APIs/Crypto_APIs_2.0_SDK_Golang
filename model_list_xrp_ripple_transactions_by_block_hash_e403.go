...
type ListXRPRippleTransactionsByBlockHashE403 struct {
...
func BannedIpAddressAsListXRPRippleTransactionsByBlockHashE403(v *BannedIpAddress) ListXRPRippleTransactionsByBlockHashE403 {
	return ListXRPRippleTransactionsByBlockHashE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsListXRPRippleTransactionsByBlockHashE403(v *EndpointNotAllowedForApiKey) ListXRPRippleTransactionsByBlockHashE403 {
	return ListXRPRippleTransactionsByBlockHashE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsListXRPRippleTransactionsByBlockHashE403(v *EndpointNotAllowedForPlan) ListXRPRippleTransactionsByBlockHashE403 {
	return ListXRPRippleTransactionsByBlockHashE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsListXRPRippleTransactionsByBlockHashE403(v *FeatureMainnetsNotAllowedForPlan) ListXRPRippleTransactionsByBlockHashE403 {
	return ListXRPRippleTransactionsByBlockHashE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ListXRPRippleTransactionsByBlockHashE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListXRPRippleTransactionsByBlockHashE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListXRPRippleTransactionsByBlockHashE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListXRPRippleTransactionsByBlockHashE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListXRPRippleTransactionsByBlockHashE403) GetActualInstance() (interface{}) {
...
type NullableListXRPRippleTransactionsByBlockHashE403 struct {
	value *ListXRPRippleTransactionsByBlockHashE403
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHashE403) Get() *ListXRPRippleTransactionsByBlockHashE403 {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHashE403) Set(val *ListXRPRippleTransactionsByBlockHashE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHashE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHashE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHashE403(val *ListXRPRippleTransactionsByBlockHashE403) *NullableListXRPRippleTransactionsByBlockHashE403 {
	return &NullableListXRPRippleTransactionsByBlockHashE403{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHashE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHashE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
