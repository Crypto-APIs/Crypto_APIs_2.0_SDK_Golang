...
type DeleteAutomaticTokensForwardingRI struct {
	...
	TokenData DeleteAutomaticTokensForwardingRITS `json:"tokenData"`
}
...
func NewDeleteAutomaticTokensForwardingRI(callbackUrl string, confirmationsCount int32, createdTimestamp int32, feeAddress string, feePriority string, fromAddress string, minimumTransferAmount string, referenceId string, toAddress string, tokenData DeleteAutomaticTokensForwardingRITS) *DeleteAutomaticTokensForwardingRI {
	this := DeleteAutomaticTokensForwardingRI{}
...
func (o *DeleteAutomaticTokensForwardingRI) GetTokenData() DeleteAutomaticTokensForwardingRITS {
	if o == nil {
		var ret DeleteAutomaticTokensForwardingRITS
		return ret
	}
...
func (o DeleteAutomaticTokensForwardingRI) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticTokensForwardingRI struct {
	value *DeleteAutomaticTokensForwardingRI
	isSet bool
}

func (v NullableDeleteAutomaticTokensForwardingRI) Get() *DeleteAutomaticTokensForwardingRI {
	return v.value
}

func (v *NullableDeleteAutomaticTokensForwardingRI) Set(val *DeleteAutomaticTokensForwardingRI) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticTokensForwardingRI) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticTokensForwardingRI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticTokensForwardingRI(val *DeleteAutomaticTokensForwardingRI) *NullableDeleteAutomaticTokensForwardingRI {
	return &NullableDeleteAutomaticTokensForwardingRI{value: val, isSet: true}
}

func (v NullableDeleteAutomaticTokensForwardingRI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticTokensForwardingRI) UnmarshalJSON(src []byte) error {
	v.isSet = true
