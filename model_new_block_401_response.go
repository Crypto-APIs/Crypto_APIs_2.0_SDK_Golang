...
type NewBlock401Response struct {
...
func (o NewBlock401Response) MarshalJSON() ([]byte, error) {
...
type NullableNewBlock401Response struct {
	value *NewBlock401Response
	isSet bool
}

func (v NullableNewBlock401Response) Get() *NewBlock401Response {
	return v.value
}

func (v *NullableNewBlock401Response) Set(val *NewBlock401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewBlock401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewBlock401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewBlock401Response(val *NewBlock401Response) *NullableNewBlock401Response {
	return &NullableNewBlock401Response{value: val, isSet: true}
}

func (v NullableNewBlock401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewBlock401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
