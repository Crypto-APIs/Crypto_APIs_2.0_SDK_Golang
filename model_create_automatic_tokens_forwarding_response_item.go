...
// CreateAutomaticTokensForwardingResponseItem struct for CreateAutomaticTokensForwardingResponseItem
type CreateAutomaticTokensForwardingResponseItem struct {
	...
	TokenData CreateAutomaticTokensForwardingResponseItemTokenData `json:"tokenData"`
}
...
func NewCreateAutomaticTokensForwardingResponseItem(callbackUrl string, confirmationsCount int32, createdTimestamp int32, feeAddress string, feePriority string, fromAddress string, minimumTransferAmount string, referenceId string, toAddress string, tokenData CreateAutomaticTokensForwardingResponseItemTokenData) *CreateAutomaticTokensForwardingResponseItem {
	this := CreateAutomaticTokensForwardingResponseItem{}
...
func (o *CreateAutomaticTokensForwardingResponseItem) GetTokenData() CreateAutomaticTokensForwardingResponseItemTokenData {
	if o == nil {
		var ret CreateAutomaticTokensForwardingResponseItemTokenData
		return ret
	}
...
func (o CreateAutomaticTokensForwardingResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableCreateAutomaticTokensForwardingResponseItem struct {
	value *CreateAutomaticTokensForwardingResponseItem
	isSet bool
}

func (v NullableCreateAutomaticTokensForwardingResponseItem) Get() *CreateAutomaticTokensForwardingResponseItem {
	return v.value
}

func (v *NullableCreateAutomaticTokensForwardingResponseItem) Set(val *CreateAutomaticTokensForwardingResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticTokensForwardingResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticTokensForwardingResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticTokensForwardingResponseItem(val *CreateAutomaticTokensForwardingResponseItem) *NullableCreateAutomaticTokensForwardingResponseItem {
	return &NullableCreateAutomaticTokensForwardingResponseItem{value: val, isSet: true}
}

func (v NullableCreateAutomaticTokensForwardingResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticTokensForwardingResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
