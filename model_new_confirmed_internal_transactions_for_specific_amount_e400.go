...
type NewConfirmedInternalTransactionsForSpecificAmountE400 struct {
...
func LimitGreaterThanAllowedAsNewConfirmedInternalTransactionsForSpecificAmountE400(v *LimitGreaterThanAllowed) NewConfirmedInternalTransactionsForSpecificAmountE400 {
	return NewConfirmedInternalTransactionsForSpecificAmountE400{
...
func UriNotFoundAsNewConfirmedInternalTransactionsForSpecificAmountE400(v *UriNotFound) NewConfirmedInternalTransactionsForSpecificAmountE400 {
	return NewConfirmedInternalTransactionsForSpecificAmountE400{
		UriNotFound: v,
	}
}
...
func (dst *NewConfirmedInternalTransactionsForSpecificAmountE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedInternalTransactionsForSpecificAmountE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedInternalTransactionsForSpecificAmountE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedInternalTransactionsForSpecificAmountE400) MarshalJSON() ([]byte, error) {
...
func (obj *NewConfirmedInternalTransactionsForSpecificAmountE400) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableNewConfirmedInternalTransactionsForSpecificAmountE400 struct {
	value *NewConfirmedInternalTransactionsForSpecificAmountE400
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmountE400) Get() *NewConfirmedInternalTransactionsForSpecificAmountE400 {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmountE400) Set(val *NewConfirmedInternalTransactionsForSpecificAmountE400) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmountE400) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmountE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsForSpecificAmountE400(val *NewConfirmedInternalTransactionsForSpecificAmountE400) *NullableNewConfirmedInternalTransactionsForSpecificAmountE400 {
	return &NullableNewConfirmedInternalTransactionsForSpecificAmountE400{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsForSpecificAmountE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsForSpecificAmountE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
