...
type GetExchangeRateByAssetsIDs401Response struct {
	...
	Error GetExchangeRateByAssetsIDsE401 `json:"error"`
}
...
func NewGetExchangeRateByAssetsIDs401Response(apiVersion string, requestId string, error_ GetExchangeRateByAssetsIDsE401) *GetExchangeRateByAssetsIDs401Response {
	this := GetExchangeRateByAssetsIDs401Response{}
...
func (o *GetExchangeRateByAssetsIDs401Response) GetError() GetExchangeRateByAssetsIDsE401 {
	if o == nil {
		var ret GetExchangeRateByAssetsIDsE401
		return ret
	}
...
func (o GetExchangeRateByAssetsIDs401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetExchangeRateByAssetsIDs401Response struct {
	value *GetExchangeRateByAssetsIDs401Response
	isSet bool
}

func (v NullableGetExchangeRateByAssetsIDs401Response) Get() *GetExchangeRateByAssetsIDs401Response {
	return v.value
}

func (v *NullableGetExchangeRateByAssetsIDs401Response) Set(val *GetExchangeRateByAssetsIDs401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExchangeRateByAssetsIDs401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExchangeRateByAssetsIDs401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExchangeRateByAssetsIDs401Response(val *GetExchangeRateByAssetsIDs401Response) *NullableGetExchangeRateByAssetsIDs401Response {
	return &NullableGetExchangeRateByAssetsIDs401Response{value: val, isSet: true}
}

func (v NullableGetExchangeRateByAssetsIDs401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExchangeRateByAssetsIDs401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
