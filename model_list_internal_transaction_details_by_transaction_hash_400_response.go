...
type ListInternalTransactionDetailsByTransactionHash400Response struct {
	...
	Error ListInternalTransactionDetailsByTransactionHashE400 `json:"error"`
}
...
func (o *ListInternalTransactionDetailsByTransactionHash400Response) GetError() ListInternalTransactionDetailsByTransactionHashE400 {
	if o == nil {
		var ret ListInternalTransactionDetailsByTransactionHashE400
		return ret
	}
...
func (o ListInternalTransactionDetailsByTransactionHash400Response) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionDetailsByTransactionHash400Response struct {
	value *ListInternalTransactionDetailsByTransactionHash400Response
	isSet bool
}

func (v NullableListInternalTransactionDetailsByTransactionHash400Response) Get() *ListInternalTransactionDetailsByTransactionHash400Response {
	return v.value
}

func (v *NullableListInternalTransactionDetailsByTransactionHash400Response) Set(val *ListInternalTransactionDetailsByTransactionHash400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionDetailsByTransactionHash400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionDetailsByTransactionHash400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionDetailsByTransactionHash400Response(val *ListInternalTransactionDetailsByTransactionHash400Response) *NullableListInternalTransactionDetailsByTransactionHash400Response {
	return &NullableListInternalTransactionDetailsByTransactionHash400Response{value: val, isSet: true}
}

func (v NullableListInternalTransactionDetailsByTransactionHash400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionDetailsByTransactionHash400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
