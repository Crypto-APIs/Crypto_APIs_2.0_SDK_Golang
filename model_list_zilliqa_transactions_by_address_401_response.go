...
type ListZilliqaTransactionsByAddress401Response struct {
	...
	Error ListZilliqaTransactionsByAddressE401 `json:"error"`
}
...
func NewListZilliqaTransactionsByAddress401Response(apiVersion string, requestId string, error_ ListZilliqaTransactionsByAddressE401) *ListZilliqaTransactionsByAddress401Response {
	this := ListZilliqaTransactionsByAddress401Response{}
...
func (o *ListZilliqaTransactionsByAddress401Response) GetError() ListZilliqaTransactionsByAddressE401 {
	if o == nil {
		var ret ListZilliqaTransactionsByAddressE401
		return ret
	}
...
func (o ListZilliqaTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableListZilliqaTransactionsByAddress401Response struct {
	value *ListZilliqaTransactionsByAddress401Response
	isSet bool
}

func (v NullableListZilliqaTransactionsByAddress401Response) Get() *ListZilliqaTransactionsByAddress401Response {
	return v.value
}

func (v *NullableListZilliqaTransactionsByAddress401Response) Set(val *ListZilliqaTransactionsByAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListZilliqaTransactionsByAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListZilliqaTransactionsByAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListZilliqaTransactionsByAddress401Response(val *ListZilliqaTransactionsByAddress401Response) *NullableListZilliqaTransactionsByAddress401Response {
	return &NullableListZilliqaTransactionsByAddress401Response{value: val, isSet: true}
}

func (v NullableListZilliqaTransactionsByAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListZilliqaTransactionsByAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
