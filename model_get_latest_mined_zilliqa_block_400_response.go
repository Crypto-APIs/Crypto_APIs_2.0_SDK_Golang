...
type GetLatestMinedZilliqaBlock400Response struct {
	...
	Error GetLatestMinedZilliqaBlockE400 `json:"error"`
}
...
func NewGetLatestMinedZilliqaBlock400Response(apiVersion string, requestId string, error_ GetLatestMinedZilliqaBlockE400) *GetLatestMinedZilliqaBlock400Response {
	this := GetLatestMinedZilliqaBlock400Response{}
...
func (o *GetLatestMinedZilliqaBlock400Response) GetError() GetLatestMinedZilliqaBlockE400 {
	if o == nil {
		var ret GetLatestMinedZilliqaBlockE400
		return ret
	}
...
func (o GetLatestMinedZilliqaBlock400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedZilliqaBlock400Response struct {
	value *GetLatestMinedZilliqaBlock400Response
	isSet bool
}

func (v NullableGetLatestMinedZilliqaBlock400Response) Get() *GetLatestMinedZilliqaBlock400Response {
	return v.value
}

func (v *NullableGetLatestMinedZilliqaBlock400Response) Set(val *GetLatestMinedZilliqaBlock400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedZilliqaBlock400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedZilliqaBlock400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedZilliqaBlock400Response(val *GetLatestMinedZilliqaBlock400Response) *NullableGetLatestMinedZilliqaBlock400Response {
	return &NullableGetLatestMinedZilliqaBlock400Response{value: val, isSet: true}
}

func (v NullableGetLatestMinedZilliqaBlock400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedZilliqaBlock400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
