...
type GetAssetDetailsByAssetID403Response struct {
	...
	Error GetAssetDetailsByAssetIDE403 `json:"error"`
}
...
func NewGetAssetDetailsByAssetID403Response(apiVersion string, requestId string, error_ GetAssetDetailsByAssetIDE403) *GetAssetDetailsByAssetID403Response {
	this := GetAssetDetailsByAssetID403Response{}
...
func (o *GetAssetDetailsByAssetID403Response) GetError() GetAssetDetailsByAssetIDE403 {
	if o == nil {
		var ret GetAssetDetailsByAssetIDE403
		return ret
	}
...
func (o GetAssetDetailsByAssetID403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetAssetDetailsByAssetID403Response struct {
	value *GetAssetDetailsByAssetID403Response
	isSet bool
}

func (v NullableGetAssetDetailsByAssetID403Response) Get() *GetAssetDetailsByAssetID403Response {
	return v.value
}

func (v *NullableGetAssetDetailsByAssetID403Response) Set(val *GetAssetDetailsByAssetID403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetDetailsByAssetID403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetDetailsByAssetID403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetDetailsByAssetID403Response(val *GetAssetDetailsByAssetID403Response) *NullableGetAssetDetailsByAssetID403Response {
	return &NullableGetAssetDetailsByAssetID403Response{value: val, isSet: true}
}

func (v NullableGetAssetDetailsByAssetID403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetDetailsByAssetID403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
