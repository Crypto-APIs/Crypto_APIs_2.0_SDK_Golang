...
type BlockHeightReached403Response struct {
	...
	Error BlockHeightReachedE403 `json:"error"`
}
...
func NewBlockHeightReached403Response(apiVersion string, requestId string, error_ BlockHeightReachedE403) *BlockHeightReached403Response {
	this := BlockHeightReached403Response{}
...
func (o *BlockHeightReached403Response) GetError() BlockHeightReachedE403 {
	if o == nil {
		var ret BlockHeightReachedE403
		return ret
	}
...
func (o BlockHeightReached403Response) MarshalJSON() ([]byte, error) {
...
type NullableBlockHeightReached403Response struct {
	value *BlockHeightReached403Response
	isSet bool
}

func (v NullableBlockHeightReached403Response) Get() *BlockHeightReached403Response {
	return v.value
}

func (v *NullableBlockHeightReached403Response) Set(val *BlockHeightReached403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockHeightReached403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockHeightReached403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockHeightReached403Response(val *BlockHeightReached403Response) *NullableBlockHeightReached403Response {
	return &NullableBlockHeightReached403Response{value: val, isSet: true}
}

func (v NullableBlockHeightReached403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockHeightReached403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
