...
type GetTransactionRequestDetailsE403 struct {
...
func BannedIpAddressAsGetTransactionRequestDetailsE403(v *BannedIpAddress) GetTransactionRequestDetailsE403 {
	return GetTransactionRequestDetailsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetTransactionRequestDetailsE403(v *EndpointNotAllowedForApiKey) GetTransactionRequestDetailsE403 {
	return GetTransactionRequestDetailsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetTransactionRequestDetailsE403(v *EndpointNotAllowedForPlan) GetTransactionRequestDetailsE403 {
	return GetTransactionRequestDetailsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetTransactionRequestDetailsE403(v *FeatureMainnetsNotAllowedForPlan) GetTransactionRequestDetailsE403 {
	return GetTransactionRequestDetailsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetTransactionRequestDetailsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetTransactionRequestDetailsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetTransactionRequestDetailsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetTransactionRequestDetailsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetTransactionRequestDetailsE403) GetActualInstance() (interface{}) {
...
type NullableGetTransactionRequestDetailsE403 struct {
	value *GetTransactionRequestDetailsE403
	isSet bool
}

func (v NullableGetTransactionRequestDetailsE403) Get() *GetTransactionRequestDetailsE403 {
	return v.value
}

func (v *NullableGetTransactionRequestDetailsE403) Set(val *GetTransactionRequestDetailsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionRequestDetailsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionRequestDetailsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionRequestDetailsE403(val *GetTransactionRequestDetailsE403) *NullableGetTransactionRequestDetailsE403 {
	return &NullableGetTransactionRequestDetailsE403{value: val, isSet: true}
}

func (v NullableGetTransactionRequestDetailsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionRequestDetailsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
