...
// ListTokensTransfersByAddressR struct for ListTokensTransfersByAddressR
type ListTokensTransfersByAddressR struct {
	...
	Data ListTokensTransfersByAddressRData `json:"data"`
}
...
func NewListTokensTransfersByAddressR(apiVersion string, requestId string, data ListTokensTransfersByAddressRData) *ListTokensTransfersByAddressR {
	this := ListTokensTransfersByAddressR{}
...
func (o *ListTokensTransfersByAddressR) GetData() ListTokensTransfersByAddressRData {
	if o == nil {
		var ret ListTokensTransfersByAddressRData
		return ret
	}
...
func (o ListTokensTransfersByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableListTokensTransfersByAddressR struct {
	value *ListTokensTransfersByAddressR
	isSet bool
}

func (v NullableListTokensTransfersByAddressR) Get() *ListTokensTransfersByAddressR {
	return v.value
}

func (v *NullableListTokensTransfersByAddressR) Set(val *ListTokensTransfersByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensTransfersByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensTransfersByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensTransfersByAddressR(val *ListTokensTransfersByAddressR) *NullableListTokensTransfersByAddressR {
	return &NullableListTokensTransfersByAddressR{value: val, isSet: true}
}

func (v NullableListTokensTransfersByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensTransfersByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
