...
type GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash struct {
...
func NewGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash(difficulty string, nonce string, size int32, bits string, chainwork string, merkleRoot string, version int32, versionHex string) *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash {
	this := GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash{}
...
func (o GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash struct {
	value *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) Get() *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) Set(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash(val *GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash {
	return &NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash) UnmarshalJSON(src []byte) error {
	v.isSet = true
