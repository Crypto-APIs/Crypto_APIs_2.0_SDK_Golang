...
type GetLastMinedBlockRIBSB struct {
...
func (o GetLastMinedBlockRIBSB) MarshalJSON() ([]byte, error) {
...
type NullableGetLastMinedBlockRIBSB struct {
	value *GetLastMinedBlockRIBSB
	isSet bool
}

func (v NullableGetLastMinedBlockRIBSB) Get() *GetLastMinedBlockRIBSB {
	return v.value
}

func (v *NullableGetLastMinedBlockRIBSB) Set(val *GetLastMinedBlockRIBSB) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastMinedBlockRIBSB) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastMinedBlockRIBSB) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastMinedBlockRIBSB(val *GetLastMinedBlockRIBSB) *NullableGetLastMinedBlockRIBSB {
	return &NullableGetLastMinedBlockRIBSB{value: val, isSet: true}
}

func (v NullableGetLastMinedBlockRIBSB) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastMinedBlockRIBSB) UnmarshalJSON(src []byte) error {
	v.isSet = true
