...
type ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey struct {
...
func NewListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey(addresses []string, asm string, hex string, type_ string) *ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey {
	this := ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey{}
...
func (o ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey struct {
	value *ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) Get() *ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) Set(val *ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey(val *ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) *NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey {
	return &NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
