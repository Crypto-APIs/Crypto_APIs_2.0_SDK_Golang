...
type GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey struct {
...
func NewGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey {
	this := GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey{}
...
func (o GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey struct {
	value *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) Get() *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) Set(val *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey(val *GetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey {
	return &NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDRIBSBCScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
