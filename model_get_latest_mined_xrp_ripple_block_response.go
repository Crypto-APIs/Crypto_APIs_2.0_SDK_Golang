...
// GetLatestMinedXRPRippleBlockResponse struct for GetLatestMinedXRPRippleBlockResponse
type GetLatestMinedXRPRippleBlockResponse struct {
	...
	Data GetLatestMinedXRPRippleBlockResponseData `json:"data"`
}
...
func NewGetLatestMinedXRPRippleBlockResponse(apiVersion string, requestId string, data GetLatestMinedXRPRippleBlockResponseData) *GetLatestMinedXRPRippleBlockResponse {
	this := GetLatestMinedXRPRippleBlockResponse{}
...
func (o *GetLatestMinedXRPRippleBlockResponse) GetData() GetLatestMinedXRPRippleBlockResponseData {
	if o == nil {
		var ret GetLatestMinedXRPRippleBlockResponseData
		return ret
	}
...
func (o GetLatestMinedXRPRippleBlockResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedXRPRippleBlockResponse struct {
	value *GetLatestMinedXRPRippleBlockResponse
	isSet bool
}

func (v NullableGetLatestMinedXRPRippleBlockResponse) Get() *GetLatestMinedXRPRippleBlockResponse {
	return v.value
}

func (v *NullableGetLatestMinedXRPRippleBlockResponse) Set(val *GetLatestMinedXRPRippleBlockResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedXRPRippleBlockResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedXRPRippleBlockResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedXRPRippleBlockResponse(val *GetLatestMinedXRPRippleBlockResponse) *NullableGetLatestMinedXRPRippleBlockResponse {
	return &NullableGetLatestMinedXRPRippleBlockResponse{value: val, isSet: true}
}

func (v NullableGetLatestMinedXRPRippleBlockResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedXRPRippleBlockResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
