...
// ListOmniTransactionsByAddressR struct for ListOmniTransactionsByAddressR
type ListOmniTransactionsByAddressR struct {
	...
	Data ListOmniTransactionsByAddressRData `json:"data"`
}
...
func NewListOmniTransactionsByAddressR(apiVersion string, requestId string, data ListOmniTransactionsByAddressRData) *ListOmniTransactionsByAddressR {
	this := ListOmniTransactionsByAddressR{}
...
func (o *ListOmniTransactionsByAddressR) GetData() ListOmniTransactionsByAddressRData {
	if o == nil {
		var ret ListOmniTransactionsByAddressRData
		return ret
	}
...
func (o ListOmniTransactionsByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByAddressR struct {
	value *ListOmniTransactionsByAddressR
	isSet bool
}

func (v NullableListOmniTransactionsByAddressR) Get() *ListOmniTransactionsByAddressR {
	return v.value
}

func (v *NullableListOmniTransactionsByAddressR) Set(val *ListOmniTransactionsByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByAddressR(val *ListOmniTransactionsByAddressR) *NullableListOmniTransactionsByAddressR {
	return &NullableListOmniTransactionsByAddressR{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
