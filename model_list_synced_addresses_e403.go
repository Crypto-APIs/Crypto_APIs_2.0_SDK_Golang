...
type ListSyncedAddressesE403 struct {
...
func BannedIpAddressAsListSyncedAddressesE403(v *BannedIpAddress) ListSyncedAddressesE403 {
...
func EndpointNotAllowedForApiKeyAsListSyncedAddressesE403(v *EndpointNotAllowedForApiKey) ListSyncedAddressesE403 {
	return ListSyncedAddressesE403{
...
func EndpointNotAllowedForPlanAsListSyncedAddressesE403(v *EndpointNotAllowedForPlan) ListSyncedAddressesE403 {
	return ListSyncedAddressesE403{
...
func FeatureMainnetsNotAllowedForPlanAsListSyncedAddressesE403(v *FeatureMainnetsNotAllowedForPlan) ListSyncedAddressesE403 {
	return ListSyncedAddressesE403{
...
func (dst *ListSyncedAddressesE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListSyncedAddressesE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListSyncedAddressesE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListSyncedAddressesE403) MarshalJSON() ([]byte, error) {
...
func (obj *ListSyncedAddressesE403) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableListSyncedAddressesE403 struct {
	value *ListSyncedAddressesE403
	isSet bool
}

func (v NullableListSyncedAddressesE403) Get() *ListSyncedAddressesE403 {
	return v.value
}

func (v *NullableListSyncedAddressesE403) Set(val *ListSyncedAddressesE403) {
	v.value = val
	v.isSet = true
}

func (v NullableListSyncedAddressesE403) IsSet() bool {
	return v.isSet
}

func (v *NullableListSyncedAddressesE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSyncedAddressesE403(val *ListSyncedAddressesE403) *NullableListSyncedAddressesE403 {
	return &NullableListSyncedAddressesE403{value: val, isSet: true}
}

func (v NullableListSyncedAddressesE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSyncedAddressesE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
