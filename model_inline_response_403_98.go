...
// InlineResponse40398 struct for InlineResponse40398
type InlineResponse40398 struct {
...
func (o InlineResponse40398) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse40398 struct {
	value *InlineResponse40398
	isSet bool
}

func (v NullableInlineResponse40398) Get() *InlineResponse40398 {
	return v.value
}

func (v *NullableInlineResponse40398) Set(val *InlineResponse40398) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse40398) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse40398) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse40398(val *InlineResponse40398) *NullableInlineResponse40398 {
	return &NullableInlineResponse40398{value: val, isSet: true}
}

func (v NullableInlineResponse40398) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse40398) UnmarshalJSON(src []byte) error {
	v.isSet = true
