...
// BlockchainDataBlockNotFoundError struct for BlockchainDataBlockNotFoundError
type BlockchainDataBlockNotFoundError struct {
...
func NewBlockchainDataBlockNotFoundError(code string, message string) *BlockchainDataBlockNotFoundError {
	this := BlockchainDataBlockNotFoundError{}
	this.Code = code
...
func (o BlockchainDataBlockNotFoundError) MarshalJSON() ([]byte, error) {
...
type NullableBlockchainDataBlockNotFoundError struct {
	value *BlockchainDataBlockNotFoundError
	isSet bool
}

func (v NullableBlockchainDataBlockNotFoundError) Get() *BlockchainDataBlockNotFoundError {
	return v.value
}

func (v *NullableBlockchainDataBlockNotFoundError) Set(val *BlockchainDataBlockNotFoundError) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockchainDataBlockNotFoundError) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockchainDataBlockNotFoundError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockchainDataBlockNotFoundError(val *BlockchainDataBlockNotFoundError) *NullableBlockchainDataBlockNotFoundError {
	return &NullableBlockchainDataBlockNotFoundError{value: val, isSet: true}
}

func (v NullableBlockchainDataBlockNotFoundError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockchainDataBlockNotFoundError) UnmarshalJSON(src []byte) error {
	v.isSet = true
