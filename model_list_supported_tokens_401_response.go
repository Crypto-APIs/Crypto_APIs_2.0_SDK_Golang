...
type ListSupportedTokens401Response struct {
	...
	Error ListSupportedTokensE401 `json:"error"`
}
...
func NewListSupportedTokens401Response(apiVersion string, requestId string, error_ ListSupportedTokensE401) *ListSupportedTokens401Response {
	this := ListSupportedTokens401Response{}
...
func (o *ListSupportedTokens401Response) GetError() ListSupportedTokensE401 {
	if o == nil {
		var ret ListSupportedTokensE401
		return ret
	}
...
func (o ListSupportedTokens401Response) MarshalJSON() ([]byte, error) {
...
type NullableListSupportedTokens401Response struct {
	value *ListSupportedTokens401Response
	isSet bool
}

func (v NullableListSupportedTokens401Response) Get() *ListSupportedTokens401Response {
	return v.value
}

func (v *NullableListSupportedTokens401Response) Set(val *ListSupportedTokens401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSupportedTokens401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSupportedTokens401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSupportedTokens401Response(val *ListSupportedTokens401Response) *NullableListSupportedTokens401Response {
	return &NullableListSupportedTokens401Response{value: val, isSet: true}
}

func (v NullableListSupportedTokens401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSupportedTokens401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
