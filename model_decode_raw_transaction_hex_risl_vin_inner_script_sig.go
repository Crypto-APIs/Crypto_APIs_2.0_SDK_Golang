...
type DecodeRawTransactionHexRISLVinInnerScriptSig struct {
...
func NewDecodeRawTransactionHexRISLVinInnerScriptSig() *DecodeRawTransactionHexRISLVinInnerScriptSig {
	this := DecodeRawTransactionHexRISLVinInnerScriptSig{}
	return &this
}
...
func (o DecodeRawTransactionHexRISLVinInnerScriptSig) MarshalJSON() ([]byte, error) {
...
type NullableDecodeRawTransactionHexRISLVinInnerScriptSig struct {
	value *DecodeRawTransactionHexRISLVinInnerScriptSig
	isSet bool
}

func (v NullableDecodeRawTransactionHexRISLVinInnerScriptSig) Get() *DecodeRawTransactionHexRISLVinInnerScriptSig {
	return v.value
}

func (v *NullableDecodeRawTransactionHexRISLVinInnerScriptSig) Set(val *DecodeRawTransactionHexRISLVinInnerScriptSig) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeRawTransactionHexRISLVinInnerScriptSig) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeRawTransactionHexRISLVinInnerScriptSig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeRawTransactionHexRISLVinInnerScriptSig(val *DecodeRawTransactionHexRISLVinInnerScriptSig) *NullableDecodeRawTransactionHexRISLVinInnerScriptSig {
	return &NullableDecodeRawTransactionHexRISLVinInnerScriptSig{value: val, isSet: true}
}

func (v NullableDecodeRawTransactionHexRISLVinInnerScriptSig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeRawTransactionHexRISLVinInnerScriptSig) UnmarshalJSON(src []byte) error {
	v.isSet = true
