...
type ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey struct {
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey(addresses []string, asm string, hex string, reqSigs int32, type_ string) *ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey{}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinScriptPubKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
