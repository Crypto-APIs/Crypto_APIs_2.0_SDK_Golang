...
type ListInternalTransactionsByAddressAndTimeRangeRData struct {
	...
	Items []ListInternalTransactionsByAddressAndTimeRangeRI `json:"items"`
}
...
func NewListInternalTransactionsByAddressAndTimeRangeRData(limit int32, offset int32, total int32, items []ListInternalTransactionsByAddressAndTimeRangeRI) *ListInternalTransactionsByAddressAndTimeRangeRData {
	this := ListInternalTransactionsByAddressAndTimeRangeRData{}
	this.Limit = limit
	this.Offset = offset
	this.Total = total
	this.Items = items
...
func (o *ListInternalTransactionsByAddressAndTimeRangeRData) GetItems() []ListInternalTransactionsByAddressAndTimeRangeRI {
	if o == nil {
		var ret []ListInternalTransactionsByAddressAndTimeRangeRI
		return ret
	}
...
func (o ListInternalTransactionsByAddressAndTimeRangeRData) MarshalJSON() ([]byte, error) {
...
type NullableListInternalTransactionsByAddressAndTimeRangeRData struct {
	value *ListInternalTransactionsByAddressAndTimeRangeRData
	isSet bool
}

func (v NullableListInternalTransactionsByAddressAndTimeRangeRData) Get() *ListInternalTransactionsByAddressAndTimeRangeRData {
	return v.value
}

func (v *NullableListInternalTransactionsByAddressAndTimeRangeRData) Set(val *ListInternalTransactionsByAddressAndTimeRangeRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListInternalTransactionsByAddressAndTimeRangeRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListInternalTransactionsByAddressAndTimeRangeRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInternalTransactionsByAddressAndTimeRangeRData(val *ListInternalTransactionsByAddressAndTimeRangeRData) *NullableListInternalTransactionsByAddressAndTimeRangeRData {
	return &NullableListInternalTransactionsByAddressAndTimeRangeRData{value: val, isSet: true}
}

func (v NullableListInternalTransactionsByAddressAndTimeRangeRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInternalTransactionsByAddressAndTimeRangeRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
