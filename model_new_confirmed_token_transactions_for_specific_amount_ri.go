...
type NewConfirmedTokenTransactionsForSpecificAmountRI struct {
...
func NewNewConfirmedTokenTransactionsForSpecificAmountRI(amountHigherThan int64, callbackUrl string, contractAddress string, createdTimestamp int32, eventType string, isActive bool, referenceId string) *NewConfirmedTokenTransactionsForSpecificAmountRI {
	this := NewConfirmedTokenTransactionsForSpecificAmountRI{}
...
func (o NewConfirmedTokenTransactionsForSpecificAmountRI) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedTokenTransactionsForSpecificAmountRI struct {
	value *NewConfirmedTokenTransactionsForSpecificAmountRI
	isSet bool
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmountRI) Get() *NewConfirmedTokenTransactionsForSpecificAmountRI {
	return v.value
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmountRI) Set(val *NewConfirmedTokenTransactionsForSpecificAmountRI) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmountRI) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmountRI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedTokenTransactionsForSpecificAmountRI(val *NewConfirmedTokenTransactionsForSpecificAmountRI) *NullableNewConfirmedTokenTransactionsForSpecificAmountRI {
	return &NullableNewConfirmedTokenTransactionsForSpecificAmountRI{value: val, isSet: true}
}

func (v NullableNewConfirmedTokenTransactionsForSpecificAmountRI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedTokenTransactionsForSpecificAmountRI) UnmarshalJSON(src []byte) error {
	v.isSet = true
