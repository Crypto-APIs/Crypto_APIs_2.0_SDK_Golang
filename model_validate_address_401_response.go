...
type ValidateAddress401Response struct {
	...
	Error ValidateAddressE401 `json:"error"`
}
...
func NewValidateAddress401Response(apiVersion string, requestId string, error_ ValidateAddressE401) *ValidateAddress401Response {
	this := ValidateAddress401Response{}
...
func (o ValidateAddress401Response) MarshalJSON() ([]byte, error) {
...
type NullableValidateAddress401Response struct {
	value *ValidateAddress401Response
	isSet bool
}

func (v NullableValidateAddress401Response) Get() *ValidateAddress401Response {
	return v.value
}

func (v *NullableValidateAddress401Response) Set(val *ValidateAddress401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateAddress401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateAddress401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateAddress401Response(val *ValidateAddress401Response) *NullableValidateAddress401Response {
	return &NullableValidateAddress401Response{value: val, isSet: true}
}

func (v NullableValidateAddress401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateAddress401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
