...
type CreateFungibleTokensTransactionRequestFromAddress403Response struct {
...
func NewCreateFungibleTokensTransactionRequestFromAddress403Response(apiVersion string, requestId string, error_ CreateFungibleTokensTransactionRequestFromAddressE403) *CreateFungibleTokensTransactionRequestFromAddress403Response {
	this := CreateFungibleTokensTransactionRequestFromAddress403Response{}
...
func (o CreateFungibleTokensTransactionRequestFromAddress403Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateFungibleTokensTransactionRequestFromAddress403Response struct {
	value *CreateFungibleTokensTransactionRequestFromAddress403Response
	isSet bool
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddress403Response) Get() *CreateFungibleTokensTransactionRequestFromAddress403Response {
	return v.value
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddress403Response) Set(val *CreateFungibleTokensTransactionRequestFromAddress403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddress403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddress403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFungibleTokensTransactionRequestFromAddress403Response(val *CreateFungibleTokensTransactionRequestFromAddress403Response) *NullableCreateFungibleTokensTransactionRequestFromAddress403Response {
	return &NullableCreateFungibleTokensTransactionRequestFromAddress403Response{value: val, isSet: true}
}

func (v NullableCreateFungibleTokensTransactionRequestFromAddress403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFungibleTokensTransactionRequestFromAddress403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
