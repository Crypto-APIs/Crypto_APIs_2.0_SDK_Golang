...
type GetTransactionDetailsByTransactionID403Response struct {
	...
	Error GetTransactionDetailsByTransactionIDE403 `json:"error"`
}
...
func (o *GetTransactionDetailsByTransactionID403Response) GetError() GetTransactionDetailsByTransactionIDE403 {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDE403
		return ret
	}
...
func (o GetTransactionDetailsByTransactionID403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionID403Response struct {
	value *GetTransactionDetailsByTransactionID403Response
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionID403Response) Get() *GetTransactionDetailsByTransactionID403Response {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionID403Response) Set(val *GetTransactionDetailsByTransactionID403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionID403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionID403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionID403Response(val *GetTransactionDetailsByTransactionID403Response) *NullableGetTransactionDetailsByTransactionID403Response {
	return &NullableGetTransactionDetailsByTransactionID403Response{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionID403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionID403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
