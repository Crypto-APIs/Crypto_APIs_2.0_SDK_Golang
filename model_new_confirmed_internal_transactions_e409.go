...
type NewConfirmedInternalTransactionsE409 struct {
...
func (dst *NewConfirmedInternalTransactionsE409) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(NewConfirmedInternalTransactionsE409)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(NewConfirmedInternalTransactionsE409)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src NewConfirmedInternalTransactionsE409) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsE409 struct {
	value *NewConfirmedInternalTransactionsE409
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsE409) Get() *NewConfirmedInternalTransactionsE409 {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsE409) Set(val *NewConfirmedInternalTransactionsE409) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsE409) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsE409) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsE409(val *NewConfirmedInternalTransactionsE409) *NullableNewConfirmedInternalTransactionsE409 {
	return &NullableNewConfirmedInternalTransactionsE409{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsE409) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsE409) UnmarshalJSON(src []byte) error {
	v.isSet = true
