...
type GetAddressDetailsFromCallbackR struct {
	...
	Data GetAddressDetailsFromCallbackRData `json:"data"`
}
...
func NewGetAddressDetailsFromCallbackR(apiVersion string, requestId string, data GetAddressDetailsFromCallbackRData) *GetAddressDetailsFromCallbackR {
	this := GetAddressDetailsFromCallbackR{}
...
func (o *GetAddressDetailsFromCallbackR) GetData() GetAddressDetailsFromCallbackRData {
	if o == nil {
		var ret GetAddressDetailsFromCallbackRData
		return ret
	}
...
func (o GetAddressDetailsFromCallbackR) MarshalJSON() ([]byte, error) {
...
type NullableGetAddressDetailsFromCallbackR struct {
	value *GetAddressDetailsFromCallbackR
	isSet bool
}

func (v NullableGetAddressDetailsFromCallbackR) Get() *GetAddressDetailsFromCallbackR {
	return v.value
}

func (v *NullableGetAddressDetailsFromCallbackR) Set(val *GetAddressDetailsFromCallbackR) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAddressDetailsFromCallbackR) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAddressDetailsFromCallbackR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAddressDetailsFromCallbackR(val *GetAddressDetailsFromCallbackR) *NullableGetAddressDetailsFromCallbackR {
	return &NullableGetAddressDetailsFromCallbackR{value: val, isSet: true}
}

func (v NullableGetAddressDetailsFromCallbackR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAddressDetailsFromCallbackR) UnmarshalJSON(src []byte) error {
	v.isSet = true
