...
type ListTokensForwardingAutomationsR struct {
	...
	Data ListTokensForwardingAutomationsRData `json:"data"`
}
...
func NewListTokensForwardingAutomationsR(apiVersion string, requestId string, data ListTokensForwardingAutomationsRData) *ListTokensForwardingAutomationsR {
	this := ListTokensForwardingAutomationsR{}
...
func (o *ListTokensForwardingAutomationsR) GetData() ListTokensForwardingAutomationsRData {
	if o == nil {
		var ret ListTokensForwardingAutomationsRData
		return ret
	}
...
func (o ListTokensForwardingAutomationsR) MarshalJSON() ([]byte, error) {
...
type NullableListTokensForwardingAutomationsR struct {
	value *ListTokensForwardingAutomationsR
	isSet bool
}

func (v NullableListTokensForwardingAutomationsR) Get() *ListTokensForwardingAutomationsR {
	return v.value
}

func (v *NullableListTokensForwardingAutomationsR) Set(val *ListTokensForwardingAutomationsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensForwardingAutomationsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensForwardingAutomationsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensForwardingAutomationsR(val *ListTokensForwardingAutomationsR) *NullableListTokensForwardingAutomationsR {
	return &NullableListTokensForwardingAutomationsR{value: val, isSet: true}
}

func (v NullableListTokensForwardingAutomationsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensForwardingAutomationsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
