...
type ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin struct {
	...
	Vin []ListTransactionsByAddressResponseItemBlockchainSpecificLitecoinVin `json:"vin"`
...
func NewListTransactionsByAddressResponseItemBlockchainSpecificLitecoin(locktime int32, size int32, vSize int32, version int32, vin []ListTransactionsByAddressResponseItemBlockchainSpecificLitecoinVin, vout []GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinVout) *ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin {
	this := ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin{}
...
func (o *ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) GetVin() []ListTransactionsByAddressResponseItemBlockchainSpecificLitecoinVin {
	if o == nil {
		var ret []ListTransactionsByAddressResponseItemBlockchainSpecificLitecoinVin
		return ret
	}
...
func (o ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin struct {
	value *ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin
	isSet bool
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) Get() *ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin {
	return v.value
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) Set(val *ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin(val *ListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) *NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin {
	return &NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressResponseItemBlockchainSpecificLitecoin) UnmarshalJSON(src []byte) error {
	v.isSet = true
