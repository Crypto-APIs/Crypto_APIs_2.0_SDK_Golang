...
type GetLatestMinedZilliqaBlock401Response struct {
	...
	Error GetLatestMinedZilliqaBlockE401 `json:"error"`
}
...
func NewGetLatestMinedZilliqaBlock401Response(apiVersion string, requestId string, error_ GetLatestMinedZilliqaBlockE401) *GetLatestMinedZilliqaBlock401Response {
	this := GetLatestMinedZilliqaBlock401Response{}
...
func (o *GetLatestMinedZilliqaBlock401Response) GetError() GetLatestMinedZilliqaBlockE401 {
	if o == nil {
		var ret GetLatestMinedZilliqaBlockE401
		return ret
	}
...
func (o GetLatestMinedZilliqaBlock401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetLatestMinedZilliqaBlock401Response struct {
	value *GetLatestMinedZilliqaBlock401Response
	isSet bool
}

func (v NullableGetLatestMinedZilliqaBlock401Response) Get() *GetLatestMinedZilliqaBlock401Response {
	return v.value
}

func (v *NullableGetLatestMinedZilliqaBlock401Response) Set(val *GetLatestMinedZilliqaBlock401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestMinedZilliqaBlock401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestMinedZilliqaBlock401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestMinedZilliqaBlock401Response(val *GetLatestMinedZilliqaBlock401Response) *NullableGetLatestMinedZilliqaBlock401Response {
	return &NullableGetLatestMinedZilliqaBlock401Response{value: val, isSet: true}
}

func (v NullableGetLatestMinedZilliqaBlock401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestMinedZilliqaBlock401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
