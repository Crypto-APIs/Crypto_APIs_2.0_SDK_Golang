...
type BroadcastTransactionSuccess struct {
	...
	Data BroadcastTransactionSuccessData `json:"data"`
}
...
func NewBroadcastTransactionSuccess(apiVersion string, referenceId string, idempotencyKey string, data BroadcastTransactionSuccessData) *BroadcastTransactionSuccess {
	this := BroadcastTransactionSuccess{}
...
func (o *BroadcastTransactionSuccess) GetData() BroadcastTransactionSuccessData {
	if o == nil {
		var ret BroadcastTransactionSuccessData
		return ret
	}
...
func (o BroadcastTransactionSuccess) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastTransactionSuccess struct {
	value *BroadcastTransactionSuccess
	isSet bool
}

func (v NullableBroadcastTransactionSuccess) Get() *BroadcastTransactionSuccess {
	return v.value
}

func (v *NullableBroadcastTransactionSuccess) Set(val *BroadcastTransactionSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastTransactionSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastTransactionSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastTransactionSuccess(val *BroadcastTransactionSuccess) *NullableBroadcastTransactionSuccess {
	return &NullableBroadcastTransactionSuccess{value: val, isSet: true}
}

func (v NullableBroadcastTransactionSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastTransactionSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
