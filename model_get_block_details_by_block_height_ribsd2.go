...
type GetBlockDetailsByBlockHeightRIBSD2 struct {
...
func NewGetBlockDetailsByBlockHeightRIBSD2(difficulty string, bits string, chainwork string, merkleRoot string, nonce string, size int32, version int32, versionHex string) *GetBlockDetailsByBlockHeightRIBSD2 {
	this := GetBlockDetailsByBlockHeightRIBSD2{}
...
func (o GetBlockDetailsByBlockHeightRIBSD2) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightRIBSD2 struct {
	value *GetBlockDetailsByBlockHeightRIBSD2
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightRIBSD2) Get() *GetBlockDetailsByBlockHeightRIBSD2 {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightRIBSD2) Set(val *GetBlockDetailsByBlockHeightRIBSD2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightRIBSD2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightRIBSD2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightRIBSD2(val *GetBlockDetailsByBlockHeightRIBSD2) *NullableGetBlockDetailsByBlockHeightRIBSD2 {
	return &NullableGetBlockDetailsByBlockHeightRIBSD2{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightRIBSD2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightRIBSD2) UnmarshalJSON(src []byte) error {
	v.isSet = true
