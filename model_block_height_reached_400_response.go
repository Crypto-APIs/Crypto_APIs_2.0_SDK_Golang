...
type BlockHeightReached400Response struct {
	...
	Error BlockHeightReachedE400 `json:"error"`
}
...
func NewBlockHeightReached400Response(apiVersion string, requestId string, error_ BlockHeightReachedE400) *BlockHeightReached400Response {
	this := BlockHeightReached400Response{}
...
func (o *BlockHeightReached400Response) GetError() BlockHeightReachedE400 {
	if o == nil {
		var ret BlockHeightReachedE400
		return ret
	}
...
func (o BlockHeightReached400Response) MarshalJSON() ([]byte, error) {
...
type NullableBlockHeightReached400Response struct {
	value *BlockHeightReached400Response
	isSet bool
}

func (v NullableBlockHeightReached400Response) Get() *BlockHeightReached400Response {
	return v.value
}

func (v *NullableBlockHeightReached400Response) Set(val *BlockHeightReached400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockHeightReached400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockHeightReached400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockHeightReached400Response(val *BlockHeightReached400Response) *NullableBlockHeightReached400Response {
	return &NullableBlockHeightReached400Response{value: val, isSet: true}
}

func (v NullableBlockHeightReached400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockHeightReached400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
