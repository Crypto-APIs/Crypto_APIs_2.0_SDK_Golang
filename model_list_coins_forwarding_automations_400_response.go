...
type ListCoinsForwardingAutomations400Response struct {
	...
	Error ListCoinsForwardingAutomationsE400 `json:"error"`
}
...
func NewListCoinsForwardingAutomations400Response(apiVersion string, requestId string, error_ ListCoinsForwardingAutomationsE400) *ListCoinsForwardingAutomations400Response {
	this := ListCoinsForwardingAutomations400Response{}
...
func (o *ListCoinsForwardingAutomations400Response) GetError() ListCoinsForwardingAutomationsE400 {
	if o == nil {
		var ret ListCoinsForwardingAutomationsE400
		return ret
	}
...
func (o ListCoinsForwardingAutomations400Response) MarshalJSON() ([]byte, error) {
...
type NullableListCoinsForwardingAutomations400Response struct {
	value *ListCoinsForwardingAutomations400Response
	isSet bool
}

func (v NullableListCoinsForwardingAutomations400Response) Get() *ListCoinsForwardingAutomations400Response {
	return v.value
}

func (v *NullableListCoinsForwardingAutomations400Response) Set(val *ListCoinsForwardingAutomations400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoinsForwardingAutomations400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoinsForwardingAutomations400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoinsForwardingAutomations400Response(val *ListCoinsForwardingAutomations400Response) *NullableListCoinsForwardingAutomations400Response {
	return &NullableListCoinsForwardingAutomations400Response{value: val, isSet: true}
}

func (v NullableListCoinsForwardingAutomations400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoinsForwardingAutomations400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
