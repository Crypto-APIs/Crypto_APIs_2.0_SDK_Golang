...
type ListTransactionsByBlockHeightRIFee struct {
...
func NewListTransactionsByBlockHeightRIFee(amount string, unit string) *ListTransactionsByBlockHeightRIFee {
	this := ListTransactionsByBlockHeightRIFee{}
	this.Amount = amount
	this.Unit = unit
	return &this
}
...
func (o ListTransactionsByBlockHeightRIFee) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightRIFee struct {
	value *ListTransactionsByBlockHeightRIFee
	isSet bool
}

func (v NullableListTransactionsByBlockHeightRIFee) Get() *ListTransactionsByBlockHeightRIFee {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightRIFee) Set(val *ListTransactionsByBlockHeightRIFee) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightRIFee) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightRIFee) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightRIFee(val *ListTransactionsByBlockHeightRIFee) *NullableListTransactionsByBlockHeightRIFee {
	return &NullableListTransactionsByBlockHeightRIFee{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightRIFee) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightRIFee) UnmarshalJSON(src []byte) error {
	v.isSet = true
