...
type GetFeeRecommendations400Response struct {
	...
	Error GetFeeRecommendationsE400 `json:"error"`
}
...
func NewGetFeeRecommendations400Response(apiVersion string, requestId string, error_ GetFeeRecommendationsE400) *GetFeeRecommendations400Response {
	this := GetFeeRecommendations400Response{}
...
func (o *GetFeeRecommendations400Response) GetError() GetFeeRecommendationsE400 {
	if o == nil {
		var ret GetFeeRecommendationsE400
		return ret
	}
...
func (o GetFeeRecommendations400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetFeeRecommendations400Response struct {
	value *GetFeeRecommendations400Response
	isSet bool
}

func (v NullableGetFeeRecommendations400Response) Get() *GetFeeRecommendations400Response {
	return v.value
}

func (v *NullableGetFeeRecommendations400Response) Set(val *GetFeeRecommendations400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeRecommendations400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeRecommendations400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeRecommendations400Response(val *GetFeeRecommendations400Response) *NullableGetFeeRecommendations400Response {
	return &NullableGetFeeRecommendations400Response{value: val, isSet: true}
}

func (v NullableGetFeeRecommendations400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeRecommendations400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
