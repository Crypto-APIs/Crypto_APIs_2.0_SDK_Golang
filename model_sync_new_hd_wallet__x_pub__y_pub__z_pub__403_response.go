...
type SyncNewHDWalletXPubYPubZPub403Response struct {
	...
	Error SyncNewHDWalletXPubYPubZPubE403 `json:"error"`
}
...
func NewSyncNewHDWalletXPubYPubZPub403Response(apiVersion string, requestId string, error_ SyncNewHDWalletXPubYPubZPubE403) *SyncNewHDWalletXPubYPubZPub403Response {
	this := SyncNewHDWalletXPubYPubZPub403Response{}
...
func (o *SyncNewHDWalletXPubYPubZPub403Response) GetError() SyncNewHDWalletXPubYPubZPubE403 {
	if o == nil {
		var ret SyncNewHDWalletXPubYPubZPubE403
		return ret
	}
...
func (o SyncNewHDWalletXPubYPubZPub403Response) MarshalJSON() ([]byte, error) {
...
type NullableSyncNewHDWalletXPubYPubZPub403Response struct {
	value *SyncNewHDWalletXPubYPubZPub403Response
	isSet bool
}

func (v NullableSyncNewHDWalletXPubYPubZPub403Response) Get() *SyncNewHDWalletXPubYPubZPub403Response {
	return v.value
}

func (v *NullableSyncNewHDWalletXPubYPubZPub403Response) Set(val *SyncNewHDWalletXPubYPubZPub403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncNewHDWalletXPubYPubZPub403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncNewHDWalletXPubYPubZPub403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncNewHDWalletXPubYPubZPub403Response(val *SyncNewHDWalletXPubYPubZPub403Response) *NullableSyncNewHDWalletXPubYPubZPub403Response {
	return &NullableSyncNewHDWalletXPubYPubZPub403Response{value: val, isSet: true}
}

func (v NullableSyncNewHDWalletXPubYPubZPub403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncNewHDWalletXPubYPubZPub403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
