...
type GetEIP1559FeeRecommendationsE403 struct {
...
func BannedIpAddressAsGetEIP1559FeeRecommendationsE403(v *BannedIpAddress) GetEIP1559FeeRecommendationsE403 {
	return GetEIP1559FeeRecommendationsE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetEIP1559FeeRecommendationsE403(v *EndpointNotAllowedForApiKey) GetEIP1559FeeRecommendationsE403 {
	return GetEIP1559FeeRecommendationsE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetEIP1559FeeRecommendationsE403(v *EndpointNotAllowedForPlan) GetEIP1559FeeRecommendationsE403 {
	return GetEIP1559FeeRecommendationsE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetEIP1559FeeRecommendationsE403(v *FeatureMainnetsNotAllowedForPlan) GetEIP1559FeeRecommendationsE403 {
	return GetEIP1559FeeRecommendationsE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetEIP1559FeeRecommendationsE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetEIP1559FeeRecommendationsE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetEIP1559FeeRecommendationsE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetEIP1559FeeRecommendationsE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetEIP1559FeeRecommendationsE403) GetActualInstance() (interface{}) {
...
type NullableGetEIP1559FeeRecommendationsE403 struct {
	value *GetEIP1559FeeRecommendationsE403
	isSet bool
}

func (v NullableGetEIP1559FeeRecommendationsE403) Get() *GetEIP1559FeeRecommendationsE403 {
	return v.value
}

func (v *NullableGetEIP1559FeeRecommendationsE403) Set(val *GetEIP1559FeeRecommendationsE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEIP1559FeeRecommendationsE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEIP1559FeeRecommendationsE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEIP1559FeeRecommendationsE403(val *GetEIP1559FeeRecommendationsE403) *NullableGetEIP1559FeeRecommendationsE403 {
	return &NullableGetEIP1559FeeRecommendationsE403{value: val, isSet: true}
}

func (v NullableGetEIP1559FeeRecommendationsE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEIP1559FeeRecommendationsE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
