...
// WalletAsAServiceTokenNotSupportedError struct for WalletAsAServiceTokenNotSupportedError
type WalletAsAServiceTokenNotSupportedError struct {
...
func NewWalletAsAServiceTokenNotSupportedError(code string, message string) *WalletAsAServiceTokenNotSupportedError {
	this := WalletAsAServiceTokenNotSupportedError{}
	this.Code = code
...
func (o WalletAsAServiceTokenNotSupportedError) MarshalJSON() ([]byte, error) {
...
type NullableWalletAsAServiceTokenNotSupportedError struct {
	value *WalletAsAServiceTokenNotSupportedError
	isSet bool
}

func (v NullableWalletAsAServiceTokenNotSupportedError) Get() *WalletAsAServiceTokenNotSupportedError {
	return v.value
}

func (v *NullableWalletAsAServiceTokenNotSupportedError) Set(val *WalletAsAServiceTokenNotSupportedError) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletAsAServiceTokenNotSupportedError) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletAsAServiceTokenNotSupportedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletAsAServiceTokenNotSupportedError(val *WalletAsAServiceTokenNotSupportedError) *NullableWalletAsAServiceTokenNotSupportedError {
	return &NullableWalletAsAServiceTokenNotSupportedError{value: val, isSet: true}
}

func (v NullableWalletAsAServiceTokenNotSupportedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletAsAServiceTokenNotSupportedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
