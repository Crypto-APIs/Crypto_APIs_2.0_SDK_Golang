...
type GetBlockDetailsByBlockHeightE403 struct {
...
func BannedIpAddressAsGetBlockDetailsByBlockHeightE403(v *BannedIpAddress) GetBlockDetailsByBlockHeightE403 {
	return GetBlockDetailsByBlockHeightE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetBlockDetailsByBlockHeightE403(v *EndpointNotAllowedForApiKey) GetBlockDetailsByBlockHeightE403 {
	return GetBlockDetailsByBlockHeightE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetBlockDetailsByBlockHeightE403(v *EndpointNotAllowedForPlan) GetBlockDetailsByBlockHeightE403 {
	return GetBlockDetailsByBlockHeightE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetBlockDetailsByBlockHeightE403(v *FeatureMainnetsNotAllowedForPlan) GetBlockDetailsByBlockHeightE403 {
	return GetBlockDetailsByBlockHeightE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetBlockDetailsByBlockHeightE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetBlockDetailsByBlockHeightE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetBlockDetailsByBlockHeightE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetBlockDetailsByBlockHeightE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetBlockDetailsByBlockHeightE403) GetActualInstance() (interface{}) {
...
type NullableGetBlockDetailsByBlockHeightE403 struct {
	value *GetBlockDetailsByBlockHeightE403
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightE403) Get() *GetBlockDetailsByBlockHeightE403 {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightE403) Set(val *GetBlockDetailsByBlockHeightE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightE403(val *GetBlockDetailsByBlockHeightE403) *NullableGetBlockDetailsByBlockHeightE403 {
	return &NullableGetBlockDetailsByBlockHeightE403{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
