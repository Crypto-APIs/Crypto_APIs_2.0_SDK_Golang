...
type ListTransactionsByBlockHashRIBS struct {
	...
	ListTransactionsByBlockHashRIBSBSC *ListTransactionsByBlockHashRIBSBSC
	...
	ListTransactionsByBlockHashRIBSZ *ListTransactionsByBlockHashRIBSZ
}
...
func (dst *ListTransactionsByBlockHashRIBS) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonListTransactionsByBlockHashRIBSBSC) == "{}" { // empty struct
			dst.ListTransactionsByBlockHashRIBSBSC = nil
		} else {
			match++
		}
	} else {
	...
	if err == nil {
		...
		if string(jsonListTransactionsByBlockHashRIBSZ) == "{}" { // empty struct
			dst.ListTransactionsByBlockHashRIBSZ = nil
		} else {
			match++
		}
	} else {
...
func (src ListTransactionsByBlockHashRIBS) MarshalJSON() ([]byte, error) {
	...
	if src.ListTransactionsByBlockHashRIBSBSC != nil {
		return json.Marshal(&src.ListTransactionsByBlockHashRIBSBSC)
	}
	...
	if src.ListTransactionsByBlockHashRIBSZ != nil {
		return json.Marshal(&src.ListTransactionsByBlockHashRIBSZ)
	}
...
func (obj *ListTransactionsByBlockHashRIBS) GetActualInstance() (interface{}) {
	...
	if obj.ListTransactionsByBlockHashRIBSBSC != nil {
		return obj.ListTransactionsByBlockHashRIBSBSC
	}
	...
	if obj.ListTransactionsByBlockHashRIBSZ != nil {
		return obj.ListTransactionsByBlockHashRIBSZ
	}
