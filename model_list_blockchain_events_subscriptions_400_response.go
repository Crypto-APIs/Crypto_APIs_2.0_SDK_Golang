...
type ListBlockchainEventsSubscriptions400Response struct {
...
func (o ListBlockchainEventsSubscriptions400Response) MarshalJSON() ([]byte, error) {
...
type NullableListBlockchainEventsSubscriptions400Response struct {
	value *ListBlockchainEventsSubscriptions400Response
	isSet bool
}

func (v NullableListBlockchainEventsSubscriptions400Response) Get() *ListBlockchainEventsSubscriptions400Response {
	return v.value
}

func (v *NullableListBlockchainEventsSubscriptions400Response) Set(val *ListBlockchainEventsSubscriptions400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListBlockchainEventsSubscriptions400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListBlockchainEventsSubscriptions400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListBlockchainEventsSubscriptions400Response(val *ListBlockchainEventsSubscriptions400Response) *NullableListBlockchainEventsSubscriptions400Response {
	return &NullableListBlockchainEventsSubscriptions400Response{value: val, isSet: true}
}

func (v NullableListBlockchainEventsSubscriptions400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListBlockchainEventsSubscriptions400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
