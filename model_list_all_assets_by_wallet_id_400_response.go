...
type ListAllAssetsByWalletID400Response struct {
	...
	Error ListAllAssetsByWalletIDE400 `json:"error"`
}
...
func NewListAllAssetsByWalletID400Response(apiVersion string, requestId string, error_ ListAllAssetsByWalletIDE400) *ListAllAssetsByWalletID400Response {
	this := ListAllAssetsByWalletID400Response{}
...
func (o *ListAllAssetsByWalletID400Response) GetError() ListAllAssetsByWalletIDE400 {
	if o == nil {
		var ret ListAllAssetsByWalletIDE400
		return ret
	}
...
func (o ListAllAssetsByWalletID400Response) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsByWalletID400Response struct {
	value *ListAllAssetsByWalletID400Response
	isSet bool
}

func (v NullableListAllAssetsByWalletID400Response) Get() *ListAllAssetsByWalletID400Response {
	return v.value
}

func (v *NullableListAllAssetsByWalletID400Response) Set(val *ListAllAssetsByWalletID400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsByWalletID400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsByWalletID400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsByWalletID400Response(val *ListAllAssetsByWalletID400Response) *NullableListAllAssetsByWalletID400Response {
	return &NullableListAllAssetsByWalletID400Response{value: val, isSet: true}
}

func (v NullableListAllAssetsByWalletID400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsByWalletID400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
