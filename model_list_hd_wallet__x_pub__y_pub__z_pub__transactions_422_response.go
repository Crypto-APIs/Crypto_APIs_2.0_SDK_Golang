...
type ListHDWalletXPubYPubZPubTransactions422Response struct {
	...
	Error ListHDWalletXPubYPubZPubTransactionsE422 `json:"error"`
}
...
func NewListHDWalletXPubYPubZPubTransactions422Response(apiVersion string, requestId string, error_ ListHDWalletXPubYPubZPubTransactionsE422) *ListHDWalletXPubYPubZPubTransactions422Response {
	this := ListHDWalletXPubYPubZPubTransactions422Response{}
...
func (o *ListHDWalletXPubYPubZPubTransactions422Response) GetError() ListHDWalletXPubYPubZPubTransactionsE422 {
	if o == nil {
		var ret ListHDWalletXPubYPubZPubTransactionsE422
		return ret
	}
...
func (o ListHDWalletXPubYPubZPubTransactions422Response) MarshalJSON() ([]byte, error) {
...
type NullableListHDWalletXPubYPubZPubTransactions422Response struct {
	value *ListHDWalletXPubYPubZPubTransactions422Response
	isSet bool
}

func (v NullableListHDWalletXPubYPubZPubTransactions422Response) Get() *ListHDWalletXPubYPubZPubTransactions422Response {
	return v.value
}

func (v *NullableListHDWalletXPubYPubZPubTransactions422Response) Set(val *ListHDWalletXPubYPubZPubTransactions422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListHDWalletXPubYPubZPubTransactions422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListHDWalletXPubYPubZPubTransactions422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListHDWalletXPubYPubZPubTransactions422Response(val *ListHDWalletXPubYPubZPubTransactions422Response) *NullableListHDWalletXPubYPubZPubTransactions422Response {
	return &NullableListHDWalletXPubYPubZPubTransactions422Response{value: val, isSet: true}
}

func (v NullableListHDWalletXPubYPubZPubTransactions422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListHDWalletXPubYPubZPubTransactions422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
