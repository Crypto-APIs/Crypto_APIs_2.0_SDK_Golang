...
type GetZilliqaBlockDetailsByBlockHashE400 struct {
...
func (dst *GetZilliqaBlockDetailsByBlockHashE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetZilliqaBlockDetailsByBlockHashE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetZilliqaBlockDetailsByBlockHashE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetZilliqaBlockDetailsByBlockHashE400) MarshalJSON() ([]byte, error) {
...
type NullableGetZilliqaBlockDetailsByBlockHashE400 struct {
	value *GetZilliqaBlockDetailsByBlockHashE400
	isSet bool
}

func (v NullableGetZilliqaBlockDetailsByBlockHashE400) Get() *GetZilliqaBlockDetailsByBlockHashE400 {
	return v.value
}

func (v *NullableGetZilliqaBlockDetailsByBlockHashE400) Set(val *GetZilliqaBlockDetailsByBlockHashE400) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZilliqaBlockDetailsByBlockHashE400) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZilliqaBlockDetailsByBlockHashE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZilliqaBlockDetailsByBlockHashE400(val *GetZilliqaBlockDetailsByBlockHashE400) *NullableGetZilliqaBlockDetailsByBlockHashE400 {
	return &NullableGetZilliqaBlockDetailsByBlockHashE400{value: val, isSet: true}
}

func (v NullableGetZilliqaBlockDetailsByBlockHashE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZilliqaBlockDetailsByBlockHashE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
