...
type ListUnspentTransactionOutputsByAddressR struct {
	...
	Data ListUnspentTransactionOutputsByAddressRData `json:"data"`
}
...
func NewListUnspentTransactionOutputsByAddressR(apiVersion string, requestId string, data ListUnspentTransactionOutputsByAddressRData) *ListUnspentTransactionOutputsByAddressR {
	this := ListUnspentTransactionOutputsByAddressR{}
...
func (o *ListUnspentTransactionOutputsByAddressR) GetData() ListUnspentTransactionOutputsByAddressRData {
	if o == nil {
		var ret ListUnspentTransactionOutputsByAddressRData
		return ret
	}
...
func (o ListUnspentTransactionOutputsByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableListUnspentTransactionOutputsByAddressR struct {
	value *ListUnspentTransactionOutputsByAddressR
	isSet bool
}

func (v NullableListUnspentTransactionOutputsByAddressR) Get() *ListUnspentTransactionOutputsByAddressR {
	return v.value
}

func (v *NullableListUnspentTransactionOutputsByAddressR) Set(val *ListUnspentTransactionOutputsByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnspentTransactionOutputsByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnspentTransactionOutputsByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnspentTransactionOutputsByAddressR(val *ListUnspentTransactionOutputsByAddressR) *NullableListUnspentTransactionOutputsByAddressR {
	return &NullableListUnspentTransactionOutputsByAddressR{value: val, isSet: true}
}

func (v NullableListUnspentTransactionOutputsByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnspentTransactionOutputsByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
