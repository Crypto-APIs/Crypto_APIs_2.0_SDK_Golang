...
type NewUnconfirmedCoinsTransactions409Response struct {
...
func (o NewUnconfirmedCoinsTransactions409Response) MarshalJSON() ([]byte, error) {
...
type NullableNewUnconfirmedCoinsTransactions409Response struct {
	value *NewUnconfirmedCoinsTransactions409Response
	isSet bool
}

func (v NullableNewUnconfirmedCoinsTransactions409Response) Get() *NewUnconfirmedCoinsTransactions409Response {
	return v.value
}

func (v *NullableNewUnconfirmedCoinsTransactions409Response) Set(val *NewUnconfirmedCoinsTransactions409Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUnconfirmedCoinsTransactions409Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUnconfirmedCoinsTransactions409Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUnconfirmedCoinsTransactions409Response(val *NewUnconfirmedCoinsTransactions409Response) *NullableNewUnconfirmedCoinsTransactions409Response {
	return &NullableNewUnconfirmedCoinsTransactions409Response{value: val, isSet: true}
}

func (v NullableNewUnconfirmedCoinsTransactions409Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUnconfirmedCoinsTransactions409Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
