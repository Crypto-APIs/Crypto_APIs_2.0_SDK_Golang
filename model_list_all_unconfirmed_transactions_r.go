...
// ListAllUnconfirmedTransactionsR struct for ListAllUnconfirmedTransactionsR
type ListAllUnconfirmedTransactionsR struct {
	...
	Data ListAllUnconfirmedTransactionsRData `json:"data"`
}
...
func NewListAllUnconfirmedTransactionsR(apiVersion string, requestId string, data ListAllUnconfirmedTransactionsRData) *ListAllUnconfirmedTransactionsR {
	this := ListAllUnconfirmedTransactionsR{}
...
func (o *ListAllUnconfirmedTransactionsR) GetData() ListAllUnconfirmedTransactionsRData {
	if o == nil {
		var ret ListAllUnconfirmedTransactionsRData
		return ret
	}
...
func (o ListAllUnconfirmedTransactionsR) MarshalJSON() ([]byte, error) {
...
type NullableListAllUnconfirmedTransactionsR struct {
	value *ListAllUnconfirmedTransactionsR
	isSet bool
}

func (v NullableListAllUnconfirmedTransactionsR) Get() *ListAllUnconfirmedTransactionsR {
	return v.value
}

func (v *NullableListAllUnconfirmedTransactionsR) Set(val *ListAllUnconfirmedTransactionsR) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllUnconfirmedTransactionsR) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllUnconfirmedTransactionsR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllUnconfirmedTransactionsR(val *ListAllUnconfirmedTransactionsR) *NullableListAllUnconfirmedTransactionsR {
	return &NullableListAllUnconfirmedTransactionsR{value: val, isSet: true}
}

func (v NullableListAllUnconfirmedTransactionsR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllUnconfirmedTransactionsR) UnmarshalJSON(src []byte) error {
	v.isSet = true
