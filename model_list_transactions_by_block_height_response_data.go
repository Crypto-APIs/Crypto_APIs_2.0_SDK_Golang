...
// ListTransactionsByBlockHeightResponseData struct for ListTransactionsByBlockHeightResponseData
type ListTransactionsByBlockHeightResponseData struct {
	...
	Items []ListTransactionsByBlockHeightResponseItem `json:"items"`
}
...
func NewListTransactionsByBlockHeightResponseData(offset int32, limit int32, total int32, items []ListTransactionsByBlockHeightResponseItem) *ListTransactionsByBlockHeightResponseData {
	this := ListTransactionsByBlockHeightResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListTransactionsByBlockHeightResponseData) GetItems() []ListTransactionsByBlockHeightResponseItem {
	if o == nil {
		var ret []ListTransactionsByBlockHeightResponseItem
		return ret
	}
...
func (o ListTransactionsByBlockHeightResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHeightResponseData struct {
	value *ListTransactionsByBlockHeightResponseData
	isSet bool
}

func (v NullableListTransactionsByBlockHeightResponseData) Get() *ListTransactionsByBlockHeightResponseData {
	return v.value
}

func (v *NullableListTransactionsByBlockHeightResponseData) Set(val *ListTransactionsByBlockHeightResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHeightResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHeightResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHeightResponseData(val *ListTransactionsByBlockHeightResponseData) *NullableListTransactionsByBlockHeightResponseData {
	return &NullableListTransactionsByBlockHeightResponseData{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHeightResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHeightResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
