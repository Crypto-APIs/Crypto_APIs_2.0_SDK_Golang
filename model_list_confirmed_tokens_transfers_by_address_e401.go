...
type ListConfirmedTokensTransfersByAddressE401 struct {
...
func (dst *ListConfirmedTokensTransfersByAddressE401) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(ListConfirmedTokensTransfersByAddressE401)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(ListConfirmedTokensTransfersByAddressE401)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListConfirmedTokensTransfersByAddressE401) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTokensTransfersByAddressE401 struct {
	value *ListConfirmedTokensTransfersByAddressE401
	isSet bool
}

func (v NullableListConfirmedTokensTransfersByAddressE401) Get() *ListConfirmedTokensTransfersByAddressE401 {
	return v.value
}

func (v *NullableListConfirmedTokensTransfersByAddressE401) Set(val *ListConfirmedTokensTransfersByAddressE401) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTokensTransfersByAddressE401) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTokensTransfersByAddressE401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTokensTransfersByAddressE401(val *ListConfirmedTokensTransfersByAddressE401) *NullableListConfirmedTokensTransfersByAddressE401 {
	return &NullableListConfirmedTokensTransfersByAddressE401{value: val, isSet: true}
}

func (v NullableListConfirmedTokensTransfersByAddressE401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTokensTransfersByAddressE401) UnmarshalJSON(src []byte) error {
	v.isSet = true
