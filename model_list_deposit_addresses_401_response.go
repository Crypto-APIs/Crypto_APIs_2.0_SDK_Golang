...
type ListDepositAddresses401Response struct {
	...
	Error ListDepositAddressesE401 `json:"error"`
}
...
func NewListDepositAddresses401Response(apiVersion string, requestId string, error_ ListDepositAddressesE401) *ListDepositAddresses401Response {
	this := ListDepositAddresses401Response{}
...
func (o *ListDepositAddresses401Response) GetError() ListDepositAddressesE401 {
	if o == nil {
		var ret ListDepositAddressesE401
		return ret
	}
...
func (o ListDepositAddresses401Response) MarshalJSON() ([]byte, error) {
...
type NullableListDepositAddresses401Response struct {
	value *ListDepositAddresses401Response
	isSet bool
}

func (v NullableListDepositAddresses401Response) Get() *ListDepositAddresses401Response {
	return v.value
}

func (v *NullableListDepositAddresses401Response) Set(val *ListDepositAddresses401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDepositAddresses401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDepositAddresses401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDepositAddresses401Response(val *ListDepositAddresses401Response) *NullableListDepositAddresses401Response {
	return &NullableListDepositAddresses401Response{value: val, isSet: true}
}

func (v NullableListDepositAddresses401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDepositAddresses401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
