...
// ListOmniTransactionsByBlockHeightResponse struct for ListOmniTransactionsByBlockHeightResponse
type ListOmniTransactionsByBlockHeightResponse struct {
	...
	Data ListOmniTransactionsByBlockHeightResponseData `json:"data"`
}
...
func NewListOmniTransactionsByBlockHeightResponse(apiVersion string, requestId string, data ListOmniTransactionsByBlockHeightResponseData) *ListOmniTransactionsByBlockHeightResponse {
	this := ListOmniTransactionsByBlockHeightResponse{}
...
func (o *ListOmniTransactionsByBlockHeightResponse) GetData() ListOmniTransactionsByBlockHeightResponseData {
	if o == nil {
		var ret ListOmniTransactionsByBlockHeightResponseData
		return ret
	}
...
func (o ListOmniTransactionsByBlockHeightResponse) MarshalJSON() ([]byte, error) {
...
type NullableListOmniTransactionsByBlockHeightResponse struct {
	value *ListOmniTransactionsByBlockHeightResponse
	isSet bool
}

func (v NullableListOmniTransactionsByBlockHeightResponse) Get() *ListOmniTransactionsByBlockHeightResponse {
	return v.value
}

func (v *NullableListOmniTransactionsByBlockHeightResponse) Set(val *ListOmniTransactionsByBlockHeightResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOmniTransactionsByBlockHeightResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOmniTransactionsByBlockHeightResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOmniTransactionsByBlockHeightResponse(val *ListOmniTransactionsByBlockHeightResponse) *NullableListOmniTransactionsByBlockHeightResponse {
	return &NullableListOmniTransactionsByBlockHeightResponse{value: val, isSet: true}
}

func (v NullableListOmniTransactionsByBlockHeightResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOmniTransactionsByBlockHeightResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
