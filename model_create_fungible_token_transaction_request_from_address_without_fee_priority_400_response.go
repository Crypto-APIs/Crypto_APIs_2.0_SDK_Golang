...
type CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response struct {
	...
	Error CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 `json:"error"`
}
...
func NewCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response(apiVersion string, requestId string, error_ CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400) *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response {
	this := CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response{}
...
func (o *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) GetError() CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400 {
	if o == nil {
		var ret CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400
		return ret
	}
...
func (o CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response struct {
	value *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response
	isSet bool
}

func (v NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) Get() *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response {
	return v.value
}

func (v *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) Set(val *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response(val *CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response {
	return &NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response{value: val, isSet: true}
}

func (v NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
