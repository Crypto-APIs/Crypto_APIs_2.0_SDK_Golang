...
type EstimateTransactionSmartFee403Response struct {
	...
	Error EstimateTransactionSmartFeeE403 `json:"error"`
}
...
func NewEstimateTransactionSmartFee403Response(apiVersion string, requestId string, error_ EstimateTransactionSmartFeeE403) *EstimateTransactionSmartFee403Response {
	this := EstimateTransactionSmartFee403Response{}
...
func (o EstimateTransactionSmartFee403Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateTransactionSmartFee403Response struct {
	value *EstimateTransactionSmartFee403Response
	isSet bool
}

func (v NullableEstimateTransactionSmartFee403Response) Get() *EstimateTransactionSmartFee403Response {
	return v.value
}

func (v *NullableEstimateTransactionSmartFee403Response) Set(val *EstimateTransactionSmartFee403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTransactionSmartFee403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTransactionSmartFee403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTransactionSmartFee403Response(val *EstimateTransactionSmartFee403Response) *NullableEstimateTransactionSmartFee403Response {
	return &NullableEstimateTransactionSmartFee403Response{value: val, isSet: true}
}

func (v NullableEstimateTransactionSmartFee403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTransactionSmartFee403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
