...
type ListXRPRippleTransactionsByBlockHashRData struct {
	...
	Items []ListXRPRippleTransactionsByBlockHashRI `json:"items"`
}
...
func NewListXRPRippleTransactionsByBlockHashRData(offset int32, limit int32, total int32, items []ListXRPRippleTransactionsByBlockHashRI) *ListXRPRippleTransactionsByBlockHashRData {
	this := ListXRPRippleTransactionsByBlockHashRData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListXRPRippleTransactionsByBlockHashRData) GetItems() []ListXRPRippleTransactionsByBlockHashRI {
	if o == nil {
		var ret []ListXRPRippleTransactionsByBlockHashRI
		return ret
	}
...
func (o ListXRPRippleTransactionsByBlockHashRData) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHashRData struct {
	value *ListXRPRippleTransactionsByBlockHashRData
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHashRData) Get() *ListXRPRippleTransactionsByBlockHashRData {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHashRData) Set(val *ListXRPRippleTransactionsByBlockHashRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHashRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHashRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHashRData(val *ListXRPRippleTransactionsByBlockHashRData) *NullableListXRPRippleTransactionsByBlockHashRData {
	return &NullableListXRPRippleTransactionsByBlockHashRData{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHashRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHashRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
