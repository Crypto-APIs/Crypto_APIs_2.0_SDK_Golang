...
type BlockHeightReachedE400 struct {
...
func InvalidPaginationAsBlockHeightReachedE400(v *InvalidPagination) BlockHeightReachedE400 {
...
func LimitGreaterThanAllowedAsBlockHeightReachedE400(v *LimitGreaterThanAllowed) BlockHeightReachedE400 {
	return BlockHeightReachedE400{
...
func UriNotFoundAsBlockHeightReachedE400(v *UriNotFound) BlockHeightReachedE400 {
	return BlockHeightReachedE400{
		UriNotFound: v,
	}
}
...
func (dst *BlockHeightReachedE400) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(BlockHeightReachedE400)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(BlockHeightReachedE400)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src BlockHeightReachedE400) MarshalJSON() ([]byte, error) {
...
func (obj *BlockHeightReachedE400) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableBlockHeightReachedE400 struct {
	value *BlockHeightReachedE400
	isSet bool
}

func (v NullableBlockHeightReachedE400) Get() *BlockHeightReachedE400 {
	return v.value
}

func (v *NullableBlockHeightReachedE400) Set(val *BlockHeightReachedE400) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockHeightReachedE400) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockHeightReachedE400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockHeightReachedE400(val *BlockHeightReachedE400) *NullableBlockHeightReachedE400 {
	return &NullableBlockHeightReachedE400{value: val, isSet: true}
}

func (v NullableBlockHeightReachedE400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockHeightReachedE400) UnmarshalJSON(src []byte) error {
	v.isSet = true
