...
type NewConfirmedInternalTransactionsAndEachConfirmationR struct {
	...
	Data NewConfirmedInternalTransactionsAndEachConfirmationRData `json:"data"`
}
...
func NewNewConfirmedInternalTransactionsAndEachConfirmationR(apiVersion string, requestId string, data NewConfirmedInternalTransactionsAndEachConfirmationRData) *NewConfirmedInternalTransactionsAndEachConfirmationR {
	this := NewConfirmedInternalTransactionsAndEachConfirmationR{}
...
func (o *NewConfirmedInternalTransactionsAndEachConfirmationR) GetData() NewConfirmedInternalTransactionsAndEachConfirmationRData {
	if o == nil {
		var ret NewConfirmedInternalTransactionsAndEachConfirmationRData
		return ret
	}
...
func (o NewConfirmedInternalTransactionsAndEachConfirmationR) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedInternalTransactionsAndEachConfirmationR struct {
	value *NewConfirmedInternalTransactionsAndEachConfirmationR
	isSet bool
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmationR) Get() *NewConfirmedInternalTransactionsAndEachConfirmationR {
	return v.value
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmationR) Set(val *NewConfirmedInternalTransactionsAndEachConfirmationR) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmationR) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmationR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedInternalTransactionsAndEachConfirmationR(val *NewConfirmedInternalTransactionsAndEachConfirmationR) *NullableNewConfirmedInternalTransactionsAndEachConfirmationR {
	return &NullableNewConfirmedInternalTransactionsAndEachConfirmationR{value: val, isSet: true}
}

func (v NullableNewConfirmedInternalTransactionsAndEachConfirmationR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedInternalTransactionsAndEachConfirmationR) UnmarshalJSON(src []byte) error {
	v.isSet = true
