...
type DecodeXAddress400Response struct {
	...
	Error DecodeXAddressE400 `json:"error"`
}
...
func NewDecodeXAddress400Response(apiVersion string, requestId string, error_ DecodeXAddressE400) *DecodeXAddress400Response {
	this := DecodeXAddress400Response{}
...
func (o DecodeXAddress400Response) MarshalJSON() ([]byte, error) {
...
type NullableDecodeXAddress400Response struct {
	value *DecodeXAddress400Response
	isSet bool
}

func (v NullableDecodeXAddress400Response) Get() *DecodeXAddress400Response {
	return v.value
}

func (v *NullableDecodeXAddress400Response) Set(val *DecodeXAddress400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeXAddress400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeXAddress400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeXAddress400Response(val *DecodeXAddress400Response) *NullableDecodeXAddress400Response {
	return &NullableDecodeXAddress400Response{value: val, isSet: true}
}

func (v NullableDecodeXAddress400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeXAddress400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
