...
type GetFeeAddressDetails403Response struct {
	...
	Error GetFeeAddressDetailsE403 `json:"error"`
}
...
func NewGetFeeAddressDetails403Response(apiVersion string, requestId string, error_ GetFeeAddressDetailsE403) *GetFeeAddressDetails403Response {
	this := GetFeeAddressDetails403Response{}
...
func (o *GetFeeAddressDetails403Response) GetError() GetFeeAddressDetailsE403 {
	if o == nil {
		var ret GetFeeAddressDetailsE403
		return ret
	}
...
func (o GetFeeAddressDetails403Response) MarshalJSON() ([]byte, error) {
...
type NullableGetFeeAddressDetails403Response struct {
	value *GetFeeAddressDetails403Response
	isSet bool
}

func (v NullableGetFeeAddressDetails403Response) Get() *GetFeeAddressDetails403Response {
	return v.value
}

func (v *NullableGetFeeAddressDetails403Response) Set(val *GetFeeAddressDetails403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeAddressDetails403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeAddressDetails403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeAddressDetails403Response(val *GetFeeAddressDetails403Response) *NullableGetFeeAddressDetails403Response {
	return &NullableGetFeeAddressDetails403Response{value: val, isSet: true}
}

func (v NullableGetFeeAddressDetails403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeAddressDetails403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
