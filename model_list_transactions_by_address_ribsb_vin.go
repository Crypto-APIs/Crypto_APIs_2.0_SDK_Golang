...
// ListTransactionsByAddressRIBSBVin struct for ListTransactionsByAddressRIBSBVin
type ListTransactionsByAddressRIBSBVin struct {
...
func NewListTransactionsByAddressRIBSBVin(addresses []string, scriptSig GetTransactionDetailsByTransactionIDRIBSBScriptSig, sequence string, txinwitness []string) *ListTransactionsByAddressRIBSBVin {
	this := ListTransactionsByAddressRIBSBVin{}
...
func (o ListTransactionsByAddressRIBSBVin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByAddressRIBSBVin struct {
	value *ListTransactionsByAddressRIBSBVin
	isSet bool
}

func (v NullableListTransactionsByAddressRIBSBVin) Get() *ListTransactionsByAddressRIBSBVin {
	return v.value
}

func (v *NullableListTransactionsByAddressRIBSBVin) Set(val *ListTransactionsByAddressRIBSBVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByAddressRIBSBVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByAddressRIBSBVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByAddressRIBSBVin(val *ListTransactionsByAddressRIBSBVin) *NullableListTransactionsByAddressRIBSBVin {
	return &NullableListTransactionsByAddressRIBSBVin{value: val, isSet: true}
}

func (v NullableListTransactionsByAddressRIBSBVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByAddressRIBSBVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
