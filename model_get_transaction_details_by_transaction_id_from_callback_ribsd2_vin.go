...
// GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin struct for GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin
type GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin struct {
...
func (o GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin struct {
	value *GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) Get() *GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) Set(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin(val *GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin {
	return &NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin) UnmarshalJSON(src []byte) error {
	v.isSet = true
