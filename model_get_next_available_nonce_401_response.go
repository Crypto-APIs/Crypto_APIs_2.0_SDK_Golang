...
type GetNextAvailableNonce401Response struct {
	...
	Error GetNextAvailableNonceE401 `json:"error"`
}
...
func NewGetNextAvailableNonce401Response(apiVersion string, requestId string, error_ GetNextAvailableNonceE401) *GetNextAvailableNonce401Response {
	this := GetNextAvailableNonce401Response{}
...
func (o *GetNextAvailableNonce401Response) GetError() GetNextAvailableNonceE401 {
	if o == nil {
		var ret GetNextAvailableNonceE401
		return ret
	}
...
func (o GetNextAvailableNonce401Response) MarshalJSON() ([]byte, error) {
...
type NullableGetNextAvailableNonce401Response struct {
	value *GetNextAvailableNonce401Response
	isSet bool
}

func (v NullableGetNextAvailableNonce401Response) Get() *GetNextAvailableNonce401Response {
	return v.value
}

func (v *NullableGetNextAvailableNonce401Response) Set(val *GetNextAvailableNonce401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNextAvailableNonce401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNextAvailableNonce401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNextAvailableNonce401Response(val *GetNextAvailableNonce401Response) *NullableGetNextAvailableNonce401Response {
	return &NullableGetNextAvailableNonce401Response{value: val, isSet: true}
}

func (v NullableGetNextAvailableNonce401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNextAvailableNonce401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
