...
// BlockchainEventsCallbacksLimitReached struct for BlockchainEventsCallbacksLimitReached
type BlockchainEventsCallbacksLimitReached struct {
	...
	Error BlockchainEventsCallbacksLimitReachedError `json:"error"`
}
...
func (o *BlockchainEventsCallbacksLimitReached) GetError() BlockchainEventsCallbacksLimitReachedError {
	if o == nil {
		var ret BlockchainEventsCallbacksLimitReachedError
		return ret
	}
