...
type ListConfirmedTransactionsByAddressR struct {
	...
	Data ListConfirmedTransactionsByAddressRData `json:"data"`
}
...
func NewListConfirmedTransactionsByAddressR(apiVersion string, requestId string, data ListConfirmedTransactionsByAddressRData) *ListConfirmedTransactionsByAddressR {
	this := ListConfirmedTransactionsByAddressR{}
...
func (o *ListConfirmedTransactionsByAddressR) GetData() ListConfirmedTransactionsByAddressRData {
	if o == nil {
		var ret ListConfirmedTransactionsByAddressRData
		return ret
	}
...
func (o ListConfirmedTransactionsByAddressR) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressR struct {
	value *ListConfirmedTransactionsByAddressR
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressR) Get() *ListConfirmedTransactionsByAddressR {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressR) Set(val *ListConfirmedTransactionsByAddressR) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressR) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressR(val *ListConfirmedTransactionsByAddressR) *NullableListConfirmedTransactionsByAddressR {
	return &NullableListConfirmedTransactionsByAddressR{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressR) UnmarshalJSON(src []byte) error {
	v.isSet = true
