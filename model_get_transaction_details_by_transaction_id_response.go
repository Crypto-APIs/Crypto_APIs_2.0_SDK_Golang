...
// GetTransactionDetailsByTransactionIDResponse struct for GetTransactionDetailsByTransactionIDResponse
type GetTransactionDetailsByTransactionIDResponse struct {
	...
	Data GetTransactionDetailsByTransactionIDResponseData `json:"data"`
}
...
func NewGetTransactionDetailsByTransactionIDResponse(apiVersion string, requestId string, data GetTransactionDetailsByTransactionIDResponseData) *GetTransactionDetailsByTransactionIDResponse {
	this := GetTransactionDetailsByTransactionIDResponse{}
...
func (o *GetTransactionDetailsByTransactionIDResponse) GetData() GetTransactionDetailsByTransactionIDResponseData {
	if o == nil {
		var ret GetTransactionDetailsByTransactionIDResponseData
		return ret
	}
...
func (o GetTransactionDetailsByTransactionIDResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionDetailsByTransactionIDResponse struct {
	value *GetTransactionDetailsByTransactionIDResponse
	isSet bool
}

func (v NullableGetTransactionDetailsByTransactionIDResponse) Get() *GetTransactionDetailsByTransactionIDResponse {
	return v.value
}

func (v *NullableGetTransactionDetailsByTransactionIDResponse) Set(val *GetTransactionDetailsByTransactionIDResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionDetailsByTransactionIDResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionDetailsByTransactionIDResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionDetailsByTransactionIDResponse(val *GetTransactionDetailsByTransactionIDResponse) *NullableGetTransactionDetailsByTransactionIDResponse {
	return &NullableGetTransactionDetailsByTransactionIDResponse{value: val, isSet: true}
}

func (v NullableGetTransactionDetailsByTransactionIDResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionDetailsByTransactionIDResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
