...
type ListTransactionsByBlockHash400Response struct {
	...
	Error ListTransactionsByBlockHashE400 `json:"error"`
}
...
func NewListTransactionsByBlockHash400Response(apiVersion string, requestId string, error_ ListTransactionsByBlockHashE400) *ListTransactionsByBlockHash400Response {
	this := ListTransactionsByBlockHash400Response{}
...
func (o ListTransactionsByBlockHash400Response) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHash400Response struct {
	value *ListTransactionsByBlockHash400Response
	isSet bool
}

func (v NullableListTransactionsByBlockHash400Response) Get() *ListTransactionsByBlockHash400Response {
	return v.value
}

func (v *NullableListTransactionsByBlockHash400Response) Set(val *ListTransactionsByBlockHash400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHash400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHash400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHash400Response(val *ListTransactionsByBlockHash400Response) *NullableListTransactionsByBlockHash400Response {
	return &NullableListTransactionsByBlockHash400Response{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHash400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHash400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
