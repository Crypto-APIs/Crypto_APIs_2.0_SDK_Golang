...
// BlockchainDataInternalTransactionNotFound struct for BlockchainDataInternalTransactionNotFound
type BlockchainDataInternalTransactionNotFound struct {
	...
	Error BlockchainDataInternalTransactionNotFoundError `json:"error"`
}
...
func NewBlockchainDataInternalTransactionNotFound(apiVersion string, requestId string, error_ BlockchainDataInternalTransactionNotFoundError) *BlockchainDataInternalTransactionNotFound {
	this := BlockchainDataInternalTransactionNotFound{}
...
func (o *BlockchainDataInternalTransactionNotFound) GetError() BlockchainDataInternalTransactionNotFoundError {
	if o == nil {
		var ret BlockchainDataInternalTransactionNotFoundError
		return ret
	}
...
func (o BlockchainDataInternalTransactionNotFound) MarshalJSON() ([]byte, error) {
...
type NullableBlockchainDataInternalTransactionNotFound struct {
	value *BlockchainDataInternalTransactionNotFound
	isSet bool
}

func (v NullableBlockchainDataInternalTransactionNotFound) Get() *BlockchainDataInternalTransactionNotFound {
	return v.value
}

func (v *NullableBlockchainDataInternalTransactionNotFound) Set(val *BlockchainDataInternalTransactionNotFound) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockchainDataInternalTransactionNotFound) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockchainDataInternalTransactionNotFound) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockchainDataInternalTransactionNotFound(val *BlockchainDataInternalTransactionNotFound) *NullableBlockchainDataInternalTransactionNotFound {
	return &NullableBlockchainDataInternalTransactionNotFound{value: val, isSet: true}
}

func (v NullableBlockchainDataInternalTransactionNotFound) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockchainDataInternalTransactionNotFound) UnmarshalJSON(src []byte) error {
	v.isSet = true
