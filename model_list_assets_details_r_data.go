...
// ListAssetsDetailsRData struct for ListAssetsDetailsRData
type ListAssetsDetailsRData struct {
	...
	Items []ListAssetsDetailsRI `json:"items"`
}
...
func (o ListAssetsDetailsRData) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetailsRData struct {
	value *ListAssetsDetailsRData
	isSet bool
}

func (v NullableListAssetsDetailsRData) Get() *ListAssetsDetailsRData {
	return v.value
}

func (v *NullableListAssetsDetailsRData) Set(val *ListAssetsDetailsRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetailsRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetailsRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetailsRData(val *ListAssetsDetailsRData) *NullableListAssetsDetailsRData {
	return &NullableListAssetsDetailsRData{value: val, isSet: true}
}

func (v NullableListAssetsDetailsRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetailsRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
