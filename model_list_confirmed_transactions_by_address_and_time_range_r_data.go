...
type ListConfirmedTransactionsByAddressAndTimeRangeRData struct {
	...
	Items []ListConfirmedTransactionsByAddressAndTimeRangeRI `json:"items"`
}
...
func NewListConfirmedTransactionsByAddressAndTimeRangeRData(limit int32, offset int32, total int32, items []ListConfirmedTransactionsByAddressAndTimeRangeRI) *ListConfirmedTransactionsByAddressAndTimeRangeRData {
	this := ListConfirmedTransactionsByAddressAndTimeRangeRData{}
	this.Limit = limit
	this.Offset = offset
	this.Total = total
	this.Items = items
...
func (o *ListConfirmedTransactionsByAddressAndTimeRangeRData) GetItems() []ListConfirmedTransactionsByAddressAndTimeRangeRI {
	if o == nil {
		var ret []ListConfirmedTransactionsByAddressAndTimeRangeRI
		return ret
	}
...
func (o ListConfirmedTransactionsByAddressAndTimeRangeRData) MarshalJSON() ([]byte, error) {
...
type NullableListConfirmedTransactionsByAddressAndTimeRangeRData struct {
	value *ListConfirmedTransactionsByAddressAndTimeRangeRData
	isSet bool
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeRData) Get() *ListConfirmedTransactionsByAddressAndTimeRangeRData {
	return v.value
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeRData) Set(val *ListConfirmedTransactionsByAddressAndTimeRangeRData) {
	v.value = val
	v.isSet = true
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeRData) IsSet() bool {
	return v.isSet
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeRData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListConfirmedTransactionsByAddressAndTimeRangeRData(val *ListConfirmedTransactionsByAddressAndTimeRangeRData) *NullableListConfirmedTransactionsByAddressAndTimeRangeRData {
	return &NullableListConfirmedTransactionsByAddressAndTimeRangeRData{value: val, isSet: true}
}

func (v NullableListConfirmedTransactionsByAddressAndTimeRangeRData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListConfirmedTransactionsByAddressAndTimeRangeRData) UnmarshalJSON(src []byte) error {
	v.isSet = true
