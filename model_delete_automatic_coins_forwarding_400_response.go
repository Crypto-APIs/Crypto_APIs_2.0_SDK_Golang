...
type DeleteAutomaticCoinsForwarding400Response struct {
...
func NewDeleteAutomaticCoinsForwarding400Response(apiVersion string, requestId string, error_ DeleteAutomaticCoinsForwardingE400) *DeleteAutomaticCoinsForwarding400Response {
	this := DeleteAutomaticCoinsForwarding400Response{}
...
func (o DeleteAutomaticCoinsForwarding400Response) MarshalJSON() ([]byte, error) {
...
type NullableDeleteAutomaticCoinsForwarding400Response struct {
	value *DeleteAutomaticCoinsForwarding400Response
	isSet bool
}

func (v NullableDeleteAutomaticCoinsForwarding400Response) Get() *DeleteAutomaticCoinsForwarding400Response {
	return v.value
}

func (v *NullableDeleteAutomaticCoinsForwarding400Response) Set(val *DeleteAutomaticCoinsForwarding400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAutomaticCoinsForwarding400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAutomaticCoinsForwarding400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAutomaticCoinsForwarding400Response(val *DeleteAutomaticCoinsForwarding400Response) *NullableDeleteAutomaticCoinsForwarding400Response {
	return &NullableDeleteAutomaticCoinsForwarding400Response{value: val, isSet: true}
}

func (v NullableDeleteAutomaticCoinsForwarding400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAutomaticCoinsForwarding400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
