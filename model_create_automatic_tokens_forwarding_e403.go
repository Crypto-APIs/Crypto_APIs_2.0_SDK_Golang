...
type CreateAutomaticTokensForwardingE403 struct {
...
func BannedIpAddressAsCreateAutomaticTokensForwardingE403(v *BannedIpAddress) CreateAutomaticTokensForwardingE403 {
	return CreateAutomaticTokensForwardingE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsCreateAutomaticTokensForwardingE403(v *EndpointNotAllowedForApiKey) CreateAutomaticTokensForwardingE403 {
	return CreateAutomaticTokensForwardingE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsCreateAutomaticTokensForwardingE403(v *EndpointNotAllowedForPlan) CreateAutomaticTokensForwardingE403 {
	return CreateAutomaticTokensForwardingE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsCreateAutomaticTokensForwardingE403(v *FeatureMainnetsNotAllowedForPlan) CreateAutomaticTokensForwardingE403 {
	return CreateAutomaticTokensForwardingE403{ FeatureMainnetsNotAllowedForPlan: v}
}
...
func TokensForwardingAutomationsLimitReachedAsCreateAutomaticTokensForwardingE403(v *TokensForwardingAutomationsLimitReached) CreateAutomaticTokensForwardingE403 {
	return CreateAutomaticTokensForwardingE403{ TokensForwardingAutomationsLimitReached: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *CreateAutomaticTokensForwardingE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(CreateAutomaticTokensForwardingE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(CreateAutomaticTokensForwardingE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CreateAutomaticTokensForwardingE403) MarshalJSON() ([]byte, error) {
...
func (obj *CreateAutomaticTokensForwardingE403) GetActualInstance() (interface{}) {
...
type NullableCreateAutomaticTokensForwardingE403 struct {
	value *CreateAutomaticTokensForwardingE403
	isSet bool
}

func (v NullableCreateAutomaticTokensForwardingE403) Get() *CreateAutomaticTokensForwardingE403 {
	return v.value
}

func (v *NullableCreateAutomaticTokensForwardingE403) Set(val *CreateAutomaticTokensForwardingE403) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAutomaticTokensForwardingE403) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAutomaticTokensForwardingE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAutomaticTokensForwardingE403(val *CreateAutomaticTokensForwardingE403) *NullableCreateAutomaticTokensForwardingE403 {
	return &NullableCreateAutomaticTokensForwardingE403{value: val, isSet: true}
}

func (v NullableCreateAutomaticTokensForwardingE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAutomaticTokensForwardingE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
