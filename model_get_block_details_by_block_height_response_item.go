...
// GetBlockDetailsByBlockHeightResponseItem struct for GetBlockDetailsByBlockHeightResponseItem
type GetBlockDetailsByBlockHeightResponseItem struct {
	...
	BlockchainSpecific GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific `json:"blockchainSpecific"`
}
...
func NewGetBlockDetailsByBlockHeightResponseItem(hash string, height int32, nextBlockHash string, previousBlockHash string, timestamp int32, transactionsCount int32, blockchainSpecific GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific) *GetBlockDetailsByBlockHeightResponseItem {
	this := GetBlockDetailsByBlockHeightResponseItem{}
	this.Hash = hash
	this.Height = height
...
func (o *GetBlockDetailsByBlockHeightResponseItem) GetBlockchainSpecific() GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific {
	if o == nil {
		var ret GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific
		return ret
	}
...
func (o GetBlockDetailsByBlockHeightResponseItem) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockDetailsByBlockHeightResponseItem struct {
	value *GetBlockDetailsByBlockHeightResponseItem
	isSet bool
}

func (v NullableGetBlockDetailsByBlockHeightResponseItem) Get() *GetBlockDetailsByBlockHeightResponseItem {
	return v.value
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItem) Set(val *GetBlockDetailsByBlockHeightResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockDetailsByBlockHeightResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockDetailsByBlockHeightResponseItem(val *GetBlockDetailsByBlockHeightResponseItem) *NullableGetBlockDetailsByBlockHeightResponseItem {
	return &NullableGetBlockDetailsByBlockHeightResponseItem{value: val, isSet: true}
}

func (v NullableGetBlockDetailsByBlockHeightResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockDetailsByBlockHeightResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
