...
// InlineResponse40098 struct for InlineResponse40098
type InlineResponse40098 struct {
...
func (o InlineResponse40098) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse40098 struct {
	value *InlineResponse40098
	isSet bool
}

func (v NullableInlineResponse40098) Get() *InlineResponse40098 {
	return v.value
}

func (v *NullableInlineResponse40098) Set(val *InlineResponse40098) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse40098) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse40098) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse40098(val *InlineResponse40098) *NullableInlineResponse40098 {
	return &NullableInlineResponse40098{value: val, isSet: true}
}

func (v NullableInlineResponse40098) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse40098) UnmarshalJSON(src []byte) error {
	v.isSet = true
