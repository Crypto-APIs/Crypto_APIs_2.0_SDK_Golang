...
type ListAssetsDetailsResponseItemLatestRate struct {
...
func NewListAssetsDetailsResponseItemLatestRate(amount string, unit string) *ListAssetsDetailsResponseItemLatestRate {
	this := ListAssetsDetailsResponseItemLatestRate{}
	this.Amount = amount
	this.Unit = unit
	return &this
}
...
func (o ListAssetsDetailsResponseItemLatestRate) MarshalJSON() ([]byte, error) {
...
type NullableListAssetsDetailsResponseItemLatestRate struct {
	value *ListAssetsDetailsResponseItemLatestRate
	isSet bool
}

func (v NullableListAssetsDetailsResponseItemLatestRate) Get() *ListAssetsDetailsResponseItemLatestRate {
	return v.value
}

func (v *NullableListAssetsDetailsResponseItemLatestRate) Set(val *ListAssetsDetailsResponseItemLatestRate) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssetsDetailsResponseItemLatestRate) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssetsDetailsResponseItemLatestRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssetsDetailsResponseItemLatestRate(val *ListAssetsDetailsResponseItemLatestRate) *NullableListAssetsDetailsResponseItemLatestRate {
	return &NullableListAssetsDetailsResponseItemLatestRate{value: val, isSet: true}
}

func (v NullableListAssetsDetailsResponseItemLatestRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssetsDetailsResponseItemLatestRate) UnmarshalJSON(src []byte) error {
	v.isSet = true
