...
type ListXRPRippleTransactionsByAddressAndTimeRange400Response struct {
	...
	Error ListXRPRippleTransactionsByAddressAndTimeRangeE400 `json:"error"`
}
...
func NewListXRPRippleTransactionsByAddressAndTimeRange400Response(apiVersion string, requestId string, error_ ListXRPRippleTransactionsByAddressAndTimeRangeE400) *ListXRPRippleTransactionsByAddressAndTimeRange400Response {
	this := ListXRPRippleTransactionsByAddressAndTimeRange400Response{}
...
func (o *ListXRPRippleTransactionsByAddressAndTimeRange400Response) GetError() ListXRPRippleTransactionsByAddressAndTimeRangeE400 {
	if o == nil {
		var ret ListXRPRippleTransactionsByAddressAndTimeRangeE400
		return ret
	}
...
func (o ListXRPRippleTransactionsByAddressAndTimeRange400Response) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByAddressAndTimeRange400Response struct {
	value *ListXRPRippleTransactionsByAddressAndTimeRange400Response
	isSet bool
}

func (v NullableListXRPRippleTransactionsByAddressAndTimeRange400Response) Get() *ListXRPRippleTransactionsByAddressAndTimeRange400Response {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByAddressAndTimeRange400Response) Set(val *ListXRPRippleTransactionsByAddressAndTimeRange400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByAddressAndTimeRange400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByAddressAndTimeRange400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByAddressAndTimeRange400Response(val *ListXRPRippleTransactionsByAddressAndTimeRange400Response) *NullableListXRPRippleTransactionsByAddressAndTimeRange400Response {
	return &NullableListXRPRippleTransactionsByAddressAndTimeRange400Response{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByAddressAndTimeRange400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByAddressAndTimeRange400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
