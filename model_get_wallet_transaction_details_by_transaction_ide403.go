...
type GetWalletTransactionDetailsByTransactionIDE403 struct {
...
func BannedIpAddressAsGetWalletTransactionDetailsByTransactionIDE403(v *BannedIpAddress) GetWalletTransactionDetailsByTransactionIDE403 {
	return GetWalletTransactionDetailsByTransactionIDE403{ BannedIpAddress: v}
}
...
func EndpointNotAllowedForApiKeyAsGetWalletTransactionDetailsByTransactionIDE403(v *EndpointNotAllowedForApiKey) GetWalletTransactionDetailsByTransactionIDE403 {
	return GetWalletTransactionDetailsByTransactionIDE403{ EndpointNotAllowedForApiKey: v}
}
...
func EndpointNotAllowedForPlanAsGetWalletTransactionDetailsByTransactionIDE403(v *EndpointNotAllowedForPlan) GetWalletTransactionDetailsByTransactionIDE403 {
	return GetWalletTransactionDetailsByTransactionIDE403{ EndpointNotAllowedForPlan: v}
}
...
func FeatureMainnetsNotAllowedForPlanAsGetWalletTransactionDetailsByTransactionIDE403(v *FeatureMainnetsNotAllowedForPlan) GetWalletTransactionDetailsByTransactionIDE403 {
	return GetWalletTransactionDetailsByTransactionIDE403{ FeatureMainnetsNotAllowedForPlan: v}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetWalletTransactionDetailsByTransactionIDE403) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(GetWalletTransactionDetailsByTransactionIDE403)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(GetWalletTransactionDetailsByTransactionIDE403)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetWalletTransactionDetailsByTransactionIDE403) MarshalJSON() ([]byte, error) {
...
func (obj *GetWalletTransactionDetailsByTransactionIDE403) GetActualInstance() (interface{}) {
...
type NullableGetWalletTransactionDetailsByTransactionIDE403 struct {
	value *GetWalletTransactionDetailsByTransactionIDE403
	isSet bool
}

func (v NullableGetWalletTransactionDetailsByTransactionIDE403) Get() *GetWalletTransactionDetailsByTransactionIDE403 {
	return v.value
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDE403) Set(val *GetWalletTransactionDetailsByTransactionIDE403) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWalletTransactionDetailsByTransactionIDE403) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDE403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWalletTransactionDetailsByTransactionIDE403(val *GetWalletTransactionDetailsByTransactionIDE403) *NullableGetWalletTransactionDetailsByTransactionIDE403 {
	return &NullableGetWalletTransactionDetailsByTransactionIDE403{value: val, isSet: true}
}

func (v NullableGetWalletTransactionDetailsByTransactionIDE403) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWalletTransactionDetailsByTransactionIDE403) UnmarshalJSON(src []byte) error {
	v.isSet = true
