...
type EstimateTransactionSmartFee501Response struct {
...
func NewEstimateTransactionSmartFee501Response(apiVersion string, requestId string, error_ Unimplemented) *EstimateTransactionSmartFee501Response {
	this := EstimateTransactionSmartFee501Response{}
...
func (o EstimateTransactionSmartFee501Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateTransactionSmartFee501Response struct {
	value *EstimateTransactionSmartFee501Response
	isSet bool
}

func (v NullableEstimateTransactionSmartFee501Response) Get() *EstimateTransactionSmartFee501Response {
	return v.value
}

func (v *NullableEstimateTransactionSmartFee501Response) Set(val *EstimateTransactionSmartFee501Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateTransactionSmartFee501Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateTransactionSmartFee501Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateTransactionSmartFee501Response(val *EstimateTransactionSmartFee501Response) *NullableEstimateTransactionSmartFee501Response {
	return &NullableEstimateTransactionSmartFee501Response{value: val, isSet: true}
}

func (v NullableEstimateTransactionSmartFee501Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateTransactionSmartFee501Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
