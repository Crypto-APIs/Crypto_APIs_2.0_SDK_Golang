...
type ListAllAssetsFromAllWallets401Response struct {
	...
	Error ListAllAssetsFromAllWalletsE401 `json:"error"`
}
...
func NewListAllAssetsFromAllWallets401Response(apiVersion string, requestId string, error_ ListAllAssetsFromAllWalletsE401) *ListAllAssetsFromAllWallets401Response {
	this := ListAllAssetsFromAllWallets401Response{}
...
func (o *ListAllAssetsFromAllWallets401Response) GetError() ListAllAssetsFromAllWalletsE401 {
	if o == nil {
		var ret ListAllAssetsFromAllWalletsE401
		return ret
	}
...
func (o ListAllAssetsFromAllWallets401Response) MarshalJSON() ([]byte, error) {
...
type NullableListAllAssetsFromAllWallets401Response struct {
	value *ListAllAssetsFromAllWallets401Response
	isSet bool
}

func (v NullableListAllAssetsFromAllWallets401Response) Get() *ListAllAssetsFromAllWallets401Response {
	return v.value
}

func (v *NullableListAllAssetsFromAllWallets401Response) Set(val *ListAllAssetsFromAllWallets401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAllAssetsFromAllWallets401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAllAssetsFromAllWallets401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAllAssetsFromAllWallets401Response(val *ListAllAssetsFromAllWallets401Response) *NullableListAllAssetsFromAllWallets401Response {
	return &NullableListAllAssetsFromAllWallets401Response{value: val, isSet: true}
}

func (v NullableListAllAssetsFromAllWallets401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAllAssetsFromAllWallets401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
