...
// ListTransactionsByBlockHashRIBSBCVin struct for ListTransactionsByBlockHashRIBSBCVin
type ListTransactionsByBlockHashRIBSBCVin struct {
...
func NewListTransactionsByBlockHashRIBSBCVin(addresses []string, coinbase string, scriptSig GetTransactionDetailsByTransactionIDRIBSBScriptSig, sequence string, txid string, txinwitness []string, value string, vout int32) *ListTransactionsByBlockHashRIBSBCVin {
	this := ListTransactionsByBlockHashRIBSBCVin{}
...
func (o ListTransactionsByBlockHashRIBSBCVin) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashRIBSBCVin struct {
	value *ListTransactionsByBlockHashRIBSBCVin
	isSet bool
}

func (v NullableListTransactionsByBlockHashRIBSBCVin) Get() *ListTransactionsByBlockHashRIBSBCVin {
	return v.value
}

func (v *NullableListTransactionsByBlockHashRIBSBCVin) Set(val *ListTransactionsByBlockHashRIBSBCVin) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashRIBSBCVin) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashRIBSBCVin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashRIBSBCVin(val *ListTransactionsByBlockHashRIBSBCVin) *NullableListTransactionsByBlockHashRIBSBCVin {
	return &NullableListTransactionsByBlockHashRIBSBCVin{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashRIBSBCVin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashRIBSBCVin) UnmarshalJSON(src []byte) error {
	v.isSet = true
