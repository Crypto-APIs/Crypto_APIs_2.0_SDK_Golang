...
type GetHDWalletXPubYPubZPubDetails400Response struct {
	...
	Error GetHDWalletXPubYPubZPubDetailsE400 `json:"error"`
}
...
func NewGetHDWalletXPubYPubZPubDetails400Response(apiVersion string, requestId string, error_ GetHDWalletXPubYPubZPubDetailsE400) *GetHDWalletXPubYPubZPubDetails400Response {
	this := GetHDWalletXPubYPubZPubDetails400Response{}
...
func (o *GetHDWalletXPubYPubZPubDetails400Response) GetError() GetHDWalletXPubYPubZPubDetailsE400 {
	if o == nil {
		var ret GetHDWalletXPubYPubZPubDetailsE400
		return ret
	}
...
func (o GetHDWalletXPubYPubZPubDetails400Response) MarshalJSON() ([]byte, error) {
...
type NullableGetHDWalletXPubYPubZPubDetails400Response struct {
	value *GetHDWalletXPubYPubZPubDetails400Response
	isSet bool
}

func (v NullableGetHDWalletXPubYPubZPubDetails400Response) Get() *GetHDWalletXPubYPubZPubDetails400Response {
	return v.value
}

func (v *NullableGetHDWalletXPubYPubZPubDetails400Response) Set(val *GetHDWalletXPubYPubZPubDetails400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHDWalletXPubYPubZPubDetails400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHDWalletXPubYPubZPubDetails400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHDWalletXPubYPubZPubDetails400Response(val *GetHDWalletXPubYPubZPubDetails400Response) *NullableGetHDWalletXPubYPubZPubDetails400Response {
	return &NullableGetHDWalletXPubYPubZPubDetails400Response{value: val, isSet: true}
}

func (v NullableGetHDWalletXPubYPubZPubDetails400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHDWalletXPubYPubZPubDetails400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
