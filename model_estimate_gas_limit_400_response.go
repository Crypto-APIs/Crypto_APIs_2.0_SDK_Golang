...
type EstimateGasLimit400Response struct {
	...
	Error EstimateGasLimitE400 `json:"error"`
}
...
func NewEstimateGasLimit400Response(apiVersion string, requestId string, error_ EstimateGasLimitE400) *EstimateGasLimit400Response {
	this := EstimateGasLimit400Response{}
...
func (o EstimateGasLimit400Response) MarshalJSON() ([]byte, error) {
...
type NullableEstimateGasLimit400Response struct {
	value *EstimateGasLimit400Response
	isSet bool
}

func (v NullableEstimateGasLimit400Response) Get() *EstimateGasLimit400Response {
	return v.value
}

func (v *NullableEstimateGasLimit400Response) Set(val *EstimateGasLimit400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEstimateGasLimit400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEstimateGasLimit400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstimateGasLimit400Response(val *EstimateGasLimit400Response) *NullableEstimateGasLimit400Response {
	return &NullableEstimateGasLimit400Response{value: val, isSet: true}
}

func (v NullableEstimateGasLimit400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstimateGasLimit400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
