...
// ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout struct for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout
type ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey `json:"scriptPubKey"`
...
func NewListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout(isSpent bool, scriptPubKey ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey, value string) *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout {
	this := ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout{}
...
func (o *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) GetScriptPubKey() ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey {
	if o == nil {
		var ret ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey
		return ret
	}
...
func (o ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) MarshalJSON() ([]byte, error) {
...
type NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout struct {
	value *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout
	isSet bool
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) Get() *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout {
	return v.value
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) Set(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) {
	v.value = val
	v.isSet = true
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) IsSet() bool {
	return v.isSet
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout(val *ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout {
	return &NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout{value: val, isSet: true}
}

func (v NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
