...
// ListUnconfirmedTransactionsByAddressRIBSBCVout struct for ListUnconfirmedTransactionsByAddressRIBSBCVout
type ListUnconfirmedTransactionsByAddressRIBSBCVout struct {
	// Defines whether the output is spent or not.
	IsSpent bool `json:"isSpent"`
	ScriptPubKey ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey `json:"scriptPubKey"`
...
func NewListUnconfirmedTransactionsByAddressRIBSBCVout(isSpent bool, scriptPubKey ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey, value string) *ListUnconfirmedTransactionsByAddressRIBSBCVout {
	this := ListUnconfirmedTransactionsByAddressRIBSBCVout{}
...
func (o *ListUnconfirmedTransactionsByAddressRIBSBCVout) GetScriptPubKey() ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey {
	if o == nil {
		var ret ListUnconfirmedTransactionsByAddressRIBSBCScriptPubKey
		return ret
	}
...
func (o ListUnconfirmedTransactionsByAddressRIBSBCVout) MarshalJSON() ([]byte, error) {
...
type NullableListUnconfirmedTransactionsByAddressRIBSBCVout struct {
	value *ListUnconfirmedTransactionsByAddressRIBSBCVout
	isSet bool
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCVout) Get() *ListUnconfirmedTransactionsByAddressRIBSBCVout {
	return v.value
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCVout) Set(val *ListUnconfirmedTransactionsByAddressRIBSBCVout) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCVout) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCVout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnconfirmedTransactionsByAddressRIBSBCVout(val *ListUnconfirmedTransactionsByAddressRIBSBCVout) *NullableListUnconfirmedTransactionsByAddressRIBSBCVout {
	return &NullableListUnconfirmedTransactionsByAddressRIBSBCVout{value: val, isSet: true}
}

func (v NullableListUnconfirmedTransactionsByAddressRIBSBCVout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnconfirmedTransactionsByAddressRIBSBCVout) UnmarshalJSON(src []byte) error {
	v.isSet = true
