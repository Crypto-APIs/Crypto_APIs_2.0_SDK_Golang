...
type NewConfirmedCoinsTransactions400Response struct {
	...
	Error NewConfirmedCoinsTransactionsE400 `json:"error"`
}
...
func NewNewConfirmedCoinsTransactions400Response(apiVersion string, requestId string, error_ NewConfirmedCoinsTransactionsE400) *NewConfirmedCoinsTransactions400Response {
	this := NewConfirmedCoinsTransactions400Response{}
...
func (o *NewConfirmedCoinsTransactions400Response) GetError() NewConfirmedCoinsTransactionsE400 {
	if o == nil {
		var ret NewConfirmedCoinsTransactionsE400
		return ret
	}
...
func (o NewConfirmedCoinsTransactions400Response) MarshalJSON() ([]byte, error) {
...
type NullableNewConfirmedCoinsTransactions400Response struct {
	value *NewConfirmedCoinsTransactions400Response
	isSet bool
}

func (v NullableNewConfirmedCoinsTransactions400Response) Get() *NewConfirmedCoinsTransactions400Response {
	return v.value
}

func (v *NullableNewConfirmedCoinsTransactions400Response) Set(val *NewConfirmedCoinsTransactions400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNewConfirmedCoinsTransactions400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNewConfirmedCoinsTransactions400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewConfirmedCoinsTransactions400Response(val *NewConfirmedCoinsTransactions400Response) *NullableNewConfirmedCoinsTransactions400Response {
	return &NullableNewConfirmedCoinsTransactions400Response{value: val, isSet: true}
}

func (v NullableNewConfirmedCoinsTransactions400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewConfirmedCoinsTransactions400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
