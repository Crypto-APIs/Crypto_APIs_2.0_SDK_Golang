...
// ListXRPRippleTransactionsByBlockHashResponseData struct for ListXRPRippleTransactionsByBlockHashResponseData
type ListXRPRippleTransactionsByBlockHashResponseData struct {
	...
	Items []ListXRPRippleTransactionsByBlockHashResponseItem `json:"items"`
}
...
func NewListXRPRippleTransactionsByBlockHashResponseData(offset int32, limit int32, total int32, items []ListXRPRippleTransactionsByBlockHashResponseItem) *ListXRPRippleTransactionsByBlockHashResponseData {
	this := ListXRPRippleTransactionsByBlockHashResponseData{}
	this.Offset = offset
	this.Limit = limit
	this.Total = total
	this.Items = items
...
func (o *ListXRPRippleTransactionsByBlockHashResponseData) GetItems() []ListXRPRippleTransactionsByBlockHashResponseItem {
	if o == nil {
		var ret []ListXRPRippleTransactionsByBlockHashResponseItem
		return ret
	}
...
func (o ListXRPRippleTransactionsByBlockHashResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListXRPRippleTransactionsByBlockHashResponseData struct {
	value *ListXRPRippleTransactionsByBlockHashResponseData
	isSet bool
}

func (v NullableListXRPRippleTransactionsByBlockHashResponseData) Get() *ListXRPRippleTransactionsByBlockHashResponseData {
	return v.value
}

func (v *NullableListXRPRippleTransactionsByBlockHashResponseData) Set(val *ListXRPRippleTransactionsByBlockHashResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListXRPRippleTransactionsByBlockHashResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListXRPRippleTransactionsByBlockHashResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListXRPRippleTransactionsByBlockHashResponseData(val *ListXRPRippleTransactionsByBlockHashResponseData) *NullableListXRPRippleTransactionsByBlockHashResponseData {
	return &NullableListXRPRippleTransactionsByBlockHashResponseData{value: val, isSet: true}
}

func (v NullableListXRPRippleTransactionsByBlockHashResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListXRPRippleTransactionsByBlockHashResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
